...
# Embedded file name: advent_calendar/scripts/client/advent_calendar/gui/feature/constants.py
...
ADVENT_PRESETS_WITH_DISABLED_ANIMATION = (GraphicsPresetSystemSettings.LOW.value,)
