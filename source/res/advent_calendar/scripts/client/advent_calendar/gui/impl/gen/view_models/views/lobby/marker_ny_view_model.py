...
# Embedded file name: advent_calendar/scripts/client/advent_calendar/gui/impl/gen/view_models/views/lobby/marker_ny_view_model.py
from frameworks.wulf import ViewModel

class MarkerNyViewModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=4, commands=0):
        super(MarkerNyViewModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(MarkerNyViewModel, self)._initialize()
