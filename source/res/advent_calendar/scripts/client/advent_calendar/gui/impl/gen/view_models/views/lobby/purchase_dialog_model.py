...
# Embedded file name: advent_calendar/scripts/client/advent_calendar/gui/impl/gen/view_models/views/lobby/purchase_dialog_model.py
from frameworks.wulf import ViewModel
from advent_calendar.gui.impl.gen.view_models.views.lobby.components.advent_calendar_ny_kit_model import AdventCalendarNyKitModel
...
class PurchaseDialogModel(ViewModel):
    __slots__ = ('onAccept', 'onCancel', 'onSwitchToBoxes')
    ...
    def _initialize(self):
        ...
        self.onSwitchToBoxes = self._addCommand('onSwitchToBoxes')
