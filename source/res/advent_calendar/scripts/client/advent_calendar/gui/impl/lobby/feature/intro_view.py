...
class AdventCalendarIntroView(BaseView):
    __adventController = dependency.descriptor(IAdventCalendarController)

    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.advent_calendar.lobby.feature.IntroScreenView(), model=IntroScreenModel(), args=args, kwargs=kwargs)
    ...
    def _onLoading(self, isFirstTime=False, *args, **kwargs):
