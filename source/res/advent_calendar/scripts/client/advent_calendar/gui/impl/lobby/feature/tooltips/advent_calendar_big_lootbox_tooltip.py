...
def _sortGroups(bonusGroup):
    ...
    return list(_PROBABILITY_GROUPS_ORDER.keys()).index(groupName) if groupName in _PROBABILITY_GROUPS_ORDER else len(_PROBABILITY_GROUPS_ORDER)
...
class AdventCalendarBigLootBoxTooltip(ViewImpl):
    ...
    def _getEvents(self):
        return ((self.__adventController.onLootBoxInfoUpdated, self.__updateModel),)
