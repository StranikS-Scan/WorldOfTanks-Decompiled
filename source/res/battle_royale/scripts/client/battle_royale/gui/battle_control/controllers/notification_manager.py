...
class NotificationManager(object):
    ...
    def addMessageToQueues(self, idx, message):
        ...
        if idx in (NotificationType.allyInBattleMsg, NotificationType.stayInCoverMsg):
            self.__curStateMsg = NotificationObj(idx, message.copy())
        elif idx in (NotificationType.allyRespawnedMessage, NotificationType.respNotAvailableMsg):
            self.__curStateMsg = None
