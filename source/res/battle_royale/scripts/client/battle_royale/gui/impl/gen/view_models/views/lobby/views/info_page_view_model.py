...
# Embedded file name: battle_royale/scripts/client/battle_royale/gui/impl/gen/view_models/views/lobby/views/info_page_view_model.py
...
class InfoPageViewModel(ViewModel):
    ...
    def __init__(self, properties=5, commands=2):
        super(InfoPageViewModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(InfoPageViewModel, self)._initialize()
