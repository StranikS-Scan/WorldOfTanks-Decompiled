...
class BattleQuestAwardsView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        return ProxyCurrencyTooltipView() if contentID == R.views.battle_royale.mono.lobby.tooltips.proxy_currency_tooltip() else super(BattleQuestAwardsView, self).createToolTipContent(event, contentID)
