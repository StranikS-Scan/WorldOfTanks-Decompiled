...
class CurrenciesBonusUIPacker(SimpleBonusUIPacker):
    ...
    def _getContentId(cls, bonus):
        return [R.views.battle_royale.mono.lobby.tooltips.proxy_currency_tooltip()] if bonus.getCode() == STP_COIN else super(CurrenciesBonusUIPacker, cls)._getContentId(bonus)
