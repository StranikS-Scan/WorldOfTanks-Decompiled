...
# Embedded file name: comp7/scripts/client/comp7/gui/Scaleform/daapi/view/battle/full_stats.py
from comp7.gui.Scaleform.daapi.view.battle.comp7_voip_helper import Comp7VoipHelper, VoiceChatControlTextStyles
from comp7.gui.Scaleform.daapi.view.meta.Comp7FullStatsMeta import Comp7FullStatsMeta
