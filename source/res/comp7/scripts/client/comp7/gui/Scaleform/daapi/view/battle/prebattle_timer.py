...
# Embedded file name: comp7/scripts/client/comp7/gui/Scaleform/daapi/view/battle/prebattle_timer.py
import BattleReplay
from constants import ARENA_PERIOD, VEHICLE_SELECTION_BLOCK_DELAY
from comp7.gui.Scaleform.daapi.view.meta.Comp7PrebattleTimerMeta import Comp7PrebattleTimerMeta
