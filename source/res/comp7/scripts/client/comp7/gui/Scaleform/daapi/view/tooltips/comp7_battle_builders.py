...
def getTooltipBuilders():
    return (DataBuilder(COMP7_BATTLE_TOOLTIPS.COMP7_ROLE_SKILL_BATTLE_TOOLTIP, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, Comp7RoleSkillBattleTooltipData(Comp7RoleSkillBattleContext())), TooltipWindowBuilder(TOOLTIPS_CONSTANTS.VEHICLE_ROLES, None, vehicle_roles.VehicleRolesTooltipContentWindowData(contexts.ToolTipContext(None))))
