...
# Embedded file name: comp7/scripts/client/comp7/gui/impl/gen/view_models/views/lobby/wci/wci_view_model.py
...
class WciViewModel(ViewModel):
    __slots__ = ('onWatchStreamingOne', 'onWatchStreamingTwo', 'onGoToShop', 'onRefresh', 'onClose')
