...
# Embedded file name: comp7/scripts/client/comp7/gui/impl/lobby/comp7_grand_tournament_widget.py
import logging
from comp7.gui.impl.gen.view_models.views.lobby.comp7_grand_tournament_widget_model import Comp7GrandTournamentWidgetModel, Comp7GrandTournamentState
...
class Comp7GrandTournamentWidget(ViewImpl):
    ...
    def __init__(self, flags=ViewFlags.VIEW):
        settings = ViewSettings(R.views.comp7.mono.lobby.grand_tournament_widget())
