...
# Embedded file name: comp7/scripts/client/comp7/gui/impl/lobby/main_widget.py
from comp7.gui.impl.gen.view_models.views.lobby.main_widget_model import MainWidgetModel
...
class Comp7MainWidget(ViewImpl):
    ...
    def __init__(self, flags=ViewFlags.VIEW):
        settings = ViewSettings(R.views.comp7.lobby.MainWidget())
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.comp7.lobby.tooltips.MainWidgetTooltip():
            return MainWidgetTooltip()
        return RankInactivityTooltip() if contentID == R.views.comp7.lobby.tooltips.RankInactivityTooltip() else super(Comp7MainWidget, self).createToolTipContent(event, contentID)
    ...
    def __onOpenMetaClick():
        comp7_events.showComp7MetaRootView()
