...
def registerComp7LightScaleform():
    ...
    registerBattleTooltipsBuilders([('comp7_light.gui.Scaleform.daapi.view.tooltips.comp7_light_battle_builders', COMP7_LIGHT_BATTLE_TOOLTIPS.COMP7_LIGHT_BATTLE_SET)])
