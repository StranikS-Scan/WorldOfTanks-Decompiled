...
class _Comp7LightConfig(namedtuple('_Comp7LightConfig', ('isEnabled', 'isTrainingEnabled', 'peripheryIDs', 'primeTimes', 'seasons', 'cycleTimes', 'battleModifiersDescr', 'maps', 'levels', 'numPlayers', 'squadSizes', 'allowedVehTypes', 'roleEquipments', 'roleEquipmentsByVehicle', 'poiEquipments', 'createVivoxTeamChannels', 'tournaments', 'progression'))):
    __slots__ = ()

    def __new__(cls, **kwargs):
        defaults = dict(isEnabled=False, isTrainingEnabled=False, peripheryIDs={}, primeTimes={}, seasons={}, cycleTimes={}, battleModifiersDescr=(), maps=set(), levels=[], numPlayers=7, squadSizes=[0, 0], allowedVehTypes=set(), roleEquipments={}, roleEquipmentsByVehicle={}, poiEquipments={}, createVivoxTeamChannels=False, tournaments={}, progression={})
