...
# Embedded file name: comp7_light_progression/scripts/client/comp7_light_progression/gui/game_control/progression_controller.py
import logging
import typing
import Event
from PlayerEvents import g_playerEvents
from account_helpers import AccountSettings
from account_helpers.AccountSettings import COMP7_LIGHT_PROGRESSION_POINTS_SEEN
...
class ProgressionOnTokensController(IComp7LightProgressionOnTokensController):
...
class BaseProgressionWithBattleQuests(ProgressionOnConfig):
    ProgressionFilterFuncKey = 'Comp7LightFuncKey'
...
class Comp7LightProgressionController(BaseProgressionWithBattleQuests):
    PREV_POINTS_ACC_SETTINGS_KEY = COMP7_LIGHT_PROGRESSION_POINTS_SEEN
    progressionToken = 'img:comp7_light:progression'
