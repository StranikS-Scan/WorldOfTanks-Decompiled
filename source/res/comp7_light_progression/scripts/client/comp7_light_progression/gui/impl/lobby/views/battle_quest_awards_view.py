...
# Embedded file name: comp7_light_progression/scripts/client/comp7_light_progression/gui/impl/lobby/views/battle_quest_awards_view.py
from comp7_light_progression.gui.impl.gen.view_models.views.lobby.views.battle_quest_awards_model import BattleQuestAwardsModel, BattleStatus
...
class BattleQuestAwardsView(ViewImpl):
    ...
    def __init__(self, stage):
        settings = ViewSettings(R.views.comp7_light_progression.BattleQuestAwardsView())
