...
# Embedded file name: comp7_light_progression/scripts/client/comp7_light_progression/gui/impl/lobby/views/progression_main_view.py
import typing
from comp7_light_progression.gui.impl.gen.view_models.views.lobby.views.progression.progression_main_view_model import ProgressionMainViewModel, MainViews
from comp7_light_progression.gui.impl.lobby.views.leaderboard_reward_tooltip import LeaderboardRewardTooltipView
from comp7_light_progression.gui.impl.lobby.views.progression_view import ProgressionView
from comp7_light_progression.gui.sounds_constants import GENERAL_SOUND_SPACE
...
class ProgressionMainView(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.comp7_light_progression.ProgressionMainView())
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.comp7_light_progression.LeaderboardRewardTooltipView():
