...
# Embedded file name: comp7_light_progression/scripts/client/comp7_light_progression/skeletons/game_controller.py
from skeletons.gui.game_control import IGameController

class IComp7LightProgressionOnTokensController(IGameController):
    progressionToken = ''
