...
class AccountCosmicEventComponent(BaseAccountExtensionComponent):
    ...
    def enqueue(self, vehInvID):
        if not events.isPlayerEntityChanging:
            ...
            self.base.doCmdIntArr(AccountCommands.REQUEST_ID_NO_RESPONSE, AccountCommands.CMD_ENQUEUE_IN_BATTLE_QUEUE, [self._QUEUE_TYPE, vehInvID, ctrl.getSelectedVehicleCD()])
