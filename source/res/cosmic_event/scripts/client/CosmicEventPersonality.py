...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionBattlePackages(__name__, ['cosmic_event.gui.Scaleform.daapi.view.battle.cosmic', 'cosmic_event.gui.Scaleform.daapi.view.battle.shared'], cosmic_constants.ARENA_GUI_TYPE.COSMIC_EVENT)
