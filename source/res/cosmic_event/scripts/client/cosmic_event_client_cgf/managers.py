...
# Embedded file name: cosmic_event/scripts/client/cosmic_event_client_cgf/managers.py
import CGF
...
class CosmicEffectComponentManager(CGF.ComponentManager):
    ...
    @onProcessQuery(GenericComponents.DynamicModelComponent, GunShotEffectComponent, UserGunShotEffectComponent, tickGroup='PostHierarchy', period=0.2)
