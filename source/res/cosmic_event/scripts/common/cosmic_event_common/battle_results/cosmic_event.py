...
BATTLE_RESULTS = [('cosmicTotalScore',
 ...
 ('cosmicScore/ASSIST',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/FIRST_BLOOD',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/KILL_STREAK',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/LOOT_RESEARCHING',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/LOOT_RESEARCHING_DONE',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/LOOT_RESEARCHABLE_PICK_UP',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicScore/MAX_KILL_SERIES',
  int,
  0,
  None,
  'skip',
 ...
 ('cosmicBattleEvent/ARTIFACT_SCAN',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/ASSIST',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/FIRST_BLOOD',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/KILL_STREAK',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/LOOT_RESEARCHING',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/LOOT_RESEARCHING_DONE',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/LOOT_RESEARCHABLE_PICK_UP',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/MAX_KILL_SERIES',
  int,
  0,
  None,
  'skip',
 ...
 ('cosmicEquipment/2459899',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_shield',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_rocket_booster',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_wave',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_mine',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_teleport',
  int,
  0,
  None,
  'sum',
 ...
 ('cosmicAbilitiesImpacts/POWER_SHOT',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicAbilitiesImpacts/TELEPORT',
  int,
  0,
  None,
  'sum',
