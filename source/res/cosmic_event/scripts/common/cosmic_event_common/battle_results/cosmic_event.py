...
BATTLE_RESULTS = [('cosmicTotalScore',
 ...
 ('cosmicBattleEvent/KILL_STREAK',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/PICKUP_MASTER',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/REVENGE',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_ALL),
 ('cosmicBattleEvent/BOOST_ME',
  int,
  0,
  None,
  'sum',
 ...
 ('cosmicEquipment/cosmic_event_wave',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('cosmicEquipment/cosmic_event_stun_shot',
  int,
  0,
  None,
  'sum',
