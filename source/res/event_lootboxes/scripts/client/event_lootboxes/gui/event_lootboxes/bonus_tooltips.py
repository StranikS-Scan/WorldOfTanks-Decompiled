...
# Embedded file name: event_lootboxes/scripts/client/event_lootboxes/gui/event_lootboxes/bonus_tooltips.py
...
class EventLootBoxVehicleBlueprintFragmentTooltipData(BlocksTooltipData):
    __itemsCache = dependency.descriptor(IItemsCache)

    def __init__(self, context):
        super(EventLootBoxVehicleBlueprintFragmentTooltipData, self).__init__(context, None)
        return

    def _packBlocks(self, vehicleCDs):
        self._items = super(EventLootBoxVehicleBlueprintFragmentTooltipData, self)._packBlocks()
