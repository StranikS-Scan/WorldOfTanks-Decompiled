...
TABS = [(TabType.PROGRESS, R.views.frontline.lobby.ProgressView(), sub_views.ProgressView), (TabType.REWARDS, R.views.frontline.lobby.RewardsView(), sub_views.RewardsView), (TabType.INFO, R.views.frontline.lobby.InfoView(), sub_views.InfoView)]
DEFAULT_TAB_ID = 0

class FrontlineContainerView(ViewImpl):
    __epicController = dependency.descriptor(IEpicBattleMetaGameController)
    __slots__ = ('_activeTab', '_tabTypeToID', '_seasonId')
