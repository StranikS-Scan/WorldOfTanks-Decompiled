...
def getViewSettings():
    ...
    from fun_random.gui.Scaleform.daapi.view.lobby.hangar.fun_random_modifiers_panel import FunRandomModifiersPanelInject
    return (ComponentSettings(HANGAR_ALIASES.FUN_RANDOM_TANK_CAROUSEL, FunRandomTankCarousel, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(HANGAR_ALIASES.FUN_RANDOM_MODIFIERS_PANEL, FunRandomModifiersPanelInject, ScopeTemplates.DEFAULT_SCOPE),
