...
def getTooltipBuilders():
    return (DataBuilder(FunRandomTooltipConstants.FUN_RANDOM_CALENDAR_DAY, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, FunRandomCalendarDayTooltip(contexts.ToolTipContext(None))), DataBuilder(FunRandomTooltipConstants.FUN_RANDOM_MODE_SELECTOR_CALENDAR_DAY, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, FunRandomModeSelectorCalendarTooltip(contexts.ToolTipContext(None))), DataBuilder(FunRandomTooltipConstants.FUN_RANDOM_REWARDS, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, FunRandomRewardsTooltip(contexts.ToolTipContext(None))))
