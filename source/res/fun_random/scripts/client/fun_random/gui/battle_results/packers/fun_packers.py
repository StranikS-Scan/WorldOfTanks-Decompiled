...
class FunRandomTeamStats(TeamStats):
    ...
    _STATS_EFFICIENCY = ((TeamStatsColumnTypes.DAMAGE, lambda sInfo: sInfo.damageDealt, StatsValueType.INTEGER), (TeamStatsColumnTypes.FRAG, lambda sInfo: sInfo.kills, StatsValueType.INTEGER), (TeamStatsColumnTypes.XP, lambda sInfo: sInfo.xp, StatsValueType.INTEGER))
