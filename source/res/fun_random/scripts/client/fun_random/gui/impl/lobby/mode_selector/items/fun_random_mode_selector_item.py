    ...
    def __fillModel(self):
        ...
        if not hasSeasons or not self.__funRandomCtrl.isEnabled():
            ...
            with self.viewModel.transaction() as model:
                ...
                model.setConditions(backport.text(R.strings.mode_selector.mode.dyn(self.modeName).condition(), levels=toRomanRangeString(self.__funRandomCtrl.getModeSettings().levels)))
