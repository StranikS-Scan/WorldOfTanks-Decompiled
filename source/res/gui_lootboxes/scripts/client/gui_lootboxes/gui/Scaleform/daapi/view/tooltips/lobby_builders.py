...
def getTooltipBuilders():
    return (DataBuilder(TOOLTIPS_CONSTANTS.LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, LootBoxVehicleBlueprintFragmentTooltipData(contexts.ToolTipContext(None))), TooltipWindowBuilder(TOOLTIPS_CONSTANTS.LOOT_BOX_TOOLTIP, None, LootBoxTooltipData(contexts.ToolTipContext(None))), TooltipWindowBuilder(TOOLTIPS_CONSTANTS.LOOT_BOX_GUARANTEED_REWARD_TOOLTIP, None, LootBoxGuaranteedRewardTooltipData(contexts.ToolTipContext(None))))
