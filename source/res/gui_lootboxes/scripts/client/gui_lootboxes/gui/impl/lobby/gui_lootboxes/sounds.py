...
# Embedded file name: gui_lootboxes/scripts/client/gui_lootboxes/gui/impl/lobby/gui_lootboxes/sounds.py
import WWISE
...
class LootboxRewardVideoSoundControl(LootboxVideoSoundControl):
    ...
    def __init__(self):
        super(LootboxRewardVideoSoundControl, self).__init__('')
