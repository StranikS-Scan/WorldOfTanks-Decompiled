...
_AUTO_BOXES_SUB_FORMATTERS = (auto_boxes_subformatters.EventBoxesFormatter(), auto_boxes_subformatters.EventLootBoxesFormatter(), auto_boxes_subformatters.LunarNYEnvelopeAutoOpenFormatter())
