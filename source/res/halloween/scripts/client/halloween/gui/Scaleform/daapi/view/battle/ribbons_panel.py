...
_RIBBONS_FMTS.update({BATTLE_EFFICIENCY_TYPES.HALLOWEEN_REPAIR: _halloweenRepairRibbonFormatter,
 BATTLE_EFFICIENCY_TYPES.HALLOWEEN_HEALTH_RESTORE: _halloweenRepairRibbonFormatter})
...
class HalloweenBattleRibbonsPanel(BattleRibbonsPanel):
    ...
    def _getRibbonsConfig(self):
        ...
        result.extend([[BATTLE_EFFICIENCY_TYPES.HALLOWEEN_REPAIR, backport.text(R.strings.hw_ingame_gui.efficiencyRibbons.halloweenRepair())], [BATTLE_EFFICIENCY_TYPES.HALLOWEEN_HEALTH_RESTORE, backport.text(R.strings.hw_ingame_gui.efficiencyRibbons.halloweenHealthRestore())]])
        return result
