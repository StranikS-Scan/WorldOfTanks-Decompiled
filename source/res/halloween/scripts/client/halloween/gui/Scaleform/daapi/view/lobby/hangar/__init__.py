...
from halloween.gui.impl.lobby.hw_carousel_entry_view import HWCarouselEntryView
from gui.Scaleform.framework import ScopeTemplates, ComponentSettings, GroupedViewSettings
registerCarouselEventEntryPoint(R.views.halloween.lobby.HWCarouselEntryView(), HWCarouselEntryView)
