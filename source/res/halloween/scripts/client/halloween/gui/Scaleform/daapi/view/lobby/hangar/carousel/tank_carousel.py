...
_EVENT_MIN_RANGE_LEVEL = 'VI'
_EVENT_MAX_RANGE_LEVEL = 'VIII'
...
class HW22TankCarousel(TankCarousel):
    ...
    def __init__(self):
        ...
        self._eventFilterSetupContext = {'event': FilterSetupContext(asset='hw22_event_toggle', ctx={'level1': _EVENT_MIN_RANGE_LEVEL,
                   'level2': _EVENT_MAX_RANGE_LEVEL})}
