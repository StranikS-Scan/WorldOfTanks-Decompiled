...
from gui.battle_results.components.vehicles import RegularVehicleStatsBlock, TeamStatsBlock, _STAT_VALUES_VO_REPLACER, _STAT_STUN_FIELD_NAMES, _getStunFilter
...
class QuestsProgressBlock(base.StatsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        currentPhase = self._hwController.phasesHalloween.getPhaseByIndex(phaseIndex)
        if not currentPhase:
            return
