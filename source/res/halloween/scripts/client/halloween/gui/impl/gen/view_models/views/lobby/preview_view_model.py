...
class PreviewViewModel(BaseViewModel):
    __slots__ = ('onBack', 'onDownloadClick', 'onSoundBtnClick', 'onSlideClick')
    ...
    def getIsDownloadDisabled(self):
        return self._getBool(9)

    def setIsDownloadDisabled(self, value):
    ...
    def _initialize(self):
        ...
        self._addBoolProperty('isDownloadDisabled', False)
        self.onBack = self._addCommand('onBack')
        self.onDownloadClick = self._addCommand('onDownloadClick')
