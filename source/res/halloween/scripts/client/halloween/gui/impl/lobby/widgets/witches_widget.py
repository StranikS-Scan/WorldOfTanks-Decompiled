...
class WitchesWidget(object):
    ...
    def updateAll(self):
        ...
        phases = self._hwController.phasesHalloween.getPhasesByType(phaseType=PhaseType.REGULAR)
        witches.clear()
        for phase in phases:
    ...
    def updateNew(self):
        ...
        for witch in witches:
            ...
            phase = self._hwController.phasesHalloween.getPhaseByIndex(phaseIndex)
            witch.setIsNew(isNewOutro(phase))
