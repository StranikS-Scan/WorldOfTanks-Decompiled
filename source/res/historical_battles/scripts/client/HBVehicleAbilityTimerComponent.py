...
# Embedded file name: historical_battles/scripts/client/HBVehicleAbilityTimerComponent.py
import BigWorld
from gui.battle_control.battle_constants import FEEDBACK_EVENT_ID
from Event import EventsSubscriber

class HBVehicleAbilityTimerComponent(BigWorld.DynamicScriptComponent):

    def __init__(self, timerViewID=None, markerID=None):
        super(HBVehicleAbilityTimerComponent, self).__init__()
