...
from historical_battles.gui.Scaleform.daapi.view.battle.respawn import HistoricalBattlesRespawn
...
def getHBViewSettings():
    ...
    from historical_battles.gui.Scaleform.daapi.view.battle.minimap import HistoricalMinimapComponent
    ...
    from historical_battles.gui.Scaleform.daapi.view.battle.shared.event_battle_hint_panel import HBBattleHintPanel
    from historical_battles.gui.Scaleform.daapi.view.battle.enemies_panel import HistoricalBattlesEnemiesPanel
    from historical_battles.gui.Scaleform.daapi.view.battle.postmortem_panel import HBPostmortemPanel
    return (ViewSettings(VIEW_ALIAS.HISTORICAL_BATTLE_LOADING, HistoricalBattleLoading, getSwfExtensionUrl('historical_battles', 'HBLoading.swf'), WindowLayer.TOP_WINDOW, None, ScopeTemplates.TOP_WINDOW_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.HINT_PANEL, HBBattleHintPanel, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.HISTORICAL_BATTLES_RESPAWN, HistoricalBattlesRespawn, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.HISTORICAL_BATTLES_ENEMIES_PANEL, HistoricalBattlesEnemiesPanel, ScopeTemplates.DEFAULT_SCOPE),
