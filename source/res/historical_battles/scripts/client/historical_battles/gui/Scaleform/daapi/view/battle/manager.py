...
from historical_battles.gui.Scaleform.daapi.view.battle.markers2d import HBVehicleMarkerSettingsPlugin, HBVehicleMarkerPlugin, HBObjectivesMarkerPlugin, HBAreaMarkerPlugin, HBEquipmentsMarkerPlugin
