...
from gui.Scaleform.daapi.view.battle.shared.markers2d.plugins import SettingsPlugin, MarkerPlugin, BaseAreaMarkerPlugin, settings, _EQUIPMENT_DELAY_FORMAT, _EQUIPMENT_DEFAULT_INTERVAL
...
class HBVehicleMarkerPlugin(RespawnableVehicleMarkerPlugin, HBStaticObjectivesMarkerComponent, HBVehicleObjectivesMarkerComponent):
    ...
    def _setMarkerInitialState(self, marker, vInfo):
        ...
        if vehicle is None:
            ...
            if arenaDP.isAlly(vehicleID) and vInfo.isBot and vInfo.vehicleType.classTag == VEHICLE_CLASS_NAME.SPG:
