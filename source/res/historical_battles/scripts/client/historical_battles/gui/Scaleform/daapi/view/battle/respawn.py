...
class HistoricalBattlesRespawn(HBRespawnMeta, CallbackDelayer):
    ...
    def show(self):
        ...
        divisionID = BigWorld.player().HBAvatarComponent.divisionID
        ...
        self.as_setTimerDataS({'time': BigWorld.player().HBAvatarComponent.respawnTime - BigWorld.serverTime(),
    ...
    def onSelectVehicle(self):
        ...
        BigWorld.player().HBAvatarComponent.confirmVehicleSelection()
