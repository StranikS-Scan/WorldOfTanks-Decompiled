...
class HistoricalBattlesTimer(HBTimerMeta, CallbackDelayer):
    ...
    def __phaseUpdate(self, arenaPhases):
        if self.__goalID == GoalId.DEFENCE_SPG.value and arenaPhases.currentWave > self.__currentWave:
    ...
    def __onGoalsUpdated(self, goalsInfo):
        ...
        showProgress = goalID != GoalId.DEFENCE_SPG.value and goalID != GoalId.DEFENCE_COUNTER_ATTACK.value and totalProgress != 0 and not goalFinished and goalID != GoalId.BOSS_ONE.value and goalID != GoalId.BOSS_FEW.value
