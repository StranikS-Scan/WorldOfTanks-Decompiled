...
def isPreviewAvailable():
    ...
    return gameEventController.isEnabled()
...
class HBVehiclePreviewPanel(VehiclePreviewHBPanelMeta):
    ...
    def _updateState(self, *_):
        hbConfig = self.gameEventController.hbConfig
    ...
    def __purchaseMainPrize(self):
        ...
        yield th_await(asyncDoAction(HBShopBuyMainPrizeAction(bundle, showHangarOnClose=True)))
