...
# Embedded file name: historical_battles/scripts/client/historical_battles/gui/Scaleform/daapi/view/meta/HBConsumablesPanelMeta.py
...
class HBConsumablesPanelMeta(ConsumablesPanel):
    ...
    def as_addAbilitySlotS(self, idx, data):
        return self.flashObject.as_addAbilitySlot(idx, data) if self._isDAAPIInited() else None
    ...
    def as_addRoleAbilitySlotS(self, idx, data):
        return self.flashObject.as_addRoleAbilitySlot(idx, data) if self._isDAAPIInited() else None
