...
from historical_battles.gui.impl.lobby.tooltips.hb_efficiency_tooltip import HBEfficiencyTooltipData
...
def getTooltipBuilders():
    return (TooltipWindowBuilder(TOOLTIPS_CONSTANTS.HANGAR_INTERACTIVE_OBJECT, None, HangarInteractiveObjectTooltipContentWindowData(contexts.ToolTipContext(None))),
     ...
     DataBuilder(TOOLTIPS_CONSTANTS.HB_EFFICIENCY_TOOLTIP, TOOLTIPS_CONSTANTS.FINAL_STSTS_UI, HBEfficiencyTooltipData(contexts.FinalStatisticContext())))
