...
class HBEventNotifications(IHBEventNotifications):
    ...
    def pushBattleQuestAwardMessage(self, message):
        self.__systemMessages.proto.serviceChannel.pushClientMessage(message, SCH_CLIENT_MSG_TYPE.HB_BATTLE_QUESTS_NOTIFICATIONS)
    ...
    def __pushHBDefenceStartedNotification(self):
        self.__systemMessages.proto.serviceChannel.pushClientMessage({}, SCH_CLIENT_MSG_TYPE.HB_FRONT_STATE_NOTIFICATION, auxData=FrontsOpenStates.EVENT_STARTED)
