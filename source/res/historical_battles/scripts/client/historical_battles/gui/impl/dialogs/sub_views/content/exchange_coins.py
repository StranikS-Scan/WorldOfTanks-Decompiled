...
class ExchangeCoins(ViewImpl):
    ...
    def _getNoFrontTooltipFactory(front):
        ...
        def create():
            return SimpleTooltipContent(R.views.common.tooltip_window.simple_tooltip_content.SimpleTooltipContent(), body=text(R.strings.hb_shop.coins_exchange.tooltip.noFront.body(), name=text(R.strings.hb_lobby.front.name.capital.dyn(front.getName())()), time=timeLeftFormatted))
