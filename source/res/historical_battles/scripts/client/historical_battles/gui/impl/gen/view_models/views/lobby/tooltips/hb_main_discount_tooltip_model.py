...
# Embedded file name: historical_battles/scripts/client/historical_battles/gui/impl/gen/view_models/views/lobby/tooltips/hb_main_discount_tooltip_model.py
from frameworks.wulf import ViewModel

class HbMainDiscountTooltipModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=4, commands=0):
        super(HbMainDiscountTooltipModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(HbMainDiscountTooltipModel, self)._initialize()
