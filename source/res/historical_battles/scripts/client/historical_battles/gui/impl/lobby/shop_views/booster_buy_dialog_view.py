...
class BoosterBuyDialogView(DialogTemplateView):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        if layout == BundleLayout.NEWBIE:
            self.setSubView(Placeholder.ICON, IconSet(rIcons.order.c_220x220.dyn(order.type.value)(), isBottomPushingDown=False, tooltip=DialogTemplateTooltip(self._orderTooltipFactory)))
        else:
        ...
        self.addButton(ConfirmButton(R.strings.hb_shop.common.button.buy(), buttonType=ButtonType.PRIMARY))
