...
class HBAssistItemPacker(LinerItemPacker):
    ...
    def __init__(self):
        super(HBAssistItemPacker, self).__init__(BATTLE_RESULTS.COMMON_TOOLTIP_ASSIST_HEADER, backport.image(R.images.historical_battles.gui.maps.icons.common.stats.c_48x48.assist()), backport.text(R.strings.battle_results.common.tooltip.hbAssist.description()))
