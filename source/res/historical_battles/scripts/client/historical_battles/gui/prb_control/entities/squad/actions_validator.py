...
from historical_battles.gui.prb_control.entities.pre_queue.actions_validator import SubdivisionValidator as SubdivisionValidatorBase, FrontValidator as FrontValidatorBase
from historical_battles.skeletons.gui.game_event_controller import IGameEventController

class SubdivisionValidator(SubdivisionValidatorBase):
...
class HistoricalBattleSquadActionsValidator(SquadActionsValidator):
    ...
    def _createVehiclesValidator(self, entity):
        return ActionsValidatorComposite(entity, [HistoricalBattleVehiclesValidator(entity), SubdivisionValidator(entity), FrontValidator(entity)])
