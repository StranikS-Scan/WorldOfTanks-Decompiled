...
class HistoricalBattleSquadEntity(SquadEntity):
    ...
    def __showDefaultDialog(self, meta, callback, parent=None):
        ...
        if res:
            ...
            result = yield wg_await(showDynamicButtonInfoDialogBuilder(res, None, '', parent, loadCallback=self.__loadDialogCallback, destroyCallback=self.__destroyDialogCallback))
            callback(result)
        return
