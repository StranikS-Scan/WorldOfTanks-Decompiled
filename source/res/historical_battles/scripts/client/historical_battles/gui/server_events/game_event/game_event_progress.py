...
from historical_battles.gui.server_events.conditions import getTokenNeededCountInCondition, getTokenReceivedCountInCondition
...
class ProgressItemsController(object):
    ...
    def start(self):
        ...
        self.eventsCache.onSyncCompleted += self._onSyncCompleted
        self._onSyncCompleted()
        self.__gameEventController.onGameParamsChanged += self.__onServerSettingsChanged
    ...
    def __onServerSettingsChanged(self):
        self._onSyncCompleted()
