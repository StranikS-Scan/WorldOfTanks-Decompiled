...
class HeaderBlockConstructor(VehicleTooltipBlockConstructor):
    ...
    def construct(self):
        ...
        vehicleType = backport.text(R.strings.menu.roleExp.roleLabel()) + ' ' + backport.text(R.strings.hb_tooltips.vehicleInfoTooltip.dyn(vehicleType)())
        icon = getTypeBigIconPath(self.vehicle.type)
