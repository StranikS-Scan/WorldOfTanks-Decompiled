...
from last_stand.gui.sounds.sound_constants import BOTS_SPAWN, DEFAULT_BOT_SPAWN, BATTLE_START, ACTIVE_PHASE_RTPC, BATTLE_FINISH, ActivePhaseState, DifficultyState
from last_stand.gui.sounds.arena_components import LSStaticDeathZoneSounds, LSPostMortemSounds, LSEquipmentPanelSounds, LSPersonalDeathZoneSounds, LSVoiceovers, LSTeamFightVoiceovers, LSBattleMusic
...
class LSArenaSoundComponent(DynamicScriptComponent):
    ...
    def _setPhaseStates(self, activePhase):
        ...
        WWISE.WW_setRTCPGlobal(ACTIVE_PHASE_RTPC, _LS_MODE_WORLD)
        WWISE.WW_setState(ActivePhaseState.GROUP, ActivePhaseState.getStateByPhase(_LS_MODE_WORLD))
