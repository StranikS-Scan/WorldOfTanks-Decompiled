...
_VEHICLE_SOUND_COMPONENTS = [(LSCommonEnemySounds, lambda parent: parent.isEnemy), (LSLootSounds, lambda parent: not parent.isEnemy), (LSObeliskSounds, lambda parent: OBELISK_ROLE_TAG in parent.entity.typeDescriptor.type.tags)]
