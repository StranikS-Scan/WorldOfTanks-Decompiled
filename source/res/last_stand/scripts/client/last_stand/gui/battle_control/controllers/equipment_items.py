...
def registerLSEquipmentsItems():
    registerEquipmentItem('LS_selfRepair', _HpRepairAndCrewHeal, LSEquipmentReplayItem)
    registerEquipmentItem('LS_teamRepair', LSEquipmentItem, LSEquipmentReplayItem)
    registerEquipmentItem('LS_damageShield', _AbilityWithDuration, LSEquipmentReplayItem)
    registerEquipmentItem('LS_fastReload', _FastReload, LSEquipmentReplayItem)
    registerEquipmentItem('LS_aoeDamageInstantShot', _LSInstantShot, LSEquipmentReplayItem)
    registerEquipmentItem('LS_aoeStunInstantShot', _LSInstantShot, LSEquipmentReplayItem)
    registerEquipmentItem('LS_aoeDrainEnemyHpInstantShot', _LSInstantShot, LSEquipmentReplayItem)
    registerEquipmentItem('LS_invisibility', LSEquipmentItem, LSEquipmentReplayItem)
    registerEquipmentItem('LS_doubleDamage', _AbilityWithDuration, LSEquipmentReplayItem)
    registerEquipmentItem('LS_nitro', _NitroEquipmentItem, _NitroEquipmentReplayItem)
