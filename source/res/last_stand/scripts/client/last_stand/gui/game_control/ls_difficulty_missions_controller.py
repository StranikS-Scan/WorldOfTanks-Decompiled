...
class DifficultyMission(namedtuple('DifficultyMission', ('missionID', 'bonusRewards', 'difficulty', 'index'))):
    ...
    def isCompleted(self):
        return isQuestCompleted(self.missionID)
...
class LSDifficultyMissionsController(ILSDifficultyMissionsController):
    ...
    def onLobbyInited(self, event):
        super(LSDifficultyMissionsController, self).onLobbyInited(event)
    ...
    def _initMissions(self):
        ...
        for questID, quest in quests.iteritems():
            ...
            mission = DifficultyMission(missionID=questID, bonusRewards=self.__getMissionBonuses(quest), difficulty=difficulty, index=index)
