...
class BattleResultView(BaseView):
    ...
    def __getProgressPointsBonus(self, points):
        return getNonQuestBonuses(TokensBonus.TOKENS, {ProgressPointsSettings.TOKEN: {'count': points}}) if points > 0 else []
    ...
    def __geProgressPointsCountFromTokens(self, tokens):
        ...
        return progressPointsToken.count if progressPointsToken else 0
