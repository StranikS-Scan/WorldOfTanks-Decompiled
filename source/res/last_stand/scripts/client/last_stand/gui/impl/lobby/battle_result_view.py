...
class BattleResultView(BaseView):
    ...
    def createContextMenu(self, event):
        statsView = self.getChildView(R.views.last_stand.lobby.virtual_res.TeamStatsView())
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        self.setChildView(resourceID=R.views.last_stand.lobby.virtual_res.TeamStatsView(), view=BattleResultStats(arenaUniqueID=self.__arenaUniqueID))
