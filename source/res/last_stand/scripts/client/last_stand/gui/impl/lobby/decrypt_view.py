...
from last_stand.gui.impl.lobby import fillRewards
from last_stand.gui.shared.event_dispatcher import showLootBoxMainViewInQueue
from last_stand.gui.sounds import playSound
from last_stand.gui.sounds.sound_constants import META_VOICEOVER_UNMUTE, META_VOICEOVER_BUTTON_CLICK_UNMUTE, META_VOICEOVER_MUTE, META_VOICEOVER_BUTTON_CLICK_MUTE, META_QUANTUM_OPEN_SOUND, META_QUANTUM_CLOSE_SOUND
...
class DecryptView(ViewImpl):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        playSound(META_QUANTUM_OPEN_SOUND.format(self.lsArtifactsCtrl.getIndex(self.__artefactID)))
    ...
    def _finalize(self):
        ...
        playSound(META_QUANTUM_CLOSE_SOUND.format(self.lsArtifactsCtrl.getIndex(self.__artefactID)))
    ...
    def __fillViewModel(self):
        ...
        if artefact is None:
            ...
            with self.viewModel.transaction() as tx:
                ...
                tx.setIndex(self.lsArtifactsCtrl.getIndex(self.__artefactID))
