...
# Embedded file name: last_stand/scripts/client/last_stand/gui/impl/lobby/page/ls_lobby_footer.py
from __future__ import absolute_import
from last_stand.gui.impl.lobby.page.ls_platoon_presenter import LSPlatoonPresenter
...
class LSLobbyFooter(LobbyFooter):

    def _initChildren(self):
        footer = R.aliases.lobby_footer.default
        self._registerChild(footer.Platoon(), LSPlatoonPresenter())
