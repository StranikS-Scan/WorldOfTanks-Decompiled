...
from last_stand.gui.impl.lobby import getArtefactState, fillRewards
...
from last_stand.gui.shared.event_dispatcher import showRewardPathView, showHangar, showMetaIntroView, showIntroVideo
...
class RewardPathView(BaseView, LobbyHeaderVisibility):
    ...
    def __init__(self, layoutID=R.views.last_stand.mono.lobby.reward_path_view(), selectedArtefactID=None):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        self.setChildView(resourceID=R.views.last_stand.lobby.virtual_res.QuestsView(), view=QuestsView(isBadgeWidget=True))
        self.__fillItems()
