...
from last_stand.gui.impl.lobby import getArtefactState, fillProminentBonus, PROMINENT_REWARD_TOOLTIP_ID
from last_stand.gui.impl.lobby.tooltips.event_mission_tooltip import EventMissionsTooltip
from last_stand.gui.shared.event_dispatcher import showHangar, showDecryptWindowView, showBundleWindow
...
class MetaWidgetView(ViewImpl):
    ...
    def __init__(self, parent=None):
        settings = ViewSettings(R.views.last_stand.lobby.virtual_res.MetaView())
