...
from last_stand.gui.battle_control.controllers.equipment_items import registerLSEquipmentsItems
from last_stand.gui.shared.tooltips.ls_advanced import registerLSEquipmentTooltipMovies
...
def registerAdditionalParams(personality):
    ...
    registerLSEquipmentTooltipMovies()
    registerLSEquipmentsItems()
