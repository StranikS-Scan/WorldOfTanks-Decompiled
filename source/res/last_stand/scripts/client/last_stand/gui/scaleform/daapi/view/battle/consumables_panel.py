...
class LSConsumablesPanel(ConsumablesPanelMeta):
    ...
    LS_BOOSTER_FACTORS = {BOOSTER_FACTOR_NAMES.ABILITY_DURATION, BOOSTER_FACTOR_NAMES.ABILITY_COST}
    ...
    def __init__(self):
        ...
        self._shellsCount = {}
        self._lsEquipmentDataCache = {'usageCost': {},
         'duration': {}}
        return
    ...
    def _buildEquipmentSlotTooltipText(self, item):
        ...
        if self._hasDuration(item):
            if int(variant.durationSeconds) > 0:
                body = '\n'.join((body, backport.text(R.strings.last_stand_battle.consumablesPanel.tooltip.durationTime(), time=str(int(self._getDurationSeconds(descriptor.compactDescr, variant))))))
