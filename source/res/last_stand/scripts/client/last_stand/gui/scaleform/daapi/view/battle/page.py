...
class _ComponentsConfig(ComponentsConfig):
    ...
    def __init__(self):
        super(_ComponentsConfig, self).__init__(((BATTLE_CTRL_ID.ARENA_PERIOD, (BATTLE_VIEW_ALIASES.PREBATTLE_TIMER,
         ...
         (BATTLE_CTRL_ID.BATTLE_HINTS, (BATTLE_VIEW_ALIASES.BATTLE_HINT, LS_ALIASES.PINNABLE_BATTLE_HINT, LS_ALIASES.PROGRESS_BAR_BATTLE_HINT))), viewsConfig=((DynamicAliases.DRONE_MUSIC_PLAYER, drone_music_player.DroneMusicPlayer),
...
_POSTMORTEM_HIDE_VIEW = {LS_ALIASES.POINT_COUNTER, BATTLE_VIEW_ALIASES.BATTLE_DAMAGE_LOG_PANEL, BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL}
