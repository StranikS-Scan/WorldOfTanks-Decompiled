...
_MARKERS_TYPE_TO_SUBTYPE_MAP.update({MarkerType.TARGET_POINT_MARKER_TYPE: {DefaultMarkerSubType.ENEMY_MARKER_SUBTYPE: LS_RADIAL_MENU_CONSTS.TARGET_STATE_LS_CAMP,
