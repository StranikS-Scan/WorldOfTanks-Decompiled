...
from last_stand.gui.scaleform.daapi.view.lobby.hangar.ls_entry_point import LSEntryPoint
...
def getViewSettings():
    ...
    return (ComponentSettings(LAST_STAND_HANGAR_ALIASES.LS_ENTRY_POINT, LSEntryPoint, ScopeTemplates.DEFAULT_SCOPE),
