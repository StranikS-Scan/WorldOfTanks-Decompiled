...
_HIGHLIGHT_LOBBY_VIOLET_LINKAGE = 'LSSelectorHighlightUI'
_HIGHLIGHT_FIGHT_VIOLET_LINKAGE = 'LSFightHighlightUI'
_HIGHLIGHT_SQUAD_VIOLET_LINKAGE = 'LSBgAnimVioletUI'
