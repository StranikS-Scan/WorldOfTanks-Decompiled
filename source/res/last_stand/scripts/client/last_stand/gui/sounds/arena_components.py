...
from last_stand.gui.sounds.sound_constants import DeathZoneSounds, PostMortemSounds, BattleEquipmentPanelSounds, PersonalDeathZoneSounds, PersonalDeathZoneAbilityBossState, LastStandVO, BattleMusic
