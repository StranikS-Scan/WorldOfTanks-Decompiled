...
from last_stand.gui.ls_gui_constants import LUI_RULES_LS
...
from last_stand.overrides.hangar_override import HangarOverride
from last_stand.overrides.battl_equeue_override import BattleQueueOverride
...
class ClientLastStandBattleMode(last_stand_constants.LastStandBattleMode):
    ...
    def _client_bannerEntryPointValidatorMethod(self):
        from last_stand.gui.impl.lobby.feature.ls_entry_point_view import isLSEntryPointAvailable
        return isLSEntryPointAvailable

    @property
    def _client_bannerEntryPointLUIRule(self):
        from gui.limited_ui.lui_rules_storage import LUI_RULES
        LUI_RULES.inject(LUI_RULES_LS)
        return LUI_RULES.LastStandEntryPoint
    ...
    def _client_equipmentTriggers(self):
        ...
        return [('LSartillery_deathzone', _EventArtilleryItem, _ReplayEventArtilleryItem)]
    ...
    def _client_lowPriorityWulfWindows(self):
        from gui.impl.gen import R
        return [R.views.last_stand.lobby.MembersWindow()]
...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionLobbyPackages(__name__, ['last_stand.gui.scaleform.daapi.view.lobby', 'last_stand.gui.scaleform.daapi.view.lobby.store', 'last_stand.gui.scaleform.daapi.view.lobby.tank_setup'])
    BATTLE_PACKAGES = ('last_stand.gui.scaleform.daapi.view.battle.shared', 'messenger.gui.Scaleform.view.battle')
