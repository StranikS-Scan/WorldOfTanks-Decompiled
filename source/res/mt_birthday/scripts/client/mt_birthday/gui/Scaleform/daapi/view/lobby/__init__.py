...
def getViewSettings():
    ...
    return (ComponentSettings(HANGAR_ALIASES.BIRTHDAY_BANNER_ENTRY_POINT, BirthdayBannerEntryPoint, ScopeTemplates.DEFAULT_SCOPE), ComponentSettings(HANGAR_ALIASES.BIRTHDAY_HEADER_ENTRY_POINT, BirthdayEntryPointWidget, ScopeTemplates.DEFAULT_SCOPE))
