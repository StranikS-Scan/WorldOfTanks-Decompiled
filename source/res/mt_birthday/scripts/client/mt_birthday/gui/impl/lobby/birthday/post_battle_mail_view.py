...
class PostBattleMailView(PostbattleExtraTabView):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return DisablePlayerTooltip() if contentID == R.views.mt_birthday.lobby.tooltips.DisablePlayerTooltip() else super(PostBattleMailView, self).createToolTipContent(event, contentID)
