...
class MuseumVehicleView(BaseTransitionView):
    ...
    def _initialize(self, *args, **kwargs):
        ...
        g_eventBus.handleEvent(events.LobbyInterfaceEvent(events.LobbyInterfaceEvent.TOGGLE_VISIBILITY, ctx={'headerIsVisible': False,
    ...
    def _finalize(self):
        ...
        self.__uiLogger.log()
        self.__unloadSpace()
        g_eventBus.handleEvent(events.LobbyInterfaceEvent(events.LobbyInterfaceEvent.TOGGLE_VISIBILITY, ctx={'headerIsVisible': True,
