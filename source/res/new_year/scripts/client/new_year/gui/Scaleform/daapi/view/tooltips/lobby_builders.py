...
def getTooltipBuilders():
    ...
    return (DataBuilder(TOOLTIPS_CONSTANTS.NEW_YEAR_AWARD_VEHICLE, TOOLTIPS_CONSTANTS.VEHICLE_INFO_UI, vehicle.VehicleInfoTooltipData(contexts.AwardContext(simplifiedOnly=False))),
