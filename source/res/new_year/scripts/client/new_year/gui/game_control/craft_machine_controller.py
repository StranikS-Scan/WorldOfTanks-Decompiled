...
# Embedded file name: new_year/scripts/client/new_year/gui/game_control/craft_machine_controller.py
from new_year.gui.impl.lobby.new_year.craft.components import RANDOM_TOY_PARAM, mapToyParamsFromCraftUiToSrv
from new_year.gui.impl.lobby.new_year.craft.components.shared_stuff import RANDOM_TOY_CONFIG_INDEX, mapToyParamsFromSrvToCraftUi, DEFAULT_TOY_RANK_INDEX
from helpers import dependency
from new_year.helpers.server_settings import getNewYearCraftCostConfig
from new_year_common.items.components.ny_constants import ToyTypes, RANDOM_VALUE, FillerState, RANDOM_TYPE, TOY_TYPES_WITH_RANDOM
from new_year_common.items.new_year import getObjectByToyType
from skeletons.gui.lobby_context import ILobbyContext
from new_year.skeletons.new_year import INewYearCraftMachineController, INewYearController
...
class NewYearCraftMachineController(INewYearCraftMachineController):
    ...
    def __getConfig(self):
        return getNewYearCraftCostConfig(lobbyContext=self.__lobbyContext)
