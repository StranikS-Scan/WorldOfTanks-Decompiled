...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/components/ny_main_menu_tab_model.py
...
class NyMainMenuTabModel(NewYearTabModel):
    ...
    def getHasBubble(self):
        return self._getBool(4)

    def setHasBubble(self, value):
        self._setBool(4, value)

    def _initialize(self):
        super(NyMainMenuTabModel, self)._initialize()
        self._addBoolProperty('isEnabled', True)
        self._addBoolProperty('hasBubble', False)
