...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/tooltips/ny_album_decoration_tooltip_model.py
from gui.impl.gen import R
from frameworks.wulf import ViewModel

class NyAlbumDecorationTooltipModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=14, commands=0):
        super(NyAlbumDecorationTooltipModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(NyAlbumDecorationTooltipModel, self)._initialize()
