...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/views/albums/ny_album_view_model.py
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.albums.ny_current_album_model import NyCurrentAlbumModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.albums.ny_old_album_model import NyOldAlbumModel
