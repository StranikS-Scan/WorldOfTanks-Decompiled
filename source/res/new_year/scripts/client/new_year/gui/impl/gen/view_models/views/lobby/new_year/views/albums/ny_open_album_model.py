...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/views/albums/ny_open_album_model.py
...
class NyOpenAlbumModel(ViewModel):
    __slots__ = ('onToyClick', 'onCollectionChange', 'onRankChange', 'onCollectionShopClick')
    ...
    @staticmethod
    def getCollectionTabsType():
        return NyAlbumCollectionTabModel
    ...
    def _initialize(self):
        ...
        self.onCollectionShopClick = self._addCommand('onCollectionShopClick')
