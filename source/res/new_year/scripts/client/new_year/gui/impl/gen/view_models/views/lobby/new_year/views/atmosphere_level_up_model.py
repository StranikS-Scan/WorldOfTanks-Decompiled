...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/views/atmosphere_level_up_model.py
...
class AtmosphereLevelUpModel(ViewModel):
    __slots__ = ('onClose', 'onGotoStore', 'onGotoQuests', 'onSelectVehicleDiscount')
    ...
    def getIsDeferredGraphics(self):
        return self._getBool(5)

    def setIsDeferredGraphics(self, value):
    ...
    def _initialize(self):
        ...
        self._addBoolProperty('isDeferredGraphics', False)
