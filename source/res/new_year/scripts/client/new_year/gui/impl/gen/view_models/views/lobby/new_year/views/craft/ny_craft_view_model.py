...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/views/craft/ny_craft_view_model.py
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_antiduplicator_model import NyCraftAntiduplicatorModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_monitor_model import NyCraftMonitorModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_regular_config_model import NyCraftRegularConfigModel
