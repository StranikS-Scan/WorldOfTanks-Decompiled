...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/gen/view_models/views/lobby/new_year/views/lootboxes/loot_box_entry_point_model.py
from frameworks.wulf import ViewModel

class LootBoxEntryPointModel(ViewModel):
    __slots__ = ('onLootBoxEntryPointClick',)
