...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/__init__.py
...
from new_year.gui.impl.lobby.new_year.lootbox_entry_point.ny_lootbox_entry_point_view import NyLootBoxesEntryPoint
from gui.impl.gen import R
registerCarouselEventEntryPoint(R.views.new_year.lobby.new_year.loot_box.LootBoxEntryView(), NyLootBoxesEntryPoint)
