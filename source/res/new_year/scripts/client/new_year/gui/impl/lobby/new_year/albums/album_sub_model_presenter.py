...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/albums/album_sub_model_presenter.py
import logging
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.albums.ny_album_collection_tab_model import NyAlbumCollectionTabModel
from new_year.gui.impl.lobby.new_year.albums.collections_builders import NY18SubCollectionBuilder, NY19SubCollectionBuilder, NY20SubCollectionBuilder, NY21SubCollectionBuilder, NY22SubCollectionBuilder, NY24SubCollectionBuilder, NY25SubCollectionBuilder
...
from new_year.gui.impl.new_year.new_year_helper import formatRomanNumber, collectionRewardQuestsFilterFunc
from new_year.gui.impl.new_year.sounds import NewYearSoundsManager
from new_year.gui.shared.ny_toy_info import NewYear18ToyInfo, NewYear19ToyInfo, NewYear20ToyInfo, NewYear21ToyInfo, NewYear22ToyInfo, NewYear24ToyInfo
...
COLLECTIONS_DATA = {Collections.NewYear18: _CollectionMeta(NY18SubCollectionBuilder, NewYear18ToyInfo),
 ...
 Collections.NewYear25: _CollectionMeta(NY25SubCollectionBuilder, NewYear24ToyInfo)}
