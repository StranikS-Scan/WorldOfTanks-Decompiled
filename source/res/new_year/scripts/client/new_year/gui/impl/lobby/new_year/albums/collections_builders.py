...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/albums/collections_builders.py
import typing
from collections import defaultdict
from new_year.gui.impl.lobby.new_year.albums.toy_page_presenter import NYToyPagePresenter, ToyOldPagePresenter
from helpers import dependency
from new_year_common.items.collectibles import g_cache
from new_year_common.items.components.ny_constants import ToySettings
from new_year.ny_constants import Collections
from new_year.gui.shared.ny_toy_info import TOYS_INFO_REGISTRY
...
class NY24SubCollectionBuilder(_SubCollectionBuilder):
    YEAR_NAME = Collections.NewYear24
    ORDER = (ToySettings.NEW_YEAR,
     ToySettings.ORIENTAL,
     ToySettings.FAIRYTALE,
     ToySettings.CHRISTMAS)
...
class NY25SubCollectionBuilder(_SubCollectionBuilder):
    YEAR_NAME = Collections.NewYear25
    ORDER = (ToySettings.NEW_YEAR,
     ToySettings.ORIENTAL,
     ToySettings.FAIRYTALE,
     ToySettings.CHRISTMAS)
