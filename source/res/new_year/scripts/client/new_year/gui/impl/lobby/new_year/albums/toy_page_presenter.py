...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/albums/toy_page_presenter.py
import typing
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.components.ny_current_album_decoration_model import NyCurrentAlbumDecorationModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.components.ny_old_album_decoration_model import NyOldAlbumDecorationModel
from helpers import dependency
from new_year_common.items.components.ny_constants import ToyTypes, YEARS_INFO
from skeletons.gui.shared import IItemsCache
if typing.TYPE_CHECKING:
    from new_year.gui.shared.ny_toy_info import _NewYearCommonToyInfo
