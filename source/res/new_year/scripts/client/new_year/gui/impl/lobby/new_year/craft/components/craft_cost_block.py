...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/components/craft_cost_block.py
from new_year_common.items.components.ny_constants import RANDOM_VALUE, MIN_TOY_RANK
