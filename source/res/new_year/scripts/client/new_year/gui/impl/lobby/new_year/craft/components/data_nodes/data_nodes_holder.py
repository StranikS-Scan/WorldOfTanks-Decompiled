...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/components/data_nodes/data_nodes_holder.py
...
class DataNodesHolder(object):
    ...
    def updateCrafting(self, isInProgress=False):
        for node in self.__nodes.itervalues():
            node.updateCrafting(isInProgress)
