...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/components/regular_toys_block.py
from new_year.gui.impl.new_year.sounds import RANDOM_STYLE_BOX, NewYearSoundsManager
from new_year_common.items.components.ny_constants import ToySettings, TOY_TYPES_FOR_OBJECTS_WITH_RANDOM_WITHOUT_MEGA, RANDOM_TYPE
...
class RegularToysBlock(ViewModelDataNode):
    ...
    def __setSoundStyles(self):
        ...
        toySetting = getSafeFromCollection(ToySettings.CURRENT_USUAL, toySettingIdx, default=RANDOM_STYLE_BOX)
