...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/components/shared_stuff.py
from new_year_common.items.components.ny_constants import RANDOM_VALUE, TOY_TYPE_IDS_BY_NAME, ToySettings, YEARS_INFO, MIN_TOY_RANK, MAX_TOY_RANK, TOY_TYPES_FOR_OBJECTS_WITHOUT_MEGA
