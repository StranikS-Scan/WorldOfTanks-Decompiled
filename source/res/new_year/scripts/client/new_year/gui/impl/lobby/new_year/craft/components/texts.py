...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/components/texts.py
from gui.impl import backport
from gui.impl.gen import R
from new_year.gui.impl.new_year.new_year_helper import formatRomanNumber
from new_year_common.items.components.ny_constants import CustomizationObjects, MAX_TOY_RANK
