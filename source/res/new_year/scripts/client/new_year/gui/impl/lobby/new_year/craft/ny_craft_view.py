...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/craft/ny_craft_view.py
import logging
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_tab_type_item_model import NyCraftTabTypeItemModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_tab_type_model import NyCraftTabTypeModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_view_model import NyCraftViewModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.craft.ny_craft_states import NyCraftStates
...
from new_year.gui.impl.new_year.views.toy_presenter import CraftToyPresenter
from helpers import dependency
from helpers.server_settings import serverSettingsChangeListener
from new_year_common.items.components.ny_constants import FillerState, TOY_TYPES_BY_OBJECT_WITH_RANDOM, CustomizationObjects
from new_year.gui.impl.lobby.new_year.craft.components import Antiduplicator, CraftButtonBlock, CraftCostBlock, CraftMonitor, FillersStorage, RegularToysBlock, ShardsStorage
from new_year.gui.impl.lobby.new_year.craft.components.data_nodes import DataNodesHolder
...
from new_year.gui.shared.gui_items.processors.ny_processor import CraftProcessor
...
class NyCraftView(HistorySubModelPresenter):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if event.contentID == R.views.new_year.lobby.new_year.tooltips.NyDecorationTooltip():
    ...
    @serverSettingsChangeListener(SyncDataKeys.MAX_LEVEL, SyncDataKeys.POINTS)
    ...
    def __onCraftBtnClick(self, *_):
        ...
        fillerState = self.__logicModules.antiduplicator.getAntiDuplicatorState()
