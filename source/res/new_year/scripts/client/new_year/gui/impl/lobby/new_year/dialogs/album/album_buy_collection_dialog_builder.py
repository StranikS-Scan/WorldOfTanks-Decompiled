...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/dialogs/album/album_buy_collection_dialog_builder.py
from gui.impl import backport
from gui.impl.dialogs.sub_views.title.simple_text_title import SimpleTextTitle
from new_year.gui.impl.lobby.new_year.dialogs.album.album_buy_dialog_base import AlbumBuyDialogBase
