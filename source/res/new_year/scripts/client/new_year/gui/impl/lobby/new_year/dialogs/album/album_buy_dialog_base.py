...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/dialogs/album/album_buy_dialog_base.py
import typing
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.dialogs.shards_balance_model import ShardsBalanceModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.dialogs.collection_price_model import CollectionPriceModel
...
class ShardsBalance(ViewImpl):
    ...
    def __init__(self):
        settings = ViewSettings(R.views.new_year.lobby.new_year.dialogs.ShardsBalance())
...
class Price(ViewImpl):
    ...
    def __init__(self, price):
        settings = ViewSettings(R.views.new_year.lobby.new_year.dialogs.CollectionPrice())
        settings.flags = ViewFlags.VIEW
