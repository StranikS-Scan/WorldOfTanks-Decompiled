...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/lootbox_entry_point/ny_lootbox_entry_point_view.py
...
class NyLootBoxesEntryPoint(ViewImpl, ICarouselEventEntry):
    ...
    def __init__(self):
        super(NyLootBoxesEntryPoint, self).__init__(ViewSettings(R.views.new_year.lobby.new_year.loot_box.LootBoxEntryView(), ViewFlags.VIEW, LootBoxEntryPointModel()))
    ...
    def _getEvents(self):
        return ((self.__guiLootBoxes.onBoxesCountChange, self.__updateBoxesCount), (self.__guiLootBoxes.onAvailabilityChange, self.__onAvailabilityChange), (self.viewModel.onLootBoxEntryPointClick, self.__onLootBoxEntryPointClick))
