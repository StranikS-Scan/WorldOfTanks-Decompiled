...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/popovers/ny_break_filter_popover.py
import typing
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.popovers.ny_break_filter_popover_model import NyBreakFilterPopoverModel
from gui.impl.pub import PopOverViewImpl
from gui.shared import g_eventBus, EVENT_BUS_SCOPE
from helpers import dependency
from new_year.gui.shared.events import NewYearEvent
from new_year_common.items.components.ny_constants import MAX_TOY_RANK
from new_year_common.items.components.ny_constants import ToySettings, ToyTypes
from skeletons.gui.lobby_context import ILobbyContext
from new_year.skeletons.new_year import INewYearController
if typing.TYPE_CHECKING:
    from typing import List, Tuple, Union
    from frameworks.wulf import Array
    from new_year.gui.impl.lobby.new_year.break_decorations.ny_break_decorations_view import SelectedToyFilters
...
class NyBreakFilterPopoverView(PopOverViewImpl):
    ...
    def __init__(self, selectedToyFilters):
        settings = ViewSettings(R.views.new_year.lobby.new_year.popovers.NyBreakFilterPopover())
    ...
    def _initialize(self, *args, **kwargs):
        g_eventBus.addListener(NewYearEvent.ON_BREAK_TOYS_ANIMATION_COMPLETED, self.__onBreakToysAnimationCompleted, scope=EVENT_BUS_SCOPE.LOBBY)

    def _finalize(self):
        self.viewModel.onToyTypeSelected -= self.__onToyTypeSelected
        self.viewModel.onToyRankSelected -= self.__onToyRankSelected
        self.viewModel.onCollectionTypeSelected -= self.__onCollectionTypeSelected
        g_eventBus.removeListener(NewYearEvent.ON_BREAK_TOYS_ANIMATION_COMPLETED, self.__onBreakToysAnimationCompleted, scope=EVENT_BUS_SCOPE.LOBBY)
    ...
    def __onFilterChanged(self):
        ...
        g_eventBus.handleEvent(NewYearEvent(NewYearEvent.ON_BREAK_TOYS_FILTER_APPLIED, ctx={'toyRanks': toyRanks,
         'toyTypes': toysTypes,
