...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/popovers/ny_loot_box_popover.py
from frameworks.wulf import ViewSettings
from frameworks.wulf.gui_constants import ViewFlags
from gui.impl.gen.resources import R
from new_year.gui.impl.gen.view_models.views.lobby.new_year.popovers.ny_loot_box_popover_model import NyLootBoxPopoverModel
...
from new_year.gui.impl.lobby.new_year.tooltips.ny_shop_unavailable_tooltip import NyShopUnavailableTooltip
...
class NyLootBoxPopoverView(PopOverViewImpl):
    ...
    def __init__(self, returnPlace=None):
        super(NyLootBoxPopoverView, self).__init__(ViewSettings(R.views.new_year.lobby.new_year.popovers.NyLootBoxPopover(), ViewFlags.VIEW, NyLootBoxPopoverModel()))
        self.__lastCount = 0
    ...
    def createToolTipContent(self, event, ctID):
        return NyShopUnavailableTooltip() if ctID == R.views.new_year.lobby.new_year.tooltips.NyShopUnavailableTooltip() else None
