...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/rewards_info/level_reward_presenter.py
import typing
...
class LevelRewardPresenter(object):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.new_year.lobby.new_year.tooltips.NyMenuCollectionsTooltip():
            return NyMenuCollectionsTooltip()
        elif contentID == R.views.new_year.lobby.new_year.tooltips.NyShardsTooltip():
            return NyShardsTooltip()
        elif contentID == R.views.new_year.lobby.new_year.tooltips.NyMarketplaceTokenTooltip():
        ...
        elif contentID == R.views.new_year.lobby.new_year.tooltips.NyCurrencyTooltip():
