...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/rewards_info/ny_collections_rewards_presenter.py
import logging
import typing
import nations
...
from new_year.gui.impl.gen.view_models.views.lobby.new_year.views.rewards_info.ny_collections_rewards_model import CollectionState
from new_year.gui.impl.lobby.new_year.dialogs.album.album_buy_collection_dialog_builder import AlbumCollectionDialogBuilder
...
from new_year.gui.impl.new_year.sounds import NewYearSoundConfigKeys, NewYearSoundStates
...
from new_year_common.items.components.ny_constants import YEARS_INFO, MAX_ATMOSPHERE_LVL
from new_year.gui.shared.collection_presenters import COLLECTION_PRESENTER_REGESTRY, getCollectionCost, getAdditionalBonusByCollectionID
from new_year.ny_constants import Collections
from new_year.gui.shared.ny_preview import getVehiclePreviewID
from new_year.gui.shared.gui_items.processors.ny_processor import BuyCollectionProcessor
...
class NyCollectionsRewardsPresenter(RewardsSubModelPresenter):
    ...
    def __updateCollections(self, model):
        ...
        for collectionID in collectionPresenter.getCollectionSettingsIDs(useMega=True, usePet=True):
