...
from new_year_common.items.components.ny_constants import RANDOM_VALUE
from skeletons.gui.shared import IItemsCache
from new_year.skeletons.new_year import INewYearController, INewYearCraftMachineController, INewYearBubbleNavigationController
...
class HistorySubModelPresenter(SubModelPresenter):
    ...
    def _goToCraftView(self, toyTypeID=RANDOM_VALUE, settingID=RANDOM_VALUE, rank=RANDOM_VALUE, *args, **kwargs):
        craftCtrl = dependency.instance(INewYearCraftMachineController)
        craftCtrl.setSettings(toyTypeID, settingID, rank)
