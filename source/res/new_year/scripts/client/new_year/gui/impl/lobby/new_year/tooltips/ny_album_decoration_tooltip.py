...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/tooltips/ny_album_decoration_tooltip.py
from frameworks.wulf import ViewSettings
from gui.impl.gen import R
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_album_decoration_tooltip_model import NyAlbumDecorationTooltipModel
...
class NyAlbumDecorationTooltip(ViewImpl):
    ...
    def __init__(self, toyID, isCountEnabled=False, *args, **kwargs):
        settings = ViewSettings(R.views.new_year.lobby.new_year.tooltips.NyAlbumDecorationTooltip())
