...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/tooltips/ny_collection_bonus_tooltip.py
from frameworks.wulf import View, ViewSettings
from gui.impl.gen import R
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_collection_bonus_tooltip_model import NyCollectionBonusTooltipModel
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_collection_table_value_model import NyCollectionTableValueModel
...
from new_year.gui.impl.lobby.new_year.albums.collections_builders import NY20SubCollectionBuilder
...
class NyCollectionBonusTooltip(View):
    ...
    def __init__(self, collection):
        settings = ViewSettings(R.views.new_year.lobby.new_year.tooltips.NyCollectionBonusTooltip(), model=NyCollectionBonusTooltipModel())
