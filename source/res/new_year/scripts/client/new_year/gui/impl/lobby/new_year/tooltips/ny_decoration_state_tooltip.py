...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/tooltips/ny_decoration_state_tooltip.py
from gui.impl import backport
from gui.impl.gen import R
from frameworks.wulf import ViewSettings
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_decoration_state_tooltip_model import NyDecorationStateTooltipModel
...
class NyDecorationStateTooltip(ViewImpl):
    ...
    def __init__(self, atmosphereBonus, *args, **kwargs):
        settings = ViewSettings(R.views.new_year.lobby.new_year.tooltips.NyDecorationStateTooltip())
