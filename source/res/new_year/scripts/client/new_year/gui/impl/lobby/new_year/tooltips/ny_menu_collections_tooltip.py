...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/lobby/new_year/tooltips/ny_menu_collections_tooltip.py
from frameworks.wulf import ViewSettings
from gui.impl.gen import R
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_menu_collections_tooltip_model import NyMenuCollectionsTooltipModel
...
class NyMenuCollectionsTooltip(ViewImpl):
    ...
    def __init__(self, layoutID=R.views.new_year.lobby.new_year.tooltips.NyMenuCollectionsTooltip()):
