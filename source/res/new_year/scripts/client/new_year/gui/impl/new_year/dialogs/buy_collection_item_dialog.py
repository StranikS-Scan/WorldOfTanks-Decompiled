...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/new_year/dialogs/buy_collection_item_dialog.py
...
class BuyCollectionItemDialogWindow(DialogWindow):
    ...
    def __init__(self, toy, parent=None):
        self.__toy = toy
        super(BuyCollectionItemDialogWindow, self).__init__(bottomContent=DialogContent(R.views.new_year.lobby.new_year.components.new_year_common.CollectionItemBottomContent(), viewModelClazz=CurrencyItemModel), balanceContent=DialogContent(R.views.new_year.lobby.new_year.components.new_year_common.CollectionItemBalanceContent(), viewModelClazz=CurrencyItemModel), parent=parent, enableBlur=True)
