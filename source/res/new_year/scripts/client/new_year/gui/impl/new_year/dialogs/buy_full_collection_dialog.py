...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/new_year/dialogs/buy_full_collection_dialog.py
...
from new_year.gui.shared.collection_presenters import getCollectionCost
...
class BuyFullCollectionDialogWindow(DialogWindow):
    ...
    def __init__(self, collectionID, parent=None):
        ...
        super(BuyFullCollectionDialogWindow, self).__init__(bottomContent=DialogContent(R.views.new_year.lobby.new_year.components.new_year_common.CollectionItemBottomContent(), viewModelClazz=CurrencyItemModel), balanceContent=DialogContent(R.views.new_year.lobby.new_year.components.new_year_common.CollectionItemBalanceContent(), viewModelClazz=CurrencyItemModel), parent=parent, enableBlur=True)
