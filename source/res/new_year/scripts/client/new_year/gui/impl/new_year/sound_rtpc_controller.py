...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/new_year/sound_rtpc_controller.py
from gui.shared import g_eventBus
from gui.hangar_cameras.hangar_camera_common import CameraRelatedEvents
from new_year.gui.impl.new_year.sounds import NewYearSoundVars, NewYearSoundsManager
