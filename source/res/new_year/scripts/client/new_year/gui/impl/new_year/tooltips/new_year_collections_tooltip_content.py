...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/new_year/tooltips/new_year_collections_tooltip_content.py
...
class NewYearCollectionsTooltipContent(View):
    ...
    def __init__(self):
        tooltipsRes = R.views.new_year.lobby.new_year.tooltips
        settings = ViewSettings(tooltipsRes.new_year_collections_tooltip_content.NYCollectionsTooltipContent())
