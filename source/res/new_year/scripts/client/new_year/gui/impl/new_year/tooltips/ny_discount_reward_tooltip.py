...
# Embedded file name: new_year/scripts/client/new_year/gui/impl/new_year/tooltips/ny_discount_reward_tooltip.py
from frameworks.wulf import ViewSettings
from gui.impl.gen import R
from gui.impl.pub import ViewImpl
from new_year.gui.impl.gen.view_models.views.lobby.new_year.tooltips.ny_discount_reward_tooltip_model import NyDiscountRewardTooltipModel
...
class NyDiscountRewardTooltip(ViewImpl):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.new_year.lobby.new_year.tooltips.NyDiscountRewardTooltip())
