...
class ApplyVehicleDiscountProcessor(Processor):
    ...
    def _errorHandler(self, code, errStr='', ctx=None):
        ...
        return makeError(backport.text(R.strings.ny.applyVehicleDiscount.server_error.dyn(clientErrKey)())) if clientErrKey else makeError(backport.text(R.strings.ny.applyVehicleDiscount.server_error()))
...
class CraftOldToysProcessor(Processor):
    ...
    def _errorHandler(self, code, errStr='', ctx=None):
        return makeError(backport.text(R.strings.ny.buyMegaToy.server_error())) if self.__toy.isMega() else makeError(backport.text(R.strings.ny.buyToy.server_error()))
