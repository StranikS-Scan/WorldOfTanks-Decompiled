...
# Embedded file name: new_year/scripts/client/new_year/gui/shared/ny_level_helper.py
import logging
import typing
...
from new_year.ny_constants import NY_LEVEL_PREFIX, PERCENT
...
class NewYearAtmospherePresenter(object):
    ...
    @classmethod
    def getPercentsLevelProgress(cls):
        levelProgress, levelTotalPoints = cls.getLevelProgress()
        return int(float(levelProgress) / levelTotalPoints * PERCENT)
