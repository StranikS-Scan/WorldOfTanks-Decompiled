...
# Embedded file name: new_year/scripts/client/new_year/gui/shared/ny_w2c_bonus_wrappers.py
...
class ToyWrapper(BonusAggregateWrapper):
    ...
    def getWrappedBonus(cls, wrappedToys):
        return {'id': 0,
         ...
         'icon': {AWARDS_SIZES.SMALL: sanitizeResPath(backport.image(R.images.new_year.gui.maps.icons.newYear.loot_box.rewards.box()))},
         'name': '',
         'description': ''}
