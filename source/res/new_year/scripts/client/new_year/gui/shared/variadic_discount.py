...
# Embedded file name: new_year/scripts/client/new_year/gui/shared/variadic_discount.py
import logging
from new_year.gui.impl.gen.view_models.common.missions.bonuses.discount_bonus_model import DiscountBonusModel
