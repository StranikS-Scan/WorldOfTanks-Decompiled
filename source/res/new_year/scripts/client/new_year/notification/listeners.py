...
# Embedded file name: new_year/scripts/client/new_year/notification/listeners.py
...
class NYGuiLootBoxConfigListener(_NotificationListener):
...
def registerNewYearNotificationListeners():
