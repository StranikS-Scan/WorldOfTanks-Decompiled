...
class GeneralConfig(object):
    ...
    def getNewYearGreetingsVideoVisible(self):
        return self._config.get(NYGeneralConsts.NEW_YEAR_GREETINGS_VIDEO_VISIBLE)

    def getMaxDynamicBonusValue(self):
        return self._config.get(NYGeneralConsts.MAX_DYNAMIC_BONUS_VALUE)

    def getEnableTamagotchiSimulation(self):
        return self._config.get(NYGeneralConsts.ENABLE_TAMAGOTCHI_SIMULATION)

    def getEmergencyDEB(self):
        return self._config.get(NYGeneralConsts.EMERGENCY_DEB)
    ...
    def getRaccoonLevelOpen(self):
        return self._config.get(NYGeneralConsts.RACCOON_LEVEL_OPEN)
