...
# Embedded file name: new_year/scripts/common/new_year_common/items/components/ny_components.py
...
class VariadicDiscountDescriptor(object):
    __slots__ = ('_id', '_goodiesRange', '_firstGoodieId', '_lastGoodieId', '_level')
