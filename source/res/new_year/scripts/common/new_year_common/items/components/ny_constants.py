...
class YEARS_INFO(object):
    ...
    _COLLECTION_TYPES_BY_YEAR = {YEARS.YEAR18: ToySettings.OLD,
     ...
     YEARS.YEAR26: (ToySettings.NEW_YEAR,) + ToySettings.RACOON}
...
class CustomizationObjects(object):
    ...
    PANEL_OBJECTS_ORDER = (INSTALLATIONS,
     FIR,
     TEREM,
     SNOW_SLIDE,
     FAIR,
...
TOY_TYPES_BY_OBJECT_WITHOUT_MEGA = {CustomizationObjects.FIR: (ToyTypes.TOP,
                            ...
                            ToyTypes.BALL,
                            ToyTypes.FLOOR),
 CustomizationObjects.TEREM: (ToyTypes.TEREM, ToyTypes.FENCE),
 CustomizationObjects.FAIR: (ToyTypes.TENT, ToyTypes.TABLE),
 CustomizationObjects.INSTALLATIONS: (ToyTypes.SCULPTURE,),
 CustomizationObjects.SNOW_SLIDE: (ToyTypes.SNOW_SLIDE,),
 CustomizationObjects.FIREWORKS: (ToyTypes.FIREWORKS,)}
