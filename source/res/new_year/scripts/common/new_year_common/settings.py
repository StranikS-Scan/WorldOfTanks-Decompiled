...
class NYGeneralConsts(object):
    ...
    NEW_YEAR_GREETINGS_VIDEO_VISIBLE = 'newYearGreetingsVideoVisible'
    EMERGENCY_DEB = 'emergencyDEB'
    RACCOON_LEVEL_OPEN = 'raccoonLevelOpen'
    MAX_DYNAMIC_BONUS_VALUE = 'maxDynamicBonusValue'
    ENABLE_TAMAGOTCHI_SIMULATION = 'enableTamagotchiSimulation'
...
class CraftCostConsts(object):
    ...
    USUAL_TOYS = {year:'ny{}costByRank'.format(year) for year in YEARS_INFO.yearsWithCraftDecreasingIter()}
