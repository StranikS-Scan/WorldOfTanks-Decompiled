...
# Embedded file name: portal/scripts/client/portal/gui/shared/utils/performance_analyzer.py
import collections
import logging
import typing
...
DEFAULT_PERFORMANCE_GROUP_LIMITS = collections.OrderedDict({PerformanceGroup.HIGH_RISK: [{LimitType.SYSTEM_DATA: {'osBit': 1,
