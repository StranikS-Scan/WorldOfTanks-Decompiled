...
# Embedded file name: races/scripts/client/races/gui/battle_control/controllers/consumables/equipment_key_binder.py
import typing
import logging
...
class EquipmentKeyBinder(object):
    ...
    def __init__(self):
        ...
        _logger.debug('KeyBinder for races was created')
    ...
    def _rebindKeys(self):
        equipmentCtrl = self._sessionProvider.shared.equipments
        self._keyBindings.clear()
        data = equipmentCtrl.getOrderedEquipmentsLayout()
        for equipmentCD, _ in data:
