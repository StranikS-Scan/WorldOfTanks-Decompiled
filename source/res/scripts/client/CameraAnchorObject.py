...
CameraAnchorDescriptor = namedtuple('CameraAnchorDescriptor', ('initMatrix', 'yawConstraints', 'pitchConstraints', 'distanceConstraints', 'fov', 'dofEnabled', 'dofParams'))
...
class CameraAnchorObject(BigWorld.Entity):
    ...
    def onEnterWorld(self, prereqs):
        anchorDescr = CameraAnchorDescriptor(Math.Matrix(self.matrix), self.yawConstraints, self.pitchConstraints, self.distanceConstraints, self.fov, self.dofEnabled, (self.nearStart,
         self.nearDist,
         self.farStart,
         self.farDist))
