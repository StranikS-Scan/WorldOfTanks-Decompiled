...
# Compiled at: 2011-09-08 14:31:00
import Math
...
class ClientArena(object):
    ...
    def __init__(self, arenaTypeID, arenaGuiType, arenaExtraData, weatherPresetID):
        self.__vehicles = {}
        ...
        self.typeDescriptor = ArenaType.g_cache.get(arenaTypeID)
    ...
    def __setupBBColliders(self):
        if BigWorld.wg_getSpaceBounds().length == 0.0:
            return False
        arenaBB = self.typeDescriptor.boundingBox
