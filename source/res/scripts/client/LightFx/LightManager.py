...
class _ChatActionsHandler:
    ...
    def __subscribe(self):
        messengerDispatcher = MessengerDispatcher.g_instance
        messengerDispatcher.invites.onReceivedInviteListModified += self.__onReceivedInviteListModified
        messengerDispatcher.invites.onReceivedInviteListInited += self.__onReceivedInviteListModified
        messengerDispatcher.serviceChannel.onReceiveServerMessage += self.__onSysMessage
        messengerDispatcher.serviceChannel.onReceiveClientMessage += self.__onSysMessage
        messengerDispatcher.channels.onJoinedToChannel += self.__onChatEnter
    ...
    def __onReceivedInviteListModified(self, *args):
        if MessengerDispatcher.g_instance.invites.getUnreadCount():
    ...
    def __onChatEnter(self, channel):
        isCurrentPlayer = MessengerDispatcher.g_instance.users.isCurrentPlayer(channel.owner)
        if not isCurrentPlayer and channel.isPrivate:
