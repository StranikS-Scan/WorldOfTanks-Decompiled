...
class _PlayerEvents(object):
    ...
    def __init__(self):
        ...
        self.onEnqueuedWeekendBrawl = Event.Event()
        self.onDequeuedWeekendBrawl = Event.Event()
        ...
        self.onEnqueuedWeekendBrawlFailure = Event.Event()
        ...
        self.onKickedFromWeekendBrawlQueue = Event.Event()
