...
# Compiled at: 2011-08-10 17:00:27
import BigWorld
import copy
...
import Event
from gui.Scaleform.SoundManager import BUTTON_TYPES
g_instance = None
...
class VibroManager:
    ...
    def setGroupsSettings(self, settings):
        ...
        for groupSettings in self.__groupsSettings.values():
            if groupSettings.gain > 1.0:
                groupSettings.gain = 1.0
            elif groupSettings.gain < 0.0:
                groupSettings.gain = 0.0
    ...
    def getGroupGain(self, groupName):
        if groupName in self.__groupsSettings:
