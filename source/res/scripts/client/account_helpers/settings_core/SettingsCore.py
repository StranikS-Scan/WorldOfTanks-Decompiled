...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__options = options.SettingsContainer(graphicSettings + ((GAME.REPLAY_ENABLED, options.ReplaySetting(GAME.REPLAY_ENABLED, storage=GAME_SETTINGS_STORAGE)),
         ...
         (GAME.SHOW_PERSONAL_ANIMATED_DOGTAG, options.DogtagsSetting(GAME.SHOW_PERSONAL_ANIMATED_DOGTAG, storage=DOG_TAGS_SETTINGS_STORAGE)),
         ...
         (SITUATIONAL_PERKS.ARMOR_PATCHING, options.SettingTrueByDefault(SITUATIONAL_PERKS.ARMOR_PATCHING, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_EAGLE_EYE, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_EAGLE_EYE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_EMERGENCY, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_EMERGENCY, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_TUTOR, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_TUTOR, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_COORDINATION, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_COORDINATION, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_HOLD_LINE, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_HOLD_LINE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.COMMANDER_STAY_SHARP, options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_STAY_SHARP, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.GUNNER_FOCUS, options.SettingTrueByDefault(SITUATIONAL_PERKS.GUNNER_FOCUS, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.GUNNER_LONE_WOLF, options.SettingTrueByDefault(SITUATIONAL_PERKS.GUNNER_LONE_WOLF, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.DRIVER_MOTOR_EXPERT, options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_MOTOR_EXPERT, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.DRIVER_SUSPENSION_REPAIR, options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_SUSPENSION_REPAIR, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.DRIVER_BULLETPROOF, options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_BULLETPROOF, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.LOADER_DESPERADO, options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_DESPERADO, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.LOADER_INTUITION, options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_INTUITION, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.LOADER_MELEE, options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_MELEE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.LOADER_SECOND_CHANCE, options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_SECOND_CHANCE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.RADIOMAN_SIDE_BY_SIDE, options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_SIDE_BY_SIDE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.RADIOMAN_EXPERT, options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_EXPERT, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (SITUATIONAL_PERKS.RADIOMAN_THREAT_SEARCH, options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_THREAT_SEARCH, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         ...
         (BATTLE_COMM.ENABLE_COMMENDATIONS_FEEDBACK, options.CommendationsSettings(BATTLE_COMM.ENABLE_COMMENDATIONS_FEEDBACK, storage=BATTLE_COMM_SETTINGS_STORAGE)),
