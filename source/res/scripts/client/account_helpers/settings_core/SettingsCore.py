...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__options = options.SettingsContainer(graphicSettings + ((GAME.REPLAY_ENABLED, options.ReplaySetting(GAME.REPLAY_ENABLED, storage=GAME_SETTINGS_STORAGE)),
         ...
         (GAME.DISABLE_THERMAL_VISION_EFFECT, options.AccountDumpSetting(GAME.DISABLE_THERMAL_VISION_EFFECT, GAME.DISABLE_THERMAL_VISION_EFFECT)),
         (GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT, options.AccountDumpSetting(GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT, GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT)),
         ...
         (GAME.SHOW_THERMAL_VISION_SECTOR_ON_MAP, options.AccountDumpSetting(GAME.SHOW_THERMAL_VISION_SECTOR_ON_MAP, GAME.SHOW_THERMAL_VISION_SECTOR_ON_MAP)),
