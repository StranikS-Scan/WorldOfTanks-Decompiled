...
def _migrateTo143(core, data, initialized):
    ...
    hints = [HintId.PLAYER_VEHICLE_OBSERVED,
     HintId.KILLED_WHILE_OBSERVED,
     HintId.IN_SAFETY_WHILE_NOT_OBSERVED,
     ...
     HintId.AMMUNITION_CRIT,
     HintId.FUELTANK_CRIT,
     ...
     HintId.MODULE_DAMAGE,
     HintId.COMMANDER_DAMAGE_MED_KIT,
     HintId.DRIVER_DAMAGE_MED_KIT,
     HintId.GUNNER_DAMAGE_MED_KIT,
     HintId.LOADER_DAMAGE_MED_KIT,
     HintId.RADIOMAN_DAMAGE_MED_KIT]
    itemsCache = dependency.instance(IItemsCache)
