...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__options = options.SettingsContainer(graphicSettings + ((GAME.REPLAY_ENABLED, options.ReplaySetting(GAME.REPLAY_ENABLED, storage=GAME_SETTINGS_STORAGE)),
         ...
         (GAME.ENABLE_BATTLE_CONTEXT_HINTS, options.StorageAccountSetting(GAME.ENABLE_BATTLE_CONTEXT_HINTS, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         (GAME.ENABLE_THERMAL_VISION_EFFECT, options.StorageAccountSetting(GAME.ENABLE_THERMAL_VISION_EFFECT, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         (GAME.ENABLE_THERMAL_VISION_SECTOR_EFFECT, options.StorageAccountSetting(GAME.ENABLE_THERMAL_VISION_SECTOR_EFFECT, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         ...
         (GAME.SHOW_THERMAL_VISION_SECTOR_ON_MAP, options.StorageAccountSetting(GAME.SHOW_THERMAL_VISION_SECTOR_ON_MAP, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         ...
         (GAME.HANGAR_CREW_WIDGET, options.HangarCrewWidgetSetting(GAME.HANGAR_CREW_WIDGET, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         ...
         (DAMAGE_INDICATOR.PRESET_ALLIES, options.SettingFalseByDefault(DAMAGE_INDICATOR.PRESET_ALLIES, storage=DAMAGE_INDICATOR_SETTINGS_STORAGE)),
         (DAMAGE_INDICATOR.DAMAGE_VALUE, options.SettingTrueByDefault(DAMAGE_INDICATOR.DAMAGE_VALUE, storage=DAMAGE_INDICATOR_SETTINGS_STORAGE)),
         (DAMAGE_INDICATOR.VEHICLE_INFO, options.SettingTrueByDefault(DAMAGE_INDICATOR.VEHICLE_INFO, storage=DAMAGE_INDICATOR_SETTINGS_STORAGE)),
         ...
         (DAMAGE_INDICATOR.DYNAMIC_INDICATOR, options.SettingTrueByDefault(DAMAGE_INDICATOR.DYNAMIC_INDICATOR, storage=DAMAGE_INDICATOR_SETTINGS_STORAGE)),
         (DAMAGE_LOG.TOTAL_DAMAGE, options.SettingTrueByDefault(DAMAGE_LOG.TOTAL_DAMAGE, storage=DAMAGE_LOG_SETTINGS_STORAGE)),
         (DAMAGE_LOG.BLOCKED_DAMAGE, options.SettingTrueByDefault(DAMAGE_LOG.BLOCKED_DAMAGE, storage=DAMAGE_LOG_SETTINGS_STORAGE)),
         (DAMAGE_LOG.ASSIST_DAMAGE, options.SettingTrueByDefault(DAMAGE_LOG.ASSIST_DAMAGE, storage=DAMAGE_LOG_SETTINGS_STORAGE)),
         ...
         (BATTLE_EVENTS.SHOW_IN_BATTLE, options.SettingTrueByDefault(BATTLE_EVENTS.SHOW_IN_BATTLE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_HP_DAMAGE, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_HP_DAMAGE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_BURNING, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_BURNING, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_RAM_ATTACK, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_RAM_ATTACK, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.BLOCKED_DAMAGE, options.SettingTrueByDefault(BATTLE_EVENTS.BLOCKED_DAMAGE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_DETECTION_DAMAGE, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_DETECTION_DAMAGE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_TRACK_DAMAGE, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_TRACK_DAMAGE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_DETECTION, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_DETECTION, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_KILL, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_KILL, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.BASE_CAPTURE_DROP, options.SettingTrueByDefault(BATTLE_EVENTS.BASE_CAPTURE_DROP, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.BASE_CAPTURE, options.SettingTrueByDefault(BATTLE_EVENTS.BASE_CAPTURE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_CRITICAL_HIT, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_CRITICAL_HIT, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.EVENT_NAME, options.SettingTrueByDefault(BATTLE_EVENTS.EVENT_NAME, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.VEHICLE_INFO, options.SettingTrueByDefault(BATTLE_EVENTS.VEHICLE_INFO, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.ENEMY_WORLD_COLLISION, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMY_WORLD_COLLISION, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.RECEIVED_DAMAGE, options.SettingTrueByDefault(BATTLE_EVENTS.RECEIVED_DAMAGE, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.RECEIVED_CRITS, options.SettingTrueByDefault(BATTLE_EVENTS.RECEIVED_CRITS, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         ...
         (BATTLE_EVENTS.ENEMIES_STUN, options.SettingTrueByDefault(BATTLE_EVENTS.ENEMIES_STUN, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         (BATTLE_EVENTS.HEALTH_ADDED, options.SettingFalseByDefault(BATTLE_EVENTS.HEALTH_ADDED, storage=BATTLE_EVENTS_SETTINGS_STORAGE)),
         ...
         (SCORE_PANEL.SHOW_HP_VALUES, options.SettingTrueByDefault(SCORE_PANEL.SHOW_HP_VALUES, storage=BATTLE_HUD_SETTINGS_STORAGE)),
         ...
         (SCORE_PANEL.ENABLE_TIER_GROUPING, options.SettingTrueByDefault(SCORE_PANEL.ENABLE_TIER_GROUPING, storage=BATTLE_HUD_SETTINGS_STORAGE)),
