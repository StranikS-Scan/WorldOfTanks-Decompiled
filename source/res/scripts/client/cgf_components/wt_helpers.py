...
from white_tiger_common.wt_constants import WT_TAGS, WT_BATTLE_STAGE, WT_TEAMS
if IS_CLIENT:
    import CGF
...
def getKilledByBoss():
    ...
    if inputHandler is not None:
        ...
        if killerInfo is not None:
            isWtBoss = WT_TAGS.WT_BOSS in killerInfo['vehicleType'].type.tags
            isWtBoss = isWtBoss or WT_TAGS.WT_BOSS_2025 in killerInfo['vehicleType'].type.tags
            return isWtBoss
    return False
