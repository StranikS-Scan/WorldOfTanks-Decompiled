...
class Window(PyObjectEntity):
    __slots__ = ('onStatusChanged', '__windowStatus', 'onShowingStatusChanged', 'onFocusChanged', 'onSizeChanged', 'onPositionChanged', '__showingStatus', '__isShown', '__isFocused', '__isReady', '__weakref__')
