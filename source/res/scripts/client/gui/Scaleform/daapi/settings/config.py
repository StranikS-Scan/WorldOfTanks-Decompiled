...
LOBBY_TOOLTIPS_BUILDERS_PATHS = (('gui.Scaleform.daapi.view.tooltips.achievement_builders', _TOOLTIPS.ACHIEVEMENTS_SET),
 ...
 ('gui.Scaleform.daapi.view.tooltips.perk_builders', _TOOLTIPS.PERK_SET),
 ...
 ('gui.Scaleform.daapi.view.tooltips.detachment_builders', _TOOLTIPS.DETACHMENT_SET),
 ('gui.Scaleform.daapi.view.tooltips.buy_vehicle_builders', _TOOLTIPS.BUY_VEHICLE_SET))
