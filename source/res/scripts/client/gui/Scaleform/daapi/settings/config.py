...
from constants import IS_CLIENT_BUILD, ARENA_GUI_TYPE, IS_DEVELOPMENT
...
LOBBY_TOOLTIPS_BUILDERS_PATHS = (('gui.Scaleform.daapi.view.tooltips.achievement_builders', _TOOLTIPS.ACHIEVEMENTS_SET),
 ...
 ('gui.Scaleform.daapi.view.tooltips.fortifications_builder', (_TOOLTIPS.DIRECT_MODULE,)),
 ...
 ('gui.Scaleform.daapi.view.tooltips.seasons_builders', _TOOLTIPS.SEASONS_SET),
...
ADVANCED_COMPLEX_TOOLTIPS = {'#tooltips:hangar/ammo_panel/device/empty': 'equipment',
 ...
 '#tooltips:header/buttons/forts/turnedOff': 'gamemodeStronghold',
