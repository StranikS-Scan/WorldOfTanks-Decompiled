...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    PROFILE_AWARDS_PAGE = 'profileAwardsPage'
    PROFILE_AWARDS_WINDOW = 'profileAwardsWindow'
    PROFILE_STATISTICS_PAGE = 'profileStatisticsPage'
    PROFILE_STATISTICS_WINDOW = 'profileStatisticsWindow'
