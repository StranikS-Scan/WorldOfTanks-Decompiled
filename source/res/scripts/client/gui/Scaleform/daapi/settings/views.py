...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    RTS_BATTLE_QUEUE = 'RTSBattleQueue'
    RTS_1x1_BATTLE_QUEUE = 'RTSBattleQueue'
    RTS_BOOTCAMP_QUEUE = 'RTSBattleQueue'
    ...
    RTS_CAROUSEL_FILTER_POPOVER = 'RTSCarouselFilterPopover'
    RTS_ROSTER_FILTER_POPOVER = 'RTSRosterFilterPopover'
    ...
    COMMANDER_BATTLE_PAGE = 'commanderBattlePage'
    COMMANDER_BOOTCAMP_BATTLE_PAGE = 'commanderBootcampBattlePage'
