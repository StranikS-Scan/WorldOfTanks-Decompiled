...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    EVENT_DIFFICULTY_UNLOCK = 'eventDifficultyUnlock'
    EVENT_MESSAGE_WINDOW = 'eventMessageWindow'
    ...
    HALLOWEEN_VEHICLE_PREVIEW = 'halloweenPreview'
    ...
    PERSONAL_TRADE_IN_VEHICLE_PREVIEW = 'personalTradeInVehiclePreview'
    ...
    EVENT_STYLES_PREVIEW = 'eventStylePreview'
    EVENT_STYLES_SHOP_PREVIEW = 'eventStyleShopPreview'
    EVENT_CONFIRMATION = 'eventConfirmation'
    EVENT_RENT_CONFIRMATION = 'eventVehicleRentConfirmation'
    EVENT_DIFFICULTY = 'eventDifficulty'
    EVENT_AFK_DIALOG = 'eventAFKDialog'
    EVENT_SIMPLE_ITEM_CONFIRMATION = 'eventSimpleItemConfirmation'
    EVENT_SIMPLE_ITEM_CONGRATULATION = 'eventSimpleItemCongratulation'
    EVENT_ITEMS_FOR_TOKENS = 'eventItemsForTokens'
    EVENT_PLAYER_PACK_CONFIRMATION = 'eventPlayerPackConfirmation'
    EVENT_ITEM_PACK_CONFIRMATION = 'eventItemPackConfirmation'
