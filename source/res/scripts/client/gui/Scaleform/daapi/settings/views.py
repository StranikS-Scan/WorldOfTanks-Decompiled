...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    SECRET_EVENT_VEHICLE_PREVIEW_20 = 'secretEventVehiclePreview'
    SECRET_EVENT_SHOP_VEHICLE_PREVIEW_20 = 'secretEventShopVehiclePreview'
    ...
    OPT_DEVICES_CMP_SELECT_POPOVER = 'optDevicesCmpSelectPopover'
    ...
    OVERLAY_TEN_YEARS_COUNTDOWN = 'overlayTenYearsCountdown'
    EVENT_INGAME_DESERTER = 'eventIngameDeserter'
