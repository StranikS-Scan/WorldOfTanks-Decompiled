...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    OVERLAY_WEB_STORE_DORMITORY = 'overlayWebStoreDormitory'
    ...
    DETACHMENT_VIEW = 'detachmentView'
    DETACHMENT_MOBILIZATION_VIEW = 'detachmentMobilizationView'
    ...
    MOBILIZATION_CREW = 'mobilizationCrew'
