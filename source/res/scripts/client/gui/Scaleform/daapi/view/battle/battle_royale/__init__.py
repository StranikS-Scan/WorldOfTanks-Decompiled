...
def getViewSettings():
    ...
    return (ViewSettings(VIEW_ALIAS.BATTLE_ROYALE_PAGE, BattleRoyalePage, 'battleRoyalePage.swf', ViewTypes.DEFAULT, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(BATTLE_VIEW_ALIASES.STATUS_NOTIFICATIONS_PANEL, StatusNotificationTimerPanel, None, ViewTypes.COMPONENT, None, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ViewSettings(BATTLE_VIEW_ALIASES.BATTLE_VEHICLE_CONFIGURATOR, veh_configurator.BattleVehicleConfigurator, 'battleVehicleConfigurator.swf', ViewTypes.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True),
