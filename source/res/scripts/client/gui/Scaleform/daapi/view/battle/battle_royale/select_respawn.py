...
class BRPrebattleTimer(IAbstractPeriodView):
    ...
    def __updateTimer(self):
        ...
        if round(self.__timeLeft) <= getBattleRoyaleSettings()['spawn']['selectEndingSoonTime']:
...
class SelectRespawnView(ViewImpl):
    ...
    def _initialize(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as vm:
            ...
            vm.setHeader(backport.text(R.strings.battle_royale.selectRespawn.header()))
            vm.setDescription(backport.text(R.strings.battle_royale.selectRespawn.description()))
            vm.setBtnDescription(backport.text(R.strings.battle_royale.selectRespawn.btnDescription()))
