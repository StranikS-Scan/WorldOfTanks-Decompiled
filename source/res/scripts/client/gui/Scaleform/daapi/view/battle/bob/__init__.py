...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/bob/__init__.py
from frameworks.wulf import WindowLayer
from gui.Scaleform.daapi.settings.views import VIEW_ALIAS
from gui.Scaleform.daapi.view.battle.bob.page import BobPage
from gui.Scaleform.daapi.view.battle.shared.page import BattlePageBusinessHandler
from gui.Scaleform.framework import ViewSettings, ComponentSettings, ScopeTemplates
...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.battle.bob import players_panel
    from gui.Scaleform.daapi.view.battle.bob import stats_exchange
    from gui.Scaleform.daapi.view.battle.bob import battle_loading
    from gui.Scaleform.daapi.view.battle.bob import consumables_panel
    ...
    import gui.Scaleform.daapi.view.battle.bob.status_notification_panel as sn_panel
    from gui.Scaleform.daapi.view.battle.bob import minimap
    return (ViewSettings(VIEW_ALIAS.BOB_BATTLE_PAGE, BobPage, 'bobBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.BATTLE_LOADING, battle_loading.BobBattleLoading, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.BATTLE_STATISTIC_DATA_CONTROLLER, stats_exchange.BobStatisticsDataController, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.PLAYERS_PANEL, players_panel.BobPlayersPanel, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.MINIMAP, minimap.BobMinimapComponent, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.CONSUMABLES_PANEL, consumables_panel.BobConsumablesPanel, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.STATUS_NOTIFICATIONS_PANEL, sn_panel.BobStatusNotificationTimerPanel, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (BattlePageBusinessHandler(VIEW_ALIAS.BOB_BATTLE_PAGE),)
