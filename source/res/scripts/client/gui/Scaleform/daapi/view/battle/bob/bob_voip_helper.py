...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/bob/bob_voip_helper.py
import enum
import typing
import VOIP
...
if typing.TYPE_CHECKING:
    from gui.battle_control.arena_info.interfaces import IBobVOIPController
_HTML_TEMPLATE = 'html_templates:bob/voiceChat'
...
class BobVoipHelper(object):
    ...
    def __voipController(self):
        return self.__sessionProvider.dynamic.bobVOIPController
