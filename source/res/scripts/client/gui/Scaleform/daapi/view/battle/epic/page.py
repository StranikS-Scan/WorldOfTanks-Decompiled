...
_GAME_UI = {BATTLE_VIEW_ALIASES.VEHICLE_ERROR_MESSAGES,
 ...
 BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR,
    ...
    def _invalidateState(self):
        ...
        if targetState == PageStates.NONE or self.__activeState == targetState:
            ...
            if vehicle is not None:
                ...
                if not vehicle.typeDescriptor.hasThermalVision:
                    if BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR in visibleUI:
                        visibleUI.remove(BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR)
                        hiddenUI.add(BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR)
                elif BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR in hiddenUI:
                    visibleUI.add(BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR)
                    hiddenUI.remove(BATTLE_VIEW_ALIASES.THERMAL_VISION_INDICATOR)
