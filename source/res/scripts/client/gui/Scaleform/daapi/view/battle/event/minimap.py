...
class EventMinimapComponent(ClassicMinimapComponent):
    ...
    def _setupPlugins(self, arenaVisitor):
        ...
        setup['area_markers'] = EventBaseAreaMarkerEntriesPlugin
        return setup
...
class EventArenaVehiclesPlugin(ArenaVehiclesPlugin):
    ...
    def _setVehicleInfo(self, vehicleID, entry, vInfo, guiProps, isSpotted=False):
        ...
        if WT_TAGS.BOSS in vehicleType.tags:
            classTag = 'wtboss'
        if WT_TAGS.MINIBOSS in vehicleType.tags:
            classTag = 'miniboss'
...
class EventBaseAreaMarkerEntriesPlugin(AreaMarkerEntriesPlugin):
    __slots__ = ('__entityMap',)

    def __init__(self, parentObj):
        super(EventBaseAreaMarkerEntriesPlugin, self).__init__(parentObj)
        self.__entityMap = {}
    ...
    def update(self, *args, **kwargs):
        super(EventBaseAreaMarkerEntriesPlugin, self).update()
