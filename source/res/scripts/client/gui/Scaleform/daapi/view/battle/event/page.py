...
EVENT_CONFIG = ComponentsConfig(config=((BATTLE_CTRL_ID.BATTLE_HINTS, (BATTLE_VIEW_ALIASES.BATTLE_HINT, BATTLE_VIEW_ALIASES.BATTLE_TIMER, _SoundPlayerAliases.BATTLE_HINT_SOUND)),
 ...
 (BATTLE_CTRL_ID.MINI_BOSS_INFO_CTRL, (BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET,)),
...
_EVENT_EXTERNAL_COMPONENTS = (EventMarkersManager, KillCamMarkersManager, EventCrosshairPanelContainer)
...
class EventBattlePage(ClassicPage, ISpawnListener):
    ...
    def showSpawnPoints(self):
        ...
        visibleComponents = {self._spawnViewAlias,
         BATTLE_VIEW_ALIASES.MINIMAP,
         BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET,
         BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET} | self._spawnVisibleComponents
    ...
    def __onRoundFinished(self, winningTeam, reason):
        hiddenComponents = {BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET, BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET, BATTLE_VIEW_ALIASES.BATTLE_HINT}
    ...
    def _onBattleLoadingStart(self):
        ...
        data = {'tutorialPages': _HUNTER_PAGES if isHunter else _BOSS_PAGES}
    ...
    def __setVisibilityInitBattlePeriod(self):
        visibleComponents = {BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT, BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET, BATTLE_VIEW_ALIASES.EVENT_MINI_BOSS_WIDGET}
