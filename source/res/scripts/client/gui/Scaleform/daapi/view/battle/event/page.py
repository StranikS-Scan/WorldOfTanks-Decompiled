...
from battle_royale.gui.battle_control.controllers.spawn_ctrl import ISpawnListener, SpawnType
...
EVENT_CONFIG = ComponentsConfig(config=((BATTLE_CTRL_ID.BATTLE_HINTS, (BATTLE_VIEW_ALIASES.BATTLE_HINT, BATTLE_VIEW_ALIASES.BATTLE_TIMER, _SoundPlayerAliases.BATTLE_HINT_SOUND)),
 ...
 (BATTLE_CTRL_ID.SPAWN_CTRL, (BATTLE_VIEW_ALIASES.EVENT_HUNTER_RESPAWN, BATTLE_VIEW_ALIASES.EVENT_BOSS_TELEPORT, _SoundPlayerAliases.RESPAWN_SOUND_PLAYER)),
