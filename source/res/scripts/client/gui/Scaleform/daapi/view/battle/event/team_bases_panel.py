...
from gui.Scaleform.daapi.view.meta.EventTeamBasesPanelMeta import EventTeamBasesPanelMeta
from gui.impl import backport
from gui.impl.gen import R
from helpers import dependency, time_utils
from skeletons.gui.battle_session import IBattleSessionProvider

class EventTeamBasesPanel(EventTeamBasesPanelMeta):
    _COLOR = 'eventPurple'
    ...
    def __onGeneratorCapture(self, index, progress, timeLeft, numInvaders, isBlocked):
        ...
        text = backport.text(R.strings.event.teamBasePanel.capturing(), num=self._GENERATOR_ID_TO_NAME.get(index), percent=progress)
