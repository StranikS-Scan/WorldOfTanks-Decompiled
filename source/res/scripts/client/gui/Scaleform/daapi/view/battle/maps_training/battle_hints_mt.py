...
class BattleHintData(namedtuple('_HintData', ('name', 'componentAlias', 'duration', 'maxWaitTime', 'priority', 'hintType', 'soundFx', 'soundNotification', 'descriptionKey1', 'descriptionKey2', 'soundNotificationNewbie'))):
