...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/battle/ranked/ranked_voip_helper.py
import enum
import typing
import VOIP
...
_HTML_TEMPLATE = 'html_templates:ranked/voiceChat'
...
class RankedVoipHelper(object):
    ...
    def populate(self):
        ...
        component.as_setVoiceChatDataS({'activeText': self.__makeHtmlString(backport.text(R.strings.ranked_battles.voiceChat.active())),
         'inactiveText': self.__makeHtmlString(backport.text(R.strings.ranked_battles.voiceChat.inactive()))})
        self.__update()
        self.__subscribe()
