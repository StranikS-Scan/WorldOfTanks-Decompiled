...
def getViewSettings():
    ...
    return (ViewSettings(VIEW_ALIAS.INGAME_MENU, ingame_menu.IngameMenu, 'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     ...
     ConditionalViewSettings(BATTLE_VIEW_ALIASES.RADIAL_MENU, EventComponentOverride(RadialMenu, EventRadialMenu), None, WindowLayer.UNDEFINED, None, ScopeTemplates.DEFAULT_SCOPE),
