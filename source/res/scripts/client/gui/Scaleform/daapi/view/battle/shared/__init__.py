...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.battle.shared import color_settings_tip
    return (ViewSettings(VIEW_ALIAS.INGAME_MENU, ingame_menu.IngameMenu, 'ingameMenu.swf', ViewTypes.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     ...
     ViewSettings(BATTLE_VIEW_ALIASES.COLOR_SETTINGS_TIP_PANEL, color_settings_tip.ColorSettingsTipPanel, None, ViewTypes.COMPONENT, None, ScopeTemplates.DEFAULT_SCOPE))
