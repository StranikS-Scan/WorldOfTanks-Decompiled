...
class ArtilleryTimeZonePlugin(plugins.MarkerPlugin, EventsHandler):
    ...
    def _getEvents(self):
        if self.__artilleryTimeZoneComponent is None:
            ...
            return ((self.__artilleryTimeZoneComponent.onTimeZoneAdded, self._onTimeZoneAdded), (self.__artilleryTimeZoneComponent.onTimeZoneRemoved, self._onTimeZoneRemoved), (self.__artilleryTimeZoneComponent.onTimeZoneTimerUpdated, self._onTimeZoneTimerUpdated)) if BattleReplay.isPlaying() else ((self.__artilleryTimeZoneComponent.onTimeZoneAdded, self._onTimeZoneAdded), (self.__artilleryTimeZoneComponent.onTimeZoneRemoved, self._onTimeZoneRemoved))
