...
class _ShellModeImgVOBuilder(_IVOBuilder):
    ...
    def _getShellModeImg(self, info):
        return _MODE_IMAGES.get(info.getAttackerMechanicShotMode(), '') if info.isShot() else self.__defaultValue
