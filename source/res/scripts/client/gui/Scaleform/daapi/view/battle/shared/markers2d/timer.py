...
class MarkerTimer(PythonTimer):
    __slots__ = ('__animated', '__statusID', '__vehicleID', '__showCountdown')

    def __init__(self, viewObject, vehicleID, typeID, totalTime, currentInterval=1.0, animated=True, statusID=0, showCountdown=True):
