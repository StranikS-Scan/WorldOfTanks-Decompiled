...
from gui.battle_control.battle_constants import MARKER_HIT_STATE, PLAYER_GUI_PROPS, MARKER_ARMOR_SCREEN_HIT_STATE
...
class VehicleMarkerPlugin(MarkerPlugin, ChatCommunicationComponent, IArenaVehiclesController):
    ...
    __slots__ = ('_markers', '_markersStates', '_clazz', '__playerVehicleID', '_isSquadIndicatorEnabled', '__showDamageIcon', '_markerTimers', '__callbackIDs', '__targetedTankMarkerID', '__targetedMarkerFromCppID', '__equipmentCtrl', '__showArmorScreenIcon')
    ...
    def __init__(self, parentObj, clazz=markers.VehicleMarker):
        ...
        self.__showArmorScreenIcon = False
        self.__callbackIDs = {}
    ...
    def start(self):
        ...
        self.__showArmorScreenIcon = self.settingsCore.getSetting(GAME.SHOW_SPACED_ARMOR_HIT_ICON) and (not isInBootcamp or enableInBootcamp)
    ...
    def _onVehicleFeedbackReceived(self, eventID, vehicleID, value):
        ...
        elif eventID in MARKER_ARMOR_SCREEN_HIT_STATE and self.__showArmorScreenIcon:
            newState, stateText, iconAnimation = self.__getHitStateVO(eventID, MARKER_ARMOR_SCREEN_HIT_STATE)
            self.__updateMarkerState(handle, newState, value, stateText, iconAnimation)
    ...
    def __setVehicleInfo(self, marker, vInfo, guiProps, nameParts):
        ...
        self._invokeMarker(markerID, 'setVehicleInfo', vType.classTag, vType.iconPath, nameParts.vehicleName, vType.level, nameParts.playerFullName, nameParts.playerName, nameParts.clanAbbrev, nameParts.regionCode, vType.maxHealth, guiProps.name(), hunting, squadIndex, backport.text(R.strings.ingame_gui.stun.seconds()))
    ...
    def __onSettingsChanged(self, diff):
        ...
        if GAME.SHOW_SPACED_ARMOR_HIT_ICON in diff:
            self.__showArmorScreenIcon = diff[GAME.SHOW_SPACED_ARMOR_HIT_ICON]
