...
REGULAR_UPPER_STATIC_SHORTCUTS = (Shortcut(title=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, action=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, icon=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, groups=[RADIAL_MENU_CONSTS.TARGET_STATE_DEFAULT,
  ...
  RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_CAMP,
  RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_COLLECTOR,
 ...
 Shortcut(title=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, action=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, icon=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, groups=[RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_CAMP, RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_COLLECTOR, RADIAL_MENU_CONSTS.TARGET_STATE_EMPTY], bState=RADIAL_MENU_CONSTS.EMPTY_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_SIXTH),
 ...
 Shortcut(title=INGAME_HELP.EVENTRADIALMENU_COLLECTOR, action=BATTLE_CHAT_COMMAND_NAMES.DEFENDING_BASE, icon=RADIAL_MENU_CONSTS.EVENT_COLLECTOR, groups=[RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_COLLECTOR], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST),
 Shortcut(title=INGAME_HELP.EVENTRADIALMENU_CAMP, action=BATTLE_CHAT_COMMAND_NAMES.ATTACKING_BASE, icon=RADIAL_MENU_CONSTS.EVENT_CAMP, groups=[RADIAL_MENU_CONSTS.TARGET_STATE_EVENT_CAMP], bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST))
...
MARKERS_TYPE_TO_SUBTYPE_MAP = {MarkerType.VEHICLE_MARKER_TYPE: {DefaultMarkerSubType.ALLY_MARKER_SUBTYPE: RADIAL_MENU_CONSTS.TARGET_STATE_ALLY,
...
CAN_CANCEL_REPLY_SHORTCUT = Shortcut(title=INGAME_HELP.RADIALMENU_CANCEL_REPLY, action=BATTLE_CHAT_COMMAND_NAMES.CANCEL_REPLY, icon=RADIAL_MENU_CONSTS.NO, groups=RADIAL_MENU_CONSTS.ALL_TARGET_STATES, bState=RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE, indexInGroup=RADIAL_MENU_CONSTS.ELEMENT_INDEX_FIRST)
...
class RadialMenu(RadialMenuMeta, BattleGUIKeyHandler, CallbackDelayer):
    ...
    def _getCanCancelReplyShortcut(self):
        return CAN_CANCEL_REPLY_SHORTCUT

    def _getSubtypeMapByMarkersType(self, targetMarkerType):
        return MARKERS_TYPE_TO_SUBTYPE_MAP[targetMarkerType]
    ...
    def __getRadialMenuState(self, targetID, targetMarkerType, targetMarkerSubtype, replyState, replyToAction):
        ...
        if targetMarkerType in MARKERS_TYPE_TO_SUBTYPE_MAP:
            subtypes = self._getSubtypeMapByMarkersType(targetMarkerType)
            if targetMarkerSubtype in subtypes:
                viewState = subtypes[targetMarkerSubtype]
            else:
                _logger.warning("Marker subtype name '%s' is not defined for '%s'.", targetMarkerSubtype, targetMarkerType)
        else:
            _logger.warning("Marker type name '%s' is not defined.", targetMarkerSubtype)
