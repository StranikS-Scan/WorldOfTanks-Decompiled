...
class TimersPanel(TimersPanelMeta):
    ...
    def _updateInspireTimer(self, isSourceVehicle, isInactivation, endTime, duration):
    ...
    def __updateHealingTimer(self, isSourceVehicle, isInactivation, endTime, duration):
        LOG_DEBUG('[HEAL_POINT] {} __updateHealingTimer: isSourceVehicle: {}, isInactivation: {}, endTime: {}, duration: {}'.format(*(str(x) for x in (BigWorld.player().id,
         isSourceVehicle,
         isInactivation,
         endTime,
         duration))))
