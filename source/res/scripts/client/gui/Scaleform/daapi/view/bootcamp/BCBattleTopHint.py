...
from bootcamp.statistic.logging_constants import BC_LOG_KEYS, BATTLE_HINTS_TO_LOG_ON_COMPLETE, BATTLE_HINTS_TO_LOG_ON_HIDE, BATTLE_HINTS_TO_LOG_ON_ANIMATION_FINISH
...
@loggerTarget(logKey=BC_LOG_KEYS.BC_BATTLE_HINTS)
