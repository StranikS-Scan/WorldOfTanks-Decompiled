...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.lobby.epicBattle.epic_battles_offline_view import EpicBattlesOfflineView
    from gui.Scaleform.daapi.view.lobby.epicBattle.epic_battles_welcome_back_view import EpicBattlesWelcomeBackView
    ...
    return (ViewSettings(EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, EpicBattlesSkillView, EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_VIEW_UI, ViewTypes.LOBBY_SUB, EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ...
     ViewSettings(EPICBATTLES_ALIASES.EPIC_BATTLES_OFFLINE_ALIAS, EpicBattlesOfflineView, EPICBATTLES_ALIASES.EPIC_BATTLES_OFFLINE_VIEW_UI, ViewTypes.LOBBY_SUB, EPICBATTLES_ALIASES.EPIC_BATTLES_OFFLINE_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ViewSettings(EPICBATTLES_ALIASES.EPIC_BATTLES_WELCOME_BACK_ALIAS, EpicBattlesWelcomeBackView, EPICBATTLES_ALIASES.EPIC_BATTLES_WELCOME_BACK_VIEW_UI, ViewTypes.LOBBY_SUB, EPICBATTLES_ALIASES.EPIC_BATTLES_WELCOME_BACK_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
     ...
     ViewSettings(EPICBATTLES_ALIASES.EPIC_BATTLES_PRIME_TIME_ALIAS, EpicBattlesPrimeTimeView, HANGAR_ALIASES.PRIME_TIME_UI, ViewTypes.LOBBY_SUB, EPICBATTLES_ALIASES.EPIC_BATTLES_PRIME_TIME_ALIAS, ScopeTemplates.LOBBY_TOP_SUB_SCOPE, True))
...
class EpicMetaGamePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = ((EPICBATTLES_ALIASES.EPIC_BATTLES_SKILL_ALIAS, self.loadViewByCtxEvent),
         ...
         (EPICBATTLES_ALIASES.EPIC_BATTLES_OFFLINE_ALIAS, self.loadViewByCtxEvent),
