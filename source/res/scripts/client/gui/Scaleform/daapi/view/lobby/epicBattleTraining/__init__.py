...
def getViewSettings():
    ...
    return [ViewSettings(PREBATTLE_ALIASES.EPICBATTLE_LIST_VIEW_PY, EpicBattlesList, 'trainingForm.swf', ViewTypes.LOBBY_SUB, PREBATTLE_ALIASES.EPICBATTLE_LIST_VIEW_PY, ScopeTemplates.DEFAULT_SCOPE, True), ViewSettings(PREBATTLE_ALIASES.EPIC_TRAINING_ROOM_VIEW_PY, EpicBattleTrainingRoom, 'EpicBattleTrainingRoom.swf', ViewTypes.LOBBY_SUB, PREBATTLE_ALIASES.EPIC_TRAINING_ROOM_VIEW_PY, ScopeTemplates.DEFAULT_SCOPE, True)]
...
class _EpicBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        ...
        LOG_DEBUG('_EpicBattlePackageBusinessHandler CREATED')
        listeners = ((PREBATTLE_ALIASES.EPICBATTLE_LIST_VIEW_PY, self.loadViewByCtxEvent), (PREBATTLE_ALIASES.EPIC_TRAINING_ROOM_VIEW_PY, self.loadViewByCtxEvent))
