...
class EpicBattlesList(TrainingsListBase):
    ...
    def _dispose(self):
        ...
        window = self.app.containerManager.getView(ViewTypes.WINDOW, criteria={POP_UP_CRITERIA.VIEW_ALIAS: PREBATTLE_ALIASES.EPIC_TRAINING_SETTINGS_WINDOW_PY})
    ...
    def createTrainingRequest(self):
        ...
        self.fireEvent(events.LoadViewEvent(PREBATTLE_ALIASES.EPIC_TRAINING_SETTINGS_WINDOW_PY, ctx={'isCreateRequest': True,
