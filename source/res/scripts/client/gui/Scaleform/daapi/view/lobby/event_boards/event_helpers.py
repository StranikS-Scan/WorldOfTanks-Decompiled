...
class EventInfo(object):
    ...
    def __getConditionIcon(self, iconNum):
        ...
        return RES_ICONS.MAPS_ICONS_EVENTBOARDS_LANDINGICONS_CONDITIONS_SERVER if iconNum == 2 else RES_ICONS.MAPS_ICONS_EVENTBOARDS_LANDINGICONS_CONDITIONS_VEHICLE
