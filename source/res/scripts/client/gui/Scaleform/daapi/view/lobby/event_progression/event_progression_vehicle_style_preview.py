...
class EventProgressionVehicleStylePreview(VehicleStylePreview):
    ...
    def _onRegisterFlashComponent(self, viewPy, alias):
        ...
        if alias == VEHPREVIEW_CONSTANTS.EVENT_PROGRESSION_STYLE_BUYING_PANEL_PY_ALIAS:
            viewPy.setData(self._style, self._getBuyingPanelData())
    ...
    def _getBuyingPanelData(self):
        ...
        tokensIcon = icons.makeImageTag(source=backport.image(R.images.gui.maps.icons.epicBattles.prestigePoints.c_32x32() if IS_CHINA else R.images.gui.maps.icons.epicBattles.rewardPoints.c_32x32()), width=32, height=32, vSpace=-6, hSpace=3)
