...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/lobby/hangar/carousels/fun_random/carousel_data_provider.py
...
class FunRandomCarouselDataProvider(BattlePassCarouselDataProvider):
    ...
    def __init__(self, carouselFilter, itemsCache, currentVehicle):
        super(FunRandomCarouselDataProvider, self).__init__(carouselFilter, itemsCache, currentVehicle)
