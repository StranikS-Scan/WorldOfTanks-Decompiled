...
@dependency.replace_none_kwargs(hwController=IHalloweenController)
def isHalloweenEntryPointAvailable(hwController=None):
    return hwController.isEnabled() and hwController.isAvailable()
...
_ENTRY_POINT_ENABLED_VALIDATOR = {HANGAR_ALIASES.CRAFT_MACHINE_ENTRY_POINT: getCraftMachineEntryPointIsActive,
 ...
 HANGAR_ALIASES.HW22_EVENT_ENTRY_POINT: isHalloweenEntryPointAvailable}
_logger = logging.getLogger(__name__)

def addEntryPointValidator(key, value):
    _ENTRY_POINT_ENABLED_VALIDATOR[key] = value
