...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/lobby/hangar/web_handlers.py
from web.web_client_api import webApiCollection
from web.web_client_api.events import EventsWebApi
...
def createHangarWebHandlers(onBrowserOpen=None, onBrowserClose=None):
    return webApiCollection(_createCloseWindowWebApi(onBrowserClose=onBrowserClose), _createOpenWindowWebApi(onBrowserOpen=onBrowserOpen, onBrowserClose=onBrowserClose), QuestsWebApi, EventsWebApi, SoundWebApi, RequestWebApi, UtilWebApi, OpenTabWebApi)
