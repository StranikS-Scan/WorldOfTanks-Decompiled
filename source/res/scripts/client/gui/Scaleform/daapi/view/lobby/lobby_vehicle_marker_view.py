...
class LobbyVehicleMarkerView(LobbyVehicleMarkerViewMeta):
    _LAYERS_WITHOUT_MARKERS = {WindowLayer.FULLSCREEN_WINDOW,
     WindowLayer.OVERLAY,
    ...
    def _canShowMarkers(self):
        ...
        windows = windowsManager.findWindows(lambda w: w.layer in self._LAYERS_WITHOUT_MARKERS and not isinstance(w, PopOverWindow))
