...
class ActionButtonStateVO(dict):
    __NOT_CRITICAL_STATES = (UNIT_RESTRICTION.UNDEFINED,
     ...
     UNIT_RESTRICTION.EVENT_UNIT_COMMANDER_NOT_SELECTED)
    ...
    def __init__(self, unitEntity):
        ...
        self.__INVALID_UNIT_MESSAGES = {UNIT_RESTRICTION.UNDEFINED: ('', {}),
         ...
         UNIT_RESTRICTION.EVENT_UNIT_COMMANDER_IS_LOCKED: (EVENT.SQUAD_GENERAL_LOCKED, {}),
         UNIT_RESTRICTION.EVENT_UNIT_COMMANDER_INACTIVE: (EVENT.SQUAD_GENERAL_INACTIVE, {}),
         UNIT_RESTRICTION.EVENT_UNIT_NOT_ENOUGH_ENERGY: (EVENT.HANGAR_TOOLTIP_NOT_ENOUGH_MONEY_BODY, {})}
