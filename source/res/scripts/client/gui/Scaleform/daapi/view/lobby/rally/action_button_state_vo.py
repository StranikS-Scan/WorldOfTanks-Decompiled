...
class ActionButtonStateVO(dict):
    __NOT_CRITICAL_STATES = (UNIT_RESTRICTION.UNDEFINED,
     ...
     UNIT_RESTRICTION.COMMANDER_GENERAL_NOT_SELECTED)
    ...
    def __init__(self, unitEntity):
        ...
        self.__INVALID_UNIT_MESSAGES = {UNIT_RESTRICTION.UNDEFINED: ('', {}),
         ...
         UNIT_RESTRICTION.EVENT_UNIT_GENERAL_NOT_VALID: (EVENT.SQUAD_GENERAL_NOT_VALID, {}),
         UNIT_RESTRICTION.EVENT_UNIT_GENERAL_IS_LOCKED: (EVENT.SQUAD_GENERAL_LOCKED, {}),
         UNIT_RESTRICTION.EVENT_UNIT_GENERAL_INACTIVE: (EVENT.SQUAD_GENERAL_INACTIVE, {}),
         UNIT_RESTRICTION.EVENT_UNIT_NOT_ENOUGHT_ENERGY: (EVENT.HANGAR_TOOLTIP_ENERGY_AVAILABLE_NOW, {'value': 0})}
