...
def getViewSettings():
    ...
    return (ViewSettings(SESSION_STATS_CONSTANTS.SESSION_BATTLE_STATS_VIEW_PY_ALIAS, SessionBattleStatsView, None, ViewTypes.COMPONENT, None, ScopeTemplates.VIEW_SCOPE), ViewSettings(SESSION_STATS_CONSTANTS.SESSION_VEHICLE_STATS_VIEW_PY_ALIAS, SessionVehicleStatsView, None, ViewTypes.COMPONENT, None, ScopeTemplates.VIEW_SCOPE), GroupedViewSettings(SESSION_STATS_CONSTANTS.SESSION_STATS_POPOVER, SessionStatsPopover, 'sessionStatsPopover.swf', ViewTypes.WINDOW, 'SessionStatsPopover', SESSION_STATS_CONSTANTS.SESSION_STATS_POPOVER, ScopeTemplates.WINDOW_VIEWED_MULTISCOPE))
