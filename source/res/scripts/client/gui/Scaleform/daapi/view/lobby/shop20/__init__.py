...
def getViewSettings():
    return (GroupedViewSettings(SHOP20_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, VehicleSellConfirmationPopover, 'vehicleSellConfirmationPopover.swf', ViewTypes.WINDOW, SHOP20_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, SHOP20_ALIASES.VEHICLE_SELL_CONFIRMATION_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE), GroupedViewSettings(SHOP20_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, RentalTermSelectionPopover, 'rentalTermSelectionPopover.swf', ViewTypes.WINDOW, SHOP20_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, SHOP20_ALIASES.RENTAL_TERM_SELECTION_POPOVER_ALIAS, ScopeTemplates.DEFAULT_SCOPE))
