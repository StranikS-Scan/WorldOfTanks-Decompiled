...
_TYPE_FILTER_ITEMS = [{'filterValue': int(_OptDeviceCategoriesFilterBit.FIREPOWER),
  ...
  'icon': backport.image(R.images.gui.maps.icons.tanksetup.specialization.firepower_filter())},
 {'filterValue': int(_OptDeviceCategoriesFilterBit.SURVIVABILITY),
  ...
  'icon': backport.image(R.images.gui.maps.icons.tanksetup.specialization.survivability_filter())},
 {'filterValue': int(_OptDeviceCategoriesFilterBit.MOBILITY),
  ...
  'icon': backport.image(R.images.gui.maps.icons.tanksetup.specialization.mobility_filter())},
 {'filterValue': int(_OptDeviceCategoriesFilterBit.STEALTH),
  ...
  'icon': backport.image(R.images.gui.maps.icons.tanksetup.specialization.stealth_filter())}]
