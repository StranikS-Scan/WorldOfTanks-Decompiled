...
def getViewSettings():
    from gui.Scaleform.daapi.view.lobby.store.browser.shop_view import ShopView, ShopOverlay, ShopOverlayDormitory, PremContentPageOverlay
    ...
    return (ViewSettings(VIEW_ALIAS.LOBBY_STORE, ShopView, 'browserScreen.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.LOBBY_STORE, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.OVERLAY_WEB_STORE_DORMITORY, ShopOverlayDormitory, 'browserScreen.swf', WindowLayer.TOP_WINDOW, VIEW_ALIAS.OVERLAY_WEB_STORE_DORMITORY, ScopeTemplates.LOBBY_SUB_SCOPE),
...
class StorePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = ((VIEW_ALIAS.LOBBY_STORE, self.loadViewByCtxEvent),
         ...
         (VIEW_ALIAS.OVERLAY_WEB_STORE_DORMITORY, self.loadViewByCtxEvent),
