...
from gui.Scaleform.daapi.view.lobby.tank_setup.context_menu.shell import ShellItemContextMenu
...
def getViewSettings():
    ...
    return (ViewSettings(VIEW_ALIAS.AMMUNITION_SETUP_VIEW, AmmunitionSetupView, 'ammunitionSetupView.swf', ViewTypes.LOBBY_TOP_SUB, VIEW_ALIAS.AMMUNITION_SETUP_VIEW, ScopeTemplates.LOBBY_SUB_SCOPE, True, isModal=True), ViewSettings(HANGAR_ALIASES.AMMUNITION_SETUP_VIEW_INJECT, AmmunitionSetupViewAdaptor, None, ViewTypes.COMPONENT, None, ScopeTemplates.DEFAULT_SCOPE), ViewSettings(HANGAR_ALIASES.AMMUNITION_SETUP_VIEW_VEHICLE_PARAMS, AmmunitionSetupViewVehicleParams, None, ViewTypes.COMPONENT, None, ScopeTemplates.DEFAULT_SCOPE))
