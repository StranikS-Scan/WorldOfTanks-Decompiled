...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/lobby/techtree/data/research_items_data.py
import logging
from gui.Scaleform.daapi.view.lobby.techtree import nodes
from gui.Scaleform.daapi.view.lobby.techtree.data.data import _ItemsData, _checkCollectibleEnabled
from gui.Scaleform.daapi.view.lobby.techtree.settings import NODE_STATE, MAX_PATH_LIMIT, RESEARCH_ITEMS, UnlockProps, DEFAULT_UNLOCK_PROPS
