...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/lobby/vehicle_preview/info/bottom_panel_trade_in_personal.py
...
class VehiclePreviewBottomPanelTradeInPersonal(VehiclePreviewBottomPanelTradeInMeta):
    __personalTradeIn = dependency.descriptor(IPersonalTradeInController)
    __itemsCache = dependency.descriptor(IItemsCache)

    def __init__(self):
        super(VehiclePreviewBottomPanelTradeInPersonal, self).__init__()
    ...
    def _populate(self):
        super(VehiclePreviewBottomPanelTradeInPersonal, self)._populate()
    ...
    def _dispose(self):
        ...
        self.__itemsCache.onSyncCompleted -= self.__onCacheSyncCompleted
        self.__personalTradeIn.onActiveSaleVehicleChanged -= self.__updateData
        super(VehiclePreviewBottomPanelTradeInPersonal, self)._dispose()
