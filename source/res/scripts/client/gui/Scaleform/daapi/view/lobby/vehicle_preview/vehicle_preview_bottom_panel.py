...
class VehiclePreviewBottomPanel(VehiclePreviewBottomPanelMeta):
    ...
    def __updateBtnState(self, *_):
        ...
        if item is None:
            ...
            hasExternalLink = (yield self.__hasExternalLink()) if not self.__isHeroTankFromBoxes() else self._lootBoxesCtrl.getBoxesCount(self._lootBoxesCtrl.mainEntryPoint) == 0
            if hasExternalLink:
