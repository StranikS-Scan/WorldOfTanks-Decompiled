...
class ConsumablesPanelMeta(BaseDAAPIComponent):
    ...
    def as_updateFestivalConsumableS(self, idx, step, current, stage):
        return self.flashObject.as_updateFestivalConsumable(idx, step, current, stage) if self._isDAAPIInited() else None
