...
class ConsumablesPanelMeta(BaseDAAPIComponent):
    ...
    def as_addEquipmentSlotS(self, idx, keyCode, sfKeyCode, quantity, timeRemaining, reloadingTime, iconPath, tooltipText, animation, stage, tags):
        return self.flashObject.as_addEquipmentSlot(idx, keyCode, sfKeyCode, quantity, timeRemaining, reloadingTime, iconPath, tooltipText, animation, stage, tags) if self._isDAAPIInited() else None
