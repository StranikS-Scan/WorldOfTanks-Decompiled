...
class DamagePanelMeta(BaseDAAPIComponent):
    ...
    def as_setupS(self, healthStr, progress, indicatorType, crewLayout, yawLimits, hasTurretRotator, hasWheel, isAutoRotationOn, isEventBoss):
        return self.flashObject.as_setup(healthStr, progress, indicatorType, crewLayout, yawLimits, hasTurretRotator, hasWheel, isAutoRotationOn, isEventBoss) if self._isDAAPIInited() else None
