...
class DamagePanelMeta(BaseDAAPIComponent):
    ...
    def as_setupS(self, healthStr, progress, indicatorType, crewLayout, yawLimits, hasTurretRotator, hasWheel, isAutoRotationOn, hasYoh, isAlive):
        return self.flashObject.as_setup(healthStr, progress, indicatorType, crewLayout, yawLimits, hasTurretRotator, hasWheel, isAutoRotationOn, hasYoh, isAlive) if self._isDAAPIInited() else None
