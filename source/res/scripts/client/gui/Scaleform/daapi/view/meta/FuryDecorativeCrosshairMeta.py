...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/FuryDecorativeCrosshairMeta.py
...
class FuryDecorativeCrosshairMeta(VehicleDecorativeCrosshair):
    ...
    def as_setGunStackProgressS(self, count, progress):
        return self.flashObject.as_setGunStackProgress(count, progress) if self._isDAAPIInited() else None
