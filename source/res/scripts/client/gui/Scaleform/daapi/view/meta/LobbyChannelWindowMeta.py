...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/LobbyChannelWindowMeta.py
...
class LobbyChannelWindowMeta(SimpleChannelWindow):
    ...
    def as_setIsPrivateS(self, isPrivate):
        return self.flashObject.as_setIsPrivate(isPrivate) if self._isDAAPIInited() else None
