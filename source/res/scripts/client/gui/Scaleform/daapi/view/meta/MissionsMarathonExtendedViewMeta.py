...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/MissionsMarathonExtendedViewMeta.py
from gui.Scaleform.framework.entities.BaseDAAPIComponent import BaseDAAPIComponent

class MissionsMarathonExtendedViewMeta(BaseDAAPIComponent):
