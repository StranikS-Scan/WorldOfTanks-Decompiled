...
# Embedded file name: scripts/client/gui/Scaleform/daapi/view/meta/WheeledDashWidgetMeta.py
...
class WheeledDashWidgetMeta(VehicleMechanicWidget):
    ...
    def as_isReducedCooldownS(self, value):
        return self.flashObject.as_isReducedCooldown(value) if self._isDAAPIInited() else None
