...
def getTooltipBuilders():
    return (builders.DataBuilder(TOOLTIPS_CONSTANTS.BATTLE_STATS_ACHIEVS, TOOLTIPS_CONSTANTS.ACHIEVEMENT_UI, achievement.AchievementTooltipData(contexts.BattleResultContext())),
     builders.DataBuilder(TOOLTIPS_CONSTANTS.SHOP_20_ACHIEVEMENT, TOOLTIPS_CONSTANTS.ACHIEVEMENT_UI, achievement.AchievementTooltipData(contexts.Shop20AchievementContext())),
     ...
     builders.DataBuilder(TOOLTIPS_CONSTANTS.WOT_RATING, TOOLTIPS_CONSTANTS.ACHIEVEMENT_UI, achievement.WtrTooltipData(contexts.ProfileContext())),
