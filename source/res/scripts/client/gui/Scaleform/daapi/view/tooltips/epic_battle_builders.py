...
from gui.shared.tooltips.frontline import FrontlineQuestsTooltipData
...
def getTooltipBuilders():
    return (DataBuilder(TOOLTIPS_CONSTANTS.EPIC_SKILL_INFO, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, epic_skills.EpicSkillExtendedTooltip(contexts.QuestsBoosterContext())),
     ...
     DataBuilder(TOOLTIPS_CONSTANTS.EPIC_QUESTS_PREVIEW, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, FrontlineQuestsTooltipData(contexts.QuestsBoosterContext())))
