...
from gui.shared.tooltips.event_battles_tooltips import EventBattlesSelectorTooltip, EventBattlesServerPrimeTime, EventBattlesCalendar, EventQuestsTooltipData, EventTicketTooltipWindowData, EventLootBoxTooltipWindowData, EventCarouselVehicleTooltipData, EventBuyLootBoxTooltipWindowData, EventStampTooltipWindowData
