...
def getTooltipBuilders():
    return (DefaultFormatBuilder(TOOLTIPS_CONSTANTS.SETTINGS_CONTROL, TOOLTIPS_CONSTANTS.COMPLEX_UI, common.SettingsControlTooltipData(contexts.HangarContext())),
     ...
     DataBuilder(TOOLTIPS_CONSTANTS.SETTINGS_KEY_SHOW_QUEST_PROGRESS, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, common.SettingsKeyShowQuestProgress(contexts.ToolTipContext(None))),
