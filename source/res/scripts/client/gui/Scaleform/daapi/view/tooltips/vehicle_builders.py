...
def getTooltipBuilders():
    return (DataBuilder(TOOLTIPS_CONSTANTS.CAROUSEL_VEHICLE, TOOLTIPS_CONSTANTS.VEHICLE_INFO_UI, vehicle.VehicleInfoTooltipData(contexts.CarouselContext())),
     ...
     AdvancedDataBuilder(TOOLTIPS_CONSTANTS.CREW_MEMBER, TOOLTIPS_CONSTANTS.VEHICLE_PREVIEW_CREW_MEMBER_UI, vehicle.CrewMemberTooltipData(contexts.HangarParamContext()), advanced.TankmanPreviewTooltipAdvanced(contexts.HangarContext())),
     ...
     AdvancedDataBuilder(TOOLTIPS_CONSTANTS.MODULE_PARAMETER, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, module.ModuleTTCTooltipData(contexts.HangarParamContext()), advanced.ModuleExtendedTooltipAdvanced(contexts.HangarParamContext())),
     AdvancedDataBuilder(TOOLTIPS_CONSTANTS.EQUIPMENT_PARAMETER, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, module.EquipmentTTCTooltipData(contexts.HangarParamContext()), advanced.ModuleExtendedTooltipAdvanced(contexts.HangarParamContext())),
     DataBuilder(TOOLTIPS_CONSTANTS.DETACHMENT_VEHICLE_PARAMETERS, TOOLTIPS_CONSTANTS.VEHICLE_PARAMETERS_UI, vehicle.VehicleInfoTooltipData(contexts.DetachmentVehicleContext(None))))
