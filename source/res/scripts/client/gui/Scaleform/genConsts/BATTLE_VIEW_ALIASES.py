...
class BATTLE_VIEW_ALIASES(object):
    ...
    BATTLE_VEHICLE_SELECTOR = 'battleVehicleSelector'
    AMMO_INFO = 'ammoInfo'
    MAP_SCENARIO_PROGRESS = 'mapScenarioProgress'
    BATTLE_HINT = 'battleHint'
    EVENT_STATS = 'eventStats'
    EVENT_RESPAWN_MINIMAP = 'eventRespawnMinimap'
