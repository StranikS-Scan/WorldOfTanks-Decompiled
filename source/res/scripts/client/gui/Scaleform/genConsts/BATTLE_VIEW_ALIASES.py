...
class BATTLE_VIEW_ALIASES(object):
    ...
    FOOTBALL_BATTLE_ANIMATION_TIMER = 'footballBattleAnimationTimer'
    FOOTBALL_FRAG_CORRELATION_BAR = 'footballFragCorrelationBar'
    PREBATTLE_TIMER = 'prebattleTimer'
    DEBUG_PANEL = 'debugPanel'
    SIXTH_SENSE = 'sixthSense'
    FOOTBALL_FULL_STATS = 'footballFullStats'
    FOOTBALL_OVERTIME_BAR = 'footballOvertimeBar'
    FOOTBALL_OVERTIME_RAGE_BAR = 'footballOvertimeRageBar'
    FOOTBALL_OVERTIME_TIMER = 'footballOvertimeTimer'
    FOOTBALL_START_TIMER = 'footballStartTimer'
    ...
    FOOTBALL_SCORE_PANEL = 'footballScorePanel'
    FOOTBALL_PREBATTLE_TIMER = 'footballPreBattleTimer'
    FOOTBALL_FADE_OVERLAY = 'footballFadeOverlay'
