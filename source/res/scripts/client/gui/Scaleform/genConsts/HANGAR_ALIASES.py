...
class HANGAR_ALIASES(object):
    ...
    CREW = 'crew'
    DETACHMENT_WIDGET = 'detachmentWidget'
    ...
    VEH_PARAM_RENDERER_STATE_SITUATIONAL = 'situational'
    ...
    DETACHMENT_VIEW_INJECT = 'detachmentViewInject'
    DETACHMENT_VIEW_VEHICLE_PARAMS = 'detachmentViewVehicleParams'
