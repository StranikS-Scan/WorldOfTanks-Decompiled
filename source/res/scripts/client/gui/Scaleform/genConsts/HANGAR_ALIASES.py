...
class HANGAR_ALIASES(object):
    ...
    RTS_TANK_CAROUSEL = 'rtsTankCarousel'
    RTS_STRATEGIST_CAROUSEL = 'strategistCarousel'
    CREW = 'crew'
    ...
    RTS_SUBMODE_SELECTOR = 'rtsSubModeSelector'
    RTS_ENTRY_BANNER = 'RTSEntryBanner'
    RTS_WARNING_WIDGET = 'rtsWarningWidget'
    RTS_META_WIDGET = 'rtsMetaWidget'
    RTS_BANNER_WIDGET = 'rtsBannerWidget'
