...
class HANGAR_ALIASES(object):
    ...
    NY_MAIN_VIEW_GF_INJECT = 'nyMainViewGFInjectUI'
    NY_MAIN_VIEW_UB_INJECT = 'nyMainViewUBInjectUI'
    NY_MAIN_VIEW_MAIN_MENU_INJECT = 'nyMainViewMainMenuInjectUI'
    NY_MAIN_VIEW_SIDEBAR_UB_INJECT = 'nyMainViewSidebarInjectUI'
