...
class PREBATTLE_ALIASES(object):
    ...
    EPIC_SQUAD_VIEW_PY = 'prebattle/company/epicSquad'
    BATTLE_ROYALE_SQUAD_VIEW_PY = 'prebattle/company/battleRoyaleSquad'
    BOB_SQUAD_VIEW_PY = 'prebattle/company/bobSquad'
    SQUAD_WINDOW_PY = 'prb_windows/squadWindow'
    EVENT_SQUAD_WINDOW_PY = 'prb_windows/eventSquadWindow'
    EPIC_SQUAD_WINDOW_PY = 'prb_windows/epicSquadWindow'
    BATTLE_ROYALE_SQUAD_WINDOW_PY = 'prb_windows/battleRoyaleSquadWindow'
    FALLOUT_SQUAD_WINDOW_PY = 'prb_windows/falloutSquadWindow'
    BOB_SQUAD_WINDOW_PY = 'prb_windows/bobSquadWindow'
