...
class PREBATTLE_ALIASES(object):
    ...
    RTS_TRAINING_SETTINGS_WINDOW_PY = 'rtsTrainingSettingsWindow'
    ...
    RTS_TRAINING_LIST_VIEW_PY = 'rtsTraining'
    RTS_TRAINING_ROOM_VIEW_PY = 'rtsTrainingRoom'
    PYTHON_ALIASES = [BATTLE_SESSION_LIST_WINDOW_PY,
     ...
     RTS_TRAINING_SETTINGS_WINDOW_PY,
     RTS_TRAINING_LIST_VIEW_PY,
     RTS_TRAINING_ROOM_VIEW_PY]
