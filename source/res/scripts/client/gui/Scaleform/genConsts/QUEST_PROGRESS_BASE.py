...
class QUEST_PROGRESS_BASE(object):
    ...
    QP_VEHICLES_METRIC_TYPE_RANGE = 'vehiclesMetricRangeValues'
    ...
    QP_VEHICLES_METRIC_RANGE_VALUES_CMP_TAB = 'QPMetricsVehiclesRangeValuesCmpTabUI'
    ...
    QP_VEHICLES_METRIC_RANGE_VALUES_CMP_TOP = 'QPMetricsVehiclesRangeValuesCmpTopUI'
