...
class TOOLTIPS_CONSTANTS(object):
    ...
    TANKMAN_DEMOBILIZED_STATE = 'tankmanDemobilizedState'
    ...
    BATTLE_BOOSTER_BLOCK_SHORTENED = 'battleBoosterBlockShortened'
    ...
    BUY_VEHICLE_SLOT_TOOLTIP = 'buyVehicleSlotTooltip'
    BUY_VEHICLE_AMMO_TOOLTIP = 'buyVehicleAmmoTooltip'
    BUY_VEHICLE_NO_WALLET = 'buyVehicleNoWallet'
    ...
    DETACHMENT_SELL_LIMIT = 'detachmentSellLimit'
    DETACHMENT_RECYCLE_BIN_FULL = 'detachmentRecycleBinFull'
    COMMANDER_PERK_GF = 'commanderPerkGf'
    DETACHMENT_PREVIEW = 'detachmentPreview'
    CREW_RETRAIN_PENALTY = 'crewRetrainPenalty'
    RECERTIFICATION_FORM = 'recertification_form'
    BOOK_ITEM = 'book_item'
    INSTRUCTOR_BONUSES = 'instructorBonuses'
    ...
    EQUIPMENT_PARAMETER = 'equipmentParameter'
    ...
    DETACHMENT_VEHICLE_PARAMETERS = 'detachmentVehicleParameters'
    DORMITORY_INFO = 'dormitoryInfo'
    GF_SIMPLE_COLORED = 'gfSimpleColored'
    GF_DETACHMENT_PERK = 'gfDetachmentPerk'
    ...
    BOOSTERS_SET = [INVENTORY_BATTLE_BOOSTER,
     ...
     BATTLE_BOOSTER_BLOCK_SHORTENED]
    COMMON_SET = [GF_SIMPLE_COLORED,
     EFFICIENCY_PARAM,
     IGR_INFO,
     CONTACT,
     SORTIE_DIVISION,
    ...
    TANKMAN_SET = [TANKMAN,
     ...
     TANKMAN_DEMOBILIZED_STATE]
    PERK_SET = [PERK, PERK_TTC]
    ...
    CREW_SKIN_SET = [CREW_SKIN,
     ...
     CREW_SKIN_SOUND]
    CREW_BOOK_SET = [CREW_BOOK, CREW_BOOK_RESTRICTED, BOOK_ITEM]
    ...
    DETACHMENT_SET = [DETACHMENT_SELL_LIMIT,
     DETACHMENT_RECYCLE_BIN_FULL,
     CREW_RETRAIN_PENALTY,
     DETACHMENT_PREVIEW,
    ...
    BUY_VEHICLE_SET = [BUY_VEHICLE_SLOT_TOOLTIP, BUY_VEHICLE_AMMO_TOOLTIP, BUY_VEHICLE_NO_WALLET]
