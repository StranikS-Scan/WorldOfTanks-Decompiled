...
class TOOLTIPS_CONSTANTS(object):
    ...
    NY_RESOURCE = 'nyResource'
    NY_RESOURCE_FOR_SHOP = 'nyResourceForShop'
    NY_RESOURCE_LIST = 'nyResourceList'
    NY_RANDOM_RESOURCE = 'nyRandomResource'
    NY_REWARD_KIT_RESTRICTION = 'nyRewardKitRestriction'
    NY_FILLERS = 'nyFillers'
    NY_SACK_RANDOM_REWARD = 'nySackRandomReward'
    ...
    SHORT_COLLAPSE_CUSTOMIZATION_ITEM_AWARD = 'ShortCollapseCustomizationItemAward'
    ...
    NY23_ACTION_TOKEN = 'NY23ActionToken'
    NY23_GUEST_COIN = 'NY23QuestCion'
    NY_COIN_TOKEN = 'NYCoinToken'
    NY23_SET = [NY23_ACTION_TOKEN, NY23_GUEST_COIN]
    ...
    COMMON_SET = [EFFICIENCY_PARAM,
     ...
     RESEARCH_BUTTON,
     COLLECTION_ITEM,
     EXCHANGE_RATE_LIMITED_DISCOUNT_INFO,
     EXCHANGE_RATE_DISCOUNT_INFO,
     NY_VEHICLE_BONUS,
     NY_AMMUNITION_BONUSES,
     NY_RESOURCE,
     NY_RANDOM_RESOURCE,
     NY_REWARD_KIT_RESTRICTION,
     NY_RESOURCE_FOR_SHOP,
     NY_RESOURCE_LIST,
     NY_FILLERS,
     NY_COIN_TOKEN,
     NY_SACK_RANDOM_REWARD]
    CUSTOMIZATION_SET = [TECH_CUSTOMIZATION_ITEM,
     ...
     SHORT_COLLAPSE_CUSTOMIZATION_ITEM_AWARD]
