...
class TOOLTIPS_CONSTANTS(object):
    ...
    EVENT_TANK_REPAIR_INFO = 'eventTankRepairInfo'
    EVENT_CREW_BOOSTER_INFO = 'eventCrewBoosterInfo'
    EVENT_TANK_RENT_INFO = 'eventTankRentInfo'
    EVENT_BANNER_INFO = 'eventBannerInfo'
    EVENT_CAROUSEL_VEHICLE = 'eventCarouselVehicle'
    EVENT_COMMANDERS_INFO = 'eventCommandersInfo'
    EVENT_COMMANDER_IN_BATTLE = 'eventCommanderInBattle'
    EVENT_MISSION_INFO = 'eventMissionInfo'
    EVENT_SELECTOR_INFO = 'eventSelectorInfo'
    EVENT_CRDITS_ERROR = 'eventCreditsError'
    EVENT_TOKEN_ERROR = 'eventTokenError'
    EVENT_GOLD_ERROR = 'eventGoldError'
    EVENT_BAN_INFO = 'eventBanInfo'
    EVENT_TOKEN_INFO = 'eventTokenInfo'
    OPERATION = 'operation'
    ...
    HALLOWEEN_TOKEN_BONUS = 'halloweenTokenBonus'
    HALLOWEEN_NO_SUITABLE_VEHICLE_FOR_QUEST = 'halloweenNoSuitableVechileForQuest'
    CN_LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT = 'cnLootBoxesVehicleBlueprintFragment'
    ...
    COMMON_SET = [EFFICIENCY_PARAM,
     ...
     DOG_TAGS_INFO,
     CN_LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT]
    ...
    EVENT_SET = [EVENT_BONUSES_INFO,
     EVENT_TANK_REPAIR_INFO,
     EVENT_CREW_BOOSTER_INFO,
     EVENT_TANK_RENT_INFO,
     EVENT_BANNER_INFO,
     EVENT_CAROUSEL_VEHICLE,
     EVENT_COMMANDERS_INFO,
     EVENT_MISSION_INFO,
     EVENT_SELECTOR_INFO,
     EVENT_CRDITS_ERROR,
     EVENT_TOKEN_ERROR,
     ...
     HALLOWEEN_TOKEN_BONUS,
     EVENT_COMMANDER_IN_BATTLE,
