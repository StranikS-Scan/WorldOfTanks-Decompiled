...
class TOOLTIPS_CONSTANTS(object):
    ...
    RTS_CALENDAR_DAY_INFO = 'rtsCalendarDayInfo'
    RTS_SELECTOR_INFO = 'rtsSelectorInfo'
    RTS_ORDER_INFO = 'rtsOrderInfo'
    RTS_VEHICLE_RESTRICTIONS = 'rtsVehicleRestrictions'
    RTS_VEHICLE_PARAMETERS = 'rtsVehicleParameters'
    RTS_ROSTER_MODULE = 'rtsRosterModule'
    RTS_ROSTER_TANKMAN = 'rtsRosterTankman'
    RTS_ROSTER_SHELL = 'rtsRosterShell'
    RTS_CAROUSEL_VEHICLE = 'rtsCarouselVehicle'
    RTS_SPECIAL_CURRENCY = 'rtsSpecialCurrency'
    ...
    RTS_SET = [RTS_SELECTOR_INFO,
     RTS_CALENDAR_DAY_INFO,
     RTS_VEHICLE_RESTRICTIONS,
     RTS_ROSTER_MODULE,
     RTS_ROSTER_TANKMAN,
     RTS_CAROUSEL_VEHICLE,
     RTS_VEHICLE_PARAMETERS,
     RTS_ROSTER_SHELL,
     RTS_SPECIAL_CURRENCY]
    RTS_BATTLE_SET = [RTS_ORDER_INFO]
