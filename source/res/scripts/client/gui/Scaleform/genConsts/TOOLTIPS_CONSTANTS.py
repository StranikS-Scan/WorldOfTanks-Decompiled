...
class TOOLTIPS_CONSTANTS(object):
    ...
    COMP7_CAROUSEL_VEHICLE = 'comp7CarouselVehicle'
    ...
    WOT_PLUS = 'wotPlus'
    NY_STATIC_DOG_TAG_INFO = 'nyStaticDogTagInfo'
    ...
    NEW_YEAR_AWARD_VEHICLE = 'newYearAwardVehicle'
    ...
    PERSONAL_MISSION_SET = [PERSONAL_QUESTS_PREVIEW,
     ...
     OPERATION_POSTPONED,
     PERSONAL_MISSIONS_ANNOUNCE,
     PERSONAL_MISSIONS_OLD_OPERATIONS,
     PM3_QUEST_CARD_TOOLTIP,
     PM3_GIFT_TOKEN]
    ...
    LB_LOBBY_SET = [LOOT_BOXES_VEHICLE_BLUEPRINT_FRAGMENT,
     LOOT_BOX_TOOLTIP,
     LOOT_BOX_KEY_TOOLTIP,
     LOOT_BOX_GUARANTEED_REWARD_TOOLTIP,
     LOOT_BOX_EXTENDED_TOOLTIP]
    ...
    NEW_YEAR_LOBBY_SET = [NEW_YEAR_AWARD_VEHICLE,
     NY_CREDIT_BONUS,
     NY_FILLERS,
     NY_STATIC_DOG_TAG_INFO]
    ...
    BIRTHDAY_SET = [BIRTHDAY_GIFT_SYSTEM_POSTMARK, BIRTHDAY_GOLDEN_TICKET, ECONOMY_BONUS_TOOLTIP]
