...
# Compiled at: 2011-06-20 14:20:15
...
class IngameHelp(object):
    __viewCmds = ('CMD_MOVE_FORWARD', 'CMD_MOVE_BACKWARD', 'CMD_ROTATE_LEFT', 'CMD_ROTATE_RIGHT', 'CMD_INCREMENT_CRUISE_MODE', 'CMD_DECREMENT_CRUISE_MODE', 'CMD_CM_VEHICLE_SWITCH_AUTOROTATION', 'CMD_CM_SHOOT', 'CMD_CM_LOCK_TARGET', 'CMD_CM_LOCK_TARGET_OFF', 'CMD_CM_ALTERNATE_MODE', 'CMD_VEHICLE_MARKERS_SHOW_INFO', 'CMD_CHAT_SHORTCUT_ATTACK', 'CMD_CHAT_SHORTCUT_BACKTOBASE', 'CMD_CHAT_SHORTCUT_FOLLOWME', 'CMD_CHAT_SHORTCUT_POSITIVE', 'CMD_CHAT_SHORTCUT_NEGATIVE', 'CMD_CHAT_SHORTCUT_HELPME', 'CMD_CHAT_SHORTCUT_ATTACK_MY_TARGET', 'CMD_VOICECHAT_MUTE')
    __viewCmdMapping = []
    __version = -1
...
class IngameHelpLobbyDelegator(UIInterface):
    ...
    def populateUI(self, proxy):
        ...
        self.uiHolder.addExternalCallbacks({'common.ingameHelp.close': self.onClose})
    ...
    def dispossessUI(self):
        ...
        self.__callback = None
        self.uiHolder.removeExternalCallbacks('common.ingameHelp.close')
