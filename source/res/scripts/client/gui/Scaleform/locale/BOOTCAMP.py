...
class BOOTCAMP(object):
    ...
    WELLCOME_BOOTCAMP_REWARDS_MEDAL = '#bootcamp:wellcome/bootcamp/rewards/medal'
    ...
    AWARD_OPTIONS_TANKTITLE = '#bootcamp:award/options/tankTitle'
    AWARD_OPTIONS_TANKSUBTITLE = '#bootcamp:award/options/tankSubTitle'
    AWARD_OPTIONS_TEXTTITLE = '#bootcamp:award/options/textTitle'
    ...
    PREVIEW_USA_TITLE = '#bootcamp:preview/usa/title'
    PREVIEW_GERMANY_TITLE = '#bootcamp:preview/germany/title'
    PREVIEW_USSR_TITLE = '#bootcamp:preview/ussr/title'
    PREVIEW_CHINA_TITLE = '#bootcamp:preview/china/title'
    PREVIEW_CZECH_TITLE = '#bootcamp:preview/czech/title'
    PREVIEW_FRANCE_TITLE = '#bootcamp:preview/france/title'
    PREVIEW_ITALY_TITLE = '#bootcamp:preview/italy/title'
    PREVIEW_JAPAN_TITLE = '#bootcamp:preview/japan/title'
    PREVIEW_POLAND_TITLE = '#bootcamp:preview/poland/title'
    PREVIEW_SWEDEN_TITLE = '#bootcamp:preview/sweden/title'
    PREVIEW_UK_TITLE = '#bootcamp:preview/uk/title'
    PREVIEW_USA_PREVIEW_VEHICLE_1 = '#bootcamp:preview/usa/preview_vehicle_1'
    PREVIEW_USA_PREVIEW_VEHICLE_2 = '#bootcamp:preview/usa/preview_vehicle_2'
    PREVIEW_USA_PREVIEW_VEHICLE_3 = '#bootcamp:preview/usa/preview_vehicle_3'
    PREVIEW_GERMANY_PREVIEW_VEHICLE_1 = '#bootcamp:preview/germany/preview_vehicle_1'
    PREVIEW_GERMANY_PREVIEW_VEHICLE_2 = '#bootcamp:preview/germany/preview_vehicle_2'
    PREVIEW_GERMANY_PREVIEW_VEHICLE_3 = '#bootcamp:preview/germany/preview_vehicle_3'
    PREVIEW_USSR_PREVIEW_VEHICLE_1 = '#bootcamp:preview/ussr/preview_vehicle_1'
    PREVIEW_USSR_PREVIEW_VEHICLE_2 = '#bootcamp:preview/ussr/preview_vehicle_2'
    PREVIEW_USSR_PREVIEW_VEHICLE_3 = '#bootcamp:preview/ussr/preview_vehicle_3'
    PREVIEW_CHINA_PREVIEW_VEHICLE_1 = '#bootcamp:preview/china/preview_vehicle_1'
    PREVIEW_CHINA_PREVIEW_VEHICLE_2 = '#bootcamp:preview/china/preview_vehicle_2'
    PREVIEW_CHINA_PREVIEW_VEHICLE_3 = '#bootcamp:preview/china/preview_vehicle_3'
    PREVIEW_CZECH_PREVIEW_VEHICLE_1 = '#bootcamp:preview/czech/preview_vehicle_1'
    PREVIEW_CZECH_PREVIEW_VEHICLE_2 = '#bootcamp:preview/czech/preview_vehicle_2'
    PREVIEW_CZECH_PREVIEW_VEHICLE_3 = '#bootcamp:preview/czech/preview_vehicle_3'
    PREVIEW_FRANCE_PREVIEW_VEHICLE_1 = '#bootcamp:preview/france/preview_vehicle_1'
    PREVIEW_FRANCE_PREVIEW_VEHICLE_2 = '#bootcamp:preview/france/preview_vehicle_2'
    PREVIEW_FRANCE_PREVIEW_VEHICLE_3 = '#bootcamp:preview/france/preview_vehicle_3'
    PREVIEW_ITALY_PREVIEW_VEHICLE_1 = '#bootcamp:preview/italy/preview_vehicle_1'
    PREVIEW_ITALY_PREVIEW_VEHICLE_2 = '#bootcamp:preview/italy/preview_vehicle_2'
    PREVIEW_ITALY_PREVIEW_VEHICLE_3 = '#bootcamp:preview/italy/preview_vehicle_3'
    PREVIEW_JAPAN_PREVIEW_VEHICLE_1 = '#bootcamp:preview/japan/preview_vehicle_1'
    PREVIEW_JAPAN_PREVIEW_VEHICLE_2 = '#bootcamp:preview/japan/preview_vehicle_2'
    PREVIEW_JAPAN_PREVIEW_VEHICLE_3 = '#bootcamp:preview/japan/preview_vehicle_3'
    PREVIEW_POLAND_PREVIEW_VEHICLE_1 = '#bootcamp:preview/poland/preview_vehicle_1'
    PREVIEW_POLAND_PREVIEW_VEHICLE_2 = '#bootcamp:preview/poland/preview_vehicle_2'
    PREVIEW_POLAND_PREVIEW_VEHICLE_3 = '#bootcamp:preview/poland/preview_vehicle_3'
    PREVIEW_SWEDEN_PREVIEW_VEHICLE_1 = '#bootcamp:preview/sweden/preview_vehicle_1'
    PREVIEW_SWEDEN_PREVIEW_VEHICLE_2 = '#bootcamp:preview/sweden/preview_vehicle_2'
    PREVIEW_SWEDEN_PREVIEW_VEHICLE_3 = '#bootcamp:preview/sweden/preview_vehicle_3'
    PREVIEW_UK_PREVIEW_VEHICLE_1 = '#bootcamp:preview/uk/preview_vehicle_1'
    PREVIEW_UK_PREVIEW_VEHICLE_2 = '#bootcamp:preview/uk/preview_vehicle_2'
    PREVIEW_UK_PREVIEW_VEHICLE_3 = '#bootcamp:preview/uk/preview_vehicle_3'
    ...
    COMPLETIONWITHOUTVICTORY_2 = '#bootcamp:completionWithoutVictory/2'
    COMPLETIONWITHOUTVICTORY_3 = '#bootcamp:completionWithoutVictory/3'
    COMPLETIONWITHOUTVICTORY_4 = '#bootcamp:completionWithoutVictory/4'
    COMPLETIONWITHOUTVICTORY_5 = '#bootcamp:completionWithoutVictory/5'
    ...
    MESSAGE_START_MESSAGE_REWARD = '#bootcamp:message/start/message/reward'
    ...
    RESULTLABEL_COMPLETE = '#bootcamp:resultlabel/complete'
    ...
    TOOLTIP_PROGRESSION_LABEL_MEDAL = '#bootcamp:tooltip/progression/label/medal'
    ...
    TOOLTIP_PROGRESSION_DESCRIPTION_MEDAL = '#bootcamp:tooltip/progression/description/medal'
    ...
    TOOLTIP_PROGRESSION_DESCRIPTION_LESSON_2_SHORT = '#bootcamp:tooltip/progression/description/lesson_2_short'
    ...
    TOOLTIP_PROGRESSION_LABEL_HEADER = '#bootcamp:tooltip/progression/label/header'
    TOOLTIP_PROGRESSION_LABEL_DESCRIPTION1 = '#bootcamp:tooltip/progression/label/description1'
    TOOLTIP_PROGRESSION_LABEL_SUBHEADER2 = '#bootcamp:tooltip/progression/label/subheader2'
    TOOLTIP_PROGRESSION_LABEL_DESCRIPTION2 = '#bootcamp:tooltip/progression/label/description2'
    TOOLTIP_PROGRESSION_LABEL_SUBHEADER3 = '#bootcamp:tooltip/progression/label/subheader3'
    TOOLTIP_PROGRESSION_LABEL_DESCRIPTION3 = '#bootcamp:tooltip/progression/label/description3'
    ...
    FINALREWARD_TITLE = '#bootcamp:finalReward/title'
    FINALREWARD_DESCRIPTION = '#bootcamp:finalReward/description'
    FINALREWARD_RECEIVED_TITLE = '#bootcamp:finalReward/received/title'
    FINALREWARD_RECEIVED_DESCRIPTION = '#bootcamp:finalReward/received/description'
    FINALREWARD_PROCEED = '#bootcamp:finalReward/proceed'
