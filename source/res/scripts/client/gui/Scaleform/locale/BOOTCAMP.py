...
class BOOTCAMP(object):
    ...
    MESSAGE_SKIP_LABEL = '#bootcamp:message/skip/label'
    MESSAGE_SKIP_LABELEXECUTE = '#bootcamp:message/skip/labelExecute'
    MESSAGE_SKIP_MESSAGE = '#bootcamp:message/skip/message'
    MESSAGE_SKIP_REFERRAL_MESSAGE = '#bootcamp:message/skip/referral/message'
    MESSAGE_SKIP_MESSAGE_PREMIUM = '#bootcamp:message/skip/message/premium'
    MESSAGE_SKIP_MESSAGE_GOLD = '#bootcamp:message/skip/message/gold'
    MESSAGE_SKIP_MESSAGE_CREW = '#bootcamp:message/skip/message/crew'
    MESSAGE_SKIP_COMPLETED_MESSAGE = '#bootcamp:message/skip/completed/message'
