...
class DIALOGS(object):
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_TITLE = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/title'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDITEMSTEXT = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/needItemsText'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDGOLDTEXT = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/needGoldText'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDITEMSSTEPPERTITLE = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/needItemsStepperTitle'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_SUBMIT = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/submit'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_CANCEL = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/cancel'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_EXCHANGENONEEDTEXT = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/exchangeNoNeedText'
    ...
    CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_GOLDNOTENOUGHTEXT = '#dialogs:confirmExchangeDialog/upgradeExchangeCredits/goldNotEnoughText'
    ...
    CUSTOMIZATION_INSTALL_BOUND_CHECK_TITLE = '#dialogs:customization/install_bound/check/title'
    CUSTOMIZATION_INSTALL_BOUND_CHECK_MESSAGE = '#dialogs:customization/install_bound/check/message'
    CUSTOMIZATION_INSTALL_BOUND_CHECK_SUBMIT = '#dialogs:customization/install_bound/check/submit'
    CUSTOMIZATION_INSTALL_BOUND_CHECK_CANCEL = '#dialogs:customization/install_bound/check/cancel'
    CUSTOMIZATION_INSTALL_BOUND_BASKET_TITLE = '#dialogs:customization/install_bound/basket/title'
    CUSTOMIZATION_INSTALL_BOUND_BASKET_MESSAGE = '#dialogs:customization/install_bound/basket/message'
    CUSTOMIZATION_INSTALL_BOUND_BASKET_SUBMIT = '#dialogs:customization/install_bound/basket/submit'
    CUSTOMIZATION_INSTALL_BOUND_BASKET_CANCEL = '#dialogs:customization/install_bound/basket/cancel'
    CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_TITLE = '#dialogs:customization/install_bound/right_click/title'
    CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_MESSAGE = '#dialogs:customization/install_bound/right_click/message'
    CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_SUBMIT = '#dialogs:customization/install_bound/right_click/submit'
    CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_CANCEL = '#dialogs:customization/install_bound/right_click/cancel'
    ...
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_TITLE = '#dialogs:frontline/dialogPrestigePointsConvert/title'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_MESSAGE = '#dialogs:frontline/dialogPrestigePointsConvert/message'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_SUBMIT = '#dialogs:frontline/dialogPrestigePointsConvert/submit'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_CANCEL = '#dialogs:frontline/dialogPrestigePointsConvert/cancel'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_TITLE = '#dialogs:frontline/dialogPrestigePointsConvert/haveAllTank/title'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_MESSAGE = '#dialogs:frontline/dialogPrestigePointsConvert/haveAllTank/message'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_SUBMIT = '#dialogs:frontline/dialogPrestigePointsConvert/haveAllTank/submit'
    FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_CANCEL = '#dialogs:frontline/dialogPrestigePointsConvert/haveAllTank/cancel'
    ...
    SE20SHOPBUYBUNDLE_TITLE = '#dialogs:se20ShopBuyBundle/title'
    SE20SHOPBUYBUNDLE_MESSAGE = '#dialogs:se20ShopBuyBundle/message'
    SE20SHOPBUYBUNDLE_SUBMIT = '#dialogs:se20ShopBuyBundle/submit'
    SE20SHOPBUYBUNDLE_CANCEL = '#dialogs:se20ShopBuyBundle/cancel'
    SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_TITLE = '#dialogs:se20quitBattle/deserter/lockedLivesAvailable/title'
    SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_MESSAGE = '#dialogs:se20quitBattle/deserter/lockedLivesAvailable/message'
    SE20QUITBATTLE_DESERTER_TITLE = '#dialogs:se20quitBattle/deserter/title'
    SE20QUITBATTLE_DESERTER_MESSAGE = '#dialogs:se20quitBattle/deserter/message'
    SE20QUITBATTLE_DESERTER_SUBMIT = '#dialogs:se20quitBattle/deserter/submit'
    SE20QUITBATTLE_DESERTER_CANCEL = '#dialogs:se20quitBattle/deserter/cancel'
    SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_SUBMIT = '#dialogs:se20quitBattle/deserter/lockedLivesAvailable/submit'
    SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_CANCEL = '#dialogs:se20quitBattle/deserter/lockedLivesAvailable/cancel'
    ...
    ALL_ENUM = (INTERVIEWQUIT_TITLE,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_TITLE,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDITEMSTEXT,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDGOLDTEXT,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_NEEDITEMSSTEPPERTITLE,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_SUBMIT,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_CANCEL,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_EXCHANGENONEEDTEXT,
     ...
     CONFIRMEXCHANGEDIALOG_UPGRADEEXCHANGECREDITS_GOLDNOTENOUGHTEXT,
     ...
     CUSTOMIZATION_INSTALL_BOUND_CHECK_TITLE,
     CUSTOMIZATION_INSTALL_BOUND_CHECK_MESSAGE,
     CUSTOMIZATION_INSTALL_BOUND_CHECK_SUBMIT,
     CUSTOMIZATION_INSTALL_BOUND_CHECK_CANCEL,
     CUSTOMIZATION_INSTALL_BOUND_BASKET_TITLE,
     CUSTOMIZATION_INSTALL_BOUND_BASKET_MESSAGE,
     CUSTOMIZATION_INSTALL_BOUND_BASKET_SUBMIT,
     CUSTOMIZATION_INSTALL_BOUND_BASKET_CANCEL,
     CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_TITLE,
     CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_MESSAGE,
     CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_SUBMIT,
     CUSTOMIZATION_INSTALL_BOUND_RIGHT_CLICK_CANCEL,
     ...
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_TITLE,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_MESSAGE,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_SUBMIT,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_CANCEL,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_TITLE,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_MESSAGE,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_SUBMIT,
     FRONTLINE_DIALOGPRESTIGEPOINTSCONVERT_HAVEALLTANK_CANCEL,
     ...
     SE20SHOPBUYBUNDLE_TITLE,
     SE20SHOPBUYBUNDLE_MESSAGE,
     SE20SHOPBUYBUNDLE_SUBMIT,
     SE20SHOPBUYBUNDLE_CANCEL,
     SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_TITLE,
     SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_MESSAGE,
     SE20QUITBATTLE_DESERTER_TITLE,
     SE20QUITBATTLE_DESERTER_MESSAGE,
     SE20QUITBATTLE_DESERTER_SUBMIT,
     SE20QUITBATTLE_DESERTER_CANCEL,
     SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_SUBMIT,
     SE20QUITBATTLE_DESERTER_LOCKEDLIVESAVAILABLE_CANCEL)
