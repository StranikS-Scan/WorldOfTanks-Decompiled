...
class EPIC_BATTLE(object):
    ...
    SUPPLY_MARKER_NEED_REPAIR = '#epic_battle:supply/marker_need_repair'
    SUPPLY_TIMER_IS_REPAIRING = '#epic_battle:supply/timer_is_repairing'
    ...
    SUPPLY_PILLBOX = '#epic_battle:supply/pillbox'
    SUPPLY_FLAMER = '#epic_battle:supply/flamer'
    SUPPLY_MORTAR = '#epic_battle:supply/mortar'
    SUPPLY_AIRSHIP = '#epic_battle:supply/airship'
    SUPPLY_MESSAGES_DEFENCE = '#epic_battle:supply/messages/defence'
    SUPPLY_MESSAGES_ATTACK = '#epic_battle:supply/messages/attack'
    SUPPLY_MESSAGES_AIRSHIPACTIVE = '#epic_battle:supply/messages/airshipActive'
    SUPPLY_MESSAGES_AIRSHIPACTIVEPOSITIVE = '#epic_battle:supply/messages/airshipActivePositive'
    ...
    TAB_SCREEN_SHOW_QUESTS = '#epic_battle:tab_screen/show_quests'
    ...
    DEPLOYMENTMAP_LANE_LEFT = '#epic_battle:deploymentMap/lane/left'
    DEPLOYMENTMAP_LANE_CENTER = '#epic_battle:deploymentMap/lane/center'
    DEPLOYMENTMAP_LANE_RIGHT = '#epic_battle:deploymentMap/lane/right'
    DEPLOYMENTMAP_LANE_TOP = '#epic_battle:deploymentMap/lane/top'
    DEPLOYMENTMAP_WARNING_1 = '#epic_battle:deploymentMap/warning/1'
    DEPLOYMENTMAP_WARNING_2 = '#epic_battle:deploymentMap/warning/2'
    DEPLOYMENTMAP_WARNING_3 = '#epic_battle:deploymentMap/warning/3'
    ...
    BATTLERESULTS_DAMAGESUPPLIES = '#epic_battle:battleResults/damageSupplies'
    BATTLERESULTS_QUESTCOMPLETED = '#epic_battle:battleResults/questCompleted'
    BATTLERESULTS_KILLSUPPLIES = '#epic_battle:battleResults/killSupplies'
