...
class EPIC_BATTLE(object):
    ...
    QUESTSTOOLTIP_EPICBATTLE_TIMELEFT_CN = '#epic_battle:questsTooltip/epicBattle/timeLeft_cn'
    ...
    WIDGETALERTMESSAGEBLOCK_NOCYCLEMESSAGE_MULTI = '#epic_battle:widgetAlertMessageBlock/noCycleMessage/multi'
    WIDGETALERTMESSAGEBLOCK_NOCYCLEMESSAGE_SINGLE = '#epic_battle:widgetAlertMessageBlock/noCycleMessage/single'
    ...
    WIDGETALERTMESSAGEBLOCK_STARTIN_MULTI = '#epic_battle:widgetAlertMessageBlock/startIn/multi'
    WIDGETALERTMESSAGEBLOCK_STARTIN_SINGLE = '#epic_battle:widgetAlertMessageBlock/startIn/single'
    ...
    EPICBATTLEITEM_REWARDPOINTS_CN_HEADER = '#epic_battle:epicBattleItem/rewardPoints_cn/header'
    EPICBATTLEITEM_REWARDPOINTS_CN_DESCRIPTION = '#epic_battle:epicBattleItem/rewardPoints_cn/description'
