...
class EVENT(object):
    ...
    WTEVENTSENTRYPOINT_WIDGET_UNFINISHED = '#event:WTEventsEntryPoint/widget/unfinished'
    WTEVENTSENTRYPOINT_WIDGET_FINISHED = '#event:WTEventsEntryPoint/widget/finished'
    ...
    TOOLTIPS_FOOTER_PROGRESSION = '#event:tooltips/footer/progression'
    ...
    WTEVENTPORTALS_BOSS_NOTGUARANTEED = '#event:WtEventPortals/boss/notGuaranteed'
    ...
    WTEVENTPORTALS_INSIDE_TANKRENTAL = '#event:WtEventPortals/inside/tankRental'
    WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_REWARD = '#event:WtEventPortals/inside/firstLaunch/reward'
    WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_TOOLTIP_HEADER = '#event:WtEventPortals/inside/firstLaunch/tooltip/header'
    WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_TOOLTIP_BODY = '#event:WtEventPortals/inside/firstLaunch/tooltip/body'
    ...
    WTEVENTPORTALS_INSIDE_REWARDS_PRIMARYTANK = '#event:WtEventPortals/inside/rewards/primaryTank'
    WTEVENTPORTALS_INSIDE_REWARDS_SECONDARYTANK = '#event:WtEventPortals/inside/rewards/secondaryTank'
    ...
    WTEVENTPORTALS_INSIDE_RENT_HEADER = '#event:WtEventPortals/inside/rent/header'
    WTEVENTPORTALS_INSIDE_RENT_DESCRIPTION = '#event:WtEventPortals/inside/rent/description'
    ...
    WTGUARANTEEDREWARDTOOLTIPVIEW_ALLCOLLECTED = '#event:WtGuaranteedRewardTooltipView/allCollected'
    ...
    WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMINSCRIPTION_TITLE = '#event:WtEventPortals/collectionTooltip/randomInscription/title'
    WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMEMBLEM_TITLE = '#event:WtEventPortals/collectionTooltip/randomEmblem/title'
    WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMCAMOUFLAGE_TITLE = '#event:WtEventPortals/collectionTooltip/randomCamouflage/title'
    ...
    PROGRESSION_TITLE = '#event:progression/title'
    PROGRESSION_ABOUT = '#event:progression/about'
    PROGRESSION_CLOSE = '#event:progression/close'
    PROGRESSION_SUBTITLE = '#event:progression/subtitle'
    PROGRESSION_TOKENSLEFT = '#event:progression/tokensLeft'
    PROGRESSION_CONGRATS = '#event:progression/congrats'
    PROGRESSION_STAGES_PROGRESS_TITLE = '#event:progression/stages/progress/title'
    PROGRESSION_STAGES_PROGRESS_SUBTITLE = '#event:progression/stages/progress/subtitle'
    PROGRESSION_STAGES_COMPLETED_TITLE = '#event:progression/stages/completed/title'
    PROGRESSION_STAGES_COMPLETED_SUBTITLE = '#event:progression/stages/completed/subtitle'
    PROGRESSION_CARD_CURRENTLEVEL = '#event:progression/card/currentLevel'
    PROGRESSION_CARD_REWARDRECEIVED = '#event:progression/card/rewardReceived'
    ...
    BONUSES_RANDOM_COLLECTION_ELEMENT_WT_TOOLTIP_HEADER = '#event:bonuses/random_collection_element_WT/tooltip/header'
    BONUSES_RANDOM_COLLECTION_ELEMENT_WT_TOOLTIP_BODY = '#event:bonuses/random_collection_element_WT/tooltip/body'
    ...
    STAMP_TITLE = '#event:stamp/title'
    STAMP_DESCRIPTION = '#event:stamp/description'
    STAMP_RECEIVETITLE = '#event:stamp/receiveTitle'
    STAMP_RECEIVETEXT = '#event:stamp/receiveText'
    STAMP_RECEIVEADDITIONALTEXT = '#event:stamp/receiveAdditionalText'
    ...
    PORTALAWARD_REROLLBUTTON = '#event:portalAward/reRollButton'
    PORTALAWARD_REROLLINFORMATION = '#event:portalAward/reRollInformation'
    PORTALAWARD_CLAIMANDCONTINUEBUTTON = '#event:portalAward/claimAndContinueButton'
    PORTALAWARD_CLAIMREWARDBUTTON = '#event:portalAward/claimRewardButton'
    PORTALAWARD_REROLLTOOLTIPHEADER = '#event:portalAward/reRollTooltipHeader'
    PORTALAWARD_FIRSTLAUNCHREWARDTITLE = '#event:portalAward/firstLaunchRewardTitle'
    PORTALAWARD_REROLLTOOLTIPHUNTERBODY = '#event:portalAward/reRollTooltipHunterBody'
    PORTALAWARD_REROLLTOOLTIPBOSSBODY = '#event:portalAward/reRollTooltipBossBody'
    ...
    AWARDVIEW_PREVIEWBTNTEXT = '#event:awardView/previewBtnText'
    ...
    NOTIFICATIONS_BATTLERESULTS_STAMP = '#event:notifications/battleResults/stamp'
    ...
    ALL_ENUM = (PUNISHMENTWINDOW_REASON_EVENT_DESERTER,
     ...
     WTEVENTSENTRYPOINT_WIDGET_UNFINISHED,
     WTEVENTSENTRYPOINT_WIDGET_FINISHED,
     TOOLTIPS_TITLE,
     TOOLTIPS_SUBTITLE,
     TOOLTIPS_PROGRESS_TEXT,
     TOOLTIPS_COMPLETE_TEXT,
     TOOLTIPS_FOOTER_PROGRESSION,
     ...
     WTEVENTPORTALS_BOSS_NOTGUARANTEED,
     ...
     WTEVENTPORTALS_INSIDE_TANKRENTAL,
     WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_REWARD,
     WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_TOOLTIP_HEADER,
     WTEVENTPORTALS_INSIDE_FIRSTLAUNCH_TOOLTIP_BODY,
     ...
     WTEVENTPORTALS_INSIDE_REWARDS_PRIMARYTANK,
     WTEVENTPORTALS_INSIDE_REWARDS_SECONDARYTANK,
     ...
     WTEVENTPORTALS_INSIDE_RENT_HEADER,
     WTEVENTPORTALS_INSIDE_RENT_DESCRIPTION,
     ...
     WTGUARANTEEDREWARDTOOLTIPVIEW_ALLCOLLECTED,
     ...
     WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMINSCRIPTION_TITLE,
     WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMEMBLEM_TITLE,
     WTEVENTPORTALS_COLLECTIONTOOLTIP_RANDOMCAMOUFLAGE_TITLE,
     ...
     PROGRESSION_ABOUT,
     PROGRESSION_CLOSE,
     PROGRESSION_SUBTITLE,
     PROGRESSION_TOKENSLEFT,
     PROGRESSION_CONGRATS,
     PROGRESSION_STAGES_PROGRESS_TITLE,
     PROGRESSION_STAGES_PROGRESS_SUBTITLE,
     PROGRESSION_STAGES_COMPLETED_TITLE,
     PROGRESSION_STAGES_COMPLETED_SUBTITLE,
     PROGRESSION_CARD_CURRENTLEVEL,
     PROGRESSION_CARD_REWARDRECEIVED,
     ...
     BONUSES_RANDOM_COLLECTION_ELEMENT_WT_TOOLTIP_HEADER,
     BONUSES_RANDOM_COLLECTION_ELEMENT_WT_TOOLTIP_BODY,
     ...
     PORTALAWARD_BACKTO,
     PORTALAWARD_REROLLBUTTON,
     PORTALAWARD_REROLLINFORMATION,
     PORTALAWARD_CLAIMANDCONTINUEBUTTON,
     PORTALAWARD_CLAIMREWARDBUTTON,
     PORTALAWARD_REROLLTOOLTIPHEADER,
     PORTALAWARD_FIRSTLAUNCHREWARDTITLE,
     PORTALAWARD_REROLLTOOLTIPHUNTERBODY,
     PORTALAWARD_REROLLTOOLTIPBOSSBODY,
     ...
     NOTIFICATIONS_BATTLERESULTS_STAMP,
