...
class EVENT(object):
    ...
    SELECTORTOOLTIP_TILLEND = '#event:selectorTooltip/tillEnd'
    ...
    TOOLTIPS_HEADER_QUESTS_HEADER_WT_HUNTER = '#event:tooltips/header/quests/header/wt_hunter'
    TOOLTIPS_HEADER_QUESTS_HEADER_WT_BOSS = '#event:tooltips/header/quests/header/wt_boss'
    ...
    TOOLTIPS_HEADER_QUESTS_HEADER_SPECIAL_WT_BOSS = '#event:tooltips/header/quests/header/special_wt_boss'
    ...
    TOOLTIPS_INFORMATIVE_TITLE = '#event:tooltips/informative/title'
    TOOLTIPS_INFORMATIVE_SUBTITLE = '#event:tooltips/informative/subtitle'
    TOOLTIPS_HIGH_RISK_TITLE = '#event:tooltips/high_risk/title'
    TOOLTIPS_HIGH_RISK_SUBTITLE = '#event:tooltips/high_risk/subtitle'
    TOOLTIPS_MEDIUM_RISK_TITLE = '#event:tooltips/medium_risk/title'
    TOOLTIPS_MEDIUM_RISK_SUBTITLE = '#event:tooltips/medium_risk/subtitle'
    ...
    WTEVENTAWARDSVIEW_MAINREWARDS_MAIN_PRIZE_DISCOUNT = '#event:WTEventAwardsView/mainRewards/main_prize_discount'
    ...
    WTEVENTAWARDSVIEW_MAINREWARD_RENT = '#event:WTEventAwardsView/mainReward/rent'
    ...
    WTEVENTPORTALS_TEXT_TANKBOUGHT = '#event:WtEventPortals/text/tankBought'
    WTEVENTPORTALS_TEXT_DISCOUNT = '#event:WtEventPortals/text/discount'
    WTEVENTPORTALS_TANK_NODISCOUNT = '#event:WtEventPortals/tank/noDiscount'
    ...
    WTEVENTPORTALS_INSIDE_HIGHPROBABILITYBOSS = '#event:WtEventPortals/inside/highProbabilityBoss'
    ...
    WTEVENTPORTALS_INSIDE_LOWPROBABILITYBOSS = '#event:WtEventPortals/inside/lowProbabilityBoss'
    ...
    WTEVENTPORTALS_INSIDE_CURRENTKEYSAMOUNT_TANK = '#event:WtEventPortals/inside/currentKeysAmount/tank'
    ...
    WTEVENTPORTALS_INSIDE_CURRENTKEYSAMOUNTIS0_TANK = '#event:WtEventPortals/inside/currentKeysAmountIs0/tank'
    ...
    WTGUARANTEEDREWARDTOOLTIPVIEW_FOOTERTITLE = '#event:WtGuaranteedRewardTooltipView/footerTitle'
    WTGUARANTEEDREWARDTOOLTIPVIEW_FOOTERDESC = '#event:WtGuaranteedRewardTooltipView/footerDesc'
    ...
    BONUSTOOLTIP_BOOSTER_FREE_XP_AND_CREW_XP_BODY = '#event:bonusTooltip/booster_free_xp_and_crew_xp/body'
    BONUSTOOLTIP_BOOSTER_FREE_XP_AND_CREW_XP_HEADER = '#event:bonusTooltip/booster_free_xp_and_crew_xp/header'
    ...
    PROGRESSION_TAB_HARRIER = '#event:progression/tab/harrier'
    PROGRESSION_TAB_ENGINEER = '#event:progression/tab/engineer'
    PROGRESSION_POINTSFORMAT = '#event:progression/pointsFormat'
    PROGRESSION_TIMER = '#event:progression/timer'
    ...
    VEHICLE_TAGS_WT_BOSS_NAME = '#event:vehicle/tags/wt_boss/name'
    VEHICLE_TAGS_WT_HUNTER_NAME = '#event:vehicle/tags/wt_hunter/name'
    SERVERALERTMESSAGE = '#event:serverAlertMessage'
    SERVERALERTMESSAGE_BATTLESEND = '#event:serverAlertMessage/battlesEnd'
    SERVERALERTMESSAGE_UNSUITABLEPERIPHERY = '#event:serverAlertMessage/unsuitablePeriphery'
    SERVERALERTMESSAGE_BUTTON = '#event:serverAlertMessage/button'
    TANKMANTOOLTIP_STATUS_BOSS = '#event:tankmanTooltip/status/boss'
    TANKMANTOOLTIP_STATUS_BOSS_2025 = '#event:tankmanTooltip/status/boss_2025'
    TANKMANTOOLTIP_STATUS_HUNTER = '#event:tankmanTooltip/status/hunter'
    TANKMANTOOLTIP_BOSS_2025_DESCR = '#event:tankmanTooltip/boss_2025/descr'
    ...
    TANKMANTOOLTIP_HUNTER_4_DESCR = '#event:tankmanTooltip/hunter_4/descr'
    ...
    LOADING_BOSS_HEADER_5 = '#event:loading/boss/header/5'
    ...
    CHARACTERISTICSPANEL_SPECIALINFO_BOSS_2025 = '#event:characteristicsPanel/specialInfo/boss_2025'
    ...
    CHARACTERISTICSPANEL_SPECIALINFO_HUNTER_4 = '#event:characteristicsPanel/specialInfo/hunter_4'
    ...
    TTX_ACCURACY = '#event:ttx/accuracy'
    TTX_DESCRIPTION_ACCURACY = '#event:ttx/description/accuracy'
    TTX_ENERGY = '#event:ttx/energy'
    TTX_DESCRIPTION_ENERGY = '#event:ttx/description/energy'
    ...
    LOOTBOXTOOLTIP_HOWTOGET_TITLE_HUNTER = '#event:lootBoxTooltip/howToGet/title/hunter'
    LOOTBOXTOOLTIP_HOWTOGET_TITLE_BOSS = '#event:lootBoxTooltip/howToGet/title/boss'
    ...
    PORTALAWARD_TAKEANDOPENGARAGEBUTTON = '#event:portalAward/takeAndOpenGarageButton'
    AWARD_VALUE = '#event:award/value'
    PORTALVEHICLEAWARD_TITLE = '#event:portalVehicleAward/title'
    ...
    POSTBATTLE_BUTTON_WTEVENT_TICKET2025 = '#event:postbattle/button/wtevent_ticket2025'
    ...
    POSTBATTLE_LABEL_WTEVENT_TICKET2025 = '#event:postbattle/label/wtevent_ticket2025'
    ...
    PBT_VICTORY_1_5 = '#event:pbt/victory/1/5'
    PBT_VICTORY_2_1 = '#event:pbt/victory/2/1'
    PBT_VICTORY_2_5 = '#event:pbt/victory/2/5'
    PBT_DEFEAT_1_1 = '#event:pbt/defeat/1/1'
    PBT_DEFEAT_2_1 = '#event:pbt/defeat/2/1'
    PBT_DEFEAT_2_3 = '#event:pbt/defeat/2/3'
    NOTIFICATIONS_TICKET_WITHDRAWN_BODY = '#event:notifications/ticket/withdrawn/body'
    NOTIFICATIONS_TICKET2025_WITHDRAWN_BODY = '#event:notifications/ticket2025/withdrawn/body'
    ...
    HANGAR_STARTBTN_RENTALSISOVER_HEADER = '#event:hangar/startBtn/rentalsIsOver/header'
    HANGAR_STARTBTN_RENTALSISOVER_BODY = '#event:hangar/startBtn/rentalsIsOver/body'
    ALL_ENUM = (PUNISHMENTWINDOW_REASON_EVENT_DESERTER,
     ...
     SELECTORTOOLTIP_TILLEND,
     QUESTS_ERROR_NO_TICKET,
     QUESTS_ERROR_NO_TICKET_TOOLTIP_HEADER,
     QUESTS_ERROR_NO_TICKET_TOOLTIP_BODY,
     TOOLTIPS_HEADER_QUESTS_HEADER_WT_HUNTER,
     TOOLTIPS_HEADER_QUESTS_HEADER_WT_BOSS,
     ...
     TOOLTIPS_HEADER_QUESTS_HEADER_SPECIAL_WT_BOSS,
     ...
     STATUS_UNAVAILABLE,
     TOOLTIPS_INFORMATIVE_TITLE,
     TOOLTIPS_INFORMATIVE_SUBTITLE,
     TOOLTIPS_HIGH_RISK_TITLE,
     TOOLTIPS_HIGH_RISK_SUBTITLE,
     TOOLTIPS_MEDIUM_RISK_TITLE,
     TOOLTIPS_MEDIUM_RISK_SUBTITLE,
     ...
     WTGUARANTEEDREWARDTOOLTIPVIEW_FOOTERTITLE,
     WTGUARANTEEDREWARDTOOLTIPVIEW_FOOTERDESC,
     ...
     BONUSTOOLTIP_BOOSTER_FREE_XP_AND_CREW_XP_BODY,
     BONUSTOOLTIP_BOOSTER_FREE_XP_AND_CREW_XP_HEADER,
     ...
     PROGRESSION_TAB_HARRIER,
     PROGRESSION_TAB_ENGINEER,
     PROGRESSION_POINTSFORMAT,
     PROGRESSION_TIMER,
     ...
     VEHICLE_TAGS_WT_BOSS_NAME,
     VEHICLE_TAGS_WT_HUNTER_NAME,
     SERVERALERTMESSAGE,
     SERVERALERTMESSAGE_BATTLESEND,
     SERVERALERTMESSAGE_UNSUITABLEPERIPHERY,
     SERVERALERTMESSAGE_BUTTON,
     TANKMANTOOLTIP_STATUS_BOSS,
     TANKMANTOOLTIP_STATUS_BOSS_2025,
     TANKMANTOOLTIP_STATUS_HUNTER,
     TANKMANTOOLTIP_BOSS_2025_DESCR,
     TANKMANTOOLTIP_BOSS_DESCR,
     TANKMANTOOLTIP_HUNTER_1_DESCR,
     TANKMANTOOLTIP_HUNTER_2_DESCR,
     TANKMANTOOLTIP_HUNTER_3_DESCR,
     TANKMANTOOLTIP_HUNTER_4_DESCR,
     ...
     CHARACTERISTICSPANEL_SPECIALINFO_HUNTER_4,
     TTX_DURABILITY,
     ...
     TTX_ACCURACY,
     TTX_DESCRIPTION_ACCURACY,
     TTX_ENERGY,
     TTX_DESCRIPTION_ENERGY,
     ...
     LOOTBOXTOOLTIP_HOWTOGET_TITLE_HUNTER,
     LOOTBOXTOOLTIP_HOWTOGET_TITLE_BOSS,
     ...
     PORTALAWARD_TAKEANDOPENGARAGEBUTTON,
     AWARD_VALUE,
     PORTALVEHICLEAWARD_TITLE,
     ...
     POSTBATTLE_BUTTON_WTEVENT_TICKET2025,
     ...
     POSTBATTLE_LABEL_WTEVENT_TICKET2025,
     ...
     PBT_DEFEAT_2_1,
     PBT_DEFEAT_2_3,
     NOTIFICATIONS_TICKET_WITHDRAWN_BODY,
     NOTIFICATIONS_TICKET2025_WITHDRAWN_BODY,
     ...
     HANGAR_STARTBTN_RENTALSISOVER_HEADER,
     HANGAR_STARTBTN_RENTALSISOVER_BODY)
