...
class INGAME_GUI(object):
    ...
    PLAYER_MESSAGES_SPAWN = '#ingame_gui:player_messages/SPAWN'
    ...
    POSTMORTEM_MESSAGES_DEATH_FROM_SUPPLY_SHOT = '#ingame_gui:postmortem_messages/DEATH_FROM_SUPPLY_SHOT'
    PLAYER_MESSAGES_DEATH_FROM_SUPPLY_SHOT_ALLY_ENEMY = '#ingame_gui:player_messages/DEATH_FROM_SUPPLY_SHOT_ALLY_ENEMY'
    PLAYER_MESSAGES_DEATH_FROM_SUPPLY_SHOT_ENEMY_ALLY = '#ingame_gui:player_messages/DEATH_FROM_SUPPLY_SHOT_ENEMY_ALLY'
