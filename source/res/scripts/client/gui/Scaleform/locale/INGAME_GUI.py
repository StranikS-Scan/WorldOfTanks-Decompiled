...
class INGAME_GUI(object):
    ...
    PLAYER_MESSAGES_DEVICE_CRITICAL_AT_SHOT_IN_PERSONAL_DEATH_ZONE = '#ingame_gui:player_messages/DEVICE_CRITICAL_AT_SHOT_IN_PERSONAL_DEATH_ZONE'
    PLAYER_MESSAGES_DEVICE_DESTROYED_AT_SHOT_IN_PERSONAL_DEATH_ZONE = '#ingame_gui:player_messages/DEVICE_DESTROYED_AT_SHOT_IN_PERSONAL_DEATH_ZONE'
    ...
    CHAT_SHORTCUTS_EVENT_CHAT_1 = '#ingame_gui:chat_shortcuts/event_chat_1'
    CHAT_SHORTCUTS_EVENT_CHAT_2 = '#ingame_gui:chat_shortcuts/event_chat_2'
    CHAT_SHORTCUTS_EVENT_CHAT_3 = '#ingame_gui:chat_shortcuts/event_chat_3'
    CHAT_SHORTCUTS_EVENT_CHAT_4 = '#ingame_gui:chat_shortcuts/event_chat_4'
    CHAT_SHORTCUTS_EVENT_CHAT_5 = '#ingame_gui:chat_shortcuts/event_chat_5'
    CHAT_SHORTCUTS_EVENT_CHAT_6 = '#ingame_gui:chat_shortcuts/event_chat_6'
    CHAT_SHORTCUTS_EVENT_CHAT_7 = '#ingame_gui:chat_shortcuts/event_chat_7'
    CHAT_SHORTCUTS_EVENT_CHAT_1_EX = '#ingame_gui:chat_shortcuts/event_chat_1_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_2_EX = '#ingame_gui:chat_shortcuts/event_chat_2_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_3_EX = '#ingame_gui:chat_shortcuts/event_chat_3_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_4_EX = '#ingame_gui:chat_shortcuts/event_chat_4_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_5_EX = '#ingame_gui:chat_shortcuts/event_chat_5_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_6_EX = '#ingame_gui:chat_shortcuts/event_chat_6_ex'
    CHAT_SHORTCUTS_EVENT_CHAT_7_EX = '#ingame_gui:chat_shortcuts/event_chat_7_ex'
    ...
    SHELLS_KINDS_PARAMSNOPIERCING = '#ingame_gui:shells_kinds/paramsNoPiercing'
    ...
    PLAYERS_PANEL_INFO_TITLE = '#ingame_gui:players_panel/info/title'
    ...
    PLAYER_MESSAGES_DEATH_FROM_SHOT_SELF_SUICIDE_BOMBER = '#ingame_gui:player_messages/DEATH_FROM_SHOT_SELF_SUICIDE_BOMBER'
    PLAYER_MESSAGES_DEATH_FROM_SHOT_SELF_SUICIDE_ARTILLERY = '#ingame_gui:player_messages/DEATH_FROM_SHOT_SELF_SUICIDE_ARTILLERY'
    ...
    PLAYER_MESSAGES_DEATH_FROM_SHOT = '#ingame_gui:player_messages/DEATH_FROM_SHOT'
    ...
    PLAYER_MESSAGES_DEATH_FROM_SHOT_SELF_ENEMY_MINEFIELD = '#ingame_gui:player_messages/DEATH_FROM_SHOT_SELF_ENEMY_MINEFIELD'
    PLAYER_MESSAGES_DEATH_FROM_SHOT_SELF_SUICIDE = '#ingame_gui:player_messages/DEATH_FROM_SHOT_SELF_SUICIDE'
    ...
    PLAYER_MESSAGES_DEATH_FROM_FIRE = '#ingame_gui:player_messages/DEATH_FROM_FIRE'
    PLAYER_MESSAGES_DEATH_FROM_FIRE_SELF_SUICIDE = '#ingame_gui:player_messages/DEATH_FROM_FIRE_SELF_SUICIDE'
    PLAYER_MESSAGES_DEATH_FROM_SHOT_ENEMY_SELF = '#ingame_gui:player_messages/DEATH_FROM_SHOT_ENEMY_SELF'
    ...
    PLAYER_MESSAGES_DEATH_FROM_DEATH_ZONE = '#ingame_gui:player_messages/DEATH_FROM_DEATH_ZONE'
    ...
    EFFICIENCYRIBBONS_DAMAGEBYABILITY = '#ingame_gui:efficiencyRibbons/damageByAbility'
    EFFICIENCYRIBBONS_DAMAGEBYDEATHZONE = '#ingame_gui:efficiencyRibbons/damageByDeathZone'
    ...
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_ARTILLERYROCKET = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_ARTILLERYROCKET'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_ARTILLERYMORTAR = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_ARTILLERYMORTAR'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_BOMBER = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_BOMBER'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_BOMBERCAS = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_BOMBERCAS'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_MINEFIELD = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_MINEFIELD'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_NITRO = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_NITRO'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_SUPERSHELLFIREBALL = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_SUPERSHELLFIREBALL'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_ARTILLERY = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_ARTILLERY'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_ARTILLERYROCKET = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_ARTILLERYROCKET'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_ARTILLERYMORTAR = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_ARTILLERYMORTAR'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_BOMBER = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_BOMBER'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_BOMBERCAS = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_BOMBERCAS'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_MINEFIELD = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_MINEFIELD'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_NITRO = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_NITRO'
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_SUPERSHELLFIREBALL = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_SUPERSHELLFIREBALL'
    CHAT_SHORTCUTS_ENUM = (CHAT_SHORTCUTS_TURN_BACK,
     ...
     CHAT_SHORTCUTS_EVENT_CHAT_1,
     CHAT_SHORTCUTS_EVENT_CHAT_2,
     CHAT_SHORTCUTS_EVENT_CHAT_3,
     CHAT_SHORTCUTS_EVENT_CHAT_4,
     CHAT_SHORTCUTS_EVENT_CHAT_5,
     CHAT_SHORTCUTS_EVENT_CHAT_6,
     CHAT_SHORTCUTS_EVENT_CHAT_7,
     CHAT_SHORTCUTS_EVENT_CHAT_1_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_2_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_3_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_4_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_5_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_6_EX,
     CHAT_SHORTCUTS_EVENT_CHAT_7_EX)
    ...
    EFFICIENCYRIBBONS_ENUM = (EFFICIENCYRIBBONS_ARMOR,
     ...
     EFFICIENCYRIBBONS_DAMAGEBYABILITY,
     EFFICIENCYRIBBONS_DAMAGEBYDEATHZONE,
