...
class INGAME_HELP(object):
    ...
    CROSSHAIRCONTROLS_EXAMPLE_DISTANCE = '#ingame_help:crosshairControls/example/distance'
    ...
    DETAILSHELP_TANKWITHABILITY_HEADER = '#ingame_help:detailsHelp/tankWithAbility/header'
    DETAILSHELP_TANKWITHABILITY_TITLE = '#ingame_help:detailsHelp/tankWithAbility/title'
    DETAILSHELP_TANKWITHABILITY_MODIFICATIONS = '#ingame_help:detailsHelp/tankWithAbility/modifications'
    DETAILSHELP_THERMALVISION_PAGE1_TITLE = '#ingame_help:detailsHelp/thermalVision/page1/title'
    DETAILSHELP_THERMALVISION_PAGE1 = '#ingame_help:detailsHelp/thermalVision/page1'
    DETAILSHELP_THERMALVISION_PAGE2_TITLE = '#ingame_help:detailsHelp/thermalVision/page2/title'
    DETAILSHELP_THERMALVISION_PAGE2 = '#ingame_help:detailsHelp/thermalVision/page2'
    ...
    DETAILSHELP_BATTLEROYALE_CONEVISIBILITY_DESCRIPTION = '#ingame_help:detailsHelp/battleRoyale/coneVisibility/description'
    ...
    RADIALMENU_DEFEND_SUPPLY = '#ingame_help:radialMenu/defend_supply'
    RADIALMENU_DEFENDING_SUPPLY = '#ingame_help:radialMenu/defending_supply'
    RADIALMENU_SUPPLY_SELF_REPAIR = '#ingame_help:radialMenu/supply_self_repair'
    RADIALMENU_ATTACK_SUPPLY = '#ingame_help:radialMenu/attack_supply'
    RADIALMENU_ATTACKING_SUPPLY = '#ingame_help:radialMenu/attacking_supply'
    ...
    DETAILSHELP_AUTOSHOOT_HEADERTITLE = '#ingame_help:detailsHelp/autoShoot/headerTitle'
    DETAILSHELP_AUTOSHOOT_TITLE = '#ingame_help:detailsHelp/autoShoot/title'
    DETAILSHELP_AUTOSHOOT_DESCRIPTION = '#ingame_help:detailsHelp/autoShoot/description'
