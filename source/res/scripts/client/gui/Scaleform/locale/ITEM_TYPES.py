...
class ITEM_TYPES(object):
    ...
    SHELL_KINDS_HOLLOW_CHARGE_DF = '#item_types:shell/kinds/HOLLOW_CHARGE_DF'
    SHELL_KINDS_HIGH_EXPLOSIVE_DF = '#item_types:shell/kinds/HIGH_EXPLOSIVE_DF'
    SHELL_KINDS_ARMOR_PIERCING_DF = '#item_types:shell/kinds/ARMOR_PIERCING_DF'
    SHELL_KINDS_ARMOR_PIERCING_HE_DF = '#item_types:shell/kinds/ARMOR_PIERCING_HE_DF'
    SHELL_KINDS_ARMOR_PIERCING_CR_DF = '#item_types:shell/kinds/ARMOR_PIERCING_CR_DF'
    ...
    SHELL_KINDSABBREVIATION_ARMOR_PIERCING_FSDS = '#item_types:shell/kindsAbbreviation/ARMOR_PIERCING_FSDS'
    ...
    SHELL_KINDSABBREVIATION_HOLLOW_CHARGE_DF = '#item_types:shell/kindsAbbreviation/HOLLOW_CHARGE_DF'
    SHELL_KINDSABBREVIATION_HIGH_EXPLOSIVE_DF = '#item_types:shell/kindsAbbreviation/HIGH_EXPLOSIVE_DF'
    SHELL_KINDSABBREVIATION_ARMOR_PIERCING_DF = '#item_types:shell/kindsAbbreviation/ARMOR_PIERCING_DF'
    SHELL_KINDSABBREVIATION_ARMOR_PIERCING_HE_DF = '#item_types:shell/kindsAbbreviation/ARMOR_PIERCING_HE_DF'
    SHELL_KINDSABBREVIATION_ARMOR_PIERCING_CR_DF = '#item_types:shell/kindsAbbreviation/ARMOR_PIERCING_CR_DF'
    ...
    SHELL_KINDSABBREVIATION_ENUM = (SHELL_KINDSABBREVIATION_ARMOR_PIERCING,
     ...
     SHELL_KINDSABBREVIATION_ARMOR_PIERCING_FSDS,
     ...
     SHELL_KINDSABBREVIATION_HOLLOW_CHARGE_DF,
     SHELL_KINDSABBREVIATION_HIGH_EXPLOSIVE_DF,
     SHELL_KINDSABBREVIATION_ARMOR_PIERCING_DF,
     SHELL_KINDSABBREVIATION_ARMOR_PIERCING_HE_DF,
     SHELL_KINDSABBREVIATION_ARMOR_PIERCING_CR_DF,
