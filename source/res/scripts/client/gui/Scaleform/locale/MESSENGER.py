...
class MESSENGER(object):
    ...
    DIALOGS_SQUAD_MESSAGE_WHITETIGERFORBIDDEN = '#messenger:dialogs/squad/message/whiteTigerForbidden'
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_WT_EVENT_GAMEMODE = '#messenger:serviceChannelMessages/battleResults/wt_event/gameMode'
    SERVICECHANNELMESSAGES_BATTLERESULTS_WT_EVENT_GAMEMODENAME = '#messenger:serviceChannelMessages/battleResults/wt_event/gameModeName'
    SERVICECHANNELMESSAGES_BATTLERESULTS_WT_EVENT_SIDE = '#messenger:serviceChannelMessages/battleResults/wt_event/side'
    SERVICECHANNELMESSAGES_BATTLERESULTS_WT_EVENT_SIDE_HUNTER = '#messenger:serviceChannelMessages/battleResults/wt_event/side/hunter'
    SERVICECHANNELMESSAGES_BATTLERESULTS_WT_EVENT_SIDE_BOSS = '#messenger:serviceChannelMessages/battleResults/wt_event/side/boss'
    SERVICECHANNELMESSAGES_WT_EVENT_COMPLETEDQUESTS = '#messenger:serviceChannelMessages/wt_event/completedQuests'
    SERVICECHANNELMESSAGES_WT_EVENT_BOXESEARNED = '#messenger:serviceChannelMessages/wt_event/boxesEarned'
    SERVICECHANNELMESSAGES_WT_EVENT_SPECIALBOXESEARNED = '#messenger:serviceChannelMessages/wt_event/specialBoxesEarned'
    SERVICECHANNELMESSAGES_WT_EVENT_TICKET = '#messenger:serviceChannelMessages/wt_event/ticket'
    ...
    SERVICECHANNELMESSAGES_LOOTBOXESAUTOOPEN_REWARDS = '#messenger:serviceChannelMessages/lootBoxesAutoOpen/rewards'
