...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_BATTLEROYALESTPCOIN = '#messenger:serviceChannelMessages/BRbattleResults/battleRoyaleStpCoin'
    ...
    PLATFORMCURRENCYMSG_RECEIVED_STPCOIN = '#messenger:platformCurrencyMsg/received/stpcoin'
    PLATFORMCURRENCYMSG_DEBITED_STPCOIN = '#messenger:platformCurrencyMsg/debited/stpcoin'
