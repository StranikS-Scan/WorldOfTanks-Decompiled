...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BLACKMARKETITEMAUTOOPEN_HEADER = '#messenger:serviceChannelMessages/blackMarketItemAutoOpen/header'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMAUTOOPEN_TEXT = '#messenger:serviceChannelMessages/blackMarketItemAutoOpen/text'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMNEXTOPEN_HEADER = '#messenger:serviceChannelMessages/blackMarketItemNextOpen/header'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMNEXTOPEN_TEXT = '#messenger:serviceChannelMessages/blackMarketItemNextOpen/text'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMFIRSTOPEN_TEXT = '#messenger:serviceChannelMessages/blackMarketItemFirstOpen/text'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMSYSMESSAGE_TEXT = '#messenger:serviceChannelMessages/blackMarketItemSysMessage/text'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMRECEIVED_HEADER = '#messenger:serviceChannelMessages/blackMarketItemReceived/header'
    SERVICECHANNELMESSAGES_BLACKMARKETITEMRECEIVED_TEXT = '#messenger:serviceChannelMessages/blackMarketItemReceived/text'
