...
class MESSENGER(object):
    ...
    PLATFORMCURRENCYMSG_RECEIVED_SUMMERGAMES_COIN = '#messenger:platformCurrencyMsg/received/summergames_coin'
    PLATFORMCURRENCYMSG_DEBITED_SUMMERGAMES_COIN = '#messenger:platformCurrencyMsg/debited/summergames_coin'
