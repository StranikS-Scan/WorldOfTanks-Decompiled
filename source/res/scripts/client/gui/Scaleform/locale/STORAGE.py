...
class STORAGE(object):
    ...
    DEVICES_BUTTONLABEL_GOTORESTORE = '#storage:devices/buttonLabel/gotoRestore'
    DEVICES_RESTORE_GOBACK = '#storage:devices/restore/goBack'
    DEVICES_RESTORE_GOBACKTOSECTIONS = '#storage:devices/restore/goBackToSections'
    DEVICES_RESTORE_TITLE = '#storage:devices/restore/title'
    DEVICES_RESTORE_AVAILABLETORESTORE = '#storage:devices/restore/availableToRestore'
