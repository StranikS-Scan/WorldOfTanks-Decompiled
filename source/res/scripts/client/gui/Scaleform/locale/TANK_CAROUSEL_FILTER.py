...
class TANK_CAROUSEL_FILTER(object):
    ...
    TOOLTIP_RECRUITS_HEADER = '#tank_carousel_filter:tooltip/recruits/header'
    TOOLTIP_RECRUITS_BODY = '#tank_carousel_filter:tooltip/recruits/body'
    TOOLTIP_NODETACHMENT_HEADER = '#tank_carousel_filter:tooltip/noDetachment/header'
    TOOLTIP_NODETACHMENT_BODY = '#tank_carousel_filter:tooltip/noDetachment/body'
    TOOLTIP_DETACHMENT_HEADER = '#tank_carousel_filter:tooltip/detachment/header'
    TOOLTIP_DETACHMENT_BODY = '#tank_carousel_filter:tooltip/detachment/body'
