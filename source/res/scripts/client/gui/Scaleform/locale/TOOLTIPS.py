...
class TOOLTIPS(object):
    ...
    VEHICLESTATUS_RENTALBATTLEISOVER_HEADER = '#tooltips:vehicleStatus/rentalBattleIsOver/header'
    ...
    PLAYSTREAK_RANDOMGOODIE_LABEL = '#tooltips:playStreak/randomGoodie/label'
