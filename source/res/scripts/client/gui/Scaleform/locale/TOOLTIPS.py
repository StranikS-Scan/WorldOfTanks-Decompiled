...
class TOOLTIPS(object):
    ...
    DETACHMENT_CONVERTPANEL_PLAYBUTTON = '#tooltips:detachment/convertPanel/playButton'
    DETACHMENT_CONVERTPANEL = '#tooltips:detachment/convertPanel'
    DETACHMENT_CONVERTPANEL_DISABLED_PLAYBUTTON = '#tooltips:detachment/convertPanel_disabled/playButton'
    DETACHMENT_CONVERTPANEL_DISABLED = '#tooltips:detachment/convertPanel_disabled'
    ...
    RANGE_COMMON = '#tooltips:range/common'
    TEMPLATE_PLUS = '#tooltips:template/plus'
    ...
    ACTIONPRICE_TOOLTIP_TITLE = '#tooltips:actionPrice/tooltip/title'
    ...
    HANGAR_CREW_TMAN_NAME_TEXT = '#tooltips:hangar/crew/tman_name/text'
    HANGAR_CREW_NOT_FULL_ROLE_HEADER = '#tooltips:hangar/crew/not_full_role/header'
    HANGAR_CREW_NOT_FULL_ROLE_TEXT = '#tooltips:hangar/crew/not_full_role/text'
    HANGAR_CREW_IS_LEADER_HEADER = '#tooltips:hangar/crew/is_leader/header'
    HANGAR_CREW_NEED_VEHICLE_SPECIALIZATION_HEADER = '#tooltips:hangar/crew/need_vehicle_specialization/header'
    HANGAR_CREW_NEED_VEHICLE_SPECIALIZATION_TEXT = '#tooltips:hangar/crew/need_vehicle_specialization/text'
    HANGAR_CREW_SKILLS_NOT_WORKING_HEADER = '#tooltips:hangar/crew/skills_not_working/header'
    HANGAR_CREW_SKILLS_NOT_WORKING_TEXT = '#tooltips:hangar/crew/skills_not_working/text'
    HANGAR_CREW_TOO_MANY_LEADERS_HEADER = '#tooltips:hangar/crew/too_many_leaders/header'
    HANGAR_CREW_INSTRUCTORS_FOR_LEADER_HEADER = '#tooltips:hangar/crew/instructors_for_leader/header'
    HANGAR_CREW_INSTRUCTORS_FOR_LEADER_TEXT = '#tooltips:hangar/crew/instructors_for_leader/text'
    HANGAR_CREW_INSTRUCTOR_INFO_HEADER = '#tooltips:hangar/crew/instructor_info/header'
    HANGAR_CREW_INSTRUCTOR_INFO_TEXT = '#tooltips:hangar/crew/instructor_info/text'
    HANGAR_CREW_IS_UNIQUE_CREW_MEMBER_HEADER = '#tooltips:hangar/crew/is_unique_crew_member/header'
    HANGAR_CREW_IS_UNIQUE_CREW_MEMBER_TEXT = '#tooltips:hangar/crew/is_unique_crew_member/text'
    HANGAR_CREW_COMMANDER_SIXTH_SENSE_HEADER = '#tooltips:hangar/crew/commander_sixth_sense/header'
    HANGAR_CREW_COMMANDER_SIXTH_SENSE_TEXT = '#tooltips:hangar/crew/commander_sixth_sense/text'
    HANGAR_CREW_IS_LOCK_CREW_HEADER = '#tooltips:hangar/crew/is_lock_crew/header'
    HANGAR_CREW_IS_DISMISSED_HEADER = '#tooltips:hangar/crew/is_dismissed/header'
    HANGAR_CREW_IS_PERMANENT_SKILL = '#tooltips:hangar/crew/is_permanent_skill'
    HANGAR_XPACCELERATOR_OLDCREW_NOELITE_BODY = '#tooltips:hangar/xpAccelerator/oldCrew/noElite/body'
    HANGAR_XPACCELERATOR_OLDCREW_ELITE_BODY = '#tooltips:hangar/xpAccelerator/oldCrew/elite/body'
    HANGAR_XPACCELERATOR_HEADER = '#tooltips:hangar/xpAccelerator/header'
    HANGAR_XPACCELERATOR_DETACHMENT_ELITE_UNCHECKED_BODY = '#tooltips:hangar/xpAccelerator/detachment/elite/unchecked/body'
    HANGAR_XPACCELERATOR_DETACHMENT_ELITE_CHECKED_BODY = '#tooltips:hangar/xpAccelerator/detachment/elite/checked/body'
    HANGAR_XPACCELERATOR_DETACHMENT_NOELITE_BODY = '#tooltips:hangar/xpAccelerator/detachment/noElite/body'
    ACCELERATEXPUNCHECKED_CHECKBOX_TOOLTIP_HEADER = '#tooltips:accelerateXPUnchecked/checkbox/tooltip/header'
    HANGAR_CREW_CONVERTVALIDATION_FULL_CREW_HEADER = '#tooltips:hangar/crew/convertValidation/full_crew/header'
    HANGAR_CREW_CONVERTVALIDATION_FULL_CREW_BODY = '#tooltips:hangar/crew/convertValidation/full_crew/body'
    HANGAR_CREW_CONVERTVALIDATION_PRESET_HEADER = '#tooltips:hangar/crew/convertValidation/preset/header'
    HANGAR_CREW_CONVERTVALIDATION_PRESET_BODY = '#tooltips:hangar/crew/convertValidation/preset/body'
    HANGAR_CREW_CONVERTVALIDATION_SPECIALIZATION_HEADER = '#tooltips:hangar/crew/convertValidation/specialization/header'
    HANGAR_CREW_CONVERTVALIDATION_SPECIALIZATION_BODY = '#tooltips:hangar/crew/convertValidation/specialization/body'
    HANGAR_CREW_CONVERTVALIDATION_INBATTLE_HEADER = '#tooltips:hangar/crew/convertValidation/inBattle/header'
    HANGAR_CREW_CONVERTVALIDATION_INBATTLE_BODY = '#tooltips:hangar/crew/convertValidation/inBattle/body'
    HANGAR_CREW_CONVERTVALIDATION_INUNIT_HEADER = '#tooltips:hangar/crew/convertValidation/inUnit/header'
    HANGAR_CREW_CONVERTVALIDATION_INUNIT_BODY = '#tooltips:hangar/crew/convertValidation/inUnit/body'
    HANGAR_CREW_RETRAIN_HEADER = '#tooltips:hangar/crew/retrain/header'
    HANGAR_CREW_RETRAIN_BODY = '#tooltips:hangar/crew/retrain/body'
    ...
    BATTLEBOOSTER_USELESS_WRONGMODULE_BODY = '#tooltips:battleBooster/useless/wrongModule/body'
    BATTLEBOOSTER_USELESS_NEEDRETRAIN_BODY = '#tooltips:battleBooster/useless/needRetrain/body'
    ...
    BARRACKS_TANKMEN_RECOVERY_TOOLTIP_TITLE = '#tooltips:barracks/tankmen/recovery/tooltip/title'
    BARRACKS_TANKMEN_RECOVERY_TOOLTIP_BODY = '#tooltips:barracks/tankmen/recovery/tooltip/body'
    BARRACKS_TANKMEN_RECOVERY_TOOLTIP_BODY1 = '#tooltips:barracks/tankmen/recovery/tooltip/body1'
    ...
    HEADER_BUTTONS_SHOP_SANDBOX_HEADER = '#tooltips:header/buttons/shop/sandbox/header'
    HEADER_BUTTONS_SHOP_SANDBOX_BODY = '#tooltips:header/buttons/shop/sandbox/body'
    ...
    HEADER_BUTTONS_BARRACKS_HASRECRUITS_BODY = '#tooltips:header/buttons/barracks/hasRecruits/body'
    HEADER_BUTTONS_BARRACKSEVENT_TITLE = '#tooltips:header/buttons/barracksEvent/title'
    HEADER_BUTTONS_BARRACKSEVENT_DESCRIPTION = '#tooltips:header/buttons/barracksEvent/description'
    HEADER_BUTTONS_BARRACKSEVENT_BODY1 = '#tooltips:header/buttons/barracksEvent/body1'
    HEADER_BUTTONS_BARRACKSEVENT_BODY2 = '#tooltips:header/buttons/barracksEvent/body2'
    HEADER_BUTTONS_BARRACKSEVENT_BODY3 = '#tooltips:header/buttons/barracksEvent/body3'
    ...
    PROGRESSION_BOOKTYPE_UNIVERSALBOOKTOOLTIP = '#tooltips:progression/bookType/universalBooktooltip'
    ...
    VEHICLE_STATS_TOOLTIP = '#tooltips:vehicle/stats/tooltip'
    VEHICLE_STATS_TOOLTIPBOTTOM = '#tooltips:vehicle/stats/tooltipBottom'
    ...
    VEHICLESTATUS_NODETACHMENT_HEADER = '#tooltips:vehicleStatus/noDetachment/header'
    ...
    VEHICLESTATUS_OLDCREW_HEADER = '#tooltips:vehicleStatus/oldCrew/header'
    VEHICLESTATUS_NOTPARTICIPATINGINTEST_HEADER = '#tooltips:vehicleStatus/notParticipatingInTest/header'
    ...
    DEMOBILIZE_INSTRUCTORSACCEPT_TOOLTIP_EXCLUDEBUTTON = '#tooltips:demobilize/instructorsAccept/tooltip/excludeButton'
    ...
    VEHICLESELECTOR_FILTER_NATION_DISABLE_BODY = '#tooltips:vehicleSelector/filter/nation/disable/body'
    ...
    AWARDITEM_DORMITORIES_HEADER = '#tooltips:awardItem/dormitories/header'
    AWARDITEM_DORMITORIES_BODY = '#tooltips:awardItem/dormitories/body'
    ...
    AWARDITEM_RANKED_202103_ACCESS_HEADER = '#tooltips:awardItem/ranked_202103_access/header'
    AWARDITEM_RANKED_202103_ACCESS_BODY = '#tooltips:awardItem/ranked_202103_access/body'
    ...
    TANK_PARAMS_DESC_RELATIVESITUATIONALBONUSES = '#tooltips:tank_params/desc/relativeSituationalBonuses'
    TANK_PARAMS_DESC_RELATIVETANKCONTROLLEVEL = '#tooltips:tank_params/desc/relativeTankControlLevel'
    ...
    VEHICLEPARAMS_BONUS_TALENT_TEMPLATE = '#tooltips:vehicleParams/bonus/talent/template'
    ...
    VEHICLEPARAMS_BONUS_NOTACHIEVEDDESCRIPTION = '#tooltips:vehicleParams/bonus/notAchievedDescription'
    ...
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTLEARNED = '#tooltips:vehicleParams/bonus/possible/notLearned'
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTINCREASED = '#tooltips:vehicleParams/bonus/possible/notIncreased'
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTACHIEVED = '#tooltips:vehicleParams/bonus/possible/notAchieved'
    ...
    VEHICLEPARAMS_SIMPLIFIEDWITHDETACHMENT_TITLE = '#tooltips:vehicleParams/simplifiedWithDetachment/title'
    ...
    VEHICLEPREVIEW_CREW_CREWMASTERY_BASIC = '#tooltips:vehiclePreview/crew/crewMastery/basic'
    VEHICLEPREVIEW_CREW_CREWMASTERY_CMDRBONUS = '#tooltips:vehiclePreview/crew/crewMastery/cmdrBonus'
    VEHICLEPREVIEW_CREW_CREWMASTERY_PERKS = '#tooltips:vehiclePreview/crew/crewMastery/perks'
    VEHICLEPREVIEW_CREW_CREWMASTERY_AUTOPERKS = '#tooltips:vehiclePreview/crew/crewMastery/autoperks'
    VEHICLEPREVIEW_CREW_CREWMASTERY_EQUIPMENT = '#tooltips:vehiclePreview/crew/crewMastery/equipment'
    VEHICLEPREVIEW_CREW_MENTOR = '#tooltips:vehiclePreview/crew/mentor'
    VEHICLEPREVIEW_CREW_MENTORDESCR = '#tooltips:vehiclePreview/crew/mentorDescr'
    ...
    DISMISSDETACHMENT_BUFFERISFULL_HEADER = '#tooltips:dismissDetachment/bufferIsFull/header'
    DISMISSDETACHMENT_BUFFERISFULL_BODY = '#tooltips:dismissDetachment/bufferIsFull/body'
    DISMISSDETACHMENT_UNIQUEDETACHMENT_HEADER = '#tooltips:dismissDetachment/uniqueDetachment/header'
    DISMISSDETACHMENT_UNIQUEDETACHMENT_BODY = '#tooltips:dismissDetachment/uniqueDetachment/body'
    DISMISSDETACHMENT_SELLLIMIT_BODY = '#tooltips:dismissDetachment/sellLimit/body'
    DISMISSDETACHMENT_SWITCHED_OFF_HEADER = '#tooltips:dismissDetachment/switched_off/header'
    DISMISSDETACHMENT_SWITCHED_OFF_BODY = '#tooltips:dismissDetachment/switched_off/body'
    ...
    SKILLS_COMMANDER_SIXTHSENSE_HEADER = '#tooltips:skills/commander_sixthSense/header'
    SKILLS_COMMANDER_SIXTHSENSE_DESCR = '#tooltips:skills/commander_sixthSense/descr'
    ...
    QUESTS_BONUSES_TOKEN_PROGRESSIONEXPERIENCE_HEADER = '#tooltips:quests/bonuses/token/progressionExperience/header'
    QUESTS_BONUSES_TOKEN_PROGRESSIONEXPERIENCE_BODY = '#tooltips:quests/bonuses/token/progressionExperience/body'
    ...
    ADVANCED_RELATIVETANKCONTROLLEVEL = '#tooltips:advanced/relativeTankControlLevel'
    ...
    ADVANCED_DORMITORIES = '#tooltips:advanced/dormitories'
    ADVANCED_RECERTIFICATION = '#tooltips:advanced/recertification'
    ADVANCED_CREWBOOKS = '#tooltips:advanced/crewBooks'
    ...
    CREWBOOKS_ITEM_HEADER = '#tooltips:crewBooks/item/header'
    ...
    CREWBOOKS_FOOTER_BUYBUTTON_DISABLE_TITLE = '#tooltips:crewBooks/footer/buyButton/disable/title'
    CREWBOOKS_FOOTER_BUYBUTTON_DISABLE_BODY = '#tooltips:crewBooks/footer/buyButton/disable/body'
    ...
    DETACHMENT_CONVERTBUTTON_HEADER = '#tooltips:detachment/convertButton/header'
    DETACHMENT_CONVERTBUTTON_BODY = '#tooltips:detachment/convertButton/body'
    DETACHMENT_RECRUITBUTTON_HEADER = '#tooltips:detachment/recruitButton/header'
    DETACHMENT_RECRUITBUTTON_BODY = '#tooltips:detachment/recruitButton/body'
    DETACHMENT_RECRUITBUTTONDISABLE_HEADER = '#tooltips:detachment/recruitButtonDisable/header'
    DETACHMENT_RECRUITBUTTONDISABLE_BODY = '#tooltips:detachment/recruitButtonDisable/body'
    DETACHMENT_BUYDORMITORY_HEADER = '#tooltips:detachment/buyDormitory/header'
    DETACHMENT_BUYDORMITORY_BODY_AVAILABLE = '#tooltips:detachment/buyDormitory/body/available'
    DETACHMENT_BUYDORMITORY_BODY_DISABLE = '#tooltips:detachment/buyDormitory/body/disable'
    DETACHMENT_DISMISS_AVAILABLE_HEADER = '#tooltips:detachment/dismiss/available/header'
    DETACHMENT_DISMISS_DISABLE_HEADER = '#tooltips:detachment/dismiss/disable/header'
    DETACHMENT_DISMISS_AVAILABLE_BODY = '#tooltips:detachment/dismiss/available/body'
    DETACHMENT_DISMISS_HASLOCKCREW_BODY = '#tooltips:detachment/dismiss/hasLockCrew/body'
    DETACHMENT_DISMISS_SELLLIMITREACHED_BODY = '#tooltips:detachment/dismiss/sellLimitReached/body'
    DETACHMENT_DISMISS_DISABLE_BODY = '#tooltips:detachment/dismiss/disable/body'
    DETACHMENT_INSTRUCTORSLIST_VOICEBUTTON_BODY = '#tooltips:detachment/instructorsList/voiceButton/body'
    DETACHMENT_INSTRUCTORCARD_TITLE = '#tooltips:detachment/instructorCard/title'
    DETACHMENT_INSTRUCTORCARD_SLOTS = '#tooltips:detachment/instructorCard/slots'
    DETACHMENT_INSTRUCTORCARD_VOICED = '#tooltips:detachment/instructorCard/voiced'
    DETACHMENT_INSTRUCTORCARD_UNIQUE = '#tooltips:detachment/instructorCard/unique'
    DETACHMENT_INSTRUCTORCARD_TOKEN = '#tooltips:detachment/instructorCard/token'
    DETACHMENT_INSTRUCTORCARD_TOKENWITHNATION = '#tooltips:detachment/instructorCard/tokenWithNation'
    DETACHMENT_INSTRUCTORCARD_PROPERTY = '#tooltips:detachment/instructorCard/property'
    DETACHMENT_INSTRUCTORCARD_TRAIT = '#tooltips:detachment/instructorCard/trait'
    DETACHMENT_INSTRUCTORCARD_UNSELECTEDTRAIT = '#tooltips:detachment/instructorCard/unselectedTrait'
    DETACHMENT_INSTRUCTORCARD_UNKNOWNPERK = '#tooltips:detachment/instructorCard/unknownPerk'
    DETACHMENT_INSTRUCTORCARD_OVERCAPPEDPERK = '#tooltips:detachment/instructorCard/overcappedPerk'
    DETACHMENT_INSTRUCTORCARD_LOCATION_TITLE = '#tooltips:detachment/instructorCard/location/title'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INCREW_TITLE = '#tooltips:detachment/instructorCard/location/inCrew/title'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INCREW_DETACHMENT = '#tooltips:detachment/instructorCard/location/inCrew/detachment'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INCREW_BARRACKS = '#tooltips:detachment/instructorCard/location/inCrew/barracks'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INBARRACKS_TITLE = '#tooltips:detachment/instructorCard/location/inBarracks/title'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INBARRACKS_MALE = '#tooltips:detachment/instructorCard/location/inBarracks/male'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INBARRACKS_FEMALE = '#tooltips:detachment/instructorCard/location/inBarracks/female'
    DETACHMENT_INSTRUCTORCARD_LOCATION_INBARRACKS_TOKEN = '#tooltips:detachment/instructorCard/location/inBarracks/token'
    DETACHMENT_INSTRUCTORCARD_BOTTOMDESCRIPTION = '#tooltips:detachment/instructorCard/bottomDescription'
    DETACHMENT_INSTRUCTORCARD_INBATTLE = '#tooltips:detachment/instructorCard/inBattle'
    DETACHMENT_INSTRUCTORCARD_INSQUAD = '#tooltips:detachment/instructorCard/inSquad'
    DETACHMENT_INSTRUCTORCARD_WRONGNATION = '#tooltips:detachment/instructorCard/wrongNation'
    DETACHMENT_INSTRUCTORCARD_EMPTY = '#tooltips:detachment/instructorCard/empty'
    DETACHMENT_INSTRUCTORCARD_EMPTYDESCRIPTION = '#tooltips:detachment/instructorCard/emptyDescription'
    DETACHMENT_INSTRUCTORCARD_WRONGLEADER = '#tooltips:detachment/instructorCard/wrongLeader'
    DETACHMENT_INSTRUCTORCARD_CLICKTOCHOOSE = '#tooltips:detachment/instructorCard/clickToChoose'
    DETACHMENT_INSTRUCTORPAGE_VOICECHECKBOX_HEADER = '#tooltips:detachment/instructorPage/voiceCheckbox/header'
    DETACHMENT_INSTRUCTORPAGE_VOICECHECKBOX_BODY = '#tooltips:detachment/instructorPage/voiceCheckbox/body'
    DETACHMENT_INSTRUCTORPAGE_VOICECHECKBOX_INFO1 = '#tooltips:detachment/instructorPage/voiceCheckbox/info1'
    DETACHMENT_INSTRUCTORPAGE_VOICECHECKBOX_INFO2 = '#tooltips:detachment/instructorPage/voiceCheckbox/info2'
    DETACHMENT_INSTRUCTORPAGE_UNIQUE_HEADER = '#tooltips:detachment/instructorPage/unique/header'
    DETACHMENT_INSTRUCTORPAGE_UNIQUE_BODY = '#tooltips:detachment/instructorPage/unique/body'
    DETACHMENT_INSTRUCTORPAGE_ASSIGNDISABLED_HEADER = '#tooltips:detachment/instructorPage/assignDisabled/header'
    DETACHMENT_INSTRUCTORPAGE_ASSIGNDISABLED_LEVELNEEDED_BODY = '#tooltips:detachment/instructorPage/assignDisabled/levelNeeded/body'
    DETACHMENT_INSTRUCTORPAGE_ASSIGNDISABLED_SLOTSTAKEN_BODY = '#tooltips:detachment/instructorPage/assignDisabled/slotsTaken/body'
    DETACHMENT_INSTRUCTORUNPACKING_NATIONTOGGLE_BODY = '#tooltips:detachment/instructorUnpacking/nationToggle/body'
    DETACHMENT_INSTRUCTORUNPACKING_WRONGNATION_HEADER = '#tooltips:detachment/instructorUnpacking/wrongNation/header'
    DETACHMENT_INSTRUCTORUNPACKING_WRONGNATION_BODY = '#tooltips:detachment/instructorUnpacking/wrongNation/body'
    DETACHMENT_INSTRUCTORUNPACKING_PROFESSION_HEADER = '#tooltips:detachment/instructorUnpacking/profession/header'
    DETACHMENT_INSTRUCTORUNPACKING_PROFESSION_BODY = '#tooltips:detachment/instructorUnpacking/profession/body'
    DETACHMENT_INSTRUCTORUNPACKING_PROFESSION_DISABLED_HEADER = '#tooltips:detachment/instructorUnpacking/profession/disabled/header'
    DETACHMENT_INSTRUCTORUNPACKING_PROFESSION_DISABLED_BODY = '#tooltips:detachment/instructorUnpacking/profession/disabled/body'
    DETACHMENT_INSTRUCTORUNPACKING_INFOTEXT_HEADER = '#tooltips:detachment/instructorUnpacking/infoText/header'
    DETACHMENT_INSTRUCTORUNPACKING_INFOTEXT_BODY = '#tooltips:detachment/instructorUnpacking/infoText/body'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_NATIONANDPERK_HEADER = '#tooltips:detachment/instructorUnpacking/button/nationAndPerk/header'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_NATIONANDPERK_BODY = '#tooltips:detachment/instructorUnpacking/button/nationAndPerk/body'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_NATION_HEADER = '#tooltips:detachment/instructorUnpacking/button/nation/header'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_NATION_BODY = '#tooltips:detachment/instructorUnpacking/button/nation/body'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_PERK_HEADER = '#tooltips:detachment/instructorUnpacking/button/perk/header'
    DETACHMENT_INSTRUCTORUNPACKING_BUTTON_PERK_BODY = '#tooltips:detachment/instructorUnpacking/button/perk/body'
    DETACHMENT_INSTRUCTORUNPACKING_DISABLED_HEADER = '#tooltips:detachment/instructorUnpacking/disabled/header'
    DETACHMENT_INSTRUCTORUNPACKING_DISABLED_BODY = '#tooltips:detachment/instructorUnpacking/disabled/body'
    DETACHMENT_VEHICLESLOT_DISABLE_HEADER = '#tooltips:detachment/vehicleSlot/disable/header'
    DETACHMENT_VEHICLESLOT_DISABLE_BODY = '#tooltips:detachment/vehicleSlot/disable/body'
    DETACHMENT_SELECTASSIGNMETHODVIEW_ACCEPTBUTTON_DISABLE_HEADER = '#tooltips:detachment/selectAssignMethodView/acceptButton/disable/header'
    DETACHMENT_SELECTASSIGNMETHODVIEW_ACCEPTBUTTON_DISABLE_BODY = '#tooltips:detachment/selectAssignMethodView/acceptButton/disable/body'
    DETACHMENT_CONVERTPANEL_PLAYBUTTON_HEADER = '#tooltips:detachment/convertPanel/playButton/header'
    DETACHMENT_CONVERTPANEL_PLAYBUTTON_BODY = '#tooltips:detachment/convertPanel/playButton/body'
    DETACHMENT_CONVERTPANEL_HEADER = '#tooltips:detachment/convertPanel/header'
    DETACHMENT_CONVERTPANEL_BODY = '#tooltips:detachment/convertPanel/body'
    DETACHMENT_CONVERTPANEL_DISABLED_PLAYBUTTON_HEADER = '#tooltips:detachment/convertPanel_disabled/playButton/header'
    DETACHMENT_CONVERTPANEL_DISABLED_PLAYBUTTON_BODY = '#tooltips:detachment/convertPanel_disabled/playButton/body'
    DETACHMENT_CONVERTPANEL_DISABLED_HEADER = '#tooltips:detachment/convertPanel_disabled/header'
    DETACHMENT_CONVERTPANEL_DISABLED_BODY = '#tooltips:detachment/convertPanel_disabled/body'
    DETACHMENT_MOBILIZATION_NOTFORMED_HEADER = '#tooltips:detachment/mobilization/notFormed/header'
    DETACHMENT_MOBILIZATION_NOTFORMED_BODY = '#tooltips:detachment/mobilization/notFormed/body'
    DETACHMENT_NEWCOMMANDER_HOVERCARD_HEAD = '#tooltips:detachment/newCommander/hoverCard/head'
    DETACHMENT_NEWCOMMANDER_HOVERCARD_BODY = '#tooltips:detachment/newCommander/hoverCard/body'
    FILTERTEMPLATE_RESET_HEADER = '#tooltips:filterTemplate/reset/header'
    FILTERTEMPLATE_RESET_BODY = '#tooltips:filterTemplate/reset/body'
    FILTERTOGGLE_POPOVERBUTTON_DETACHMENT_HEADER = '#tooltips:filterToggle/popoverButton/detachment/header'
    FILTERTOGGLE_POPOVERBUTTON_DETACHMENT_BODY = '#tooltips:filterToggle/popoverButton/detachment/body'
    FILTERTOGGLE_POPOVERBUTTON_RECRUIT_HEADER = '#tooltips:filterToggle/popoverButton/recruit/header'
    FILTERTOGGLE_POPOVERBUTTON_RECRUIT_BODY = '#tooltips:filterToggle/popoverButton/recruit/body'
    FILTERTOGGLE_POPOVERBUTTON_INSTRUCTORS_HEADER = '#tooltips:filterToggle/popoverButton/instructors/header'
    FILTERTOGGLE_POPOVERBUTTON_INSTRUCTORS_BODY = '#tooltips:filterToggle/popoverButton/instructors/body'
    FILTERTOGGLE_POPOVERBUTTON_PROFILE_HEADER = '#tooltips:filterToggle/popoverButton/profile/header'
    FILTERTOGGLE_POPOVERBUTTON_PROFILE_BODY = '#tooltips:filterToggle/popoverButton/profile/body'
    FILTERTOGGLE_POPOVERBUTTON_VEHICLE_HEADER = '#tooltips:filterToggle/popoverButton/vehicle/header'
    FILTERTOGGLE_POPOVERBUTTON_VEHICLE_BODY = '#tooltips:filterToggle/popoverButton/vehicle/body'
    FILTERTOGGLE_SPECIALIZATION_DETACHMENT_BODY = '#tooltips:filterToggle/specialization/detachment/body'
    FILTERTOGGLE_SPECIALIZATION_RECRUIT_BODY = '#tooltips:filterToggle/specialization/recruit/body'
    FILTERTOGGLE_NATION_DETACHMENT_BODY = '#tooltips:filterToggle/nation/detachment/body'
    FILTERTOGGLE_NATION_RECRUIT_BODY = '#tooltips:filterToggle/nation/recruit/body'
    FILTERTOGGLE_NATION_SKINS_BODY = '#tooltips:filterToggle/nation/skins/body'
    FILTERTOGGLE_SPECIALITY_RECRUIT_BODY = '#tooltips:filterToggle/speciality/recruit/body'
    FILTERTOGGLE_GRADE_INSTRUCTORS_GRADE1_HEADER = '#tooltips:filterToggle/grade/instructors/grade1/header'
    FILTERTOGGLE_GRADE_INSTRUCTORS_GRADE2_HEADER = '#tooltips:filterToggle/grade/instructors/grade2/header'
    FILTERTOGGLE_GRADE_INSTRUCTORS_GRADE3_HEADER = '#tooltips:filterToggle/grade/instructors/grade3/header'
    FILTERTOGGLE_GRADE_INSTRUCTORS_BODY = '#tooltips:filterToggle/grade/instructors/body'
    FILTERTOGGLE_VEHICLETYPE_VEHICLE_BODY = '#tooltips:filterToggle/vehicleType/vehicle/body'
    FILTERTOGGLE_LEVEL_VEHICLE_HEADER = '#tooltips:filterToggle/level/vehicle/header'
    FILTERTOGGLE_LEVEL_VEHICLE_BODY = '#tooltips:filterToggle/level/vehicle/body'
    TOKENGROUP_TITLE = '#tooltips:tokenGroup/title'
    TOKENGROUP_DESCRIPTION = '#tooltips:tokenGroup/description'
    FILTERTOGGLE_INBARRACKS_DETACHMENT_HEADER = '#tooltips:filterToggle/inBarracks/detachment/header'
    FILTERTOGGLE_INBARRACKS_DETACHMENT_BODY = '#tooltips:filterToggle/inBarracks/detachment/body'
    FILTERTOGGLE_CREW_INSTRUCTORSCLASS_HEADER = '#tooltips:filterToggle/crew/instructorsClass/header'
    FILTERTOGGLE_CREW_INSTRUCTORSCLASS_BODY = '#tooltips:filterToggle/crew/instructorsClass/body'
    FILTERTOGGLE_CREW_INSTRUCTORSNATION_BODY = '#tooltips:filterToggle/crew/instructorsNation/body'
    FILTERTOGGLE_INBARRACKS_INSTRUCTORS_HEADER = '#tooltips:filterToggle/inBarracks/instructors/header'
    FILTERTOGGLE_INBARRACKS_INSTRUCTORS_BODY = '#tooltips:filterToggle/inBarracks/instructors/body'
    FILTERTOGGLE_INBARRACKS_RECRUIT_HEADER = '#tooltips:filterToggle/inBarracks/recruit/header'
    FILTERTOGGLE_INBARRACKS_RECRUIT_BODY = '#tooltips:filterToggle/inBarracks/recruit/body'
    FILTERTOGGLE_ONVEHICLE_DETACHMENT_HEADER = '#tooltips:filterToggle/onVehicle/detachment/header'
    FILTERTOGGLE_ONVEHICLE_DETACHMENT_BODY = '#tooltips:filterToggle/onVehicle/detachment/body'
    FILTERTOGGLE_ONVEHICLE_RECRUIT_HEADER = '#tooltips:filterToggle/onVehicle/recruit/header'
    FILTERTOGGLE_ONVEHICLE_RECRUIT_BODY = '#tooltips:filterToggle/onVehicle/recruit/body'
    FILTERTOGGLE_DISMISSED_DETACHMENT_HEADER = '#tooltips:filterToggle/dismissed/detachment/header'
    FILTERTOGGLE_DISMISSED_DETACHMENT_BODY = '#tooltips:filterToggle/dismissed/detachment/body'
    FILTERTOGGLE_DISMISSED_RECRUIT_HEADER = '#tooltips:filterToggle/dismissed/recruit/header'
    FILTERTOGGLE_DISMISSED_RECRUIT_BODY = '#tooltips:filterToggle/dismissed/recruit/body'
    FILTERTOGGLE_CREW_INSTRUCTORS_HEADER = '#tooltips:filterToggle/crew/instructors/header'
    FILTERTOGGLE_CREW_INSTRUCTORS_BODY = '#tooltips:filterToggle/crew/instructors/body'
    FILTERTOGGLE_REMOVED_INSTRUCTORS_HEADER = '#tooltips:filterToggle/removed/instructors/header'
    FILTERTOGGLE_REMOVED_INSTRUCTORS_BODY = '#tooltips:filterToggle/removed/instructors/body'
    FILTERTOGGLE_HISTORICAL_PROFILE_HEADER = '#tooltips:filterToggle/historical/profile/header'
    FILTERTOGGLE_HISTORICAL_PROFILE_BODY = '#tooltips:filterToggle/historical/profile/body'
    FILTERTOGGLE_NONHISTORICAL_PROFILE_HEADER = '#tooltips:filterToggle/nonHistorical/profile/header'
    FILTERTOGGLE_NONHISTORICAL_PROFILE_BODY = '#tooltips:filterToggle/nonHistorical/profile/body'
    FILTERTOGGLE_USED_PROFILE_HEADER = '#tooltips:filterToggle/used/profile/header'
    FILTERTOGGLE_USED_PROFILE_BODY = '#tooltips:filterToggle/used/profile/body'
    FILTERTOGGLE_DOCUMENTS_PROFILE_HEADER = '#tooltips:filterToggle/documents/profile/header'
    FILTERTOGGLE_DOCUMENTS_PROFILE_BODY = '#tooltips:filterToggle/documents/profile/body'
    FILTERTOGGLE_SKINS_PROFILE_HEADER = '#tooltips:filterToggle/skins/profile/header'
    FILTERTOGGLE_SKINS_PROFILE_BODY = '#tooltips:filterToggle/skins/profile/body'
    FILTERTOGGLE_INHANGAR_VEHICLE_HEADER = '#tooltips:filterToggle/inHangar/vehicle/header'
    FILTERTOGGLE_INHANGAR_VEHICLE_BODY = '#tooltips:filterToggle/inHangar/vehicle/body'
    FILTERTOGGLE_NOTINHANGAR_VEHICLE_HEADER = '#tooltips:filterToggle/notInHangar/vehicle/header'
    FILTERTOGGLE_NOTINHANGAR_VEHICLE_BODY = '#tooltips:filterToggle/notInHangar/vehicle/body'
    FILTERTOGGLE_HASCREW_VEHICLE_HEADER = '#tooltips:filterToggle/hasCrew/vehicle/header'
    FILTERTOGGLE_HASCREW_VEHICLE_BODY = '#tooltips:filterToggle/hasCrew/vehicle/body'
    FILTERTOGGLE_FAVORITE_VEHICLE_HEADER = '#tooltips:filterToggle/favorite/vehicle/header'
    FILTERTOGGLE_FAVORITE_VEHICLE_BODY = '#tooltips:filterToggle/favorite/vehicle/body'
    DETACHMENT_MATRIX_SHOWRECOMMENDEDPERKS_HEADER = '#tooltips:detachment/matrix/showRecommendedPerks/header'
    DETACHMENT_MATRIX_SHOWRECOMMENDEDPERKS_BODY = '#tooltips:detachment/matrix/showRecommendedPerks/body'
    DETACHMENT_MATRIX_SHOWRECOMMENDEDPERKS_DISABLED = '#tooltips:detachment/matrix/showRecommendedPerks/disabled'
    DETACHMENT_MATRIX_BUTTON_SAVE_BODY = '#tooltips:detachment/matrix/button/save/body'
    DETACHMENT_MATRIX_BUTTON_SAVE_DISABLE_BODY = '#tooltips:detachment/matrix/button/save/disable/body'
    DETACHMENT_MATRIX_BUTTON_CANCEL_BODY = '#tooltips:detachment/matrix/button/cancel/body'
    DETACHMENT_MATRIX_BUTTON_EDIT_BODY = '#tooltips:detachment/matrix/button/edit/body'
    DETACHMENT_MATRIX_BUTTON_RESET_BODY = '#tooltips:detachment/matrix/button/reset/body'
    DETACHMENT_MATRIX_POPOVER_CHECKBOX_VEHICLEINHANGAR_HEADER = '#tooltips:detachment/matrix/popover/checkbox/vehicleInHangar/header'
    DETACHMENT_MATRIX_POPOVER_CHECKBOX_VEHICLEINHANGAR_BODY = '#tooltips:detachment/matrix/popover/checkbox/vehicleInHangar/body'
    DETACHMENT_MATRIX_POPOVER_SORTBUTTON_VEHICLEINHANGAR_HEADER = '#tooltips:detachment/matrix/popover/sortButton/vehicleInHangar/header'
    DETACHMENT_MATRIX_POPOVER_SORTBUTTON_VEHICLEINHANGAR_BODY = '#tooltips:detachment/matrix/popover/sortButton/vehicleInHangar/body'
    DETACHMENT_OFFICE_MOVEUNAVAILABLE = '#tooltips:detachment/office/moveUnavailable'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_TITLE = '#tooltips:detachment/vehicleCompare/pointsInfo/title'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_DESCRIPTION = '#tooltips:detachment/vehicleCompare/pointsInfo/description'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_POINTS_TITLE = '#tooltips:detachment/vehicleCompare/pointsInfo/points/title'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_POINTS_DESCRIPTION = '#tooltips:detachment/vehicleCompare/pointsInfo/points/description'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_INSTRUCTOR_TITLE = '#tooltips:detachment/vehicleCompare/pointsInfo/instructor/title'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_INSTRUCTOR_DESCRIPTION = '#tooltips:detachment/vehicleCompare/pointsInfo/instructor/description'
    DETACHMENT_VEHICLECOMPARE_CLEAR = '#tooltips:detachment/vehicleCompare/clear'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_DESCRIPTION2 = '#tooltips:detachment/vehicleCompare/pointsInfo/description2'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_POINTS_DESCRIPTION2 = '#tooltips:detachment/vehicleCompare/pointsInfo/points/description2'
    DETACHMENT_VEHICLECOMPARE_POINTSINFO_INSTRUCTOR_DESCRIPTION2 = '#tooltips:detachment/vehicleCompare/pointsInfo/instructor/description2'
    BUYVEHICLE_SLOTS_HEADER = '#tooltips:buyVehicle/slots/header'
    BUYVEHICLE_SLOTS_BODY = '#tooltips:buyVehicle/slots/body'
    BUYVEHICLE_AMMO_HEADER = '#tooltips:buyVehicle/ammo/header'
    BUYVEHICLE_AMMO_BODY = '#tooltips:buyVehicle/ammo/body'
    BUYVEHICLE_NOSLOTS_HEADER = '#tooltips:buyVehicle/noSlots/header'
    BUYVEHICLE_NOSLOTS_BODY = '#tooltips:buyVehicle/noSlots/body'
    BUYVEHICLE_NOWALLET_HEADER = '#tooltips:buyVehicle/noWallet/header'
    BUYVEHICLE_NOWALLET_BODY = '#tooltips:buyVehicle/noWallet/body'
    NOTENOUGH = '#tooltips:notEnough'
    DETACHMENT_INFO_MAXPROGRESS = '#tooltips:detachment/info/maxProgress'
    DETACHMENT_INFO_DETACHMENTLOCKED = '#tooltips:detachment/info/detachmentLocked'
    DETACHMENT_INFO_COMMANDER = '#tooltips:detachment/info/commander'
    DETACHMENT_INFO_SPECIALTY_TITLE = '#tooltips:detachment/info/specialty/title'
    DETACHMENT_INFO_SPECIALTY_INFO = '#tooltips:detachment/info/specialty/info'
    DETACHMENT_INFO_VEHICLES_DRIVES = '#tooltips:detachment/info/vehicles/drives'
    DETACHMENT_INFO_VEHICLES_UNIQUEDETACHMENT = '#tooltips:detachment/info/vehicles/uniqueDetachment'
    DETACHMENT_INFO_SKILLPOINTS_TITLE = '#tooltips:detachment/info/skillPoints/title'
    DETACHMENT_INFO_SKILLPOINTS_DESCRIPTION = '#tooltips:detachment/info/skillPoints/description'
    DETACHMENT_INFO_INSTRUCTORS_TITLE = '#tooltips:detachment/info/instructors/title'
    DETACHMENT_INFO_INSTRUCTORS_UNIQTITLE = '#tooltips:detachment/info/instructors/uniqTitle'
    DETACHMENT_INFO_INSTRUCTORS_DEMOBILIZED = '#tooltips:detachment/info/instructors/demobilized'
    DETACHMENT_INFO_SLOTS_INSTRUCTOR_EMPTY = '#tooltips:detachment/info/slots/instructor/empty'
    DETACHMENT_INFO_SLOTS_VEHICLE_EMPTY = '#tooltips:detachment/info/slots/vehicle/empty'
    DETACHMENT_INFO_SLOTS_LOCKED = '#tooltips:detachment/info/slots/locked'
    DETACHMENT_INFO_INBATTLE = '#tooltips:detachment/info/inBattle'
    DETACHMENT_INFO_INPLATOON = '#tooltips:detachment/info/inPlatoon'
    DETACHMENT_INFO_DEMOBILIZED_TITLE = '#tooltips:detachment/info/demobilized/title'
    RECOVERY_TITLE = '#tooltips:recovery/title'
    DETACHMENT_INFO_DEMOBILIZED_FULLTERM = '#tooltips:detachment/info/demobilized/fullTerm'
    DETACHMENT_INFO_DEMOBILIZED_FREETERM = '#tooltips:detachment/info/demobilized/freeTerm'
    DETACHMENT_INFO_DEMOBILIZED_PAIDTERM = '#tooltips:detachment/info/demobilized/paidTerm'
    DETACHMENT_INFO_DEMOBILIZED_FULLTERMPRICE = '#tooltips:detachment/info/demobilized/fullTermPrice'
    DETACHMENT_INFO_DEMOBILIZED_DISSOLVED = '#tooltips:detachment/info/demobilized/dissolved'
    DETACHMENT_INFO_DEMOBILIZED_DESCRIPTION = '#tooltips:detachment/info/demobilized/description'
    DETACHMENT_INFO_EMPTY_TITLE = '#tooltips:detachment/info/empty/title'
    DETACHMENT_INFO_EMPTY_HASRECRUITERS = '#tooltips:detachment/info/empty/hasRecruiters'
    DETACHMENT_INFO_EMPTY_NORECRUITERS = '#tooltips:detachment/info/empty/noRecruiters'
    DETACHMENT_INFO_EMPTY_DESCRIPTION = '#tooltips:detachment/info/empty/description'
    DETACHMENT_RESTORE_TITLE = '#tooltips:detachment/restore/title'
    DETACHMENT_POINTSINFO_TITLE = '#tooltips:detachment/pointsInfo/title'
    DETACHMENT_POINTSINFO_MOBILIZATION_DESCRIPTION = '#tooltips:detachment/pointsInfo/mobilization/description'
    DETACHMENT_POINTSINFO_POINTSPERLEVEL_DESCRIPTION = '#tooltips:detachment/pointsInfo/pointsPerLevel/description'
    DETACHMENT_POINTSINFO_DEFAULT_DESCRIPTION = '#tooltips:detachment/pointsInfo/default/description'
    DETACHMENT_POINTSINFO_POINTS_DESCRIPTION = '#tooltips:detachment/pointsInfo/points/description'
    DETACHMENT_POINTSINFO_POINTS_BLUE = '#tooltips:detachment/pointsInfo/points/blue'
    DETACHMENT_POINTSINFO_POINTS_BLUEDESC = '#tooltips:detachment/pointsInfo/points/blueDesc'
    DETACHMENT_POINTSINFO_POINTS_RED = '#tooltips:detachment/pointsInfo/points/red'
    DETACHMENT_POINTSINFO_POINTS_REDDESC = '#tooltips:detachment/pointsInfo/points/redDesc'
    DETACHMENT_ISCLICKABLE_GOTOPERKMATRIX = '#tooltips:detachment/isClickable/gotoPerkMatrix'
    DORMITORYINFO_HEADER = '#tooltips:dormitoryInfo/header'
    DORMITORYINFO_TOOLTIP = '#tooltips:dormitoryInfo/tooltip'
    DORMITORYINFO_LABEL = '#tooltips:dormitoryInfo/label'
    DORMITORYINFO_HANGARDORMS = '#tooltips:dormitoryInfo/hangarDorms'
    DORMITORYINFO_EXTRADORMS = '#tooltips:dormitoryInfo/extraDorms'
    DORMITORYINFO_TOTAL = '#tooltips:dormitoryInfo/total'
    DORMITORYINFO_DESCRIPTION_0 = '#tooltips:dormitoryInfo/description/0'
    DORMITORYINFO_DESCRIPTION_1 = '#tooltips:dormitoryInfo/description/1'
    DORMITORYINFO_DESCRIPTION_2 = '#tooltips:dormitoryInfo/description/2'
    DORMITORYINFO_DESCRIPTION_3 = '#tooltips:dormitoryInfo/description/3'
    DORMITORYNEW_BODY = '#tooltips:dormitoryNew/body'
    DORMITORYNEW_AMOUNT = '#tooltips:dormitoryNew/amount'
    DORMITORYNEW_HOWCREDITED = '#tooltips:dormitoryNew/howCredited'
    DORMITORYNEW_DESCRIPTION = '#tooltips:dormitoryNew/description'
    TRAINVEHICLE_FREE_TITLE = '#tooltips:trainVehicle/free/title'
    TRAINVEHICLE_FREE_BODY = '#tooltips:trainVehicle/free/body'
    TRAINVEHICLE_SCHOOL_TITLE = '#tooltips:trainVehicle/school/title'
    TRAINVEHICLE_SCHOOL_BODY = '#tooltips:trainVehicle/school/body'
    TRAINVEHICLE_ACADEMY_TITLE = '#tooltips:trainVehicle/academy/title'
    TRAINVEHICLE_ACADEMY_BODY = '#tooltips:trainVehicle/academy/body'
    TRAINVEHICLE_TRAINING_TITLE = '#tooltips:trainVehicle/training/title'
    TRAINVEHICLE_TRAINING_BODY = '#tooltips:trainVehicle/training/body'
    TRAINVEHICLE_TRAINING_BODY2 = '#tooltips:trainVehicle/training/body2'
    DETACHMENT_PERK_VEHPARAMS_TITLE = '#tooltips:detachment/perk/vehParams/title'
    DETACHMENT_PERK_INDICATORS_LEARNING = '#tooltips:detachment/perk/indicators/learning'
    DETACHMENT_PERK_INDICATORS_LEARNED = '#tooltips:detachment/perk/indicators/learned'
    DETACHMENT_PERK_INDICATORS_ULTIMATE = '#tooltips:detachment/perk/indicators/ultimate'
    DETACHMENT_PERK_INSTRUCTOR_TITLE = '#tooltips:detachment/perk/instructor/title'
    DETACHMENT_PERK_INSTRUCTION_TITLE = '#tooltips:detachment/perk/instruction/title'
    DETACHMENT_PERK_INSTRUCTORANDINSTRUCTION_TITLE = '#tooltips:detachment/perk/instructorAndInstruction/title'
    DETACHMENT_PERK_INSTRUCTOR_POINTS = '#tooltips:detachment/perk/instructor/points'
    DETACHMENT_PERK_INSTRUCTOR_POINTSOVERCAPPED = '#tooltips:detachment/perk/instructor/pointsOvercapped'
    DETACHMENT_PERK_HINT = '#tooltips:detachment/perk/hint'
    DETACHMENT_PERK_HINTSHORT = '#tooltips:detachment/perk/hintShort'
    DETACHMENT_PERK_HINTINSTRUCTOR = '#tooltips:detachment/perk/hintInstructor'
    DETACHMENT_PERK_HOTKEYSONE = '#tooltips:detachment/perk/hotkeysOne'
    DETACHMENT_PERK_HOTKEYSALL = '#tooltips:detachment/perk/hotkeysAll'
    DETACHMENT_PERK_VEHPARAMSITUATIONAL = '#tooltips:detachment/perk/vehParamSituational'
    DETACHMENT_COMMANDERPERK_TITLE_SIXTHSENSE = '#tooltips:detachment/commanderPerk/title/sixthSense'
    DETACHMENT_COMMANDERPERK_TITLE_ENEMYSHOTPREDICTOR = '#tooltips:detachment/commanderPerk/title/enemyShotPredictor'
    DETACHMENT_COMMANDERPERK_SUBTITLE = '#tooltips:detachment/commanderPerk/subtitle'
    DETACHMENT_COMMANDERPERK_DESCRIPTION_SIXTHSENSE = '#tooltips:detachment/commanderPerk/description/sixthSense'
    DETACHMENT_COMMANDERPERK_DESCRIPTION_ENEMYSHOTPREDICTOR = '#tooltips:detachment/commanderPerk/description/enemyShotPredictor'
    DETACHMENT_COMMANDERPERK_INFO = '#tooltips:detachment/commanderPerk/info'
    BARRACKS_MENU_DETACHMENT_NAME = '#tooltips:barracks/menu/detachment/name'
    BARRACKS_MENU_DETACHMENT_DESC = '#tooltips:barracks/menu/detachment/desc'
    BARRACKS_MENU_INSTRUCTORS_NAME = '#tooltips:barracks/menu/instructors/name'
    BARRACKS_MENU_INSTRUCTORS_DESC = '#tooltips:barracks/menu/instructors/desc'
    BARRACKS_MENU_RECRUITS_NAME = '#tooltips:barracks/menu/recruits/name'
    BARRACKS_MENU_RECRUITS_DESC = '#tooltips:barracks/menu/recruits/desc'
    MOBILIZATION_STATEDESCRIPTION_NOVEHICLESELECTED_HEADER = '#tooltips:mobilization/stateDescription/noVehicleSelected/header'
    MOBILIZATION_STATEDESCRIPTION_NOVEHICLESELECTED_BODY = '#tooltips:mobilization/stateDescription/noVehicleSelected/body'
    MOBILIZATION_STATEDESCRIPTION_INBATTLE_HEADER = '#tooltips:mobilization/stateDescription/inBattle/header'
    MOBILIZATION_STATEDESCRIPTION_INBATTLE_BODY = '#tooltips:mobilization/stateDescription/inBattle/body'
    MOBILIZATION_STATEDESCRIPTION_INPLATOON_HEADER = '#tooltips:mobilization/stateDescription/inPlatoon/header'
    MOBILIZATION_STATEDESCRIPTION_INPLATOON_BODY = '#tooltips:mobilization/stateDescription/inPlatoon/body'
    MOBILIZATION_STATEDESCRIPTION_LEADERSOVERFLOW_HEADER = '#tooltips:mobilization/stateDescription/leadersOverflow/header'
    MOBILIZATION_STATEDESCRIPTION_LEADERSOVERFLOW_BODY = '#tooltips:mobilization/stateDescription/leadersOverflow/body'
    MOBILIZATION_STATEDESCRIPTION_NOTFORMED_HEADER = '#tooltips:mobilization/stateDescription/notFormed/header'
    MOBILIZATION_STATEDESCRIPTION_NOTFORMED_BODY = '#tooltips:mobilization/stateDescription/notFormed/body'
    MOBILIZATION_STATEDESCRIPTION_NEEDRETRAIN_HEADER = '#tooltips:mobilization/stateDescription/needRetrain/header'
    MOBILIZATION_STATEDESCRIPTION_NEEDRETRAIN_BODY = '#tooltips:mobilization/stateDescription/needRetrain/body'
    MOBILIZATION_STATEDESCRIPTION_CONVERTINGAVAILABLE_HEADER = '#tooltips:mobilization/stateDescription/convertingAvailable/header'
    MOBILIZATION_STATEDESCRIPTION_CONVERTINGAVAILABLE_BODY = '#tooltips:mobilization/stateDescription/convertingAvailable/body'
    MOBILIZATION_BANNER_MOBILIZEBUTTON_HEADER = '#tooltips:mobilization/banner/mobilizeButton/header'
    MOBILIZATION_BANNER_MOBILIZEBUTTON_BODY = '#tooltips:mobilization/banner/mobilizeButton/body'
    FASTOPERATION_INBATTLE_BODY = '#tooltips:fastOperation/inBattle/body'
    FASTOPERATION_INPLATOON_BODY = '#tooltips:fastOperation/inPlatoon/body'
    FASTOPERATION_RETRAIN_HEADER = '#tooltips:fastOperation/retrain/header'
    FASTOPERATION_RETRAIN_BODY_AVAILABLE = '#tooltips:fastOperation/retrain/body/available'
    FASTOPERATION_RETRAIN_BODY_ALLINPLACE = '#tooltips:fastOperation/retrain/body/allInPlace'
    FASTOPERATION_RETRAIN_BODY_EMPTY = '#tooltips:fastOperation/retrain/body/empty'
    FASTOPERATION_RETRAIN_BODY_UNKNOWN = '#tooltips:fastOperation/retrain/body/unknown'
    FASTOPERATION_PREVIOUS_HEADER = '#tooltips:fastOperation/previous/header'
    FASTOPERATION_PREVIOUS_BODY_AVAILABLE = '#tooltips:fastOperation/previous/body/available'
    FASTOPERATION_PREVIOUS_BODY_ALLINPLACE = '#tooltips:fastOperation/previous/body/allInPlace'
    FASTOPERATION_PREVIOUS_BODY_INBATTLE = '#tooltips:fastOperation/previous/body/inBattle'
    FASTOPERATION_PREVIOUS_BODY_INPLATOON = '#tooltips:fastOperation/previous/body/inPlatoon'
    FASTOPERATION_PREVIOUS_BODY_DISMISSED = '#tooltips:fastOperation/previous/body/dismissed'
    FASTOPERATION_PREVIOUS_BODY_CONVERTED = '#tooltips:fastOperation/previous/body/converted'
    FASTOPERATION_PREVIOUS_BODY_EMPTY = '#tooltips:fastOperation/previous/body/empty'
    FASTOPERATION_PREVIOUS_BODY_RETRAINED = '#tooltips:fastOperation/previous/body/retrained'
    FASTOPERATION_PREVIOUS_BODY_UNKNOWN = '#tooltips:fastOperation/previous/body/unknown'
    FASTOPERATION_TOP_HEADER = '#tooltips:fastOperation/top/header'
    FASTOPERATION_TOP_BODY_AVAILABLE = '#tooltips:fastOperation/top/body/available'
    FASTOPERATION_TOP_BODY_ALLINPLACE = '#tooltips:fastOperation/top/body/allInPlace'
    FASTOPERATION_TOP_BODY_EMPTY = '#tooltips:fastOperation/top/body/empty'
    FASTOPERATION_TOP_BODY_LOCKCREW = '#tooltips:fastOperation/top/body/lockCrew'
    FASTOPERATION_TOP_BODY_UNKNOWN = '#tooltips:fastOperation/top/body/unknown'
    FASTOPERATION_DROPINBARRACK_HEADER = '#tooltips:fastOperation/dropInBarrack/header'
    FASTOPERATION_DROPINBARRACK_BODY_AVAILABLE = '#tooltips:fastOperation/dropInBarrack/body/available'
    FASTOPERATION_DROPINBARRACK_BODY_EMPTY = '#tooltips:fastOperation/dropInBarrack/body/empty'
    FASTOPERATION_DROPINBARRACK_BODY_LOCKCREW = '#tooltips:fastOperation/dropInBarrack/body/lockCrew'
    FASTOPERATION_DROPINBARRACK_BODY_UNKNOWN = '#tooltips:fastOperation/dropInBarrack/body/unknown'
    CREWSKINS_USED = '#tooltips:crewSkins/used'
    CREWSKINS_INSTORAGE = '#tooltips:crewSkins/inStorage'
    CREWSKINS_USAGERESTRICTIONS = '#tooltips:crewSkins/usageRestrictions'
    CREWSKINS_NO = '#tooltips:crewSkins/no'
    CREWSKINS_ISUSEDBY = '#tooltips:crewSkins/isUsedBy'
    CREWSKINS_INBARRACKS = '#tooltips:crewSkins/inBarracks'
    DOCUMENT_HEADER = '#tooltips:document/header'
    DOCUMENT_BODY = '#tooltips:document/body'
    TOTALCAPS = '#tooltips:totalCaps'
    DETACHMENTPREVIEW_HEADER = '#tooltips:detachmentPreview/header'
    DETACHMENTPREVIEW_INSTRUCTORS = '#tooltips:detachmentPreview/instructors'
    DETACHMENT_MOBILIZATION_TITLE = '#tooltips:detachment/mobilization/title'
    DETACHMENT_MOBILIZATION_DESCTOP = '#tooltips:detachment/mobilization/descTop'
    DETACHMENT_MOBILIZATION_DESCBOTTOM = '#tooltips:detachment/mobilization/descBottom'
    DETACHMENT_MOBILIZATION_ENDTIME = '#tooltips:detachment/mobilization/endTime'
    PROGRESSIONDISCOUNT_SCHOOL_TITLE = '#tooltips:progressionDiscount/school/title'
    PROGRESSIONDISCOUNT_SCHOOL_BODY = '#tooltips:progressionDiscount/school/body'
    PROGRESSIONDISCOUNT_TRAINING_TITLE = '#tooltips:progressionDiscount/training/title'
    PROGRESSIONDISCOUNT_TRAINING_BODY = '#tooltips:progressionDiscount/training/body'
    PROGRESSIONDISCOUNT_TRAINING_BODY2 = '#tooltips:progressionDiscount/training/body2'
    PROGRESSIONDISCOUNT_ACADEMY_TITLE = '#tooltips:progressionDiscount/academy/title'
    PROGRESSIONDISCOUNT_ACADEMY_BODY = '#tooltips:progressionDiscount/academy/body'
    PROGRESSIONDISCOUNT_LEARNINGHELP = '#tooltips:progressionDiscount/learningHelp'
    RANK_HEADER = '#tooltips:rank/header'
    RANK_BODY = '#tooltips:rank/body'
    RANK_FOOTER = '#tooltips:rank/footer'
    DETACHMENT_CONVERTATION_VEHICLE_NOTPREMIUMVEHICLE_HEADER = '#tooltips:detachment/convertation/vehicle/notPremiumVehicle/header'
    DETACHMENT_CONVERTATION_VEHICLE_NOTPREMIUMVEHICLE_DESCRIPTION = '#tooltips:detachment/convertation/vehicle/notPremiumVehicle/description'
    DETACHMENT_CONVERTATION_VEHICLE_NOTPREMIUMVEHICLE_ABOUTPREMIUM_DESCRIPTION = '#tooltips:detachment/convertation/vehicle/notPremiumVehicle/aboutPremium/description'
    DETACHMENT_CONVERTATION_VEHICLE_PREMIUMVEHICLE_HEADER = '#tooltips:detachment/convertation/vehicle/premiumVehicle/header'
    DETACHMENT_CONVERTATION_VEHICLE_PREMIUMVEHICLE_ABOUTPREMIUM_DESCRIPTION = '#tooltips:detachment/convertation/vehicle/premiumVehicle/aboutPremium/description'
    DETACHMENT_CONVERTATION_VEHICLE_PREMIUMVEHICLE_WARNING_DESCRIPTION = '#tooltips:detachment/convertation/vehicle/premiumVehicle/warning/description'
    DETACHMENT_CONVERTATION_VEHICLE_PREMIUMVEHICLE_WARNING_TITLE = '#tooltips:detachment/convertation/vehicle/premiumVehicle/warning/title'
    DETACHMENT_MOBILIZATION_VEHICLE_PREMIUMVEHICLE_HEADER = '#tooltips:detachment/mobilization/vehicle/premiumVehicle/header'
    DETACHMENT_MOBILIZATION_VEHICLE_PREMIUMVEHICLE_ABOUTPREMIUM_DESCRIPTION = '#tooltips:detachment/mobilization/vehicle/premiumVehicle/aboutPremium/description'
    DETACHMENT_MOBILIZATION_VEHICLE_PREMIUMVEHICLE_WARNING_DESCRIPTION = '#tooltips:detachment/mobilization/vehicle/premiumVehicle/warning/description'
    DETACHMENT_MOBILIZATION_VEHICLE_PREMIUMVEHICLE_WARNING_TITLE = '#tooltips:detachment/mobilization/vehicle/premiumVehicle/warning/title'
    DETACHMENT_MOBILIZATION_ADDITIONALSPECIALITY_HEAD = '#tooltips:detachment/mobilization/additionalSpeciality/head'
    DETACHMENT_MOBILIZATION_ADDITIONALSPECIALITY_BODY = '#tooltips:detachment/mobilization/additionalSpeciality/body'
    DETACHMENT_MOBILIZATION_ADDITIONALSPECIALITY_BODYLOCKED = '#tooltips:detachment/mobilization/additionalSpeciality/bodyLocked'
    DETACHMENT_VEHICLESLOT_HEADER = '#tooltips:detachment/vehicleSlot/header'
    DETACHMENT_VEHICLESLOT_DESCRIPTION_CLOSED = '#tooltips:detachment/vehicleSlot/description/closed'
    DETACHMENT_VEHICLESLOT_DESCRIPTION_OPENED = '#tooltips:detachment/vehicleSlot/description/opened'
    DETACHMENT_VEHICLESLOT_DESCRIPTION_NOTAVAILABLE = '#tooltips:detachment/vehicleSlot/description/notAvailable'
    DETACHMENT_VEHICLESLOT_FOOTER_BUY = '#tooltips:detachment/vehicleSlot/footer/buy'
    DETACHMENT_VEHICLESLOT_FOOTER_CHOOSE = '#tooltips:detachment/vehicleSlot/footer/choose'
    DETACHMENT_VEHICLESLOT_OPEN = '#tooltips:detachment/vehicleSlot/open'
    DETACHMENT_PREMIUMVEHICLESLOT_LIGHTTANK = '#tooltips:detachment/premiumVehicleSlot/lightTank'
    DETACHMENT_PREMIUMVEHICLESLOT_MEDIUMTANK = '#tooltips:detachment/premiumVehicleSlot/mediumTank'
    DETACHMENT_PREMIUMVEHICLESLOT_HEAVYTANK = '#tooltips:detachment/premiumVehicleSlot/heavyTank'
    DETACHMENT_PREMIUMVEHICLESLOT_AT_SPG = '#tooltips:detachment/premiumVehicleSlot/AT-SPG'
    DETACHMENT_PREMIUMVEHICLESLOT_SPG = '#tooltips:detachment/premiumVehicleSlot/SPG'
    DETACHMENT_PREMIUMVEHICLESLOT_DESCRIPTION = '#tooltips:detachment/premiumVehicleSlot/description'
    DETACHMENT_VEHICLESLOTREWARD_HEADER = '#tooltips:detachment/vehicleSlotReward/header'
    DETACHMENT_VEHICLESLOTREWARD_BODY = '#tooltips:detachment/vehicleSlotReward/body'
    DETACHMENT_MASTERYREWARD_HEADER = '#tooltips:detachment/masteryReward/header'
    DETACHMENT_MASTERYREWARD_BODY = '#tooltips:detachment/masteryReward/body'
    DETACHMENT_INSTRUCTORSLOTS_DISABLED_HEADER = '#tooltips:detachment/instructorSlots/disabled/header'
    DETACHMENT_INSTRUCTORSLOTS_DISABLED_BODY = '#tooltips:detachment/instructorSlots/disabled/body'
    LEVELUP_LEVELBADGETOOLTIP_BODY = '#tooltips:levelUp/levelBadgeTooltip/body'
    LEVELUP_LEVELBADGETOOLTIP_BATTLES = '#tooltips:levelUp/levelBadgeTooltip/battles'
    DETACHMENT_ULTIMATEUNLOCK_HEADER = '#tooltips:detachment/ultimateUnlock/header'
    DETACHMENT_ULTIMATEUNLOCK_DESCRIPTION = '#tooltips:detachment/ultimateUnlock/description'
    DETACHMENT_ULTIMATEUNLOCK_FEATURES_HEADER = '#tooltips:detachment/ultimateUnlock/features/header'
    DETACHMENT_ULTIMATEUNLOCK_FEATURES_0 = '#tooltips:detachment/ultimateUnlock/features/0'
    DETACHMENT_ULTIMATEUNLOCK_FEATURES_1 = '#tooltips:detachment/ultimateUnlock/features/1'
    DETACHMENT_ULTIMATEUNLOCK_NOIMPACT_HEADER = '#tooltips:detachment/ultimateUnlock/noImpact/header'
    DETACHMENT_ULTIMATEUNLOCK_NOIMPACT_0 = '#tooltips:detachment/ultimateUnlock/noImpact/0'
    DETACHMENT_ULTIMATEUNLOCK_NOIMPACT_1 = '#tooltips:detachment/ultimateUnlock/noImpact/1'
    DETACHMENT_ULTIMATEUNLOCK_LOCKED = '#tooltips:detachment/ultimateUnlock/locked'
    DETACHMENT_ULTIMATEUNLOCK_UNLOCKED = '#tooltips:detachment/ultimateUnlock/unlocked'
    DETACHMENT_ULTIMATEUNLOCK_SELECTED = '#tooltips:detachment/ultimateUnlock/selected'
    DETACHMENT_ULTIMATEUNLOCK_POINTS = '#tooltips:detachment/ultimateUnlock/points'
    DETACHMENT_MOBILIZATIONNEWCOMMANDER_HEADER = '#tooltips:detachment/mobilizationNewCommander/header'
    DETACHMENT_MOBILIZATIONNEWCOMMANDER_BODY = '#tooltips:detachment/mobilizationNewCommander/body'
    DETACHMENT_CREWBOOSTER_PERKNAME = '#tooltips:detachment/crewBooster/perkName'
    DETACHMENT_CREWBOOSTER_PERKPROGRESS = '#tooltips:detachment/crewBooster/perkProgress'
    DETACHMENT_CREWBOOSTER_WORKINGPRINCIPLE = '#tooltips:detachment/crewBooster/workingPrinciple'
    DETACHMENT_CREWBOOSTER_LOWLEVEL = '#tooltips:detachment/crewBooster/lowLevel'
    DETACHMENT_CREWBOOSTER_LOWLEVELEXPL = '#tooltips:detachment/crewBooster/lowLevelExpl'
    DETACHMENT_CREWBOOSTER_HIGHLEVEL = '#tooltips:detachment/crewBooster/highLevel'
    DETACHMENT_CREWBOOSTER_HIGHLEVELEXPL = '#tooltips:detachment/crewBooster/highLevelExpl'
    DETACHMENT_CREWBOOSTER_ISSITUATIONAL = '#tooltips:detachment/crewBooster/isSituational'
    PRESENTATION_INSTRUCTION_SUBHEADER_TITLE = '#tooltips:presentation/instruction/subheader/title'
    PRESENTATION_INSTRUCTION_SUBHEADER_DESCRIPTION = '#tooltips:presentation/instruction/subheader/description'
    PRESENTATION_INSTRUCTION_SUBHEADER_TOTAL = '#tooltips:presentation/instruction/subheader/total'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_TITLE = '#tooltips:presentation/instruction/subheader/principle/title'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_DESCRIPTION = '#tooltips:presentation/instruction/subheader/principle/description'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM1 = '#tooltips:presentation/instruction/subheader/principle/item1'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM2 = '#tooltips:presentation/instruction/subheader/principle/item2'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM3 = '#tooltips:presentation/instruction/subheader/principle/item3'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM4 = '#tooltips:presentation/instruction/subheader/principle/item4'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM5 = '#tooltips:presentation/instruction/subheader/principle/item5'
    PRESENTATION_INSTRUCTION_SUBHEADER_PRINCIPLE_ITEM6 = '#tooltips:presentation/instruction/subheader/principle/item6'
    PRESENTATION_CREW_SUBHEADER_TITLE = '#tooltips:presentation/crew/subheader/title'
    PRESENTATION_CREW_SUBHEADER_DESCRIPTION = '#tooltips:presentation/crew/subheader/description'
    PRESENTATION_CREW_SUBHEADER_TOTAL = '#tooltips:presentation/crew/subheader/total'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_TITLE = '#tooltips:presentation/crew/subheader/convertation/title'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_ITEM1 = '#tooltips:presentation/crew/subheader/convertation/item1'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_ITEM2 = '#tooltips:presentation/crew/subheader/convertation/item2'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_ITEM3 = '#tooltips:presentation/crew/subheader/convertation/item3'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_ITEM4 = '#tooltips:presentation/crew/subheader/convertation/item4'
    PRESENTATION_CREW_SUBHEADER_CONVERTATION_ITEM5 = '#tooltips:presentation/crew/subheader/convertation/item5'
    DETACHMENT_NEWCOMMANDER_BUTTON_HEAD = '#tooltips:detachment/newCommander/button/head'
    DETACHMENT_NEWCOMMANDER_BUTTON_BODY = '#tooltips:detachment/newCommander/button/body'
    DETACHMENT_RECERTIFICATION_HEADER = '#tooltips:detachment/recertification/header'
    DETACHMENT_RECERTIFICATION_DESCRIPTION = '#tooltips:detachment/recertification/description'
    DETACHMENT_INSTRUCTORBONUSES_HEADER = '#tooltips:detachment/instructorBonuses/header'
    DETACHMENT_INSTRUCTORBONUSES_DESCRIPTIONBLOCK_1 = '#tooltips:detachment/instructorBonuses/descriptionBlock/1'
    DETACHMENT_INSTRUCTORBONUSES_DESCRIPTIONBLOCK_2 = '#tooltips:detachment/instructorBonuses/descriptionBlock/2'
    DETACHMENT_INSTRUCTORBONUSES_DESCRIPTIONBLOCK_3 = '#tooltips:detachment/instructorBonuses/descriptionBlock/3'
    DETACHMENT_INSTRUCTORBONUSES_COMMONBONUS = '#tooltips:detachment/instructorBonuses/commonBonus'
    DETACHMENT_INSTRUCTORBONUSES_EXTRABONUS = '#tooltips:detachment/instructorBonuses/extraBonus'
    DETACHMENT_INSTRUCTORBONUSES_COMMONBONUSWITHVALUE = '#tooltips:detachment/instructorBonuses/commonBonusWithValue'
    DETACHMENT_INSTRUCTORBONUSES_EXTRABONUSWITHVALUE = '#tooltips:detachment/instructorBonuses/extraBonusWithValue'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_HEADER_SINGLE = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/header/single'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_HEADER_DOUBLE = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/header/double'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_HEADER_FIRST = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/header/first'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_HEADER_SECOND = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/header/second'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_GIVEIFINRANGE = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/giveIfInRange'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_GIVEIFINRANGEMULT = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/giveIfInRangeMult'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_GIVEIFMORE = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/giveIfMore'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_COMMON_GIVEIFMOREMULT = '#tooltips:detachment/instructorBonuses/bonusesBlock/common/giveIfMoreMult'
    DETACHMENT_INSTRUCTORBONUSES_BONUSESBLOCK_EXTRA_HEADER = '#tooltips:detachment/instructorBonuses/bonusesBlock/extra/header'
    DETACHMENT_INSTRUCTORBONUSES_BONUSPOINTSDESCRIPTION_HEADER = '#tooltips:detachment/instructorBonuses/bonusPointsDescription/header'
    DETACHMENT_INSTRUCTORBONUSES_BONUSPOINTSDESCRIPTION_0 = '#tooltips:detachment/instructorBonuses/bonusPointsDescription/0'
    DETACHMENT_INSTRUCTORBONUSES_BONUSPOINTSDESCRIPTION_1 = '#tooltips:detachment/instructorBonuses/bonusPointsDescription/1'
    DETACHMENT_INSTRUCTORBONUSES_BONUSPOINTSDESCRIPTION_2 = '#tooltips:detachment/instructorBonuses/bonusPointsDescription/2'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_VALUE = '#tooltips:detachment/instructorBonuses/points/value'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_WITHOUTOVERCAP_2 = '#tooltips:detachment/instructorBonuses/points/withoutOvercap/2'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_WITHOUTOVERCAP_4 = '#tooltips:detachment/instructorBonuses/points/withoutOvercap/4'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_WITHOUTOVERCAP_5 = '#tooltips:detachment/instructorBonuses/points/withoutOvercap/5'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_WITHOUTOVERCAP_10 = '#tooltips:detachment/instructorBonuses/points/withoutOvercap/10'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_OVERCAP_1 = '#tooltips:detachment/instructorBonuses/points/overcap/1'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_OVERCAP_2 = '#tooltips:detachment/instructorBonuses/points/overcap/2'
    DETACHMENT_INSTRUCTORBONUSES_POINTS_OVERCAP_4 = '#tooltips:detachment/instructorBonuses/points/overcap/4'
    DISCOUNT_FIRSTOPERATIONONLY = '#tooltips:discount/firstOperationOnly'
    DISCOUNT_HEADER = '#tooltips:discount/header'
    DISCOUNT_CURRENT = '#tooltips:discount/current'
    DISCOUNT_OLD = '#tooltips:discount/old'
    DETACHMENT_DORMITORY_HEADER = '#tooltips:detachment/dormitory/header'
    DETACHMENT_DORMITORY_BODY = '#tooltips:detachment/dormitory/body'
    DETACHMENT_SKILLSBRANCH_TEXT = '#tooltips:detachment/skillsBranch/text'
    DETACHMENT_CONVERTBOOKS_TITLEBOOKS = '#tooltips:detachment/convertBooks/titleBooks'
    DETACHMENT_CONVERTBOOKS_DESCBOOKS = '#tooltips:detachment/convertBooks/descBooks'
    DETACHMENT_CONVERTBOOKS_SUBTITLEBOOKS = '#tooltips:detachment/convertBooks/subTitleBooks'
    DETACHMENT_CONVERTBOOKS_SUBDESCBOOKS = '#tooltips:detachment/convertBooks/subDescBooks'
    DETACHMENT_CONVERTBOOKS_TITLERECRUITS = '#tooltips:detachment/convertBooks/titleRecruits'
    DETACHMENT_CONVERTBOOKS_DESCRECRUITS = '#tooltips:detachment/convertBooks/descRecruits'
    DETACHMENT_CONVERTBOOKS_SUBTITLERECRUITS = '#tooltips:detachment/convertBooks/subTitleRecruits'
    DETACHMENT_CONVERTBOOKS_SUBDESCRECRUITS = '#tooltips:detachment/convertBooks/subDescRecruits'
    DETACHMENT_CONVERTBOOKS_TOTALCOUNT = '#tooltips:detachment/convertBooks/totalCount'
    DETACHMENT_DEMOBILIZE_CANTRESTORE_HEADER = '#tooltips:detachment/demobilize/cantRestore/header'
    DETACHMENT_DEMOBILIZE_CANTRESTORE_BODY = '#tooltips:detachment/demobilize/cantRestore/body'
    DETACHMENT_DEMOBILIZE_BUFFERISFULL_HEADER = '#tooltips:detachment/demobilize/bufferIsFull/header'
    DETACHMENT_DEMOBILIZE_BUFFERISFULL_BODY = '#tooltips:detachment/demobilize/bufferIsFull/body'
    DETACHMENT_LISTCATEGORY_GRADE1 = '#tooltips:detachment/listCategory/grade1'
    DETACHMENT_LISTCATEGORY_GRADE2 = '#tooltips:detachment/listCategory/grade2'
    DETACHMENT_LISTCATEGORY_GRADE3 = '#tooltips:detachment/listCategory/grade3'
    DETACHMENT_LISTCATEGORY_DESCRIPTION = '#tooltips:detachment/listCategory/description'
    DETACHMENT_PROGRESSION_OVERFLOWEXP_TITLE = '#tooltips:detachment/progression/overflowExp/title'
    DETACHMENT_PROGRESSION_OVERFLOWEXP_MESSAGE = '#tooltips:detachment/progression/overflowExp/message'
    DETACHMENT_PROGRESSION_OVERFLOWEXP_USEDEXP = '#tooltips:detachment/progression/overflowExp/usedExp'
    DETACHMENT_PROGRESSION_OVERFLOWEXP_LOSTEXP = '#tooltips:detachment/progression/overflowExp/lostExp'
    DETACHMENT_CONFIRMEXPOVERFLOW_APPLYHINT = '#tooltips:detachment/confirmExpOverflow/applyHint'
    ...
    TANK_PARAMS_DESC_ENUM = (TANK_PARAMS_DESC_MAXHEALTH,
     ...
     TANK_PARAMS_DESC_RELATIVESITUATIONALBONUSES,
     TANK_PARAMS_DESC_RELATIVETANKCONTROLLEVEL,
    ...
    AWARDITEM_ALL_HEADER_ENUM = (AWARDITEM_GROUPS_HEADER,
     ...
     AWARDITEM_RANKED_202103_ACCESS_HEADER,
    ...
    AWARDITEM_ALL_BODY_ENUM = (AWARDITEM_GROUPS_BODY,
     ...
     AWARDITEM_RANKED_202103_ACCESS_BODY,
    ...
    SKILLS_ALL_HEADER_ENUM = (SKILLS_CAMOUFLAGE_HEADER,
     ...
     SKILLS_COMMANDER_SIXTHSENSE_HEADER,
    ...
    SKILLS_ALL_DESCR_ENUM = (SKILLS_CAMOUFLAGE_DESCR,
     ...
     SKILLS_COMMANDER_SIXTHSENSE_DESCR,
    ...
    ADVANCED_ENUM = (ADVANCED_INFO,
     ...
     ADVANCED_RELATIVETANKCONTROLLEVEL,
     ADVANCED_EQUIPMENT,
     ...
     ADVANCED_DORMITORIES,
     ADVANCED_RECERTIFICATION,
     ADVANCED_CREWBOOKS,
    ...
    HEADER_BUTTONS_ALL_FIRSTDESC_ENUM = (HEADER_BUTTONS_CREDITS_FIRSTDESC, HEADER_BUTTONS_FREEXP_FIRSTDESC)
    HEADER_BUTTONS_ALL_TITLE_ENUM = (HEADER_BUTTONS_CRYSTAL_TITLE,
     ...
     HEADER_BUTTONS_BARRACKSEVENT_TITLE)
