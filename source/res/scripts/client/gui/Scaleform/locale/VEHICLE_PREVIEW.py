...
class VEHICLE_PREVIEW(object):
    ...
    HEADER_BACKBTN_DESCRLABEL_BLACKMARKETITEMOPENSCREEN = '#vehicle_preview:header/backBtn/descrLabel/blackMarketItemOpenScreen'
    HEADER_BACKBTN_DESCRLABEL_BLACKMARKETVEHICLELISTSCREEN = '#vehicle_preview:header/backBtn/descrLabel/blackMarketVehicleListScreen'
    ...
    HEADER_BACKBTN_DESCRLABEL_ENUM = (HEADER_BACKBTN_DESCRLABEL_RESEARCHTREE,
     ...
     HEADER_BACKBTN_DESCRLABEL_BLACKMARKETITEMOPENSCREEN,
     HEADER_BACKBTN_DESCRLABEL_BLACKMARKETVEHICLELISTSCREEN,
