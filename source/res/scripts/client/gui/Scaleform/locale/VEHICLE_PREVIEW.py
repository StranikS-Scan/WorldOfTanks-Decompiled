...
class VEHICLE_PREVIEW(object):
    ...
    HEADER_BACKBTN_DESCRLABEL_SPRINGMARATHON = '#vehicle_preview:header/backBtn/descrLabel/springMarathon'
    HEADER_BACKBTN_DESCRLABEL_BOB = '#vehicle_preview:header/backBtn/descrLabel/bob'
    ...
    HEADER_BACKBTN_DESCRLABEL_ENUM = (HEADER_BACKBTN_DESCRLABEL_RESEARCHTREE,
     ...
     HEADER_BACKBTN_DESCRLABEL_SPRINGMARATHON,
     HEADER_BACKBTN_DESCRLABEL_BOB)
