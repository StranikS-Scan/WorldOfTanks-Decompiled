...
class FadeManager(CallbackDelayer, TimeDeltaMeter):
    ...
    def __init__(self, fadeDuration=None):
        ...
        self.__fadeDuration = fadeDuration or self.FADE_TIME
        return
    ...
    def destroy(self):
        ...
        if self.__fadeWindow is not None:
    ...
    def __inFadeUpdate(self):
        self.__fadeInTime += min(self.measureDeltaTime(), self.MAX_DT) / self.__fadeDuration
