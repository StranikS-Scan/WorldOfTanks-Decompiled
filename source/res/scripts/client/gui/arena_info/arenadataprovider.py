# Embedded file name: scripts/client/gui/arena_info/ArenaDataProvider.py
from collections import defaultdict
from constants import ARENA_GUI_TYPE
from debug_utils import LOG_NOTE, LOG_WARNING, LOG_DEBUG
from gui.arena_info import getPlayerVehicleID, getPlayerTeam, getPlayerName
from gui.arena_info.arena_vos import VehicleArenaInfoVO
from gui.arena_info.arena_vos import VehicleArenaStatsDict, VehicleArenaStatsVO
from gui.arena_info.settings import SQUAD_RANGE_TO_SHOW, TEAM_RANGE, invertTeam
...
class ArenaDataProvider(object):
    ...
    def __init__(self):
        ...
        self.__playerVehicleID = getPlayerVehicleID()
        self.__vInfoVOs = {}
