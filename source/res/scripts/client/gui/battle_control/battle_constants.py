...
class VEHICLE_VIEW_STATE(object):
    ...
    FIRE_WITH_MESSAGE = 35184372088832L
    LOSE_SOULS_IN_AURA = 70368744177664L
    CAN_BE_DAMAGED = 140737488355328L
    COLLECTOR_STATUS = 281474976710656L
...
MARKER_HIT_STATE = {FEEDBACK_EVENT_ID.VEHICLE_HIT: ('hit', 'hit_blocked', R.strings.ingame_gui.hitMarker.blocked()),
 ...
 FEEDBACK_EVENT_ID.VEHICLE_INVULNERABLE: ('hit_invulnerable', 'hit_blocked', R.strings.ingame_gui.hitMarker.boss())}
...
class SoulCollectorDestroyTimerState(IntEnum):
    NO_TIMER = 0
    COLLECTOR_PROGRESS = 1
    WAIT_ALLIES = 2
    ALARM_TIMER = 3
