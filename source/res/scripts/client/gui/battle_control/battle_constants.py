...
class VEHICLE_VIEW_STATE(object):
    ...
    CAN_BE_DAMAGED = 4722366482869645213696L
    ABILITY = 4722366482869645213696L
    THERMAL_VISION_WARNING = 9444732965739290427392L
    HB_LAST_STAND = 18889465931478580854784L
    HB_ARTILLERY_ON_YOURSELF = 37778931862957161709568L
