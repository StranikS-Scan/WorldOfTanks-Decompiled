...
class VEHICLE_VIEW_STATE(object):
    ...
    FIRE_WITH_MESSAGE = 4398046511104L
    LOSE_SOULS_IN_AURA = 8796093022208L
    CAN_BE_DAMAGED = 17592186044416L
    COLLECTOR_STATUS = 35184372088832L
...
MARKER_HIT_STATE = {FEEDBACK_EVENT_ID.VEHICLE_HIT: ('hit', 'hit_blocked', '#ingame_gui:hitMarker/blocked'),
 ...
 FEEDBACK_EVENT_ID.VEHICLE_INVULNERABLE: ('hit_invulnerable', 'hit_blocked', '#ingame_gui:hitMarker/boss')}
