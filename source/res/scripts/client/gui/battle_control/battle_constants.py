...
RTS_HIT_INDICATOR_MAX_PER_VEHICLE = 5
...
class VehicleConditions(object):
    NO_CONDITION = 'NoCondition'
    ON_FIRE_CONDITION = 'OnFireCondition'
    DROWNING_CONDITION = 'DrowningCondition'
    OVERTURNED_CONDITION = 'OverturnedCondition'
    NO_SHOT_CONDITION = 'NoShotCondition'
    NO_MOVE_CONDITION = 'NoMoveCondition'
    SPOTTED_CONDITION = 'OnSpottedCondition'
    SOS_CONDITION = 'OnSOSCondition'
    DEAD_CONDITION = 'OnDeadCondition'
    SOS_HEALTH_THRESHOLD = 0.5
    ALL_CONDITIONS = [NO_CONDITION,
     ON_FIRE_CONDITION,
     DROWNING_CONDITION,
     OVERTURNED_CONDITION,
     NO_SHOT_CONDITION,
     NO_MOVE_CONDITION,
     SPOTTED_CONDITION,
     SOS_CONDITION,
     DEAD_CONDITION]
    STICKY_CONDITIONS = [DEAD_CONDITION, SOS_CONDITION]
    CONDITIONS_PRIORITIES = {DEAD_CONDITION: 0,
     OVERTURNED_CONDITION: 1,
     DROWNING_CONDITION: 2,
     NO_MOVE_CONDITION: 3,
     NO_SHOT_CONDITION: 4,
     ON_FIRE_CONDITION: 5,
     SOS_CONDITION: 6,
