...
class VEHICLE_VIEW_STATE(object):
    ...
    HW_VEHICLE_FROZEN_ARROW = 4722366482869645213696L
    HW_VEHICLE_HEALING_ARROW = 9444732965739290427392L
    HW_VEHICLE_LAUGH_ARROW = 18889465931478580854784L
    HW_VEHICLE_FROZEN_MANTLE = 37778931862957161709568L
