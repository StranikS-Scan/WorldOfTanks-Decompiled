...
MARKER_ARMOR_SCREEN_HIT_STATE = {FEEDBACK_EVENT_ID.VEHICLE_ARMOR_SCREEN_BLOCKED: ('hit', 'hit_spaced_armor_blocked', R.strings.ingame_gui.hitMarker.spacedArmorBlocked()),
