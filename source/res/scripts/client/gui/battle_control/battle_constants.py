...
class VEHICLE_VIEW_STATE(object):
    ...
    PORTAL_ANOMALY = 18889465931478580854784L
    PORTAL_TELEPORT = 37778931862957161709568L
    PORTAL_RATTE_AURA = 75557863725914323419136L
