...
class BATTLE_CTRL_ID(object):
    AMMO, EQUIPMENTS, OPTIONAL_DEVICES, OBSERVED_VEHICLE_STATE, ARENA_LOAD_PROGRESS, ARENA_PERIOD, TEAM_BASES, DEBUG, HIT_DIRECTION, FEEDBACK, CHAT_COMMANDS, MESSAGES, DRR_SCALE, RESPAWN, REPAIR, DYN_SQUADS, AVATAR_PRIVATE_STATS, FLAG_NOTS, CROSSHAIR, MOD, GUI, PERSONAL_EFFICIENCY, VIEW_POINTS, BATTLE_FIELD_CTRL, PLAYER_GAME_MODE_DATA, TEAM_HEALTH_BAR, ARENA_BORDER, PROGRESS_TIMER, MAPS, SPECTATOR, GAME_NOTIFICATIONS, EPIC_MISSIONS, GAME_MESSAGES_PANEL, QUEST_PROGRESS, ANONYMIZER_FAKES, GAME_RESTRICTIONS_MESSAGES, BATTLE_HINTS, DOG_TAGS, CALLOUT, PROGRESSION_CTRL, RADAR_CTRL, SPAWN_CTRL, DEATH_SCREEN_CTRL, VEHICLES_COUNT_CTRL, AREA_MARKER, DEATHZONES, APPEARANCE_CACHE_CTRL, BATTLE_NOTIFIER, PREBATTLE_SETUPS_CTRL, SOUND_PLAYERS_CTRL, POINTS_OF_INTEREST_CTRL, COMP7_PREBATTLE_SETUP_CTRL, COMP7_VOIP_CTRL, INGAME_HELP_CTRL = range(1, 55)
