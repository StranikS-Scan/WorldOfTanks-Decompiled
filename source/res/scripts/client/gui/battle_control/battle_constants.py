...
UNDEFINED_VEHICLE_ID = NULL_ENTITY_ID
WEEKEND_BRAWL_EQUIPMENT_TAG = 'weekend_brawl'
...
class VEHICLE_VIEW_STATE(object):
    ...
    POINT_OF_INTEREST = 8796093022208L
