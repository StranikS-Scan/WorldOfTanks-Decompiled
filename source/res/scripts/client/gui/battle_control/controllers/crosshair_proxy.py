...
_CTRL_MODE_TO_VIEW_ID = {_CTRL_MODE.ARCADE: CROSSHAIR_VIEW_ID.ARCADE,
 ...
 _CTRL_MODE.ASSAULT_SPG: CROSSHAIR_VIEW_ID.ASSAULT}
_GUN_MARKERS_SET_IDS = (_BINDING_ID.GUN_MARKERS_FLAGS,
 ...
 _BINDING_ID.CLIENT_ASSAULT_SPG_GUN_MARKER_DATA_PROVIDER,
 _BINDING_ID.SERVER_ASSAULT_SPG_GUN_MARKER_DATA_PROVIDER,
...
class GunMarkersSetInfo(object):
    ...
    clientAssaultSPGMarkerDataProvider = aih_global_binding.bindRO(_BINDING_ID.CLIENT_ASSAULT_SPG_GUN_MARKER_DATA_PROVIDER)
    ...
    serverAssaultSPGMarkerDataProvider = aih_global_binding.bindRO(_BINDING_ID.SERVER_ASSAULT_SPG_GUN_MARKER_DATA_PROVIDER)
...
class CrosshairDataProxy(IBattleController):
    ...
    def __init__(self):
        ...
        self.onAssaultCameraStateChanged = Event.Event(self.__eManager)
    ...
    def startControl(self, *args):
        ...
        aih_global_binding.subscribe(_BINDING_ID.ASSAULT_SPG_CAMERA_STATE, self.__onAssaultCameraStateChanged)
    ...
    def stopControl(self):
        ...
        aih_global_binding.unsubscribe(_BINDING_ID.ASSAULT_SPG_CAMERA_STATE, self.__onAssaultCameraStateChanged)
        for bindingID in _GUN_MARKERS_SET_IDS:
    ...
    def __onAssaultCameraStateChanged(self, cameraState):
        self.onAssaultCameraStateChanged(cameraState)
