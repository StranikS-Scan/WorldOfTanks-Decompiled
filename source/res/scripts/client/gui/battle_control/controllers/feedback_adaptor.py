...
class BattleFeedbackAdaptor(IBattleController):
    ...
    def __init__(self, setup):
        ...
        self.onOvertime = Event.Event(self.__eManager)
        self.onGeneratorLocked = Event.Event(self.__eManager)
