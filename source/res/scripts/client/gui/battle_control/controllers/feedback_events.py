...
class _DamageExtra(object):
    __slots__ = ('__damage', '__attackReasonID', '__isBurst', '__shellType', '__isShellGold', '__secondaryAttackReasonID', '__isRoleAction', '__isAutoShoot', '__attackReasonExtID', '__attackerMechanicShotMode')
...
class _CritsExtra(object):
    __slots__ = ('__critsCount', '__shellType', '__isShellGold', '__attackReasonID', '__secondaryAttackReasonID', '__isAutoShoot', '__attackReasonExtID', '__attackerMechanicShotMode')
