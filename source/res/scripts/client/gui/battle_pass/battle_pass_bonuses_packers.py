...
class BattlePassStyleProgressTokenBonusPacker(_BattlePassFinalBonusPacker):
    ...
    @classmethod
    def _getContentId(cls, bonus):
        return [R.views.mono.battle_pass.tooltips.upgrade_style()]
...
class ExtendedCurrenciesBonusUIPacker(BaseBonusUIPacker):
    ...
    def _getContentId(cls, bonus):
        code = bonus.getCode()
        return [R.views.mono.battle_pass.tooltips.bptaler()] if code == CurrencyBP.TALER.value else super(ExtendedCurrenciesBonusUIPacker, cls)._getContentId(bonus)
...
class QuestChainBonusPacker(SimpleBonusUIPacker):
    ...
    @classmethod
    def _getContentId(cls, bonus):
        return [R.views.mono.battle_pass.tooltips.quest_chain()]
...
class RandomQuestBonusPacker(SimpleBonusUIPacker):
    ...
    @classmethod
    def _getContentId(cls, bonus):
        return [R.views.mono.battle_pass.tooltips.random_quest()]
...
class BattlePassVehiclesBonusUIPacker(VehiclesBonusUIPacker):
    ...
    def _packTooltip(cls, bonus, vehicle, vehInfo):
        ...
        return first(cls.__packCompensationTooltip(first(compensation), vehicle, vehInfo)) if compensation else super(BattlePassVehiclesBonusUIPacker, cls)._packTooltip(bonus, vehicle, vehInfo)
