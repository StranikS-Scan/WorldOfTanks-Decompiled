...
class BattlePassSounds(CONST_CONTAINER):
    ...
    VIDEO_BEFORE_VOTING = 'bp_video_final_level_progression_start'
    VIDEO_OPT1_FREE = 'bp_video_not_purchased_tank_01_start'
    VIDEO_OPT2_FREE = 'bp_video_not_purchased_tank_02_start'
    VIDEO_OPT1_PAID = 'bp_video_purchased_character_01_start'
    VIDEO_OPT2_PAID = 'bp_video_purchased_character_02_start'
