...
def getBattleType(reusable):
    ...
    if _isDevBattle(reusable):
        return R.strings.menu.loading.battleTypes.dev()
    if arenaBonusType == ARENA_BONUS_TYPE.GLOBAL_MAP:
        return R.strings.menu.loading.battleTypes.globalMap()
