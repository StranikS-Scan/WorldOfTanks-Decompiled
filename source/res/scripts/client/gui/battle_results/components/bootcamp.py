...
class VideoButtonItem(base.StatsItem):
    ...
    def _convert(self, record, reusable):
        ...
        return None if player.spaFlags.getFlag(SPA_ATTRS.BOOTCAMP_VIDEO_DISABLED) or teamResult != PlayerTeamResult.WIN or not messageVO else {'label': backport.text(R.strings.bootcamp.battle.result.videoButton()),
