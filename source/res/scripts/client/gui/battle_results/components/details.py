...
class MoneyDetailsBlock(_EconomicsDetailsBlock):
    ...
    def __addEventsMoney(self, baseCredits, premiumCredits, goldRecords):
        baseEventCredits = baseCredits.findRecord('eventCreditsList_') + baseCredits.findRecord('eventCreditsFactor1000List_')
        premiumEventCredits = premiumCredits.findRecord('eventCreditsList_') + premiumCredits.findRecord('eventCreditsFactor1000List_')
...
class CrystalDetailsBlock(_EconomicsDetailsBlock):
    ...
    def setRecord(self, result, reusable):
        ...
        if crystalAchive > 0:
            self._addRecord(backport.text(R.strings.battle_results.details.calculations.crystal.achievement()), crystalAchive)
