...
def _getTeamStatsOther():
    return TeamStatsOther(explosionHitsReceived=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='explosionHitsReceived', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='explosionHitsReceived'), damageBlockedByArmor=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageBlockedByArmor', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='damageBlockedByArmor'), damageToAllies=TeamStatsMultiValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageToAllies', valueType=PlayerDetailsModel.INT_ARRAY, model=StatsTwoValuesItem, valueIDs=('tkills', 'tdamageDealt')), spotted=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='spotted', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='spotted'), damageToEnemies=TeamStatsMultiValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageToEnemies', valueType=PlayerDetailsModel.INT_ARRAY, model=StatsTwoValuesItem, valueIDs=('damaged', 'kills')), damageAssisted=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageAssisted', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='damageAssisted'), damageAssistedSelf=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageAssistedSelf', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='damageAssisted'), stunDuration=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='stunDuration', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='stunDuration'), damageAssistedStun=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageAssistedStun', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='damageAssistedStun'), damageAssistedStunSelf=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='damageAssistedStunSelf', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='damageAssistedStun'), stunNum=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='stunNum', valueType=PlayerDetailsModel.INTEGER, model=StatsOneValueItem, valueID='stunNum'), baseCapture=TeamStatsMultiValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='baseCapture', valueType=PlayerDetailsModel.INT_ARRAY, model=StatsTwoValuesItem, valueIDs=('capturePoints', 'droppedCapturePoints')), mileage=TeamStatsOneValueField(blockIdx=_TeamStatsBlockIndexes.OTHER, stringID='mileage', valueType=PlayerDetailsModel.MILEAGE, model=StatsOneValueItem, valueID='mileage'))


def _getTeamStatsTime():
    return TeamStatsTime(arenaCreateTime=TeamStatsArenaCreateTimeField(blockIdx=_TeamStatsBlockIndexes.TIME, stringID='arenaCreateTime', valueType=PlayerDetailsModel.LOCAL_TIME, model=StatsOneValueItem), battleDuration=TeamStatsBattleDurationField(blockIdx=_TeamStatsBlockIndexes.TIME, stringID='duration', valueType=PlayerDetailsModel.BATTLE_DURATION, model=StatsOneValueItem), playerLifetime=TeamStatsLifetimeField(blockIdx=_TeamStatsBlockIndexes.TIME, stringID='lifetime', valueType=PlayerDetailsModel.LIFETIME, model=StatsOneValueItem))
