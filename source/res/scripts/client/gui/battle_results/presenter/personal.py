...
from gui.battle_results.presenter.common import getTotalXPToShow, getTotalCreditsToShow, getXpRecords, getCreditsRecords, getCrystalsRecords, setPremiumBonuses
...
def _setGeneralInfoData(model, reusable, result, itemsCache=None):
    ...
    if reusable.common.finishReason != FINISH_REASON.TECHNICAL:
