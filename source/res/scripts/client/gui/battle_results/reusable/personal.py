...
class PersonalInfo(shared.UnpackedInfo):
    __slots__ = ('__avatar', '__vehicles', '__lifeTimeInfo', '__isObserver', '_economicsRecords', '__rankInfo', '__isTeamKiller', '__premiumMask', '__isAddXPBonusApplied', '__c11nProgress', '__dogTags')
    itemsCache = dependency.descriptor(IItemsCache)
