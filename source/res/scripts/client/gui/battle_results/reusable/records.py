...
class ReplayRecords(ResultRecord):
    __slots__ = ('_records',)
    __NEW_YEAR_MAP = {'eventFreeXPList_ny20battle##xp_freeXP': 'newYearFreeXp',
     'eventFreeXPFactor100List_ny20battle##xp_freeXP': 'newYearFreeXpFactor',
     'eventXPList_ny20battle##xp_freeXP': 'newYearXp',
     'eventXPFactor100List_ny20battle##xp_freeXP': 'newYearXpFactor',
     'eventCreditsList_ny20battle##credits_gold': 'newYearCredits',
     'eventCreditsFactor1000List_ny20battle##credits_gold': 'newYearCreditsFactor'}
