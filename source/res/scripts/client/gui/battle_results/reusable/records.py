...
class ReplayRecords(ResultRecord):
    __slots__ = ('_records',)
    __NEW_YEAR_MAP = {'eventFreeXPList_ny25battle##xp_freeXP': 'newYearFreeXp',
     'eventFreeXPFactor100List_ny25battle##xp_freeXP': 'newYearFreeXpFactor',
     'eventXPList_ny25battle##xp_freeXP': 'newYearXp',
     'eventXPFactor100List_ny25battle##xp_freeXP': 'newYearXpFactor',
     'eventCreditsList_ny25battle##credits_gold': 'newYearCredits',
     'eventCreditsFactor1000List_ny25battle##credits_gold': 'newYearCreditsFactor'}
