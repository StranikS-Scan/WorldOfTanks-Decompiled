...
class ReplayRecords(ResultRecord):
    __slots__ = ('_records',)
    __NEW_YEAR_MAP = {'eventFreeXPList_ny_battle##xp_freeXP': 'newYearFreeXp',
     'eventFreeXPFactor100List_ny_battle##xp_freeXP': 'newYearFreeXpFactor',
     'eventXPList_ny_battle##xp_freeXP': 'newYearXp',
     'eventXPFactor1000List_ny_battle##xp_freeXP': 'newYearXpFactor',
     'eventCreditsList_ny_battle##credits_gold': 'newYearCredits',
     'eventCreditsFactor1000List_ny_battle##credits_gold': 'newYearCreditsFactor'}
