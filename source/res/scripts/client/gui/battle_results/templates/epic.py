...
EPIC_PERSONAL_STATS_BLOCK = regular.REGULAR_PERSONAL_STATS_BLOCK.clone(15)
EPIC_PERSONAL_STATS_BLOCK.addComponent(15, vehicles.PersonalVehiclesEpicStatsBlock(base.ListMeta(), 'statValues', _RECORD.PERSONAL))
