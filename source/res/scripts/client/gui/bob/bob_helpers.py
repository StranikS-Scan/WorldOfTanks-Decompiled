...
# Embedded file name: scripts/client/gui/bob/bob_helpers.py
from gui.bob.bob_constants import BOB_TOKENS_DELIMITER, BOB_TEAM_ID_POS
...
def getSkillTimeLeft(timeValue):
    return backport.backport_time_utils.getTillTimeStringByRClass(timeValue=timeValue, stringRClass=R.strings.bob.skill.timeLeft, removeLeadingZeros=True)
