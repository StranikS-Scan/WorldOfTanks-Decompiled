...
class Club(object):
    ...
    def getMember(self, memberDbID=None):
        ...
        return self.__makeMemberItem(memberDbID, self._clubDescr.members[memberDbID]) if self.hasMember(memberDbID) else None
    ...
    def getPermissions(self, memberDbID=None):
        ...
        return MemberPermissions(self._clubDescr.members[memberDbID]) if self.hasMember(memberDbID) else DefaultMemberPermissions()
