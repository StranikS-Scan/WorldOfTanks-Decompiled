...
SEASON_NAME_TO_TYPE = {SEASONS_CONSTANTS.SUMMER: SeasonType.SUMMER,
 SEASONS_CONSTANTS.WINTER: SeasonType.WINTER,
...
SEASON_TYPE_TO_NAME = {SeasonType.ALL: SEASONS_CONSTANTS.ALL,
 SeasonType.SUMMER: SEASONS_CONSTANTS.SUMMER,
...
SEASONS_BIN_VIEW_ORDER = (SeasonType.ALL,
 SeasonType.SUMMER,
 SeasonType.WINTER,
 SeasonType.DESERT)
