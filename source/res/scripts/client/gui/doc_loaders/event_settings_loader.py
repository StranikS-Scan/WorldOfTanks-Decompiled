...
_EventSettings = namedtuple('_EventSettings', ('vehicleCharacteristics', 'portals', 'hunterCollection', 'bossCollection'))
...
def _readEventSettings():
    ...
    result = _EventSettings(_readVehicleCharacteristics(section['vehicleCharacteristics']), _readPortals(section['portals']), _readCollection(section['hunterCollection']), _readCollection(section['bossCollection']))
