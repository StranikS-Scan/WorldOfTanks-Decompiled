...
_EventSettings = namedtuple('_EventSettings', ('vehicleCharacteristics', 'portals'))
...
def _readEventSettings():
    ...
    result = _EventSettings(_readVehicleCharacteristics(section['vehicleCharacteristics']), _readPortals(section['portals']))
