...
from gui.bob.bob_announcement_helpers import BeforeEventStartAnnouncement, PausedAnnouncement, RegistrationAfterEventStartAnnouncement, EventFinishAnnouncement, AvailablePrimeTimeAnnouncement, NotAvailablePrimeTimeAnnouncement
...
class BobAnnouncementController(IBobAnnouncementController, IGlobalListener):
    ...
    def __start(self):
        if self.__bootcampController.isInBootcamp():
            return
        self.__announcements = [BeforeEventStartAnnouncement(),
         PausedAnnouncement(),
