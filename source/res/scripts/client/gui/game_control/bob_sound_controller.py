...
_BOB_HANGAR_PREVIEW_GROUP = 'STATE_overlay_hangar_general'
_BOB_HANGAR_PREVIEW_ENTER = 'STATE_overlay_hangar_general_on'
_BOB_HANGAR_PREVIEW_EXIT = 'STATE_overlay_hangar_general_off'
...
class BobSoundController(IBobSoundController, IGlobalListener):
    ...
    def onStylePreviewOpen(self):
        ...
        WWISE.WW_setState(_BOB_HANGAR_PREVIEW_GROUP, _BOB_HANGAR_PREVIEW_ENTER)
        self.__playSound()

    def onStylePreviewClose(self):
        self.__isInPreview = False
        WWISE.WW_setState(_BOB_HANGAR_PREVIEW_GROUP, _BOB_HANGAR_PREVIEW_EXIT)
        self.__playSound()
