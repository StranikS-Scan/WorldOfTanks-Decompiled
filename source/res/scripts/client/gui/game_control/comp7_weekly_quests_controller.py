...
# Embedded file name: scripts/client/gui/game_control/comp7_weekly_quests_controller.py
import logging
from functools import partial
import typing
from Event import Event, EventManager
from PlayerEvents import g_playerEvents
from comp7_common import Comp7QuestType, offerWeeklyQuestsRewardGiftTokenBySeasonNumber, offerWeeklyQuestsRewardTokenBySeasonNumber
from gui.impl.gen.view_models.views.lobby.missions.widget.comp7_daily_quest_model import State
from gui.impl.lobby.comp7.comp7_quest_helpers import Comp7ParsedQuestID
