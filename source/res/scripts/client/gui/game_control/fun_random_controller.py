...
# Embedded file name: scripts/client/gui/game_control/fun_random_controller.py
import typing
import logging
import adisp
...
from gui.fun_random.fun_random_models import FunRandomAlertData, FunRandomSeason
from gui.battle_modifiers.modifiers_data_provider import ModifiersDataProvider
from gui.prb_control.entities.base.ctx import PrbAction
from gui.prb_control.entities.listener import IGlobalListener
from gui.prb_control.items import ValidationResult
from gui.prb_control.settings import FUNCTIONAL_FLAG, SELECTOR_BATTLE_TYPES, PRE_QUEUE_RESTRICTION, PREBATTLE_ACTION_NAME, UNIT_RESTRICTION
...
class FunRandomController(IFunRandomController, Notifiable, SeasonProvider, IGlobalListener):
    ...
    def selectFunRandomBattle(self):
        ...
        if dispatcher is None:
            ...
            yield dispatcher.doSelectAction(PrbAction(PREBATTLE_ACTION_NAME.FUN_RANDOM))
            return
    ...
    def __rememberGameMode(self):
        ...
        if currentCycleID is not None and currentCycleID != rememberedCycleID:
            ...
            SelectorBattleTypesUtils.setBattleTypeAsUnknown(SELECTOR_BATTLE_TYPES.FUN_RANDOM)
        return
