...
from gui.hangar_presets.hangar_presets_getters import DefaultPresetsGetter, Comp7PresetsGetter, MapboxPresetsGetter, BobPresetsGetter
...
registerHangarPresetGetter(QUEUE_TYPE.BOB, BobPresetsGetter)
