...
from gui.hangar_presets.hangar_presets_getters import DefaultPresetsGetter, Comp7PresetsGetter, MapboxPresetsGetter, SpecBattlePresetsGetter, WgshPresetsGetter
...
registerHangarPresetGetter(QUEUE_TYPE.STRONGHOLD_UNITS, WgshPresetsGetter)
