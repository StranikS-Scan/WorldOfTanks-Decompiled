...
from gui.server_events.awards_formatters import getPackRentVehiclesAwardPacker, getPostBattleAwardsPacker
...
STYLES_TAGS = ['NY2019_style', 'NY2020_style']
VIDEO_TAGS = ['NY2019_video', 'NY2020_video']
...
class LootNewYearToyPresenter(LootRewardDefModelPresenter):
    ...
    def _formatModel(self, model, ttId, showCongrats):
        ...
        model.setRankImage(toyInfo.getRankIcon())
...
class LootVideoWithCongratsRewardPresenter(LootRewardDefModelPresenter):
        ...
        if specialArgs:
            if self.__congratsType == LootCongratsTypes.CONGRAT_TYPE_STYLE:
                ...
                if _isSpecialStyle(styleIntCD):
                    ...
                    self.__congratsData['showCongrats'] = True
                else:
                ...
                self.__congratsData['vehicleName'] = recruitInfo.getFullUserName()
    ...
    def _formatModel(self, model, ttId, showCongrats):
        super(LootVideoWithCongratsRewardPresenter, self)._formatModel(model, ttId, showCongrats)
        with model.transaction() as m:
            ...
            m.congratsViewModel.setShowCongrats(self.__congratsData.get('showCongrats', False))
