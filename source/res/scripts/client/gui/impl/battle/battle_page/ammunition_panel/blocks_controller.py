...
class PrebattleShellsBlock(ShellsBlock):
    ...
    def _getKeySettings(self):
        ...
        return ('CMD_AMMO_CHOICE_7', 'CMD_AMMO_CHOICE_8', 'CMD_AMMO_CHOICE_9') if arena is not None and arena.guiType == constants.ARENA_GUI_TYPE.HALLOWEEN_BATTLES else super(PrebattleShellsBlock, self)._getKeySettings()
