...
class BaseBlock(object):
    ...
    def _createSlots(self):
        array = Array()
        rangeIter = range(len(self._getInstalled()))
...
class OptDeviceBlock(BaseBlock):
    ...
    def __init__(self, vehicle, currentSection, ctx=None):
        ...
        self.__isSpecializationClickable = ctx.get('specializationClickable', False) if ctx else False
    ...
    def _updateSpecializations(self, slotModel, slotItem, idx):
        ...
        isSpecializationClickable = isDynamic and optDeviceItem.categories and self.__isSpecializationClickable
