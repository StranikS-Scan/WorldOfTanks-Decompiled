    ...
    class _lobby(DynAccessor):
        ...
        class _tooltips(DynAccessor):
            ...
            class _clans(DynAccessor):
                __slots__ = ()
                ClanShortInfoTooltipContent = DynAccessor(54)
