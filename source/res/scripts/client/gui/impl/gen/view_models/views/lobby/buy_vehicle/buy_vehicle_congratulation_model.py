...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/buy_vehicle/buy_vehicle_congratulation_model.py
from gui.impl.gen import R
from frameworks.wulf import ViewModel

class BuyVehicleCongratulationModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=12, commands=0):
        super(BuyVehicleCongratulationModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(BuyVehicleCongratulationModel, self)._initialize()
