...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/crew/tankman_skin_data_card_model.py
...
class TankmanSkinDataCardModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=9, commands=0):
        super(TankmanSkinDataCardModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(TankmanSkinDataCardModel, self)._initialize()
