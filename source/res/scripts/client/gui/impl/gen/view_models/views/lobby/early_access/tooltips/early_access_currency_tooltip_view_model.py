...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/early_access/tooltips/early_access_currency_tooltip_view_model.py
from frameworks.wulf import ViewModel

class EarlyAccessCurrencyTooltipViewModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=5, commands=0):
        super(EarlyAccessCurrencyTooltipViewModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(EarlyAccessCurrencyTooltipViewModel, self)._initialize()
