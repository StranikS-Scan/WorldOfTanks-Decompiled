...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/missions/widget/comp7_daily_quest_model.py
...
class Comp7DailyQuestModel(WidgetQuestModel):
    __slots__ = ('onClick', 'onViewLoaded')

    def __init__(self, properties=11, commands=2):
        super(Comp7DailyQuestModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(Comp7DailyQuestModel, self)._initialize()
