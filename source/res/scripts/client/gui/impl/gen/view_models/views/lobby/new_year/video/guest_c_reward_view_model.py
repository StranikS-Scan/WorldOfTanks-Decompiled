...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/new_year/video/guest_c_reward_view_model.py
from frameworks.wulf import ViewModel

class GuestCRewardViewModel(ViewModel):
    __slots__ = ('onContinue', 'onGoQuests', 'onClose', 'onVideoStarted', 'onVideoStopped')

    def __init__(self, properties=3, commands=5):
        super(GuestCRewardViewModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(GuestCRewardViewModel, self)._initialize()
