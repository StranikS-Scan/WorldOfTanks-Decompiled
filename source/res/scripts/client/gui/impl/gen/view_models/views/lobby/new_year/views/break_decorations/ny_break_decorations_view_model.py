...
class NyBreakDecorationsViewModel(ViewModel):
    __slots__ = ('onSelectedAllChanged', 'onSlotStatusIsNewChanged', 'onBreakDecorationsBtnClick', 'onBreakAnimationComplete', 'onQuestsBtnClick', 'onCelebrityBtnClick', 'onDecorationClicked')
