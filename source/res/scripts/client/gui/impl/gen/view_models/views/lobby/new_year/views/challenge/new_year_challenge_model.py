...
class NewYearChallengeModel(ViewModel):
    __slots__ = ('onLeaveIntroScreen', 'onOpenIntroScreen', 'onChangeAllQuestsVisibility', 'onExit', 'onUpdateTimeTill', 'onSimplify', 'onVisited', 'onSimplificationAnimationEnd', 'onCompletedAnimationShown')
