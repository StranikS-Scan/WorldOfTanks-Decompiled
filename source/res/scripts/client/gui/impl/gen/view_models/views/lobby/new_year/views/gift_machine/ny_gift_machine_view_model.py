...
class NyGiftMachineViewModel(NySceneRotatableView):
    __slots__ = ('onGoToBuyTokens', 'onGoToIdle', 'onSkipAnimation', 'onBuyTokens', 'onGoToChallengeGuest', 'onGoToVillage', 'onBackFromVehiclePreview', 'onGoToHangar', 'onHintClose')

    def __init__(self, properties=14, commands=11):
