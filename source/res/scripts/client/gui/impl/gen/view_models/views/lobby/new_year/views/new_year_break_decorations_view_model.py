...
class NewYearBreakDecorationsViewModel(ViewModel):
    __slots__ = ('onQuestsBtnClick', 'onFilterResetBtnClick', 'onSelectedAllChanged', 'onSlotStatusIsNewChanged', 'onBreakDecorationsBtnClick', 'onBreakAnimationComplete', 'onViewResized')
