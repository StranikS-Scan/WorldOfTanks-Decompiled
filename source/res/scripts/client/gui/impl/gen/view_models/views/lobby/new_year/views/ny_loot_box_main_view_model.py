...
class NyLootBoxMainViewModel(ViewModel):
    __slots__ = ('onWindowClose', 'onTabClick', 'onCountSelected', 'onOpenBoxHitAreaClick', 'onOpenBoxBtnClick', 'onBuyBoxBtnClick', 'onCelebrityBtnClick', 'onQuestsBtnClick', 'onAnimationSwitchClick', 'onStatisticsButtonClick', 'onSwitchBoxHover')

    def __init__(self, properties=15, commands=11):
