...
# Embedded file name: scripts/client/gui/impl/gen/view_models/views/lobby/post_progression/post_progression_view_model.py
...
class PostProgressionViewModel(ViewModel):
    __slots__ = ('onGoBackAction', 'onResearchAction', 'onViewRendered')
    ...
    def getProgressionAvailability(self):
        return ProgressionAvailability(self._getString(3))
