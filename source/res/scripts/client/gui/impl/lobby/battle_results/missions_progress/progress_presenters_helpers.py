...
from gui.battle_results.progress.progress_filters import dailyQuestsProgressFilter, weeklyQuestsProgressFilter, battleMattersProgressFilter, prestigeProgressFilter, battlePassProgressFilter, personalMissionProgressFilter, vehicleProgressFilter, commonBattleQuestsProgressFilter, challengesMissionsProgressFilter
...
from gui.impl.lobby.battle_results.missions_progress.challenges_missions_progress import ChallengesMissionsProgressPresenter
...
registerProgressionPresenter(BATTLE_PROGRESS_CATEGORY.CHALLENGES_MISSIONS, ProgressPresenterEntry(challengesMissionsProgressFilter, ChallengesMissionsProgressPresenter))
