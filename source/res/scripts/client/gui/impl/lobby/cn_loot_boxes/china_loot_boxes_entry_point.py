...
from account_helpers.AccountSettings import CN_LOOT_BOXES_VIEWED_COUNT
...
class ChinaLootBoxesEntryPointWidget(ViewImpl):
    ...
    def __onWidgetClick(self):
        ...
        AccountSettings.setSettings(CN_LOOT_BOXES_VIEWED_COUNT, self.__cnLootBoxes.getBoxesCount())

    def __updateBoxesCount(self, count, *_):
        lastViewed = AccountSettings.getSettings(CN_LOOT_BOXES_VIEWED_COUNT)
