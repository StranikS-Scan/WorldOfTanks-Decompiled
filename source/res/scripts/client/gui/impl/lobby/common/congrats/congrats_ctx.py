...
class EventProgressionCongratsCtx(CongratsCtx):
    ...
    @property
    def background(self):
        return R.images.gui.maps.icons.epicBattles.backgrounds.back_congrats_cn() if IS_CHINA else R.images.gui.maps.icons.epicBattles.backgrounds.back_congrats()
