...
def getStylePreviewVehicle(style, defaultVehicle=None, itemsCache=None):
    if g_currentVehicle.isPresent() and style.mayInstall(g_currentVehicle.item):
        ...
        comp7Season = COMP7_SEASON_NUMBERS[-1]
        ...
        if vehicles:
            ...
            for vehicleCD, _ in sortedVehicles:
                vehicle = itemsCache.items.getVehicleCopyByCD(vehicleCD)
