...
class RankRewardsPage(PageSubModelPresenter):
    ...
    def _getEvents(self):
        return ((self.viewModel.onPreviewOpen, self.__onPreviewOpen), (self.__eventsCache.onSyncCompleted, self.__onEventsSyncCompleted), (self.__comp7Controller.onComp7RanksConfigChanged, self.__onRanksConfigChanged))
