...
class BaseCrewDialogTemplateView(DialogTemplateView):
    ...
    def __init__(self, layoutID=None, uniqueID=None, *args, **kwargs):
        ...
        loggerClass = kwargs.get('loggerClass', CrewDialogLogger)
        self._uiLogger = loggerClass(self, kwargs.get('loggingKey'), kwargs.get('parentViewKey'), kwargs.get('loggingAdditionalInfo'))
