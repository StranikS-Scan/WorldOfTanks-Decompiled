...
class QuickTrainingView(BaseCrewView):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return QuickTrainingLostXpTooltip() if contentID == R.views.lobby.crew.tooltips.QuickTrainingLostXpTooltip() else super(QuickTrainingView, self).createToolTipContent(event=event, contentID=contentID)
    ...
    def _getCallbacks(self):
        return (('inventory', self.__onInventoryUpdate), ('stats.freeXP', self.__onFreeXpChanged), ('stats.XPpp', self.__onFreeXpChanged))
    ...
    def __playErrorPersonalFileTips(self, personalXP):
        ...
        return True if self.tankman and not self.tankman.isMaxSkillEfficiency and (personalXP or not self.tankman.isInTank) else None
