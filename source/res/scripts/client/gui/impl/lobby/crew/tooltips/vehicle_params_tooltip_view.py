...
class VehicleAdvancedParamsTooltipView(BaseVehicleAdvancedParamsTooltipView):
    ...
    def _fillBonuses(self, model):
        ...
        vehicle = self.vehicle
        situationalScheme = (partial(self._formatValueText, ValueStyleEnum.RED), partial(self._formatValueText, ValueStyleEnum.WHITESPANISH), partial(self._formatValueText, ValueStyleEnum.YELLOW))
        extractedBonusScheme = (partial(self._formatValueText, ValueStyleEnum.RED), partial(self._formatValueText, ValueStyleEnum.WHITESPANISH), partial(self._formatValueText, ValueStyleEnum.GREENBRIGHT))
