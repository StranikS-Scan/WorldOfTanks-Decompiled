...
# Embedded file name: scripts/client/gui/impl/lobby/customization/context/editable_style_mode.py
import logging
...
from gui.customization.shared import C11nId, EDITABLE_STYLE_APPLY_TO_ALL_AREAS_TYPES, EDITABLE_STYLE_IRREMOVABLE_TYPES, PurchaseItem, getAvailableRegions
from gui.impl.lobby.customization.context.custom_mode import CustomMode
from gui.impl.lobby.customization.context.styled_mode import StyledMode
from gui.impl.lobby.customization.shared import CustomizationTabs, ITEM_TYPE_TO_SLOT_TYPE, changePartsOutfit, correctSlot, fitOutfit, getComponentFromSlot, getCurrentVehicleAvailableRegionsMap, getEditableStyleOutfitDiff, getItemFromSlot, getItemInventoryCount, getOutfitWithoutItems, getOutfitWithoutItemsNoDiff, getSlotDataFromSlot, getStylePurchaseItems, getUnsuitableDependentData, removeItemFromEditableStyle, removeUnselectedItemsFromEditableStyle
...
from items.components.c11n_constants import CustomizationType, MAX_USERS_PROJECTION_DECALS, SeasonType
...
class EditableStyleMode(CustomMode):
    ...
    def _applyItems(self, purchaseItems, isModeChanged, callback):
        ...
        if not requestData:
            ...
            if outfit.style is not None and outfit.style.isProgression:
    ...
    def _getAnchorsData(self):
        return [EDITABLE_STYLE_APPLY_TO_ALL_AREAS_TYPES[self.slotType]] if self.slotType in EDITABLE_STYLE_APPLY_TO_ALL_AREAS_TYPES else super(EditableStyleMode, self)._getAnchorsData()
