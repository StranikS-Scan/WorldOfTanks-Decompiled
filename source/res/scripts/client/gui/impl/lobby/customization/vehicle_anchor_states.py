...
# Embedded file name: scripts/client/gui/impl/lobby/customization/vehicle_anchor_states.py
import logging
...
class Anchor(StateContext):
    __slots__ = ('__service', '__slotId', '__uid', '__anchorShift', '__position', '__direction', '__ctx', '__index', '__model')
