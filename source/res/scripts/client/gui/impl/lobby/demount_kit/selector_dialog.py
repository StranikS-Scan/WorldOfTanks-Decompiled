...
class DemountOpDevDialog(BaseItemDialog):
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            ...
            if tooltipId == TOOLTIPS_CONSTANTS.AWARD_DEMOUNT_KIT:
                args = [DEMOUNT_KIT_ID]
            if tooltipId == TOOLTIPS_CONSTANTS.GOLD_ALTERNATIVE_INFO or tooltipId == TOOLTIPS_CONSTANTS.AWARD_DEMOUNT_KIT:
    ...
    def _setBaseParams(self, model):
        ...
        model.secondItem.setTooltipName(SelectorDialogItemModel.GOLD_TOOLTIP)
