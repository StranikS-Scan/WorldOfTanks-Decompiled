...
# Embedded file name: scripts/client/gui/impl/lobby/dog_tags/dog_tags.py
import logging
...
class DogTags(ViewImpl):
    ...
    def __init__(self, layoutID=R.views.lobby.dog_tags.DogTags(), *args, **kwargs):
        ...
        super(DogTags, self).__init__(settings)
    ...
    @property
    def viewModel(self):
        return super(DogTags, self).getViewModel()
    ...
    def __update(self, highlightedComponentId=-1):
        ...
        with self.viewModel.transaction() as tx:
            ...
            selectedTabIdx = DogTags.__getSelectedTabIdx(highlightedComponentId)
    ...
    def __getSelectedTabIdx(highlightedComponentId):
        ...
        highlightedComponentTabIdx = DogTags.__getComponentTabIdx(highlightedComponentId)
