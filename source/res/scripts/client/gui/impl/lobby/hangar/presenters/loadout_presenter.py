...
class LoadoutPresenter(ViewComponent[AmmunitionPanelModel]):
    ...
    def createToolTip(self, event):
        isBackportContentId = event.contentID in (R.aliases.common.tooltip.Backport(), R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent())
