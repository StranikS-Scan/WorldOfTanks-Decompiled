...
def showStyledVehicleByStyleCD(styleIntCD, isBackToMultiOpen=False, itemsCache=None, c11nService=None):
    ...
    if vehicle.isInInventory and vehicle.isCustomizationEnabled():
        ...
        showStylePreview(vehCD=vehicle.intCD, style=style, descr=style.getDescription(), backCallback=_backCallback, destoryCallback=_exitCallback, backBtnDescrLabel=backport.text(R.strings.vehicle_preview.header.backBtn.descrLabel.personalAwards()))
