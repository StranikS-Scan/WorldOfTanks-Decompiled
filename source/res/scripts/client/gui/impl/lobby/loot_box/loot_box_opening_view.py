...
class LootBoxOpeningView(LootBoxHideableView):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        isVideoOff = self.settingsCore.getSetting(settings_constants.GAME.LOOT_BOX_VIDEO_OFF)
    ...
    def __onNeedShowRewards(self):
        self.__videoStartStopHandler.setVideoState(isOn=False)
    ...
    def __onOpenNextBox(self, event):
        ...
        with self.viewModel.transaction() as tx:
            ...
            tx.setIsVideoOff(self.settingsCore.getSetting(settings_constants.GAME.LOOT_BOX_VIDEO_OFF))
...
class LootBoxOpeningWindow(LobbyOverlay):
    __slots__ = ()

    def __init__(self, parent=None):
        super(LootBoxOpeningWindow, self).__init__(content=LootBoxOpeningView(), parent=parent)
