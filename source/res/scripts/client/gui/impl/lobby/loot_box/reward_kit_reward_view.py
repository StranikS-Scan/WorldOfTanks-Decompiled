...
class RewardKitRewardView(LootBoxHideableView, UsersInfoHelper):
    ...
    def __init__(self, boxItem, rewards, isBackward=False, lastStatisticsResetFailed=None, isGuaranteedReward=False, giftsInfo=None):
        settings = ViewSettings(R.views.lobby.new_year.RewardKitRewardView(), flags=ViewFlags.NON_REARRANGE_VIEW, model=RewardKitRewardViewModel())
    ...
    def _onLoaded(self, *args, **kwargs):
        super(RewardKitRewardView, self)._onLoaded()
    ...
    def __onVideoSettingsChanged(self, _=None):
        self.__settingsCore.applySetting(NewYearStorageKeys.LOOT_BOX_VIDEO_OFF, not self.isVideoOff)
