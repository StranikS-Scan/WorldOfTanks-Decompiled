...
from gui.impl.lobby.mode_selector.items.bob_mode_selector_item import BobModeSelectorItem
...
registerModeSelectorItem(PREBATTLE_ACTION_NAME.BOB, BobModeSelectorItem)
