...
from skeletons.new_year import ICelebrityController, INewYearTriggerHintsController
...
class NewYearChallengeGuest(NyHistoryPresenter):
    ...
    def _getListeners(self):
        ...
        return listeners + ((NyCelebrityStoriesEvent.STORIES_VIEW_CLOSED, self.__onActionViewClosed, EVENT_BUS_SCOPE.DEFAULT), (NyCelebrityAnimationEvent.ANIMATION_VIEW_CLOSED, self.__onActionViewClosed, EVENT_BUS_SCOPE.DEFAULT))
