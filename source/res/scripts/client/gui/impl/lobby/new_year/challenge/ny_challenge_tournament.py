...
_ADVANCED_BONUS_ORDER = ('items', Currency.EQUIP_COIN, 'dossier')

def _advancedBonusesSortOrder(bonus):
    bonusName = bonus.getName()
    return _ADVANCED_BONUS_ORDER.index(bonusName) if bonusName in _ADVANCED_BONUS_ORDER else len(_ADVANCED_BONUS_ORDER)
