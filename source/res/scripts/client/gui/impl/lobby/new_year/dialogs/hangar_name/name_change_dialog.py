...
class NameChangeDialog(FullScreenDialogBaseView):
    __slots__ = ('__titleId', '__descriptionId', '__hasChanges')

    def __init__(self, nameID, descID, hasChanges):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as tx:
            ...
            tx.setHasChanges(self.__hasChanges)
