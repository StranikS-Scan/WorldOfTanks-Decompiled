...
from gui.shared.event_dispatcher import showLootBoxBuyWindow, showLootBoxOpeningStream, showAboutEvent
...
class NyInfoView(NyHistoryPresenter):
    ...
    def _getEvents(self):
        ...
        return events + ((self.viewModel.videoCover.onClick, self.__onPlayVideo),
         (self.viewModel.onShowRewardKitStream, self.__onShowRewardKitStream),
    ...
    def __onShowRewardKitStream(self):
