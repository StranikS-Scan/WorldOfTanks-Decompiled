...
class NyCustomizationObjectMarkerView(NyHangarMarkerView):
    ...
    def _getEvents(self):
        ...
        return events + ((self._nyController.onDataUpdated, self._onDataUpdated),
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        self._updateMarker()
        self.viewModel.setIsMaxLevelState(self.__isMaxLevelState())

    def _onObjectUpdate(self):
        self.viewModel.setIsAbleForUpgrade(NewYearNavigation.getCurrentObject() == self._OBJECT_TYPE)
