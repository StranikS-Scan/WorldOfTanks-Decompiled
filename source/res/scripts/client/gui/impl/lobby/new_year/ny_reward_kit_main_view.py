...
from gui.impl.lobby.new_year.tooltips.ny_attachments_statistics_tooltip import NyAttachmentsStatisticsTooltip
...
class NyRewardKitMainView(LootBoxHideableView):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return NyAttachmentsStatisticsTooltip(self.__tabsController.getSelectedBoxID()) if contentID == R.views.lobby.new_year.tooltips.NyAttachmentsStatisticsTooltip() else super(NyRewardKitMainView, self).createToolTipContent(event, contentID)
    ...
    @staticmethod
    def __updateLootBoxesDeliveryVideoViewed():
    ...
    @staticmethod
    def __sendSwitchBoxHoveredEvent(isBoxHovered):
