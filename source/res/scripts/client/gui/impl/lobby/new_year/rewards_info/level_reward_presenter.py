...
class LevelRewardPresenter(object):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        elif event.contentID == R.views.lobby.new_year.tooltips.NyGuestTooltip():
    ...
    def __makeRewardsGroup(self, renderer):
        ...
        self.__bonuses = [ bonus for bonus in self.__bonuses if bonus.getName() != 'ny25Toys' ]
