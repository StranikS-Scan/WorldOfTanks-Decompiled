...
class ShopOverlayView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return NyAttachmentsStatisticsTooltip(self.__tabsController.getSelectedBoxID()) if contentID == R.views.lobby.new_year.tooltips.NyAttachmentsStatisticsTooltip() else super(ShopOverlayView, self).createToolTipContent(event, contentID)
    ...
    @staticmethod
    def __changeLayersVisibiliy(isHide):
