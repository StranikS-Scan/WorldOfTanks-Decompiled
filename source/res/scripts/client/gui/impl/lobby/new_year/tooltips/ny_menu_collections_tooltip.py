...
from new_year.collection_presenters import getCurrentNYCollectionPresenter
...
class NyMenuCollectionsTooltip(ViewImpl):
    ...
    def _initialize(self, *args, **kwargs):
        ...
        collectionPresenter = getCurrentNYCollectionPresenter()
        self.viewModel.setCurrentToysCount(collectionPresenter.getCount())
        self.viewModel.setAllToysCount(collectionPresenter.getTotalCount())
