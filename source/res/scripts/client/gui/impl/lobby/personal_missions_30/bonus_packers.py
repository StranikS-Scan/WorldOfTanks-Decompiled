...
# Embedded file name: scripts/client/gui/impl/lobby/personal_missions_30/bonus_packers.py
...
class PawnedBonusPacker(BaseBonusUIPacker):
    ...
    def _pack(cls, bonus):
        ...
        formattedBonuses = missions_helper.getPersonalMissionAwardsFormatter().getPawnedQuestBonuses([bonus], size=AWARDS_SIZES.SMALL, pawnedTokensCount=pawnedTokensCount, freeTokenName=PM_BRANCH_TO_FREE_TOKEN_NAME.get(branchID))
