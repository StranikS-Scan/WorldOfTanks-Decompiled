...
class ProgressiveRewardAwardWindow(LobbyOverlay):
    __slots__ = ()

    def __init__(self, bonuses, specialRewardType, currentStep):
        super(ProgressiveRewardAwardWindow, self).__init__(content=ProgressiveRewardAwardView(R.views.lobby.progressive_reward.progressive_reward_award.ProgressiveRewardAward(), bonuses, specialRewardType, currentStep), decorator=None)
        return
