...
# Embedded file name: scripts/client/gui/impl/lobby/rts/quests_widget_view.py
...
class RtsQuestsWidgetView(DailyQuestsWidgetView):
    ...
    def _getQuests(self):
        ...
        quests = self.__progressionCtrl.getQuests(isCommander, includeFuture=False)
        return filterCompletedProgressionQuests(quests, 2)
