...
# Embedded file name: scripts/client/gui/impl/lobby/seniority_awards/popovers/vehicle_filter_popover.py
...
from gui.impl.gen.view_models.views.lobby.seniority_awards.popovers.vehicle_filter_popover_model import VehicleFilterPopoverModel
...
class VehicleFilterPopover(PopOverViewImpl):
    ...
    def __init__(self, filtersDict=None, updateCallback=None):
        settings = ViewSettings(R.views.lobby.seniority_awards.popovers.VehicleFilterPopover())
