...
class LootBoxCategoryTooltipContent(ViewImpl):
    ...
    def __init__(self, category):
        super(LootBoxCategoryTooltipContent, self).__init__(R.views.lobby.tooltips.loot_box_category_tooltip.LootBoxCategoryTooltipContent(), ViewFlags.VIEW, LootBoxCategoryTooltipModel, category)
