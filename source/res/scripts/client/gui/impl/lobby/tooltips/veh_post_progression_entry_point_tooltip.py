...
class VehPostProgressionEntryPointTooltip(ViewImpl):
    ...
    def _onLoaded(self, *args, **kwargs):
        ...
        self.__uiLogger.onTooltipOpened(self.__parentScreen, self.__vehicle.postProgression.isUnlocked(self.__vehicle).result)
    ...
    def __getStatus(self, eliteProgress):
        ...
        isVehicleUnlocked = self.__vehicle.postProgression.isUnlocked(self.__vehicle)
        if isVehicleUnlocked.result or isVehicleUnlocked.reason == PostProgressionAvailability.VEH_IS_RENT_OVER:
            return R.invalid()
