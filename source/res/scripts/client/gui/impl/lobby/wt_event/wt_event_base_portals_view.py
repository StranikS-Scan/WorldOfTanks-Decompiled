...
class WtEventBasePortalsView(ViewImpl):
    ...
    _lootBoxesCtrl = dependency.descriptor(IWTLootBoxesController)
    ...
    def _updateModel(self):
        ...
        self._eventCtrl.getLootBoxAreaSoundMgr().updatePortal(self.portalType)
    ...
    def __onSelectVehicleInHangar(self, _):
        self.destroyWindow()
