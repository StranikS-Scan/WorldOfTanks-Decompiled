...
class WTEventVehicleSoundPlayer(object):
    _SOUND_MAPPING = {'ussr:R97_Object_140_hound_TLXXL': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_Ob140',)),
     'france:F18_Bat_Chatillon25t_hound_TLXXL': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_B25t',)),
     'usa:A120_M48A5_hound_TLXXL': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_M48P',)),
     'germany:G98_Waffentrager_E100_TLXXL': (_TicketSoundComponent, ('ev_white_tiger_hangar_electric_substance_wt',)),
