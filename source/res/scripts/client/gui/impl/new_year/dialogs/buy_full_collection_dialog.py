...
# Embedded file name: scripts/client/gui/impl/new_year/dialogs/buy_full_collection_dialog.py
...
class BuyFullCollectionDialogWindow(DialogWindow):
    ...
    def __init__(self, collectionID, parent=None):
        ...
        super(BuyFullCollectionDialogWindow, self).__init__(bottomContent=DialogContent(R.views.lobby.new_year.components.new_year_common.CollectionItemBottomContent(), viewModelClazz=CurrencyItemModel), balanceContent=DialogContent(R.views.lobby.new_year.components.new_year_common.CollectionItemBalanceContent(), viewModelClazz=CurrencyItemModel), parent=parent, enableBlur=True, enableBlur3dScene=False)
