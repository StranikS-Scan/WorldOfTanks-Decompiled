...
from skeletons.new_year import INewYearController, ICraftMachineSettingsStorage
_logger = logging.getLogger(__name__)

class AlbumPage20View(AlbumPageView):
    ...
    def createToolTipContent(self, event, ctID):
        ...
        return self.__getCurrentTypeBonusTooltip(self.getStateInfo()['typeName']) if event.contentID == R.views.lobby.new_year.tooltips.new_year_collection_bonus_tooltip.NewYearCollectionBonusTooltip() else super(AlbumPage20View, self).createToolTipContent(event, ctID)

    def _initialize(self, *args, **kwargs):
        super(AlbumPage20View, self)._initialize(*args, **kwargs)
    ...
    def _changeData(self, model, typeName, rank=None):
        ...
        super(AlbumPage20View, self)._changeData(model, typeName, rank)
    ...
    def _changeToyPage(self, model, toyPage):
        super(AlbumPage20View, self)._changeToyPage(model, toyPage)
