...
import nations
from gui import SystemMessages, GUI_NATIONS_ORDER_INDEX
...
from gui.shared.utils import decorators, sortByFields
...
class NYSelectVehicleForDiscountPopover(VehicleSelectorBase, NYSelectVehiclePopoverMeta):
    ...
    def __init__(self, ctx=None):
        ...
        g_eventBus.handleEvent(NySelectVehiclePopOver(eventType=NySelectVehiclePopOver.SHOW, ctx={'discountID': discountID}))
    ...
    def _dispose(self):
        self.__itemsCache.onSyncCompleted -= self.__onResync
        g_eventBus.handleEvent(NySelectVehiclePopOver(eventType=NySelectVehiclePopOver.HIDE))
