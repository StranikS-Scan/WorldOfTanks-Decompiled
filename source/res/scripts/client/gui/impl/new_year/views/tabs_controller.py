...
class ChallengeTabsController(NyTabsController):
    ...
    def getSettingKeysForUpdate(self):
        return {NY_DOG_PAGE_VISITED, NY_CELEBRITY_DAY_QUESTS_VISITED_MASK, NY_CELEBRITY_ADV_QUESTS_VISITED_MASK}
...
class MarketplaceTabsController(NyTabsController):
    ...
    @tabUpdateFunc(NyTabBarMarketplaceView.NY24_CATEGORY)
    def _updateCategory2024(self, viewModel, _=False):
        viewModel.setIsCompleted(isCollectionReceived(Collections.NewYear24))
