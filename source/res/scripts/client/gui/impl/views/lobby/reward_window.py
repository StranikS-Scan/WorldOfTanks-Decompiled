...
# Embedded file name: scripts/client/gui/impl/views/lobby/reward_window.py
import GUI
...
from gui.impl.views import ViewImpl
...
from gui.impl.views.backport_tooltip import TooltipData, BackportTooltipWindow
from gui.impl.windows import StandardWindow
    ...
    def createToolTip(self, event):
        if event.contentID == R.views.backportTooltipContent:
            ...
            if tooltipId is not None:
                return BackportTooltipWindow(self.__items[tooltipId], self.getParentWindow())
            return
        else:
