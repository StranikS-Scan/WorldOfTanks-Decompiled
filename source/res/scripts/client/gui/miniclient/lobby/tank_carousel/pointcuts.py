...
class MakeTankUnavailableInCarousel(aop.Pointcut):
    ...
    def __init__(self, config):
        aop.Pointcut.__init__(self, 'gui.Scaleform.daapi.view.lobby.hangar.TankCarousel', 'TankCarousel', 'as_updateVehiclesS', aspects=(aspects.MakeTankUnavailableInCarousel(config),))
