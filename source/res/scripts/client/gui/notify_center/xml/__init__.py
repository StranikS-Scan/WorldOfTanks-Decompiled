...
# Embedded file name: scripts/client/gui/notify_center/xml/__init__.py
import ResMgr
from gui.notify_center.errors import ParseError
from gui.notify_center.xml import actions_parsers, gui_parsers, shared_parsers, proxy_data_parsers
