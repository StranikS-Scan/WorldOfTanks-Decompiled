...
# Embedded file name: scripts/client/gui/notify_center/xml/gui_parsers.py
from debug_utils import LOG_WARNING
from gui.notify_center.settings import NOTIFY_CENTER_POP_UP_PRIORITIES
from gui.notify_center.xml.format_by_tags import formatText
from gui.notify_center.xml.shared_parsers import ParsersCollection, SectionParser
from gui.notify_center import gui_items
...
class _PopUpParser(SectionParser):
    ...
    def parse(self, section, parentSection=None):
        ...
        if priority not in NOTIFY_CENTER_POP_UP_PRIORITIES:
