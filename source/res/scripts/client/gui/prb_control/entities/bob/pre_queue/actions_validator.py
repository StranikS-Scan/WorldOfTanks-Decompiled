...
class BobVehicleValidator(BaseActionsValidator):
    ...
    def _validate(self):
        ...
        return ValidationResult(False, PRE_QUEUE_RESTRICTION.LIMIT_LEVEL, {'levels': levels}) if vehicle.level not in levels else super(BobVehicleValidator, self)._validate()
