...
class BobSquadEntity(RandomSquadEntity):
    ...
    def leave(self, ctx, callback=None):
        if ctx.hasFlags(FUNCTIONAL_FLAG.SWITCH) or not self.bobController.needShowEventMode():
    ...
    def getConfirmDialogMeta(self, ctx):
        return None if not self.bobController.needShowEventMode() else super(BobSquadEntity, self).getConfirmDialogMeta(ctx)
