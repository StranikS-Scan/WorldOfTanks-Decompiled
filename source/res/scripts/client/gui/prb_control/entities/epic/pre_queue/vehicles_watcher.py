...
class EpicVehiclesWatcher(BaseVehiclesWatcher):
    ...
    def _getUnsuitableVehicles(self, onClear=False):
        ...
        eventVehs = self.itemsCache.items.getVehicles(REQ_CRITERIA.INVENTORY | REQ_CRITERIA.VEHICLE.EVENT_BATTLE ^ REQ_CRITERIA.VEHICLE.CLAN_WARS ^ REQ_CRITERIA.VEHICLE.RANDOM_ONLY).itervalues()
