...
class EpicSquadEntity(SquadEntity):
    ...
    def _vehicleStateCondition(self, v):
        ...
        return self.__restrictedSPGDataProvider.isTagVehicleAvailable() if v.type == VEHICLE_CLASS_NAME.SPG and not self.hasSlotForSPG() else super(EpicSquadEntity, self)._vehicleStateCondition(v)
