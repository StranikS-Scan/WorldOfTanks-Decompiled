...
class RankedVehiclesWatcher(BaseVehiclesWatcher):
    ...
    def _getUnsuitableVehicles(self, onClear=False):
        ...
        weekendBrawlVehs = self.__itemsCache.items.getVehicles(REQ_CRITERIA.INVENTORY | REQ_CRITERIA.VEHICLE.WEEKEND_BRAWL_BATTLE).itervalues()
        return chain(vehs, classVehs, typeVehs, eventVehs, epicVehs, battleRoyaleVehs, bobVehs, weekendBrawlVehs) if not onClear else allVehs
