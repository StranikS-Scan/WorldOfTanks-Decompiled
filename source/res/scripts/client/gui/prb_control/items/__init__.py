...
class FunctionalState(object):
    ...
    def isSquadSelected(self, prbType):
        if self.isInUnit(prbType):
            return True
        return True if self.isInPreQueue(QUEUE_TYPE.EVENT_BATTLES) and prbType == PREBATTLE_TYPE.EVENT else False
