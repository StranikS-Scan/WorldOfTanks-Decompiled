...
class _UnitActionValidator(object):
    ...
    def canCreatorDoAction(self, pInfo, stats, flags, vInfos, slots):
        ...
        return (valid, restriction) if not valid else self._validateSlots(pInfo, stats, flags, slots)
    ...
    def canPlayerDoAction(self, pInfo, flags, vInfos):
        ...
        return (False, restriction) if not valid else (True, UNIT_RESTRICTION.UNDEFINED)
    ...
    def _validateFlags(self, pInfo, flags, vInfos):
        ...
        return (False, UNIT_RESTRICTION.IS_IN_PRE_ARENA) if not pInfo.isCreator() and flags.isInPreArena() else (True, UNIT_RESTRICTION.UNDEFINED)
...
class ClubsActionValidator(_UnitActionValidator):
    ...
    def _validateSlots(self, pInfo, stats, flags, slots):
        ...
        if unit.isRated() and self._rosterSettings.getMinSlots() > stats.occupiedSlotsCount:
            return (False, UNIT_RESTRICTION.MIN_SLOTS)
        return (False, UNIT_RESTRICTION.NOT_READY_IN_SLOTS) if not flags.isInPreArena() and stats.readyCount != stats.occupiedSlotsCount else (True, UNIT_RESTRICTION.UNDEFINED)
...
class SquadActionValidator(_UnitActionValidator):
    ...
    def _validateFlags(self, pInfo, flags, vInfos):
        if flags.isInArena():
            return (False, UNIT_RESTRICTION.IS_IN_ARENA)
        return (False, UNIT_RESTRICTION.IS_IN_IDLE) if flags.isInIdle() else (True, UNIT_RESTRICTION.UNDEFINED)
