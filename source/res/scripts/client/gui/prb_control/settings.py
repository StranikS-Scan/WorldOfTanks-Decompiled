...
class FUNCTIONAL_FLAG(BitmaskHelper):
    ...
    MODES_BITMASK = E_SPORT | TRAINING | BATTLE_SESSION | RANDOM | EVENT | SANDBOX | TUTORIAL | STRONGHOLD | RANKED | BOOTCAMP
