...
ENTER_UNIT_MGR_RESTORE_ERRORS = (UNIT_ERROR.CANT_FIND_UNIT_MGR,
 UNIT_ERROR.NO_UNIT_MGR,
 UNIT_ERROR.NO_AVAILABLE_SLOTS,
 UNIT_ERROR.UNIT_MGR_ENTITY_CREATION_FAIL)
ENTER_UNIT_MGR_RESET_ERRORS = (UNIT_ERROR.INVITE_REMOVED,
...
class UNIT_RESTRICTION(object):
    ...
    CLASSES_RESTRICTIONS = (SPG_IS_FULL,
     ...
     SCOUT_IS_FORBIDDEN,
     WHEELED_IS_FULL,
     WHEELED_IS_FORBIDDEN,
     AT_SPG_IS_FULL,
     AT_SPG_IS_FORBIDDEN,
     HEAVYTANK_IS_FULL,
     HEAVYTANK_IS_FORBIDDEN,
     MEDIUMTANK_IS_FULL,
     MEDIUMTANK_IS_FORBIDDEN)
