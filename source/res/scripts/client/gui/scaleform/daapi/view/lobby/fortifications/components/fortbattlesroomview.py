...
class FortBattlesRoomView(FortRoomMeta, FortViewHelper, UnitListener):
    ...
    def __playersLabel(self, playerCount, limit):
        ...
        legionariesMSG = self.app.utilsManager.textManager.getText(TEXT_MANAGER_STYLES.STANDARD_TEXT, i18n.makeString(FORTIFICATIONS.FORTBATTLEROOM_LEGIONARIESCOUNT))
