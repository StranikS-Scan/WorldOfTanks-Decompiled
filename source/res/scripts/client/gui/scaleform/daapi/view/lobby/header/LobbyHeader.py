    ...
    def _updatePrebattleControls(self):
        ...
        if self.__isHeaderButtonPresent(LobbyHeader.BUTTONS.SQUAD):
            ...
            if state.isInUnit(constants.PREBATTLE_TYPE.EVENT):
                ...
                iconSquad = RES_ICONS.MAPS_ICONS_BATTLETYPES_40X40_BOBSQUAD
