...
class BATTLE_VIEW_ALIASES(object):
    ...
    FESTIVAL_RACE_PLAYER_HEALTH_BAR = 'festivalRacePlayerHealthBar'
    FESTIVAL_RACE_SPEEDOMETER = 'festivalRaceSpeedometer'
    FESTIVAL_RACE_MESSAGES = 'festivalRaceMessages'
    FESTIVAL_RACE_INGAME_HELP = 'festivalRaceIngameHelp'
    FESTIVAL_RACE_FULL_STATS = 'festRaceFullStats'
    FESTIVAL_RACE_INGAME_MENU = 'festRaceIngameMenu'
