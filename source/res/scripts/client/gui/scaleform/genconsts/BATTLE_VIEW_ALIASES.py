...
class BATTLE_VIEW_ALIASES(object):
    ...
    COMMANDER_SPAWN_MENU = 'commanderSpawnMenu'
    COMMANDER_SUPPLY_PANEL = 'commanderSupplyPanel'
    COMMANDER_VEHICLE_SELECTION = 'commanderVehicleSelection'
    COMMANDER_HELP = 'commanderHelp'
    COMMANDER_VEHICLES_PANEL = 'commanderVehiclesPanel'
    RTS_HIT_DIRECTION = 'rtsHitDirection'
    TICKER = 'battleTicker'
