...
class TOOLTIPS_CONSTANTS(object):
    ...
    BIRTHDAY_SET = [BIRTHDAY_ENTRY_POINT,
     BIRTHDAY_GIFT_SYSTEM_POSTMARK,
     BIRTHDAY_GOLDEN_TICKET,
     ECONOMY_BONUS_TOOLTIP,
     BIRTHDAY_GIFT_SYSTEM_DISABLED_PLAYER]
    WT_BATTLES_SET = [EVENT_BATTLES_SELECTOR_INFO,
