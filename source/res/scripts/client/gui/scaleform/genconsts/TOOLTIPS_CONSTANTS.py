...
class TOOLTIPS_CONSTANTS(object):
    ...
    WEEKEND_BRAWL_SELECTOR_INFO = 'weekendBrawlInfo'
    WEEKEND_BRAWL_SERVER_PRIMETIME = 'weekendBrawlServerPrimeTime'
    ...
    WEEKEND_BRAWL_SET = [WEEKEND_BRAWL_SELECTOR_INFO, WEEKEND_BRAWL_SERVER_PRIMETIME]
