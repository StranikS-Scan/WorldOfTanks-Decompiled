...
class TOOLTIPS_CONSTANTS(object):
    ...
    COLLAPSE_CUSTOMIZATION_ITEM_AWARD = 'collapseCustomizationItemAward'
    ...
    NY_GIFT_STAMPS = 'nyGiftStamps'
    NY_AMMUNITION_BONUSES = 'nyAmmunitionBonuses'
    ...
    CURRENT_DISCOUNT_INFO = 'currentDiscountInfo'
    SHOP_SALES_FREE_SHUFFLE_INFO = 'shopSalesFreeShuffleInfo'
    SHOP_SALES_PAID_SHUFFLE_INFO = 'shopSalesPaidShuffleInfo'
    SHOP_SALES_VOTE_FOR_DISCOUNT = 'shopSalesVoteForDiscount'
    ...
    LUNAR_NY_PROGRESSION_ACHIEVS = 'lunarNYProgressionAchieves'
    LUNAR_NY_CHARM = 'lunarNYCharm'
    LUNAR_NY_ENVELOPE = 'lunarNYEnvelope'
    SHOP_LUNAR_NY_ENVELOPE = 'shopLunarNYEnvelope'
    SHOP_LUNAR_NY_PREREQUISITE = 'shopLunarNYPrerequisite'
    ...
    SHOP_SALES_EVENT_SET = [CURRENT_DISCOUNT_INFO,
     SHOP_SALES_FREE_SHUFFLE_INFO,
     SHOP_SALES_PAID_SHUFFLE_INFO,
     SHOP_SALES_VOTE_FOR_DISCOUNT]
    ...
    LUNAR_NY_SET = [LUNAR_NY_CHARM,
     LUNAR_NY_ENVELOPE,
     SHOP_LUNAR_NY_ENVELOPE,
     SHOP_LUNAR_NY_PREREQUISITE]
