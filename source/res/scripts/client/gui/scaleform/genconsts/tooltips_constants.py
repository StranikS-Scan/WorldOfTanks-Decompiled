...
class TOOLTIPS_CONSTANTS(object):
    ...
    EVENT_FACTION_INFO = 'eventFactionInfo'
    EVENT_FACTION_INFO_WIN_SCREEN = 'eventFactionInfoWinScreen'
    EVENT_FRONT_INFO = 'eventFrontInfo'
    EVENT_ENERGY_INFO = 'eventEnergyInfo'
    EVENT_BANNER_INFO = 'eventBannerInfo'
    EVENT_AWARD_MODULE = 'eventAwardModule'
    EVENT_SELECTOR_INFO = 'eventSelectorInfo'
    EVENT_GENERAL_PROGRESSION = 'eventGeneralProgression'
    ...
    EVENT_SET = [EVENT_FACTION_INFO,
     EVENT_FRONT_INFO,
     EVENT_ENERGY_INFO,
     EVENT_BANNER_INFO,
     EVENT_FACTION_INFO_WIN_SCREEN,
     EVENT_AWARD_MODULE,
     EVENT_GENERAL_PROGRESSION,
     EVENT_SELECTOR_INFO]
