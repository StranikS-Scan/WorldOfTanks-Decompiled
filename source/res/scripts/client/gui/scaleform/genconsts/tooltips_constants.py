...
class TOOLTIPS_CONSTANTS(object):
    ...
    MAP_SMALL = 'mapSmall'
    FOOTBALL_BUFFON = 'footballBuffon'
    FOOTBALL_GREEN_FLAG = 'footballGreenFlag'
    ...
    FOOTBALL_SET = [FOOTBALL_BUFFON, FOOTBALL_GREEN_FLAG]
    ...
    SETTINGS_SET = [SETTINGS_CONTROL,
     ...
     SETTINGS_KEY_FOLLOW_ME,
     SETTINGS_KEY_TURN_BACK,
     SETTINGS_KEY_NEED_HELP,
     SETTINGS_KEY_RELOAD,
     SETTINGS_KEY_SWITCH_MODE]
    TUTORIAL_SET = [HANGAR_TUTORIAL_RESEARCH_VEHICLE_INFO,
     HANGAR_TUTORIAL_RESEARCH_MODULES_PREMIUM,
     HANGAR_TUTORIAL_RESEARCH_MODULES,
     HANGAR_TUTORIAL_CUSTOMIZATION_TYPES,
     HANGAR_TUTORIAL_NATIONS,
     HANGAR_TUTORIAL_RESEARCH_TREE,
