...
class TOOLTIPS_CONSTANTS(object):
    ...
    SETTINGS_SET = [SETTINGS_CONTROL,
     ...
     SERVERS_INFO,
     SETTINGS_KEY_SPECIAL_ABILITY,
     SETTINGS_SITUATIONAL_PERK]
    ...
    VEHICLES_SET = [CAROUSEL_VEHICLE,
     ...
     EASY_TANK_EQUIP_VEHICLE_ADVANCED_PARAMETERS]
    ...
    VEHICLES_ITEMS_SET = [INVENTORY_MODULE,
     ...
     HANGAR_CARD_MODULE,
     HANGAR_SLOT_SPEC,
     CONTEXT_VEHICLE_MODULE,
     ARMOR_INSPECTOR_SHELL]
    ...
    FRONTLINE_LOBBY_SET = [EPIC_SKILL_INFO,
    ...
    ROYALE_LOBBY_SET = [BATTLE_ROYALE_MODULES_HANGAR,
