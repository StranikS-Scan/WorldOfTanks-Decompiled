...
class CHAT(object):
    ...
    CHANNELS_COMMON_TOOLTIP = '#chat:channels/common/tooltip'
    ...
    ERRORS_NOVICERESTRICTIONS = '#chat:errors/novicerestrictions'
    ERRORS_NOVICERESTRICTIONSSHORT = '#chat:errors/novicerestrictionsshort'
