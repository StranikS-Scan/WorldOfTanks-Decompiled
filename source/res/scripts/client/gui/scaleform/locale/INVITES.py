...
class INVITES(object):
    ...
    INVITES_NOTE_LEAVE_STRONGHOLD = '#invites:invites/note/leave/STRONGHOLD'
    INVITES_NOTE_CHANGE_AND_LEAVE_STRONGHOLD = '#invites:invites/note/change_and_leave/STRONGHOLD'
