...
class INVITES(object):
    ...
    INVITES_NOTE_LEAVE_QUEUE_BOB = '#invites:invites/note/leave/QUEUE_BOB'
    INVITES_NOTE_CHANGE_AND_LEAVE_QUEUE_BOB = '#invites:invites/note/change_and_leave/QUEUE_BOB'
    INVITES_NOTE_LEAVE_PREBATTLE_BOB = '#invites:invites/note/leave/PREBATTLE_BOB'
    INVITES_NOTE_CHANGE_AND_LEAVE_PREBATTLE_BOB = '#invites:invites/note/change_and_leave/PREBATTLE_BOB'
