...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_QUESTS_VARIADICDISCOUNT = '#messenger:serviceChannelMessages/battleResults/quests/variadicDiscount'
    ...
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_TITLE = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/title'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_DATE = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/date'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_DEBIT = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/debit'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ACCRUED = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/accrued'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_CREDITS_ACCRUED = '#messenger:serviceChannelMessages/sysMsg/consumables/credits/accrued'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEM_ONE = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/item/one'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEM_MANY = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/item/many'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEMS_QUALITYOIL = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/items/qualityOil'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEMS_LENDLEASEOIL = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/items/lendLeaseOil'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEMS_GASOLINE100 = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/items/gasoline100'
    SERVICECHANNELMESSAGES_SYSMSG_CONSUMABLES_REPLACEDITEMS_ITEMS_GASOLINE105 = '#messenger:serviceChannelMessages/sysMsg/consumables/replacedItems/items/gasoline105'
    ...
    SERVICECHANNELMESSAGES_LOOTBOXESAUTOOPEN_BOXESANDCOINS = '#messenger:serviceChannelMessages/lootBoxesAutoOpen/boxesAndCoins'
    SERVICECHANNELMESSAGES_LOOTBOXESAUTOOPEN_BOXESCOUNTER = '#messenger:serviceChannelMessages/lootBoxesAutoOpen/boxesCounter'
    SERVICECHANNELMESSAGES_LOOTBOXESAUTOOPEN_COINSCOUNTER = '#messenger:serviceChannelMessages/lootBoxesAutoOpen/coinsCounter'
    SERVICECHANNELMESSAGES_LOOTBOXESAUTOOPEN_SACKSCOUNTER = '#messenger:serviceChannelMessages/lootBoxesAutoOpen/sacksCounter'
    ...
    PLATFORMCURRENCYMSG_RECEIVED_NY_CRYSTAL = '#messenger:platformCurrencyMsg/received/ny_crystal'
    PLATFORMCURRENCYMSG_DEBITED_NY_CRYSTAL = '#messenger:platformCurrencyMsg/debited/ny_crystal'
    PLATFORMCURRENCYMSG_RECEIVED_NY_AMBER = '#messenger:platformCurrencyMsg/received/ny_amber'
    PLATFORMCURRENCYMSG_DEBITED_NY_AMBER = '#messenger:platformCurrencyMsg/debited/ny_amber'
    PLATFORMCURRENCYMSG_RECEIVED_NY_EMERALD = '#messenger:platformCurrencyMsg/received/ny_emerald'
    PLATFORMCURRENCYMSG_DEBITED_NY_EMERALD = '#messenger:platformCurrencyMsg/debited/ny_emerald'
    PLATFORMCURRENCYMSG_RECEIVED_NY_IRON = '#messenger:platformCurrencyMsg/received/ny_iron'
    PLATFORMCURRENCYMSG_DEBITED_NY_IRON = '#messenger:platformCurrencyMsg/debited/ny_iron'
    ...
    SERVICECHANNELMESSAGES_NEWYEAR_CELEBRITYCHALLENGE_ACHIEVEMENTS = '#messenger:serviceChannelMessages/newYear/celebrityChallenge/achievements'
    SERVICECHANNELMESSAGES_NEWYEAR_CELEBRITYCHALLENGE_OPTDEVICES = '#messenger:serviceChannelMessages/newYear/celebrityChallenge/optDevices'
