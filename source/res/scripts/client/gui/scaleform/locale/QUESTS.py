...
class QUESTS(object):
    ...
    MISSIONS_TAB_XYEARS = '#quests:missions/tab/xyears'
    ...
    MISSIONS_TAB_LABEL_XYEARS = '#quests:missions/tab/label/xyears'
    MISSIONS_TAB_XYEARS_HEADER = '#quests:missions/tab/xyears/header'
    MISSIONS_TAB_XYEARS_BODY = '#quests:missions/tab/xyears/body'
    MISSIONS_TAB_XYEARS_DISABLED = '#quests:missions/tab/xyears/disabled'
    MISSIONS_TAB_XYEARS_DISABLED_HEADER = '#quests:missions/tab/xyears/disabled/header'
    MISSIONS_TAB_XYEARS_DISABLED_BODY = '#quests:missions/tab/xyears/disabled/body'
