...
class QUESTS(object):
    ...
    MISSIONS_TAB_PANHARD = '#quests:missions/tab/panhard'
    ...
    MISSIONS_TAB_LABEL_PANHARD = '#quests:missions/tab/label/panhard'
    ...
    MISSIONS_TAB_PANHARD_HEADER = '#quests:missions/tab/panhard/header'
    MISSIONS_TAB_PANHARD_BODY = '#quests:missions/tab/panhard/body'
