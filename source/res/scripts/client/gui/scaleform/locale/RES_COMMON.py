...
class RES_COMMON(object):
    ...
    MAPS_ICONS_NEWYEAR_INFO_BG = '../maps/icons/newYear/info/bg.png'
    MAPS_ICONS_NEWYEAR_POPOVERS_BG = '../maps/icons/newYear/popovers/bg.png'
    MAPS_ICONS_NEWYEAR_REWARDS_INFO_BG = '../maps/icons/newYear/rewards_info/bg.png'
    MAPS_ICONS_NEWYEAR_STYLE_REWARD_BG = '../maps/icons/newYear/style_reward/bg.png'
    MAPS_ICONS_NEWYEAR_TOOLTIPS_DISCOUNT_REWARD_TOOLTIP_BG = '../maps/icons/newYear/tooltips/discount_reward_tooltip/bg.png'
    MAPS_ICONS_NEWYEAR_TOY_STORAGE_BG = '../maps/icons/newYear/toy_storage/bg.png'
    MAPS_ICONS_NEWYEAR_VEHICLES_BG = '../maps/icons/newYear/vehicles/bg.png'
