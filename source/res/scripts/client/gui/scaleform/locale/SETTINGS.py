...
class SETTINGS(object):
    ...
    UIEFFECTS = '#settings:uiEffects'
    UIEFFECTS_HEADER = '#settings:uiEffects/header'
    UIEFFECTS_BODY = '#settings:uiEffects/body'
    UIEFFECTS_ATTENTION = '#settings:uiEffects/attention'
