...
class SYSTEM_MESSAGES(object):
    ...
    NEWYEAR_CELEBRITYCHALLENGE_QUESTREWARD_TMANBONUS_TITLE = '#system_messages:newYear/celebrityChallenge/questReward/tmanBonus/title'
    ...
    NEWYEAR_BREED_BOUGHT_HEADER = '#system_messages:newYear/breed/bought/header'
    NEWYEAR_BREED_BOUGHT_BODY = '#system_messages:newYear/breed/bought/body'
    NEWYEAR_BREED_BOUGHT_GOLD = '#system_messages:newYear/breed/bought/gold'
    NEWYEAR_BREED_BOUGHT_ERROR_HEADER = '#system_messages:newYear/breed/bought/error/header'
    NEWYEAR_BREED_BOUGHT_ERROR_BODY = '#system_messages:newYear/breed/bought/error/body'
    NEWYEAR_SURPRISE_CLAIM_FAILED = '#system_messages:newYear/surprise/claim_failed'
    ...
    ALL_ENUM = (REPAIR_SUCCESS,
     ...
     NEWYEAR_CELEBRITYCHALLENGE_QUESTREWARD_TMANBONUS_TITLE,
     ...
     NEWYEAR_BREED_BOUGHT_HEADER,
     NEWYEAR_BREED_BOUGHT_BODY,
     NEWYEAR_BREED_BOUGHT_GOLD,
     NEWYEAR_BREED_BOUGHT_ERROR_HEADER,
     NEWYEAR_BREED_BOUGHT_ERROR_BODY,
     NEWYEAR_SURPRISE_CLAIM_FAILED)
