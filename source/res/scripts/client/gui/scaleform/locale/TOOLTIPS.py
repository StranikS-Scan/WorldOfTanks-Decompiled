...
class TOOLTIPS(object):
    ...
    TERRAIN_TESSELLATION_ENABLED_HEADER = '#tooltips:TERRAIN_TESSELLATION_ENABLED/header'
    TERRAIN_TESSELLATION_ENABLED_BODY = '#tooltips:TERRAIN_TESSELLATION_ENABLED/body'
    ...
    MARATHON_CLASSICDATE = '#tooltips:marathon/classicDate'
    ...
    DDAY_HEADER = '#tooltips:dday/header'
    DDAY_BONUSES = '#tooltips:dday/bonuses'
    DDAY_BONUSES_CAPITAL = '#tooltips:dday/bonuses/capital'
    DDAY_BODY = '#tooltips:dday/body'
    DDAY_VEHICLERECEIVED_BODY = '#tooltips:dday/vehicleReceived/body'
    DDAY_REWARDSRECEIVED_BODY = '#tooltips:dday/rewardsReceived/body'
    DDAY_BODY_EXTRA = '#tooltips:dday/body/extra'
    DDAY_EXTRA_STATE_STEPS = '#tooltips:dday/extra_state/steps'
    DDAY_ERROR_VEH_TYPE = '#tooltips:dday/error/veh_type'
    DDAY_EXTRA_STATE_VEHICLE_COMPLETED = '#tooltips:dday/extra_state/vehicle/completed'
    DDAY_EXTRA_STATE_REWARDS_COMPLETED = '#tooltips:dday/extra_state/rewards/completed'
    DDAY_PROGRESS = '#tooltips:dday/progress'
    DDAY_BONUS_TOOLTIP_HEADER = '#tooltips:dday/bonus/tooltip/header'
    DDAY_BONUS_TOOLTIP_HEADER_ENDTIME = '#tooltips:dday/bonus/tooltip/header/endTime'
    DDAY_BONUS_TOOLTIP_BODY = '#tooltips:dday/bonus/tooltip/body'
    DDAY_BONUS_TOOLTIP_NAME = '#tooltips:dday/bonus/tooltip/name'
    DDAY_BONUS_TOOLTIP_TOTALXP = '#tooltips:dday/bonus/tooltip/totalXP'
    DDAY_BONUS_TOOLTIP_TANKMANXP = '#tooltips:dday/bonus/tooltip/tankmanXP'
