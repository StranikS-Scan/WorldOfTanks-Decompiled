...
class TOOLTIPS(object):
    ...
    BLOGGERS_HEADER = '#tooltips:bloggers/header'
    BLOGGERS_SUBTITLE = '#tooltips:bloggers/subtitle'
    BLOGGERS_DATE = '#tooltips:bloggers/date'
    BLOGGERS_BODY = '#tooltips:bloggers/body'
