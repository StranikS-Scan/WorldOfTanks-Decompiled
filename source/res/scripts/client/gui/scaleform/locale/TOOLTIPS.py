...
class TOOLTIPS(object):
    ...
    SPRINGMARATHON_HEADER = '#tooltips:springMarathon/header'
    SPRINGMARATHON_BODY = '#tooltips:springMarathon/body'
    SPRINGMARATHON_BODY_EXTRA = '#tooltips:springMarathon/body/extra'
