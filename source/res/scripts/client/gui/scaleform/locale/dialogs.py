...
class DIALOGS(object):
    ...
    PUNISHMENTWINDOW_REASON_EVENT_DESERTER = '#dialogs:punishmentWindow/reason/event_deserter'
    ...
    PUNISHMENTWINDOW_REASON_EVENT_AFK = '#dialogs:punishmentWindow/reason/event_afk'
    ...
    HALLOWEENSHOPBUYITEM_TITLE = '#dialogs:halloweenShopBuyItem/title'
    HALLOWEENSHOPBUYITEM_MESSAGE = '#dialogs:halloweenShopBuyItem/message'
    HALLOWEENSHOPBUYITEM_SUBMIT = '#dialogs:halloweenShopBuyItem/submit'
    HALLOWEENSHOPBUYITEM_CANCEL = '#dialogs:halloweenShopBuyItem/cancel'
    ...
    ALL_ENUM = (INTERVIEWQUIT_TITLE,
     ...
     GAMMADIALOG_CANCEL,
     HALLOWEENSHOPBUYITEM_TITLE,
     HALLOWEENSHOPBUYITEM_MESSAGE,
     HALLOWEENSHOPBUYITEM_SUBMIT,
     HALLOWEENSHOPBUYITEM_CANCEL)
