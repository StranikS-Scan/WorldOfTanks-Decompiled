...
class INGAME_GUI(object):
    ...
    PLAYER_MESSAGES_EVENT_USERNOHASAMMO = '#ingame_gui:player_messages/event_userNoHasAmmo'
    ...
    PLAYER_MESSAGES_DEATH_FROM_SHOT_SELF_ENEMY_BOMBER_ATTACK = '#ingame_gui:player_messages/DEATH_FROM_SHOT_SELF_ENEMY_BOMBER_ATTACK'
    ...
    PLAYER_MESSAGES_DEATH_FROM_SHOT_ALLY_ENEMY_BOMBER_ATTACK = '#ingame_gui:player_messages/DEATH_FROM_SHOT_ALLY_ENEMY_BOMBER_ATTACK'
    PLAYER_MESSAGES_DEATH_FROM_SHOT_ALLY_ENEMY_MINEFIELD = '#ingame_gui:player_messages/DEATH_FROM_SHOT_ALLY_ENEMY_MINEFIELD'
    ...
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_READY_BOMBER_ATTACK = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_READY_BOMBER_ATTACK'
    ...
    PLAYER_MESSAGES_COMBAT_EQUIPMENT_USED_BOMBER_ATTACK = '#ingame_gui:player_messages/COMBAT_EQUIPMENT_USED_BOMBER_ATTACK'
    ...
    RADIALMENU_CHATABOUT = '#ingame_gui:radialMenu/chatAbout'
    RADIALMENU_CHATWITH = '#ingame_gui:radialMenu/chatWith'
    RADIALMENU_ALLIES = '#ingame_gui:radialMenu/allies'
    RADIALMENU_NEXTPAGE = '#ingame_gui:radialMenu/nextPage'
