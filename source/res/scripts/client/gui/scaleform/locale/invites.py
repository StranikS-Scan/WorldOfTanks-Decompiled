...
class INVITES(object):
    ...
    INVITES_TEXT_RANKED = '#invites:invites/text/RANKED'
    ...
    INVITES_NOTE_LEAVE_PREBATTLE_RANKED = '#invites:invites/note/leave/PREBATTLE_RANKED'
    INVITES_NOTE_CHANGE_AND_LEAVE_PREBATTLE_RANKED = '#invites:invites/note/change_and_leave/PREBATTLE_RANKED'
