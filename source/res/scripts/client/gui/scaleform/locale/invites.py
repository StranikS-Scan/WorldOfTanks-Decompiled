...
class INVITES(object):
    ...
    INVITES_PREBATTLE_ALREADYJOINED_FUN_RANDOM = '#invites:invites/prebattle/alreadyJoined/FUN_RANDOM'
    ...
    INVITES_TEXT_FUN_RANDOM = '#invites:invites/text/FUN_RANDOM'
    ...
    INVITES_NOTE_LEAVE_PREBATTLE_FUN_RANDOM = '#invites:invites/note/leave/PREBATTLE_FUN_RANDOM'
    INVITES_NOTE_CHANGE_AND_LEAVE_PREBATTLE_FUN_RANDOM = '#invites:invites/note/change_and_leave/PREBATTLE_FUN_RANDOM'
    INVITES_NOTE_LEAVE_QUEUE_FUN_RANDOM = '#invites:invites/note/leave/QUEUE_FUN_RANDOM'
    INVITES_NOTE_CHANGE_AND_LEAVE_QUEUE_FUN_RANDOM = '#invites:invites/note/change_and_leave/QUEUE_FUN_RANDOM'
    INVITES_WARNING_ANONYMIZED = '#invites:invites/warning/anonymized'
    INVITES_TOOLTIP_FUNRANDOM_NOVEHICLES = '#invites:invites/tooltip/funRandom/noVehicles'
