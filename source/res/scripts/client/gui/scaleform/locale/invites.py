...
class INVITES(object):
    ...
    INVITES_PREBATTLE_ALREADYJOINED_EVENT_SQUAD = '#invites:invites/prebattle/alreadyJoined/EVENT_SQUAD'
    ...
    INVITES_TEXT_EVENT_SQUAD = '#invites:invites/text/EVENT_SQUAD'
    ...
    INVITES_NOTE_LEAVE_EVENT_SQUAD = '#invites:invites/note/leave/EVENT_SQUAD'
    INVITES_NOTE_CHANGE_AND_LEAVE_EVENT_SQUAD = '#invites:invites/note/change_and_leave/EVENT_SQUAD'
    ...
    INVITES_PREBATTLE_ALREADYJOINED_ENUM = (INVITES_PREBATTLE_ALREADYJOINED_SQUAD,
     INVITES_PREBATTLE_ALREADYJOINED_EVENT_SQUAD,
    ...
    INVITES_NOTE_CHANGE_AND_LEAVE_ENUM = (INVITES_NOTE_CHANGE_AND_LEAVE_COMPANY,
     ...
     INVITES_NOTE_CHANGE_AND_LEAVE_EVENT_SQUAD,
    ...
    INVITES_NOTE_LEAVE_ENUM = (INVITES_NOTE_LEAVE_COMPANY,
     ...
     INVITES_NOTE_LEAVE_EVENT_SQUAD,
