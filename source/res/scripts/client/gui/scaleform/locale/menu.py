...
class MENU(object):
    ...
    AWARDWINDOW_DDAYMEDAL_TITLE = '#menu:awardWindow/ddayMedal/title'
    AWARDWINDOW_DDAYMEDAL_HEADER = '#menu:awardWindow/ddayMedal/header'
    AWARDWINDOW_DDAYMEDAL_BONUSES = '#menu:awardWindow/ddayMedal/bonuses'
    AWARDWINDOW_DDAYMEDAL_DESCRIPTION = '#menu:awardWindow/ddayMedal/description'
    AWARDWINDOW_DDAYMEDAL_OKBUTTON = '#menu:awardWindow/ddayMedal/okButton'
