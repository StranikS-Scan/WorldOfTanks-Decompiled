...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FORMAT_ITEMS_DEFAULT = '#messenger:serviceChannelMessages/invoiceReceived/format/items/default'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FORMAT_ITEMS_CREWBOOK = '#messenger:serviceChannelMessages/invoiceReceived/format/items/crewBook'
    ...
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATS_HEADER = '#messenger:serviceChannelMessages/playStreakCongrats/header'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHREWARDS_PERIODIC_BODY = '#messenger:serviceChannelMessages/playStreakCongratsWithRewards/periodic/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHREWARDS_REGULAR_BODY = '#messenger:serviceChannelMessages/playStreakCongratsWithRewards/regular/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHREWARDS_RANDOM_PREFIX = '#messenger:serviceChannelMessages/playStreakCongratsWithRewards/random/prefix'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHREWARDS_RANDOM_EQUIPMENT = '#messenger:serviceChannelMessages/playStreakCongratsWithRewards/random/equipment'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHREWARDS_RANDOM_GOODIE = '#messenger:serviceChannelMessages/playStreakCongratsWithRewards/random/goodie'
    SERVICECHANNELMESSAGES_PLAYSTREAKCONGRATSWITHOUTREWARDS_BODY = '#messenger:serviceChannelMessages/playStreakCongratsWithoutRewards/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKPAUSEUSED_BODY = '#messenger:serviceChannelMessages/playStreakPauseUsed/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKDROPPROGRESS_BODY = '#messenger:serviceChannelMessages/playStreakDropProgress/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKUNAVAILABLE_BODY = '#messenger:serviceChannelMessages/playStreakUnavailable/body'
    SERVICECHANNELMESSAGES_PLAYSTREAKAVAILABLE_BODY = '#messenger:serviceChannelMessages/playStreakAvailable/body'
