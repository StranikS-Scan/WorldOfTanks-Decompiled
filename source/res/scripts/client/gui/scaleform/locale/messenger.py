...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_QUESTS_FESTIVALTICKETS = '#messenger:serviceChannelMessages/battleResults/quests/festivalTickets'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FESTIVALITEMSACCRUED = '#messenger:serviceChannelMessages/invoiceReceived/festivalItemsAccrued'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FESTIVALITEMSDEBITED = '#messenger:serviceChannelMessages/invoiceReceived/festivalItemsDebited'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FESTIVALTICKETSACCRUED = '#messenger:serviceChannelMessages/invoiceReceived/festivalTicketsAccrued'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_FESTIVALTICKETSDEBITED = '#messenger:serviceChannelMessages/invoiceReceived/festivalTicketsDebited'
    ...
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_CHEVRONSLOST = '#messenger:serviceChannelMessages/BRbattleResults/chevronsLost'
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_CHEVRONSEARNED = '#messenger:serviceChannelMessages/BRbattleResults/chevronsEarned'
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_CHEVRONSSAVED = '#messenger:serviceChannelMessages/BRbattleResults/chevronsSaved'
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_TITLELOST = '#messenger:serviceChannelMessages/BRbattleResults/titleLost'
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_TITLEEARNED = '#messenger:serviceChannelMessages/BRbattleResults/titleEarned'
