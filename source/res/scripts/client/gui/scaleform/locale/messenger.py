...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_COMPENSATION_PROJECTION_DECAL = '#messenger:serviceChannelMessages/invoiceReceived/compensation/projection_decal'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_COMPENSATION_PERSONAL_NUMBER = '#messenger:serviceChannelMessages/invoiceReceived/compensation/personal_number'
