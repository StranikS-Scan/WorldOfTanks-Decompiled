...
class QUESTS(object):
    ...
    DETAILS_RELATIONS_GREATER = '#quests:details/relations/greater'
    DETAILS_RELATIONS_LESS = '#quests:details/relations/less'
    DETAILS_RELATIONS_EQUAL = '#quests:details/relations/equal'
    DETAILS_RELATIONS_NOTEQUAL = '#quests:details/relations/notEqual'
    DETAILS_RELATIONS_LESSOREQUAL = '#quests:details/relations/lessOrEqual'
    DETAILS_RELATIONS_GREATEROREQUAL = '#quests:details/relations/greaterOrEqual'
    ...
    DETAILS_CONDITIONS_RESULTS_UNIT_ALIVE = '#quests:details/conditions/results/unit/alive'
    DETAILS_CONDITIONS_RESULTS_UNIT_ALIVE_NOT = '#quests:details/conditions/results/unit/alive/not'
    DETAILS_CONDITIONS_RESULTS_UNIT_SIMPLE = '#quests:details/conditions/results/unit/simple'
    DETAILS_CONDITIONS_RESULTS_UNIT_AVG = '#quests:details/conditions/results/unit/avg'
    DETAILS_CONDITIONS_CUMULATIVE_SINGLE = '#quests:details/conditions/cumulative/single'
    DETAILS_CONDITIONS_CUMULATIVE_UNIT = '#quests:details/conditions/cumulative/unit'
