...
class RES_COMMON(object):
    ...
    MAPS_ICONS_EVENT_BANNERTOOLTIP_BG = '../maps/icons/event/bannerTooltip/bg.png'
    MAPS_ICONS_EVENT_HANGAR_BG = '../maps/icons/event/hangar/bg.png'
    MAPS_ICONS_EVENT_HANGAR_CHARACTERISTICS_BG = '../maps/icons/event/hangar/characteristics/bg.png'
    MAPS_ICONS_EVENT_SHOP21_BG = '../maps/icons/event/shop21/bg.png'
    MAPS_ICONS_EVENT_VIDEO_BG = '../maps/icons/event/video/bg.png'
    ...
    MAPS_ICONS_YHA_BG = '../maps/icons/yha/bg.png'
