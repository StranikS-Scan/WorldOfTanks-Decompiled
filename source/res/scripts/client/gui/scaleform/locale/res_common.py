...
class RES_COMMON(object):
    ...
    MAPS_ICONS_NEWYEAR_RESOURCEPROGRESSION_BG = '../maps/icons/newYear/resourceProgression/bg.png'
    MAPS_ICONS_NEWYEAR_SHOPOVERLAY_BG = '../maps/icons/newYear/shopOverlay/bg.png'
