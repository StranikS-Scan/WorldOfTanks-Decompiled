...
class TOOLTIPS(object):
    ...
    FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_VEHICLENOTVALID_BODY = FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_VEHICLENOTVALID + '/body'
    FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_NOTINSLOT_BODY = FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_NOTINSLOT + '/body'
    FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_PRESSFORREADY_BODY = FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_PRESSFORREADY + '/body'
    FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_PRESSFORNOTREADY_BODY = FORTIFICATION_FORTCLANBATTLEROOM_FIGHTBTN_PRESSFORNOTREADY + '/body'
