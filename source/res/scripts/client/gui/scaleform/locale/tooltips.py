...
class TOOLTIPS(object):
    ...
    AWARDITEM_RANDOMNYINSTRUCTION_HEADER = '#tooltips:awardItem/randomNyInstruction/header'
    AWARDITEM_RANDOMNYINSTRUCTION_BODY = '#tooltips:awardItem/randomNyInstruction/body'
    AWARDITEM_RANDOMNYBOOKLET_HEADER = '#tooltips:awardItem/randomNyBooklet/header'
    AWARDITEM_RANDOMNYBOOKLET_BODY = '#tooltips:awardItem/randomNyBooklet/body'
    AWARDITEM_RANDOMNYGUIDE_HEADER = '#tooltips:awardItem/randomNyGuide/header'
    AWARDITEM_RANDOMNYGUIDE_BODY = '#tooltips:awardItem/randomNyGuide/body'
    AWARDITEM_RANDOMNY24TOY_HEADER = '#tooltips:awardItem/randomNy24Toy/header'
    AWARDITEM_RANDOMNY24TOY_BODY = '#tooltips:awardItem/randomNy24Toy/body'
    ...
    AWARDITEM_ALL_HEADER_ENUM = (AWARDITEM_GROUPS_HEADER,
     ...
     AWARDITEM_RANDOMNYINSTRUCTION_HEADER,
     AWARDITEM_RANDOMNYBOOKLET_HEADER,
     AWARDITEM_RANDOMNYGUIDE_HEADER,
     AWARDITEM_RANDOMNY24TOY_HEADER)
    AWARDITEM_ALL_BODY_ENUM = (AWARDITEM_GROUPS_BODY,
     ...
     AWARDITEM_RANDOMNYINSTRUCTION_BODY,
     AWARDITEM_RANDOMNYBOOKLET_BODY,
     AWARDITEM_RANDOMNYGUIDE_BODY,
     AWARDITEM_RANDOMNY24TOY_BODY)
