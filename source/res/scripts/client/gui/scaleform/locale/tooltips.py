...
class TOOLTIPS(object):
    ...
    AWARDITEM_NY20FILLERS_HEADER = '#tooltips:awardItem/ny20Fillers/header'
    AWARDITEM_NY20FILLERS_BODY = '#tooltips:awardItem/ny20Fillers/body'
