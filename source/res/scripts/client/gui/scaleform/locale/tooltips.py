...
class TOOLTIPS(object):
    ...
    VEHICLECOLLECTORINFO_HEADER = '#tooltips:vehicleCollectorInfo/header'
    VEHICLECOLLECTORINFO_BODY = '#tooltips:vehicleCollectorInfo/body'
    VEHICLECOLLECTORINFO_NOTE = '#tooltips:vehicleCollectorInfo/note'
