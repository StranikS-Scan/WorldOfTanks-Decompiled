...
class _BattleBonusTypeFormatter(ConditionFormatter):
    ...
    def _format(self, condition, event):
        ...
        if not event.isGuiDisabled():
            ...
            if len(bonusTypes) == 1 and findFirst(None, bonusTypes) in (ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.RANKED, ARENA_BONUS_TYPE.COMP7) or ARENA_BONUS_TYPE.EVENT_BATTLES in bonusTypes:
