...
__all__ = ('ArgsEvent', 'ComponentEvent', 'LoadViewEvent', 'LoadGuiImplViewEvent', 'ShowDialogEvent', 'LoginEvent', 'LoginEventEx', 'LobbySimpleEvent', 'FightButtonDisablingEvent', 'FightButtonEvent', 'CloseWindowEvent', 'BrowserEvent', 'HangarVehicleEvent', 'HangarCustomizationEvent', 'GameEvent', 'BootcampEvent', 'ViewEventType', 'OpenLinkEvent', 'ChannelManagementEvent', 'PreBattleChannelEvent', 'AmmunitionSetupViewEvent', 'HasCtxEvent', 'DogTagsEvent', 'FullscreenModeSelectorEvent', 'ModeSelectorPopoverEvent', 'ModeSelectorLoadedEvent', 'ModeSubSelectorEvent', 'NyGladeVisibilityEvent', 'NyCelebrityRewardEvent', 'NyMarketPlaceRewardEvent', 'NyCelebrityStoriesEvent', 'NyCelebrityAnimationEvent', 'MarkerEvent')
...
class MarkerEvent(HasCtxEvent):
    SCALABLE_ALLOWED_CHANGE = 'markersScalableChange'
...
class NyCelebrityRewardEvent(HasCtxEvent):
    REWARD_GUEST_VIEW_CLOSED = 'rewardGuestViewClosed'
    REWARD_GUEST_VIEW_OPENED = 'rewardGuestViewOpened'
    REWARD_CHALLENGE_VIEW_CLOSED = 'rewardChallengeViewClosed'
    REWARD_CHALLENGE_VIEW_OPENED = 'rewardChallengeViewOpened'
