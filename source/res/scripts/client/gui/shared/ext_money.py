...
# Embedded file name: scripts/client/gui/shared/ext_money.py
...
class ExtendedMoney(Money):
    ...
    def __init__(self, xp=None, vehXP=None, freeXP=None, *args, **kwargs):
        ...
        if kwargs.get(FREE_XP_CODE) is not None:
            self._values[_FREE_XP] = kwargs[FREE_XP_CODE]
        return
