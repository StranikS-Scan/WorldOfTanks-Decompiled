...
__all__ = ('standard', 'main', 'mainBig', 'neutral', 'stats', 'statInfo', 'statusAttention', 'statusAlert', 'statusAttention', 'middleTitle', 'highTitle', 'highTitleAccented', 'highTitleDisabled', 'disabled', 'promoTitle', 'promoSubTitle', 'alert', 'alertBig', 'success', 'statsIncrease', 'error', 'warning', 'critical', 'expText', 'statsDecrease', 'expTextBig', 'gold', 'credits', 'crystal', 'defRes', 'counter', 'titleFont', 'tutorial', 'playerOnline', 'getRawStyles', 'getStyles', 'concatStylesToSingleLine', 'concatStylesToMultiLine', 'superPromoTitle', 'superPromoTitleEm', 'highlightText', 'unavailable', 'missionStatusAvailable', 'epicTitle', 'epicTitleYellow', 'heroTitle', 'heroTitleYellow', 'heroTitleTK', 'grandTitle', 'grandTitleYellow', 'grandTitleTK', 'grandTitleRed', 'textEpic', 'yellowText', 'greenText', 'poiCapturedBoldText', 'poiCapturedRegularText', 'prestige', 'statusSimple', 'statusBright', 'cream', 'creamBold', 'creamTitle', 'lightGray', 'lightBlue', 'bptaler')
