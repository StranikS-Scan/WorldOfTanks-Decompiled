...
class KPI(object):
    ...
    class Name(CONST_CONTAINER):
        ...
        TRACK_RAMMING_DAMAGE_FACTOR = 'trackRammingDamageFactor'
        ...
        CHARGE_TIME_BONUS = 'chargeTimeBonus'
        PENALTY_AFTER_SHOT_BONUS = 'penaltyAfterShotBonus'
        LOAD_SHELL_INTO_DUALGUN_BONUS = 'loadShellIntoDualGunBonus'
        SPEED_LIMITS_BONUS = 'speedLimitsBonus'
        ABILITY_DURATION_BONUS = 'abilityDurationBonus'
        VEHICLE_GUN_RELOAD_PENALTY = 'vehicleGunReloadPenalty'
        ABILITY_COOLDOWN_BONUS = 'abilityCooldownBonus'
...
def kpiFormatNoSignWithSpec(kpiName, values, addEnding=True):
    ...
    return (kpiFormatNoSignValue(kpiName, value, False), kpiFormatNoSignValue(kpiName + 'Spec', specValue, addEnding))
