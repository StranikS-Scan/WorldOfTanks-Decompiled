...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement),
 ...
 (_AB.UNIQUE, 'wt2022HunterWins'): _AchieveFactory.get(_abstract_achievements.QuestAchievement),
 (_AB.UNIQUE, 'wt2022BossWins'): _AchieveFactory.get(_abstract_achievements.QuestAchievement),
 (_AB.TOTAL, 'wt2022SpecBossDefeat'): _AchieveFactory.get(_abstract_achievements.QuestAchievement)}
