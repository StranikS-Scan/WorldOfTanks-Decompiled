...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.WarriorAchievement),
 ...
 (_AB.TOTAL, 'FE18ClosedStage'): _AchieveFactory.get(_as.FE18StageAchievement),
 (_AB.TOTAL, 'FE18SoloStriker'): _AchieveFactory.get(_as.FE18StageAchievement),
 (_AB.TOTAL, 'FE18SoloMidfielder'): _AchieveFactory.get(_as.FE18StageAchievement),
 (_AB.TOTAL, 'FE18SoloDefender'): _AchieveFactory.get(_as.FE18StageAchievement),
