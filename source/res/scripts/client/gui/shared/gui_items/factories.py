...
class GuiItemFactory(IGuiItemsFactory):
    ...
    def createShell(self, intCompactDescr, count=0, proxy=None, isBoughtForCredits=False, weight=1):
        return Shell(intCompactDescr, count, proxy, isBoughtForCredits, weight)
