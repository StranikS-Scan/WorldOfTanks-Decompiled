...
class _ParameterInfo(collections.namedtuple('_ParameterInfo', ('name',
 'value',
 'state',
 'possibleBonuses',
 'inactiveBonuses',
...
CONDITIONAL_BONUSES = {('invisibilityMovingFactor',
 ...
 ('ration_intunion', BonusTypes.EQUIPMENT),
 ...
 ('modernizedDamageVentilation3', BonusTypes.OPTIONAL_DEVICE)): (('camouflage', BonusTypes.SKILL),),
 ...
 ('modernizedDamageVentilation1', BonusTypes.OPTIONAL_DEVICE),
 ('modernizedDamageVentilation2', BonusTypes.OPTIONAL_DEVICE),
 ('modernizedDamageVentilation3', BonusTypes.OPTIONAL_DEVICE)): (('repair', BonusTypes.SKILL),),
                          (('improvedVentilationBattleBooster', BonusTypes.BATTLE_BOOSTER),): (('improvedVentilation_tier1', BonusTypes.OPTIONAL_DEVICE),
                                                                                               ('improvedVentilation_tier2', BonusTypes.OPTIONAL_DEVICE),
                                                                                               ('improvedVentilation_tier3', BonusTypes.OPTIONAL_DEVICE),
                                                                                               ('deluxImprovedVentilation', BonusTypes.OPTIONAL_DEVICE),
 ...
 'reloadTimeSecs',
 'avgDamagePerMinute',
 AUTOSHOOT_FLAME_CHANGE_SHELL_TIME): {(('improvedVentilationBattleBooster', BonusTypes.BATTLE_BOOSTER),): (('improvedVentilation_tier1', BonusTypes.OPTIONAL_DEVICE),
                                                                                                                                                                     ('improvedVentilation_tier2', BonusTypes.OPTIONAL_DEVICE),
                                                                                                                                                                     ('improvedVentilation_tier3', BonusTypes.OPTIONAL_DEVICE),
                                                                                                                                                                     ('deluxImprovedVentilation', BonusTypes.OPTIONAL_DEVICE),
                                                                                                                                                                     ('trophyBasicImprovedVentilation', BonusTypes.OPTIONAL_DEVICE),
 ...
 'enginePowerPerTon',
 'turboshaftEnginePower'): {(('turbochargerBattleBooster', BonusTypes.BATTLE_BOOSTER),): (('turbocharger_tier1', BonusTypes.OPTIONAL_DEVICE),
 ...
 ('avgDamage',): {((),): (('modernizedDamageVentilation1', BonusTypes.OPTIONAL_DEVICE), ('modernizedDamageVentilation2', BonusTypes.OPTIONAL_DEVICE), ('modernizedDamageVentilation3', BonusTypes.OPTIONAL_DEVICE))}}
