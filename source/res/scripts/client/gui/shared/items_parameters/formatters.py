...
ITEMS_PARAMS_LIST = {ITEM_TYPES.vehicleRadio: ('radioDistance', 'weight'),
 ...
 ITEM_TYPES.vehicleEngine: ('enginePower',
                            ...
                            'fireStartingChance',
                            'weight'),
 ITEM_TYPES.vehicleTurret: ('armor',
                            'rotationSpeed',
                            'circularVisionRadius',
                            'weight'),
 ITEM_TYPES.vehicle: VEHICLE_PARAMS,
 ITEM_TYPES.equipment: {artefacts.RageArtillery: ('damage',
                                                  'piercingPower',
                                                  'caliber',
                                                  'shotsNumberRange',
                                                  'areaRadius',
                                                  'artDelayRange'),
                        artefacts.RageBomber: ('bombDamage',
                                               'piercingPower',
                                               'bombsNumberRange',
                                               'areaSquare',
                                               'flyDelayRange'),
                        artefacts.AttackArtilleryFortEquipment: ('maxDamage',
                                                                 'areaRadius',
                                                                 'duration',
                                                                 'commonDelay'),
                        artefacts.FortConsumableInspire: ('crewRolesFactor',
                                                          'commonAreaRadius',
                                                          'inactivationDelay',
                                                          'duration'),
                        artefacts.ConsumableInspire: ('crewRolesFactor',
                                                      'commonAreaRadius',
                                                      'inactivationDelay',
                                                      'duration')},
...
FORMAT_SETTINGS = {'relativePower': _integralFormat,
 ...
 CRITICAL_HIT_CHANCE: {'preprocessor': formatCriticalHitChance,
                       'rounder': lambda v: v}}
...
def _cutDigits(value):
    ...
    return decimal_round(value, 1) if abs(value) > 9 else decimal_round(value, 2)
