...
_integralRangeFormat = {'rounder': backport.getIntegralFormat,
 'separator': _DASH}
...
MEASURE_UNITS = {'aimingTime': MENU.TANK_PARAMS_S,
 ...
 'distanceFactorDamage': MENU.TANK_PARAMS_VAL,
 'distanceFactorPiercingPower': MENU.TANK_PARAMS_MM,
 'avgDamagePerMinute': MENU.TANK_PARAMS_VPM,
 'damagePerSecond': MENU.TANK_PARAMS_VPS,
 'avgDamagePerSecond': MENU.TANK_PARAMS_VPS,
 ...
 'shotSpeedAccelerated': MENU.TANK_PARAMS_MPS,
...
KPIFormatter = namedtuple('KPIFormatter', ['formatter', 'separator', 'addEnding'])
...
ITEMS_PARAMS_LIST = {ITEM_TYPES.vehicleRadio: ('radioDistance', 'weight'),
 ...
 ITEM_TYPES.shell: ('caliber', 'damage', 'damagePerSecond', 'avgPiercingPower', 'shotSpeed', 'explosionRadius', 'flameMaxDistance', 'stunMaxDuration', 'shotSpeedAccelerated'),
...
MULTIPLE_TITLES_PARAMS = {CHASSIS_REPAIR_TIME: ChangeCondition(useYohChassisRepairTime, CHASSIS_REPAIR_TIME_YOH),
 SHELLS_COUNT_PROP_NAME: ChangeCondition(useAutoShootGunShellsCount, 'autoShootShellsCount')}
    ...
    if not hasattr(reloadTimes, '__iter__'):
        ...
        if len(times) > _COUNT_OF_AUTO_RELOAD_SLOTS_TIMES_TO_SHOW_IN_INFO:
            ...
            if states:
                ...
                return ((minTime, maxTime), _DASH, (minState, maxState))
...
FORMAT_SETTINGS = {'relativePower': _integralFormat,
 ...
 'flameMaxDistance': _niceListFormat,
 ...
 'shotSpeedAccelerated': _integralRangeFormat,
