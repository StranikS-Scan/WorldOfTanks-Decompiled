...
class NYVehicleBonusTooltipWindowData(ToolTipBaseData):
    ...
    def __init__(self, context):
        super(NYVehicleBonusTooltipWindowData, self).__init__(context, TOOLTIPS_CONSTANTS.NY_VEHICLE_BONUS)
...
class NyCoinTokenTooltipContentWindowData(WulfTooltipData):

    def __init__(self, context):
        super(NyCoinTokenTooltipContentWindowData, self).__init__(context, TOOLTIPS_CONSTANTS.NY_COIN_TOKEN)
...
class NySackRandomRewardTooltipContentWindowData(WulfTooltipData):

    def __init__(self, context):
        super(NySackRandomRewardTooltipContentWindowData, self).__init__(context, TOOLTIPS_CONSTANTS.NY_SACK_RANDOM_REWARD)

    def getTooltipContent(self, *args, **kwargs):
        return NySackRandomRewardTooltip(*args)
