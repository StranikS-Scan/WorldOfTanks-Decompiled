...
from skeletons.gui.game_control import ITradeInController, IWotPlusController, IEventBattlesController
...
class VehicleInfoTooltipData(BlocksTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        valueWidth = 77
        textGap = -2
        anyExpires = any((arg == 'anyExpires' for arg in args if isinstance(arg, str)))
        if vehicle.rentInfo and vehicle.rentInfo.anyExpires or anyExpires:
