...
class _ParametersCache(object):
    ...
    def __getItemDescriptor(self, typeIdx, nationIdx, itemID):
        return vehicles.VehicleDescr(typeID=(nationIdx, itemID)) if typeIdx == vehicles._VEHICLE else vehicles.getDictDescr(itemID)
    ...
    def __getItems(self, typeIdx, nationIdx=None):
        if nationIdx is None:
            ...
            return list() if items is None else items
