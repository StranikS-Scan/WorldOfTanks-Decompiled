...
SHOT_SPEED_ACCELERATED_PROP_NAME = 'shotSpeedAccelerated'
DISTANCE_DAMAGE_PROP_NAME = 'distanceDamage'
...
THERMAL_VISION_REUSE_AND_DURATION = 'thermalVisionReuseAndDuration'
THERMAL_VISION_DISTANCE = 'thermalVisionDistance'
THERMAL_VISION_RELOAD_TIME = 'thermalVisionReloadTime'
THERMAL_VISION_OBSERVE_TIME = 'thermalVisionObserveTime'
...
RELOAD_TIME_PER_SECOND = 'reloadTimePerSecond'
AVG_DAMAGE_PER_SECOND = 'avgDamagePerSecond'
AUTOSHOOT_FLAME_CHANGE_SHELL_TIME = 'autoShootFlameChangeShellTime'
AUOTSHOOT_FLAME_OVERHEAT_COOLING_TIME = 'autoShootFlameOverheatCoolingTime'
AUTOSHOOT_FIRE_UNTIL_OVERHEAT_TIME = 'autoShootFireUntilOverheatTime'
FLAME_MAX_DISTANCE = 'flameMaxDistance'
GUN_RELOADING_TYPE = 'gunReloadingType'
CHASSIS_REPAIR_TIME = 'chassisRepairTime'
CHASSIS_REPAIR_TIME_YOH = 'chassisRepairTimeYoh'
CHASSIS_REPAIR_TIME_MULTITRACK_SEQUENT = 'chassisRepairTimeMultiTrackSequent'
CHASSIS_REPAIR_TIME_MULTITRACK_PARALLEL = 'chassisRepairTimeMultiTrackParallel'
GUN_CAN_BE_CLIP = 1
GUN_CLIP = 2
GUN_NORMAL = 4
