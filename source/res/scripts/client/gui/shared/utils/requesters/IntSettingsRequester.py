...
class IntSettingsRequester(object):
    __SETTINGS = {'VERSION': 0,
     ...
     'HW20_NARRATIVE': constants.USER_SERVER_SETTINGS.HW20_NARRATIVE,
     'HW20_NARRATIVE_ROASTER_MED_HIGH': constants.USER_SERVER_SETTINGS.HW20_NARRATIVE_ROASTER_MED_HIGH,
     ...
     'ROYALE_CAROUSEL_FILTER_1': 101,
     'ROYALE_CAROUSEL_FILTER_2': 102}
