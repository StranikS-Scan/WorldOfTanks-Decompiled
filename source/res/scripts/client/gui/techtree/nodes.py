...
# Embedded file name: scripts/client/gui/techtree/nodes.py
import typing
...
class RealNode(ExposedNode):
    ...
    def getTypeName(self):
        return GUI_ITEM_TYPE_NAMES[self.__item.itemTypeID]
