...
__all__ = ('NODE_STATE', 'RequestState', 'UnlockProps', 'DEFAULT_UNLOCK_PROPS', 'BpfProps', '_DEFAULT_BPF_PROPS', 'VehicleClassInfo', 'MAX_PATH_LIMIT', 'RESEARCH_ITEMS', 'TREE_SHARED_REL_FILE_PATH', 'NATION_TREE_REL_FILE_PATH', 'TreeDataFilesPath')
TREE_SHARED_REL_FILE_PATH = 'gui/techtree/tree-shared.xml'
NATION_TREE_REL_FILE_PATH = 'gui/techtree/{}-tree.xml'
NATION_TREE_REL_PREMIUM_FILE_PATH = 'gui/techtree/{}-premium.xml'
TreeDataFilesPath = namedtuple('TreeDataFilesPath', 'shared nation nationPremium')
