...
# Embedded file name: scripts/client/gui/veh_post_porgression/models/modifications.py
import typing
from enum import Enum, unique
from gui.impl.gen import R
from gui.impl.gen_utils import DynAccessor
from gui.veh_post_porgression.models.ext_money import ExtendedMoney, ExtendedGuiItemEconomyCode, EXT_MONEY_UNDEFINED, EXT_MONEY_ZERO_CREDITS
