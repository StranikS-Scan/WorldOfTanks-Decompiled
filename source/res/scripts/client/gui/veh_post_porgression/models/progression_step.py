...
# Embedded file name: scripts/client/gui/veh_post_porgression/models/progression_step.py
import typing
from enum import Enum, unique
from gui.veh_post_porgression.models.ext_money import ExtendedMoney, ExtendedGuiItemEconomyCode
from gui.veh_post_porgression.models.modifications import getActionModel
from gui.veh_post_porgression.models.purchase import PurchaseProvider, PurchaseCheckResult, VALID_CHECK_RESULT
from items.components.post_progression_components import TreeStep
if typing.TYPE_CHECKING:
    from items.artefacts_helpers import VehicleFilter
    from gui.veh_post_porgression.models.modifications import SimpleModItem, MultiModsItem, FeatureModItem, RoleSlotModItem
...
class PostProgressionStepItem(PurchaseProvider):
    ...
    def getHackedState(self):
        needHack = self.isReceived() and not self.action.isPurchased()
        return PostProgressionStepState.UNLOCKED if needHack else self.__state
