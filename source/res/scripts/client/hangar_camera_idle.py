...
# Embedded file name: scripts/client/hangar_camera_idle.py
import math
import BigWorld
import Math
import WWISE
...
_STATE_HANGAR_CAM_ROTATING = 'STATE_hangar_camera_rotating'
_SOUND_STATE_CAM_ROTATING_OFF = '{}_off'.format(_STATE_HANGAR_CAM_ROTATING)
_SOUND_STATE_CAM_ROTATING_ON = '{}_on'.format(_STATE_HANGAR_CAM_ROTATING)
...
class HangarCameraIdle(CallbackDelayer, TimeDeltaMeter):
    ...
    def __startCameraIdle(self):
        WWISE.WW_setState(_STATE_HANGAR_CAM_ROTATING, _SOUND_STATE_CAM_ROTATING_ON)
    ...
    def __stopCameraIdle(self):
        WWISE.WW_setState(_STATE_HANGAR_CAM_ROTATING, _SOUND_STATE_CAM_ROTATING_OFF)
        self.stopCallback(self.__updateIdleMovement)
        self.__currentIdleTime = 0.0
