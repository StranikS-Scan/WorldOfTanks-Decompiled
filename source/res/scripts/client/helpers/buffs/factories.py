...
from helpers.buffs.components import EffectBuffComponent, ModelBuffComponent, IconBuffComponent, DecalBuffComponent, TerrainCircleBuffComponent, AuraVictimVisualComponent, LaserBeamBuffComponent, SequenceBuffComponent, InvulnerabilityBuffComponent, ExhaustBuffComponent, RibbonBuffComponent, SoundBuffComponent
...
class ClientBuffFactory(BuffFactory):
    ...
    def _xmlFactories(self):
        return {'effect': EffectBuffComponentFactory,
         'sound': SoundBuffComponentFactory,
         ...
         'auraVictimEffect': AuraVictimVisualComponentFactory,
         'laserBeam': LaserBeamBuffComponentFactory,
         ...
         'ribbon': RibbonBuffComponentFactory}
...
class AuraVictimVisualComponentFactory(ClientBuffComponentFactory):

    @property
    def _componentClass(self):
        return AuraVictimVisualComponent


class LaserBeamBuffComponentFactory(ClientBuffComponentFactory):
...
class RibbonBuffComponentFactory(ClientBuffComponentFactory):
