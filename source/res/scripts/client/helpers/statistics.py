...
_HANGAR_LOADING_STATES = ['LOGIN',
 ...
 'SPACE LOADING END',
 'HANGAR UI READY',
 ' GAMEFACE UI LOADING SCREEN DESTROYED',
 'TRAINING UI READY',
 'HANGAR READY',
...
class StatisticsCollector(IStatisticsCollector):
    ...
    def __getSystemData(self, statisticsDict):
        return {'isLaptop': statisticsDict['isLaptop'],
         ...
         'prevHasMods': statisticsDict['prevHasMods'],
         'prevCrashAddr': statisticsDict['prevCrashAddr'],
         'prevClientVersion': statisticsDict['prevClientVersion'],
