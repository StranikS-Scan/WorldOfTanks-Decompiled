...
SERVER_FORMATTERS = {_SM_TYPE.serverReboot.index(): _sc.ServerRebootFormatter(),
 ...
 _SM_TYPE.eventBuyBundleReward.index(): _sc.EventBuyBundleFormatter(),
 _SM_TYPE.eventGeneralLevelReached.index(): _sc.EventUnitProgressFormatter(),
 _SM_TYPE.eventGeneralBundleBuyReward.index(): _sc.EventBuyUnitBundleFormatter(),
 _SM_TYPE.eventSE20EnergyDraw.index(): _sc.EventSE20EnergyDrawFormatter(),
 _SM_TYPE.eventFrontLevelReached.index(): _sc.TokenQuestsFormatter(),
 _SM_TYPE.eventGeneralLevelReached.index(): _sc.TokenQuestsFormatter(),
 _SM_TYPE.eventExchangerOrder.index(): _sc.EventExchangeOrderFormatter()}
