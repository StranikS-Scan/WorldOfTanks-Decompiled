...
SERVER_FORMATTERS = {_SM_TYPE.serverReboot.index(): _sc.ServerRebootFormatter(),
 ...
 _SM_TYPE.eventFrontReward.index(): _sc.EventFrontRewardFormatter(),
 _SM_TYPE.eventFrontLevelReached.index(): _sc.EventFrontLevelReachedFormatter(),
 _SM_TYPE.eventGeneralLevelReached.index(): _sc.EventGeneralLevelReachedFormatter(),
 _SM_TYPE.prbWrongFrontKick.index(): _sc.PrbEventWrongFrontFormatter(),
 _SM_TYPE.eventGeneralReward.index(): _sc.EventGeneralRewardFormatter(),
 _SM_TYPE.eventGeneralBuyReward.index(): _sc.EventGeneralBuyRewardFormatter()}
