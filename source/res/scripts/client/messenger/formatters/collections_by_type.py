...
registerLootBoxAutoOpenSubFormatters((auto_boxes_subformatters.EventBoxesFormatter(),
 ...
 auto_boxes_subformatters.NyLootBoxSystemAutoOpenFormatter()))
...
SERVER_FORMATTERS = {_SM_TYPE.serverReboot.index(): _sc.ServerRebootFormatter(),
 ...
 _SM_TYPE.goodiesExpired.index(): _sc.GoodiesExpiredFormatter(),
 ...
 _SM_TYPE.wotPlusUnlocked.index(): _wotPlusFormatters.WotPlusUnlockedAwardFormatter(),
...
def initRegistrationFormatters():
    ...
    registerMessengerClientFormatter(SCH_CLIENT_MSG_TYPE.NY_BREED_BOUGHT_MESSAGE, _sc.NYBreedBoughtFormatter())
