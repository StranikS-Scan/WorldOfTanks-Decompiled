...
class SCH_CLIENT_MSG_TYPE(object):
    SYS_MSG_TYPE, PREMIUM_ACCOUNT_EXPIRY_MSG, AOGAS_NOTIFY_TYPE, ACTION_NOTIFY_TYPE, BATTLE_TUTORIAL_RESULTS_TYPE, KOREA_PARENTAL_CONTROL_TYPE, TECH_TREE_ACTION_DISCOUNT, NEW_NY_LOOT_BOXES = range(8)
