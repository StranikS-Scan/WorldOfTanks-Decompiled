...
class SCH_CLIENT_MSG_TYPE(object):
    ...
    BATTLE_MATTERS_PAUSED = 12
    BATTLE_MATTERS_STARTED = 13
    ...
    WOTPLUS_TANKRENTAL_DISABLED = 20
    WOTPLUS_TANKRENTAL_ENABLED = 21
    WOTPLUS_FREEDIRECTIVES_DISABLED = 22
    WOTPLUS_FREEDIRECTIVES_ENABLED = 23
    INTEGRATED_AUCTION_LOST_RATE = 24
