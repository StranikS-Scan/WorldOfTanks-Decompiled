...
class SCH_CLIENT_MSG_TYPE(object):
    ...
    INTEGRATED_AUCTION_LOST_RATE = 20
    ...
    NY_EVENT_BUTTON_MESSAGE = 401
    NY_RESOURCES_CONVERTED_MESSAGE = 402
    NY_GUEST_QUEST_COMPLETED_MESSAGE = 403
    NY_COLLECTING_MESSAGE = 404
    NY_CURRENCY_FINANCIAL_OPERATION_MESSAGE = 407
    NY_COLLECTION_REWARD_MESSAGE = 408
    NY_FRIEND_RESOURCE_COLLECTING_AVAILABLE = 409
    NY_GF_SM_TYPE = 410
    NY_SACK_BOUGHT_MESSAGE = 411
