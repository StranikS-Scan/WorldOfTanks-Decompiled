...
_reloadingChatCommandsWithParams = {BATTLE_CHAT_COMMAND_NAMES.RELOADINGGUN: ('rTime',),
 ...
 BATTLE_CHAT_COMMAND_NAMES.RELOADING_CASSETE_AUTO_SHOOT: ('rTime', 'ammoQuantityLeft'),
 BATTLE_CHAT_COMMAND_NAMES.RELOADING_READY_CASSETE: ('ammoInCassete',),
 BATTLE_CHAT_COMMAND_NAMES.RELOADING_READY_CASSETE_AUTO_SHOOT: ('ammoInCassete',)}
