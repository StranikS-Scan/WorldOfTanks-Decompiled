...
_battleChatShortcuts = (CHAT_COMMANDS.HELPME.name(),
 ...
 CHAT_COMMANDS.EVENT_CHAT_1.name(),
 CHAT_COMMANDS.EVENT_CHAT_2.name(),
 CHAT_COMMANDS.EVENT_CHAT_3.name(),
 CHAT_COMMANDS.EVENT_CHAT_4.name(),
 CHAT_COMMANDS.EVENT_CHAT_5.name(),
 CHAT_COMMANDS.EVENT_CHAT_6.name(),
 CHAT_COMMANDS.EVENT_CHAT_7.name(),
 CHAT_COMMANDS.EVENT_CHAT_1_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_2_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_3_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_4_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_5_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_6_EX.name(),
 CHAT_COMMANDS.EVENT_CHAT_7_EX.name())
