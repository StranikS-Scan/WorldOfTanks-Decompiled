...
class _MessengerEvents(object):
    __slots__ = ('__channels', '__users', '__serviceChannel', '__voip', '__shadow', '__eventManager', 'onErrorReceived', 'onWarningReceived', 'onPluginConnected', 'onPluginDisconnected', 'onPluginConnectFailed', 'onLockPopUpMessages', 'onUnlockPopUpMessages', 'onComp7VOIPNotificationReceived')
