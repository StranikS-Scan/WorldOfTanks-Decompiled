...
from gui.shared.event_dispatcher import showCelebrityGuestReward
...
class CelebrityController(ICelebrityController):
    ...
    def __init__(self):
        ...
        self.onCelebActionTokensUpdated = Event(self.__eventsManager)
    ...
    def __handleGuestQuestComplete(self, guestName, questIndex):
        ...
        if quest is None:
            ...
            self.onCelebActionTokensUpdated()
            ...
            showCelebrityGuestReward(guestName, questIndex)
            return
