...
class GiftMachineController(IGiftMachineController):
    ...
    def __init__(self):
        ...
        self.__canSkipAnimState = None
        self.__canRedButtonPressState = None
    ...
    def __canBuy(self):
        return self.__nyController.isEnabled() and NewYearAtmospherePresenter.isMaxLevel() and self.__celebrityController.isGuestQuestsCompletedFully((GuestsQuestsTokens.GUEST_A, GuestsQuestsTokens.GUEST_M))
