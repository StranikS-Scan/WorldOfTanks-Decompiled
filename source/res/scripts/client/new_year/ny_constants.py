...
class MegaDecorationsObjects(CONST_CONTAINER):
    FIR = 'Mega_Fir_Camera'
    FAIR = 'Mega_Fair_Camera'
    INSTALLATION = 'Mega_Installation_Camera'
...
NY_ATM_VIDEO_SCREEN_LEVELS = 5
DAYS_BETWEEN_FRIEND_TAB_REMINDER = 3
MAX_TOKENS_DISPLAYED = 9999
...
class NyTabBarMarketplaceView(object):
    ...
    NY24_CATEGORY = Collections.NewYear24
    ALL = (NY18_CATEGORY,
     NY19_CATEGORY,
     NY20_CATEGORY,
     NY21_CATEGORY,
...
class NyGFNotificationTemplates(CONST_CONTAINER):
    ...
    NY_ATTACHED_3D_REWARDS = 'NyAttached3DRewards'
