...
class NyLootBoxesReceivedDecorator(NyMessageButtonDecorator):
...
class NYResourceCollectingAvailableDecorator(NyMessageButtonDecorator):

    def getType(self):
        return NOTIFICATION_TYPE.NY_RESOURCE_COLLECTING_AVAILABLE
