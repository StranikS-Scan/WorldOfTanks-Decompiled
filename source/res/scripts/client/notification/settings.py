...
class NOTIFICATION_TYPE(object):
    ...
    TRADING_CARAVAN_REFILL = 24
    PSACOIN_REMINDER = 25
    GIFT_SYSTEM_OPERATION = 26
    NEW_YEAR_SPECIAL_LOOTBOXES = 27
    CUSTOM_NOTIFICATIONS = 28
    BIRTHDAY_BONUS = 29
    BIRTHDAY_GIFT = 30
    BLACK_MARKET_STAGE_START = 31
    BLACK_MARKET_STAGE_FINISH = 32
    SENIORITY_AWARDS_OFFER = 33
    RANGE = None
...
ITEMS_MAX_LENGTHS = {NOTIFICATION_TYPE.MESSAGE: 250,
 ...
 NOTIFICATION_TYPE.NOTIFY_CENTER_POP_UP: 500,
 ...
 NOTIFICATION_TYPE.CUSTOM_NOTIFICATIONS: 1,
 NOTIFICATION_TYPE.BIRTHDAY_BONUS: 1,
 NOTIFICATION_TYPE.BIRTHDAY_GIFT: 1,
 NOTIFICATION_TYPE.BLACK_MARKET_STAGE_START: 1,
 NOTIFICATION_TYPE.BLACK_MARKET_STAGE_FINISH: 1,
 ...
 NOTIFICATION_TYPE.SENIORITY_AWARDS_OFFER: 1}
