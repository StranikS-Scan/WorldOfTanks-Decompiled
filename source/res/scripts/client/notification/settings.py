...
class NOTIFICATION_TYPE(object):
    ...
    NY_DOG_REMINDER = 28
    NY_MARKETPLACE_AVAILABLE = 29
    NY_FRIEND_RESOURCE_COLLECTING_AVAILABLE = 30
    NY_RESOURCE_REMINDER = 31
    NY_FRIEND_RESOURCE_REMINDER = 32
    NY_NO_FRIENDS_REMINDER = 33
    ADVENT_CALENDAR_DOORS_AVAILABLE = 34
    RANGE = None
...
ITEMS_MAX_LENGTHS = {NOTIFICATION_TYPE.MESSAGE: 250,
 ...
 NOTIFICATION_TYPE.NY_RESOURCE_REMINDER: 1,
 NOTIFICATION_TYPE.ADVENT_CALENDAR_DOORS_AVAILABLE: 1,
 NOTIFICATION_TYPE.NY_FRIEND_RESOURCE_REMINDER: 1,
 NOTIFICATION_TYPE.NY_NO_FRIENDS_REMINDER: 1}
