...
class _PlayerEvents(object):
    ...
    def __init__(self):
        ...
        self.onEnqueuedBattleRoyale = Event.Event()
        self.onEnqueuedBattleRoyaleTournament = Event.Event()
        self.onEnqueuedMapbox = Event.Event()
        self.onDequeuedMapbox = Event.Event()
        self.onDequeuedBattleRoyale = Event.Event()
        self.onEnqueuedRTS = Event.Event()
        self.onDequeuedRTS = Event.Event()
        self.onEnqueuedRTS1x1 = Event.Event()
        self.onDequeuedRTS1x1 = Event.Event()
        self.onEnqueuedRTSBootcamp = Event.Event()
        self.onEnqueuedRTSBootcampFailure = Event.Event()
        self.onDequeuedRTSBootcamp = Event.Event()
        self.onDequeuedBattleRoyaleTournament = Event.Event()
        self.onEnqueuedMapsTraining = Event.Event()
        self.onDequeuedMapsTraining = Event.Event()
        ...
        self.onEnqueuedBattleRoyaleFailure = Event.Event()
        self.onEnqueuedRTSFailure = Event.Event()
        self.onEnqueuedRTS1x1Failure = Event.Event()
        self.onEnqueuedBattleRoyaleTournamentFailure = Event.Event()
        self.onEnqueuedMapboxFailure = Event.Event()
        self.onEnqueuedMapsTrainingFailure = Event.Event()
        ...
        self.onKickedFromBattleRoyaleQueue = Event.Event()
        self.onKickedFromRTSQueue = Event.Event()
        self.onKickedFromRTS1x1Queue = Event.Event()
        self.onKickedFromRTSBootcampQueue = Event.Event()
        self.onKickedFromBattleRoyaleTournamentQueue = Event.Event()
        self.onKickedFromMapboxQueue = Event.Event()
        self.onKickedFromMapsTrainingQueue = Event.Event()
