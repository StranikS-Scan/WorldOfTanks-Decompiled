...
class PrebattleVehicle(IPrebattleVehicle):
    ...
    def selectAny(self):
        ...
        if not hunters:
            _logger.warning('No hunters available. Account does not have any hunter vehicles while being in WT hangar.')
            return
    ...
    def __isPreviewVehicle(self):
        return g_currentPreviewVehicle.item is not None
