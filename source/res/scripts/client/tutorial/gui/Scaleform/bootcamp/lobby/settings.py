...
BOOTCAMP_LOBBY_VIEW_SETTINGS = (GroupedViewSettings(VIEW_ALIAS.BOOTCAMP_MESSAGE_WINDOW, BCMessageWindow, 'BCMessageWindow.swf', ViewTypes.OVERLAY, '', None, ScopeTemplates.OVERLAY_SCOPE), GroupedViewSettings(VIEW_ALIAS.BOOTCAMP_NATIONS_WINDOW, BCNationsWindow, 'BCNationsWindow.swf', ViewTypes.OVERLAY, '', None, ScopeTemplates.OVERLAY_SCOPE))
