...
class TUTORIAL_SETTINGS(object):
    ...
    TANK_ACADEMY = _SettingsDesc('TANK_ACADEMY', True, True, False, False, 'TANK_ACADEMY', '{0:>s}/tank-academy-descriptor.xml'.format(DOC_DIRECTORY), TUTORIAL_DESCRIPTOR_PARSER, _ClassPath('tutorial.control.sales.context', 'SalesStartReqs', ()), _ClassPath('tutorial.control.sales', 'SalesControlsFactory', ()), _ClassPath('tutorial.gui.Scaleform.sales.proxy', 'SfSalesProxy', ()), TUTORIAL_LOBBY_DISPATCHER, 'tutorial.doc_loader.sub_parsers.sales', TUTORIAL_CHAPTER_PARSER)
