...
# Embedded file name: scripts/client/uilogging/decorators.py
from functools import wraps
from uilogging.base.loggers import BaseLogger, isUILoggingEnabled
from uilogging.logging_constants import KEYS_MAPPING
__all__ = ('loggerTarget', 'loggerEntry', 'simpleLog', 'logOnMatch', 'logOnCondition', 'logProperty')
