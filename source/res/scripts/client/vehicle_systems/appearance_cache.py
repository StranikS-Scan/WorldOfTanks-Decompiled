...
class _AppearanceCache(object):
    ...
    def __getWholeVehModels(self, vDesc):
        ...
        for chassie in vType.chassis:
            ...
            brprereqs.add(chassie.splineDesc.segmentModelLeft())
            brprereqs.add(chassie.splineDesc.segmentModelRight())
            brprereqs.add(chassie.splineDesc.segment2ModelLeft())
            brprereqs.add(chassie.splineDesc.segment2ModelRight())
