...
class OnVehicleEngineStateChange(Block, VehicleMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._out = self._makeEventOutputSlot('out')
        self._outPowerMode = self._makeDataOutputSlot('engineState', SLOT_TYPE.INT, None)
        return
...
class GetGunReloadTime(Block, VehicleMeta):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._clipInterval = self._makeDataOutputSlot('clipInterval', SLOT_TYPE.FLOAT, self._exec)
