...
from arena_components.player_type_specific_components import getPlayerTypeSpecificComponentsForFestivalRace
...
class EventBattleComponentAssembler(ClientArenaComponentAssembler):
    ...
    def assembleComponents(componentSystem):
        ...
        ClientArenaComponentAssembler._addArenaComponents(componentSystem, getPlayerTypeSpecificComponentsForFestivalRace())
