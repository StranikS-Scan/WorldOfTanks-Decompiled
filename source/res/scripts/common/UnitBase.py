...
from unit_roster_config import SquadRoster, UnitRoster, SpecRoster, EventRoster, EpicRoster, BattleRoyaleRoster, MapBoxRoster, FunRandomRoster, Comp7Roster, RankedRoster
if TYPE_CHECKING:
...
class UNIT_NOTIFY_CMD:
    ...
    REMOVED_VEHICLE_MAX_FLAMETHROWER_EXCEED = 21
...
UNIT_MGR_FLAGS_TO_PREBATTLE_TYPE = {UNIT_MGR_FLAGS.EVENT: PREBATTLE_TYPE.EVENT,
 ...
 UNIT_MGR_FLAGS.RANKED: PREBATTLE_TYPE.RANKED}
...
UNIT_MGR_FLAGS_TO_UNIT_MGR_ENTITY_NAME = {UNIT_MGR_FLAGS.EVENT: 'EventUnitMgr',
 ...
 UNIT_MGR_FLAGS.RANKED: 'RankedUnitMgr'}
...
UNIT_MGR_FLAGS_TO_QUEUE_TYPE = {UNIT_MGR_FLAGS.EVENT: QUEUE_TYPE.EVENT_BATTLES,
 ...
 UNIT_MGR_FLAGS.RANKED: QUEUE_TYPE.RANKED}
...
class ROSTER_TYPE:
    ...
    RANKED_ROSTER = UNIT_MGR_FLAGS.SQUAD | UNIT_MGR_FLAGS.RANKED
    VERSUS_AI_ROSTER = UNIT_MGR_FLAGS.VERSUS_AI | UNIT_MGR_FLAGS.SQUAD
    _MASK = SQUAD_ROSTER | SPEC_ROSTER | UNIT_MGR_FLAGS.FALLOUT_CLASSIC | UNIT_MGR_FLAGS.FALLOUT_MULTITEAM | UNIT_MGR_FLAGS.EVENT | STRONGHOLD_ROSTER | TOURNAMENT_ROSTER | UNIT_MGR_FLAGS.EPIC | UNIT_MGR_FLAGS.BATTLE_ROYALE | UNIT_MGR_FLAGS.MAPBOX | UNIT_MGR_FLAGS.FUN_RANDOM | COMP7_ROSTER | UNIT_MGR_FLAGS.VERSUS_AI | RANKED_ROSTER
...
PREBATTLE_TYPE_BY_UNIT_MGR_ROSTER = {PREBATTLE_TYPE.UNIT: UNIT_MGR_FLAGS.DEFAULT,
 ...
 PREBATTLE_TYPE.RANKED: ROSTER_TYPE.RANKED_ROSTER}
...
ROSTER_TYPE_TO_CLASS = {ROSTER_TYPE.UNIT_ROSTER: UnitRoster,
 ...
 ROSTER_TYPE.RANKED_ROSTER: RankedRoster}
