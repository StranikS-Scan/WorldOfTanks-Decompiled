...
class ARENA_BONUS_TYPE_CAPS():
    ...
    FESTIVAL_RACE = 'FESTIVAL_RACE'
    FESTIVAL_RACE_ATTEMPTS = 'FESTIVAL_RACE_ATTEMPTS'
    FESTIVAL_RACE_RAMMING = 'FESTIVAL_RACE_RAMMING'
    AUTO_AIM_WITH_PREDICTION = 'AUTO_AIM_WITH_PREDICTION'
    ANTI_OVERTURN = 'ANTI_OVERTURN'
    DOSSIER_ACHIEVEMENTS_RACING_2019 = 'DOSSIER_ACHIEVEMENTS_RACING_2019'
    FESTIVAL_RACE_REPAIR = 'FESTIVAL_RACE_REPAIR'
    ARENA_INFO = 'ARENA_INFO'
    TEAM_BASE_EXTENDED_INFO = 'TEAM_BASE_EXTENDED_INFO'
    ...
    TOURNAMENT_EVENT = frozenset((RESULTS,
     ...
     FESTIVAL_RACE,
     VEHICLE_NO_DAMAGE_FROM_STATICS,
     FESTIVAL_RACE_RAMMING,
     NO_ALLY_DAMAGE,
     AUTO_AIM_WITH_PREDICTION,
     ANTI_OVERTURN,
     FESTIVAL_RACE_REPAIR,
     ARENA_INFO,
     TEAM_BASE_EXTENDED_INFO,
     CUSTOM_ALLY_DAMAGE_EFFECT))
    ...
    EVENT_BATTLES = frozenset((RESULTS,
     ...
     CREW_IMMUNE_TO_DAMAGE,
     FESTIVAL_RACE,
     FESTIVAL_RACE_ATTEMPTS,
     VEHICLE_NO_DAMAGE_FROM_STATICS,
     FESTIVAL_RACE_RAMMING,
     NO_ALLY_DAMAGE,
     AUTO_AIM_WITH_PREDICTION,
     ANTI_OVERTURN,
     DOSSIER_ACHIEVEMENTS_RACING_2019,
     FESTIVAL_RACE_REPAIR,
     ARENA_INFO,
     TEAM_BASE_EXTENDED_INFO,
     CUSTOM_ALLY_DAMAGE_EFFECT))
