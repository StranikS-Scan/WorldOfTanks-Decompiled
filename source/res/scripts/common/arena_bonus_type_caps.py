...
class ARENA_BONUS_TYPE_CAPS():
    ...
    WITH_AI = 'WITH_AI'
    KEEP_AI_BOTS_ALIVE = 'KEEP_AI_BOTS_ALIVE'
    EVENT_POINTS_PICKUP_MECHANICS = 'EVENT_POINTS_PICKUP_MECHANICS'
    ZOMBIE_MECHANICS = 'ZOMBIE_MECHANICS'
    NO_DAMAGE_WITH_OBJECTS = 'NO_DAMAGE_WITH_OBJECTS'
    NO_DAMAGE_RANDOMIZATION = 'NO_DAMAGE_RANDOMIZATION'
    NAVIGATION_MARKERS = 'NAVIGATION_MARKERS'
    RANDOM_EVENT_MECHANICS = 'RANDOM_EVENT_MECHANICS'
    EVENT_POINTS_MECHANICS = 'EVENT_POINTS_MECHANICS'
    EVENT_POINTS_BASE_MECHANICS = 'EVENT_POINTS_BASE_MECHANICS'
    EVENT_MUTATION_SCENARIO = 'EVENT_MUTATION_SCENARIO'
    ...
    EVENT_BATTLES = frozenset((RESULTS,
     ...
     EVENT_POINTS_PICKUP_MECHANICS,
     ZOMBIE_MECHANICS,
     NO_ALLY_DAMAGE,
     NO_DAMAGE_WITH_OBJECTS,
     NO_DAMAGE_RANDOMIZATION,
     NAVIGATION_MARKERS,
     BOOSTERS,
     CREW_IMMUNE_TO_DAMAGE,
     EVENT_POINTS_MECHANICS,
     EVENT_POINTS_BASE_MECHANICS,
     RANDOM_EVENT_MECHANICS,
     EVENT_MUTATION_SCENARIO,
     INFINITE_AMMO))
