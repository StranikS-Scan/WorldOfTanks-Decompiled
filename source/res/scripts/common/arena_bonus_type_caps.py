...
class ARENA_BONUS_TYPE_CAPS():
    ...
    DOSSIER_RANKED_10x10 = 'DOSSIER_RANKED_10x10'
    DOSSIER_MAXRANKED_10x10 = 'DOSSIER_MAXRANKED_10x10'
    ...
    __RULES = (lambda caps: not set(ARENA_BONUS_TYPE_CAPS.DOSSIER_ACHIEVEMENTS) & set(caps) or ARENA_BONUS_TYPE_CAPS.MULTITEAMS not in caps,
     ...
     lambda caps: not (ARENA_BONUS_TYPE_CAPS.DOSSIER_RANKED in caps and ARENA_BONUS_TYPE_CAPS.DOSSIER_RANKED_10x10 in caps or ARENA_BONUS_TYPE_CAPS.DOSSIER_MAXRANKED in caps and ARENA_BONUS_TYPE_CAPS.DOSSIER_MAXRANKED_10x10 in caps))
    _typeToCaps = {}
