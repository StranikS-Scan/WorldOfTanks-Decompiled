...
# Embedded file name: scripts/common/battle_modifiers/battle_modifiers.py
import battle_params
import battle_modifier_readers
import battle_modifier_appliers
from battle_modifier_constants import UseType, GameplayImpact
...
class BattleModifiers(object):
    ...
    def __readConfig(self, config):
        ...
        domain = 0
        for modifierSection in config.values():
