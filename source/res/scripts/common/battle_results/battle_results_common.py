...
BATTLE_RESULTS = [('health',
 ...
 ('wotPlusFreeXPFactor100',
  ...
  'skip',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostCredits',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostCreditsFactor100',
  int,
  0,
  None,
  'skip',
 ...
 ('wotPlusProBoostXP',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostXPFactor100',
  int,
  0,
  None,
  'skip',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostCrewXP',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostCrewXPFactor100',
  int,
  0,
  None,
  'skip',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostFreeXP',
  int,
  0,
  None,
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('wotPlusProBoostFreeXPFactor100',
  int,
  0,
  None,
  'skip',
