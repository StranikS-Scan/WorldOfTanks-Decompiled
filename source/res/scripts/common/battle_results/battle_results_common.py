...
BATTLE_RESULTS = [('health',
 ...
 ('isDebutBoxesEnabled',
  ...
  'any',
  ENTRY_TYPE.VEHICLE_SELF),
 ('teamSubscribersCount',
  int,
  0,
  None,
  'skip',
  ENTRY_TYPE.ACCOUNT_SELF),
 ('teamSubsBonusCredits',
  int,
  0,
  None,
  'sum',
 ...
 ('directivesTMenXP',
  ...
  'sum',
  ENTRY_TYPE.VEHICLE_SELF),
 ('directivesCreditsFactor100',
  int,
  0,
  None,
  'any',
  ENTRY_TYPE.VEHICLE_SELF),
 ('directivesXPFactor100',
  int,
  0,
  None,
  'any',
  ENTRY_TYPE.VEHICLE_SELF),
 ('directivesFreeXPFactor100',
  int,
  0,
  None,
  'any',
  ENTRY_TYPE.VEHICLE_SELF),
 ('directivesTMenXPFactor100',
  int,
  0,
  None,
  'any',
