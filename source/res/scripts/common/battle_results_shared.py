...
VEH_CELL_RESULTS_EXTS = {'extPublic': {'recoveryMechanic': _buildMapsForExt(('numRecovered',
 ...
 'extServer': {'achievementsData': _buildMapsForExt(('ironShieldDamage',
                                    ...
                                    None,
                                    'sum')),
               'battleXP': _buildMapsForExt(('total',
                            int,
                            0,
                            None,
                            'sum')),
               'inBattleUpgrades': _buildMapsForExt(('modulesDescriptors',
                                    list,
                                    [],
                                    None,
                                    'extend'))}}
...
_VEH_BASE_RESULTS_PUBLIC = Meta(('accountDBID',
 ...
 None,
 'sum'))
_THE_WORSE_BR_POSITION_IN_BATTLE = 255
_VEH_BASE_RESULTS_PRIVATE = Meta(('xpPenalty',
 ...
 'sum'), ('brPosInBattle',
 int,
 _THE_WORSE_BR_POSITION_IN_BATTLE,
 None,
 'skip'))
...
_AVATAR_BASE_PRIVATE_RESULTS = Meta(('accountDBID',
 ...
 False,
 None,
 'skip'), ('efficiencyBonusBattles',
 int,
 0,
 None,
 'skip'), ('stepsBonusBattles',
 int,
 0,
 None,
...
_AVATAR_BASE_PUBLIC_RESULTS_EXTS = {'playerRank': _buildMapsForExt(('rank',
 ...
 'battlePass': _buildMapsForExt(('basePointsDiff',
                ...
                None,
                'skip')),
 'battleRoyale': _buildMapsForExt(('accPos',
                  int,
                  0,
                  None,
                  'skip'))}
...
_AVATAR_FULL_RESULTS_PRIVATE = Meta(('questsProgress',
 ...
 None,
 'skip'))
_PRIVATE_EVENT_RESULTS = Meta(('eventCreditsList',
 list,
 [],
 None,
 'skip'), ('eventXPList',
...
VEH_FULL_RESULTS_UPDATE = Meta(('eventCreditsList',
 list,
 [],
 None,
 'skip'), ('originalCredits',
...
_VEH_FULL_RESULTS_PRIVATE = Meta(('questsProgress',
 ...
 {},
 None,
 'joinDicts'), ('c11nProgress',
 dict,
 {},
 None,
 'skip'), ('originalCreditsToDrawSquad',
 int,
 0,
 None,
