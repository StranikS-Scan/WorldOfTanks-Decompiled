...
CHAT_COMMANDS = Enumeration('chatCommands', [('initAck', {'chnlCmd': 0}),
 ...
 ('EPIC_GLOBAL_EAST', {'battleCmd': 1,
   ...
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/global_msg/lane/east'}),
 ('EVENT_CHAT_1', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_1'}),
 ('EVENT_CHAT_2', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_2'}),
 ('EVENT_CHAT_3', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_3'}),
 ('EVENT_CHAT_4', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_4'}),
 ('EVENT_CHAT_5', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_5'}),
 ('EVENT_CHAT_6', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_6'}),
 ('EVENT_CHAT_7', {'battleCmd': 1,
   'argsCnt': 0,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_7'}),
 ('EVENT_CHAT_1_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_1_ex'}),
 ('EVENT_CHAT_2_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_2_ex'}),
 ('EVENT_CHAT_3_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_3_ex'}),
 ('EVENT_CHAT_4_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_4_ex'}),
 ('EVENT_CHAT_5_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_5_ex'}),
 ('EVENT_CHAT_6_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_6_ex'}),
 ('EVENT_CHAT_7_EX', {'battleCmd': 1,
   'argsCnt': 1,
   'cooldown': {'period': __BATTLE_COMMANDS_DEFAULT_COOLDOWN,
                'side': __COOLDOWN_CHECK_ALL},
   'msgText': '#ingame_gui:chat_shortcuts/event_chat_7_ex'})], instance=AttributeEnumItem)
...
_g_chatCommandProcessors = {CHAT_COMMANDS.BAN: BanCommandProcessor(),
 ...
 CHAT_COMMANDS.EVENT_CHAT_1: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_1),
 CHAT_COMMANDS.EVENT_CHAT_2: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_2),
 CHAT_COMMANDS.EVENT_CHAT_3: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_3),
 CHAT_COMMANDS.EVENT_CHAT_4: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_4),
 CHAT_COMMANDS.EVENT_CHAT_5: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_5),
 CHAT_COMMANDS.EVENT_CHAT_6: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_6),
 CHAT_COMMANDS.EVENT_CHAT_7: NoArgsCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_7),
 CHAT_COMMANDS.EVENT_CHAT_1_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_1_EX),
 CHAT_COMMANDS.EVENT_CHAT_2_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_2_EX),
 CHAT_COMMANDS.EVENT_CHAT_3_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_3_EX),
 CHAT_COMMANDS.EVENT_CHAT_4_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_4_EX),
 CHAT_COMMANDS.EVENT_CHAT_5_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_5_EX),
 CHAT_COMMANDS.EVENT_CHAT_6_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_6_EX),
 CHAT_COMMANDS.EVENT_CHAT_7_EX: OneStringArgCommandProcessor(CHAT_COMMANDS.EVENT_CHAT_7_EX)}
