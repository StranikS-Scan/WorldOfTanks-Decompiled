...
if not sum([IS_CHINA,
 ...
 IS_SINGAPORE]) <= 1:
    ...
    ARENA_GAMEPLAY_NAMES = ('ctf', 'domination', 'assault', 'nations', 'ctf2', 'domination2', 'assault2', 'fallout', 'fallout2')
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        EVENT_BATTLES = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | QUESTS | RESPAWN | INTERACTIVE_STATS | FLAG_MECHANICS | WIN_POINTS_MECHANICS | REPAIR_MECHANICS | NO_ALLY_DAMAGE
    ...
    class ARENA_UPDATE:
        ...
        FLAG_STATE_CHANGED = 16
        RESPAWN_RESURRECTED = 17
        INTERACTIVE_STATS = 18
        DISAPPEAR_BEFORE_RESPAWN = 19
