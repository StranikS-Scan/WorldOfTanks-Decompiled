...
class OVERTURN_CONDITION:
    IGNOR_DELAY = 0.1
    WARNING_COSINE = math.cos(math.radians(60))
    ONBOARD_COSINE = math.cos(math.radians(60))
...
FAIRPLAY_VIOLATIONS_NAMES = ('deserter', 'suicide', 'afk', 'event_afk')
...
class ACTIONS_GROUP_TYPE:
    TANK = 1
    FIRST_LINE_SUPPORT_ONE = 2
    FIRST_LINE_SUPPORT_TWO = 3
    FIRE_SUPPORT_ONE = 4
    FIRE_SUPPORT_TWO = 5
    SNIPER = 6
    SCOUT = 7
