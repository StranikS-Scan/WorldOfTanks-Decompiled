...
if not sum([IS_CHINA,
 ...
 IS_SINGAPORE]) <= 1:
    ...
    ARENA_GAMEPLAY_NAMES = ('ctf', 'domination', 'assault', 'nations', 'ctf2', 'domination2', 'assault2', 'fallout', 'fallout2', 'fallout3', 'fallout4')
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        REGULAR = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | REWARD_FOR_ACHIEVEMENT | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_ACHIEVEMENTS_15X15 | DOSSIER_MAX15X15 | TKILL_RATING | REF_SYSTEM_BONUS | DAILY_MULTIPLIED_XP
        TRAINING = RESULTS
        COMPANY = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_COMPANY | DOSSIER_MAX15X15 | TKILL_RATING | DAILY_MULTIPLIED_XP
        TOURNAMENT = RESULTS | TKILL_RATING
        CLAN = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_CLAN | TKILL_RATING | DAILY_MULTIPLIED_XP
        GLOBAL_MAP = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_GLOBAL_MAP | TKILL_RATING
        TUTORIAL = 0
        CYBERSPORT = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_7X7 | DOSSIER_MAX7X7 | CYBERSPORT_RATING | DOSSIER_ACHIEVEMENTS_7X7 | TKILL_RATING | DAILY_MULTIPLIED_XP
        HISTORICAL = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_15X15 | XP | XP_FACTOR_15X15 | QUESTS | DOSSIER_KILL_LIST | DOSSIER_HISTORICAL | DOSSIER_ACHIEVEMENTS_HISTORICAL | DOSSIER_MAXHISTORICAL | TKILL_RATING | DAILY_MULTIPLIED_XP
        EVENT_BATTLES = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | QUESTS | RESPAWN | INTERACTIVE_STATS | FLAG_MECHANICS | WIN_POINTS_MECHANICS | REPAIR_MECHANICS | NO_ALLY_DAMAGE | MULTITEAMS | RAGE_MECHANICS | RESOURCE_POINTS
        SORTIE = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_SORTIE | DOSSIER_MAXSORTIE | DOSSIER_ACHIEVEMENTS_SORTIE | FORT_RESOURCE | INFLUENCE_POINTS | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP
        FORT_BATTLE = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | DOSSIER_TOTAL | DOSSIER_KILL_LIST | FORT_BATTLE_RESULTS | DOSSIER_FORT_BATTLE | DOSSIER_MAXFORTBATTLE | QUESTS | TKILL_RATING | DAILY_MULTIPLIED_XP
        RATED_CYBERSPORT = RESULTS | DAMAGE_VEHICLE | CREDITS | CREDITS_FACTOR_7X7 | XP | XP_FACTOR_7X7 | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | TKILL_RATING | DOSSIER_RATED7X7 | DOSSIER_MAXRATED7X7 | CYBERSPORT_RATING | DOSSIER_CLUB | DOSSIER_ACHIEVEMENTS_RATED7X7
