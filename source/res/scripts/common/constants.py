...
class ARENA_BONUS_TYPE:
    ...
    EXTERNAL_RANGE = (SORTIE_2,
     ...
     TOURNAMENT_REGULAR,
     TOURNAMENT_EVENT)
    NOT_IMMEDIATE_BATTLE_RESULTS = BATTLE_ROYALE_RANGE + (MAPS_TRAINING, EVENT_BATTLES, EVENT_BATTLES_2)
