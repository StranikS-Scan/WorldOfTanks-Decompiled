...
def __updateFromAccountDossier163(compDescr):
    blocksLayout = ['a15x15',
     ...
     'comp7CutArchivePegasus',
     'commendations',
     'statTrackersVehStatsCut']
    updateCtx = {'dossierCompDescr': compDescr,
     'blockSizeFormat': 'H',
     'versionFormat': 'H',
     'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    formats = [('readyForBattleAssault', 'B'), ('readyForBattleSniper', 'B'), ('readyForBattleSupport', 'B')]
    addRecords(updateCtx, 'achievements', formats, {})
...
def __updateFromAccountDossier164(compDescr):
    ...
    return (165, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier165(compDescr):
    ...
    return (166, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier166(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr,
     ...
     'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    formats = [('steamGetTankLevel11Medal', 'B')]
    addRecords(updateCtx, 'steamAchievements', formats, {})
    setVersion(updateCtx, 167)
    return (167, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier167(compDescr):
    ...
    return (168, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier168(compDescr):
    ...
    return (169, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier169(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr,
     ...
     'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    formats = [('readyForBattleFossaAssault', 'B'), ('readyForBattleFossaSniper', 'B'), ('readyForBattleFossaSupport', 'B')]
    addRecords(updateCtx, 'achievements', formats, {})
...
def __updateFromAccountDossier170(compDescr):
    ...
    return (171, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier171(compDescr):
    ...
    return (172, updateCtx['dossierCompDescr'])
