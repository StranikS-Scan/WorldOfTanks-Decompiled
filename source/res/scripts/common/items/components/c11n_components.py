...
class CustomizationCache(object):
 ...
 911       0	LOAD_GLOBAL       'False'
           3	STORE_FAST        'force'

 912       6	LOAD_GLOBAL       'CustomizationType'
           9	LOAD_ATTR         'RANGE'
          12	STORE_FAST        'itemTypes'

 913      15	LOAD_FAST         'itemForce'
          18	LOAD_CONST        ''
          21	COMPARE_OP        'is not'
          24	POP_JUMP_IF_FALSE '48'

 914      27	LOAD_GLOBAL       'True'
          30	STORE_FAST        'force'

 915      33	LOAD_FAST         'itemForce'
 ...
 917      48	SETUP_LOOP        '322'
          51	LOAD_FAST         'itemTypes'
          54	GET_ITER          ''
          55	FOR_ITER          '321'
          58	STORE_FAST        'itemType'

 918      61	LOAD_GLOBAL       'lower'
 ...
 929     180	CONTINUE          '144'
         183	JUMP_FORWARD      '186'
       186_0	COME_FROM         '183'

 931     186	SETUP_EXCEPT      '290'

 933     189	LOAD_GLOBAL       'isinstance'
         192	LOAD_FAST         'component'
         195	LOAD_GLOBAL       'int'
         198	CALL_FUNCTION_2   ''
         201	POP_JUMP_IF_FALSE '210'

 934     204	CONTINUE_LOOP     '144'
         207	JUMP_FORWARD      '210'
       210_0	COME_FROM         '207'

 936     210	LOAD_FAST         'force'
 ...
 937     234	CONTINUE_LOOP     '144'
         237	JUMP_FORWARD      '240'
       240_0	COME_FROM         '237'

 939     240	LOAD_FAST         'storage'
         243	LOAD_ATTR         'get'
 ...
 940     258	LOAD_GLOBAL       '_adjustProgression'
 ...
 943     303	LOAD_GLOBAL       'LOG_CURRENT_EXCEPTION'
         306	CALL_FUNCTION_0   ''
         309	POP_TOP           ''
         310	JUMP_BACK         '144'
         313	END_FINALLY       ''
 ...
 945     322	SETUP_EXCEPT      '445'

 946     325	LOAD_GLOBAL       'CustomizationType'
         328	LOAD_ATTR         'STYLE'
         331	LOAD_FAST         'itemTypes'
         334	COMPARE_OP        'in'
         337	POP_JUMP_IF_FALSE '441'

 947     340	LOAD_FAST         'outfit'
 ...
 949     407	LOAD_GLOBAL       '_adjustProgression'
 ...
 952     458	LOAD_GLOBAL       'LOG_CURRENT_EXCEPTION'
         461	CALL_FUNCTION_0   ''
         464	POP_TOP           ''
