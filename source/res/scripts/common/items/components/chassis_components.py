...
Wheel = reflectedNamedTuple('Wheel', ('index', 'isLeft', 'radius', 'nodeName', 'isLeading', 'leadingSyncAngle', 'hitTesterManager', 'materials', 'position', 'trackPairIndex'))
Wheel.hitTester = property(lambda self: self.hitTesterManager.activeHitTester)
WheelGroup = reflectedNamedTuple('WheelGroup', ('isLeft', 'template', 'count', 'startIndex', 'radius', 'trackPairIndex'))
...
TrackNode = reflectedNamedTuple('TrackNode', ('name', 'isLeft', 'initialOffset', 'leftNodeName', 'rightNodeName', 'damping', 'elasticity', 'forwardElasticityCoeff', 'backwardElasticityCoeff', 'trackPairIndex'))
...
TrackSplineParams = reflectedNamedTuple('TrackSplineParams', ('trackPairIdx', 'thickness', 'maxAmplitude', 'maxOffset', 'gravity'))
GroundNodesParams = reflectedNamedTuple('GroundNodesParams', ('groundNodes',))
GroundNode = reflectedNamedTuple('GroundNode', ('nodeName', 'affectedWheelName', 'isLeft', 'minOffset', 'maxOffset', 'collisionSamplesCount', 'hasLiftMode', 'trackPairIdx'))
GroundNodeGroup = namedtuple('GroundNodeGroup', ('isLeft', 'minOffset', 'maxOffset', 'nodesTemplate', 'affectedWheelsTemplate', 'nodesCount', 'startIndex', 'collisionSamplesCount', 'hasLiftMode', 'trackPairIdx'))
