...
class ObjectsWithMarkers(object):
...
class Ny23CoinToken(object):
    ID = 'lootBox:231201'
    TYPE = 'ny23Coin'
    INT_ID = int(ID.split(':')[-1])


def _makeATMRewardFullName(name):
    return '_'.join((YEARS_INFO.CURRENT_YEAR_STR, name))


def _makeATMRewardUnlockToken(name):
    return '{}:{}_unlock'.format(YEARS_INFO.CURRENT_YEAR_STR, name)
...
class CelebrityQuestTokenParts(object):
    PREFIX = 'NY20{}_clbty'.format(YEARS_INFO.CURRENT_YEAR)
    MARATHON_PREFIX = 'NY20{}_mrthn_clbty'.format(YEARS_INFO.CURRENT_YEAR)
    SEPARATOR = ':'
    TYPE = 'type'
    QUEST = 'quest'
    DAY = 'day'
...
class NY_LOGS(object):
    ...
    @classmethod
    def makeLogValueForAutoCollectingState(cls, isAutoCollectingActivated, isDisabledManually=False):
        if isDisabledManually:
            return 0
        return 1 if isAutoCollectingActivated else 2
...
class NYFriendServiceDataTokens(object):
    ...
    GUEST_M_QUEST_COMPLETED = 'guest_M_quest_complete'
    GUEST_CAT_QUEST_COMPLETED = 'guest_cat_quest_complete'
    CAT_UNLOCK = 'guest_cat_unlock'
    DOG_UNLOCK = 'ny23:dog_unlock'
    GUEST_A_QUEST_DECORATION_1 = 'ny23:guest_A:decoration:1'
    GUEST_A_QUEST_DECORATION_2 = 'ny23:guest_A:decoration:2'
    GUEST_A_QUEST_DECORATION_3 = 'ny23:guest_A:decoration:3'
    GUEST_M_QUEST_DECORATION_1 = 'ny23:guest_M:decoration:1'
    GUEST_M_QUEST_DECORATION_2 = 'ny23:guest_M:decoration:2'
    GUEST_M_QUEST_DECORATION_3 = 'ny23:guest_M:decoration:3'
    HANGAR_DECORATION_AIRSHIP = 'ny23:deco:airship'
    HANGAR_DECORATION_FERRIS_WHEEL = 'ny23:deco:ferriswheel'
    HANGAR_DECORATION_CHALET = 'ny23:deco:chalet'
    GUEST_A_QUEST_ANIM_1 = 'ny23:guest_A:anim:1'
    GUEST_A_QUEST_ANIM_2 = 'ny23:guest_A:anim:2'
    GUEST_A_QUEST_ANIM_3 = 'ny23:guest_A:anim:3'
    GUEST_M_QUEST_ANIM_1 = 'ny23:guest_M:anim:1'
    GUEST_M_QUEST_ANIM_2 = 'ny23:guest_M:anim:2'
    GUEST_M_QUEST_ANIM_3 = 'ny23:guest_M:anim:3'
    GUEST_C_QUEST_ANIM_1 = 'ny23:guest_cat:anim:1'
    GUEST_C_QUEST_ANIM_2 = 'ny23:guest_cat:anim:2'
    GUEST_C_QUEST_ANIM_3 = 'ny23:guest_cat:anim:3'
    ALL = (CELEBRITY_QUEST_COMPLETED,
     GUEST_A_QUEST_COMPLETED,
     GUEST_M_QUEST_COMPLETED,
     GUEST_CAT_QUEST_COMPLETED,
     CAT_UNLOCK,
     DOG_UNLOCK,
     GUEST_A_QUEST_DECORATION_1,
     GUEST_A_QUEST_DECORATION_2,
     GUEST_A_QUEST_DECORATION_3,
     GUEST_M_QUEST_DECORATION_1,
     GUEST_M_QUEST_DECORATION_2,
     GUEST_M_QUEST_DECORATION_3,
     HANGAR_DECORATION_AIRSHIP,
     HANGAR_DECORATION_CHALET,
     HANGAR_DECORATION_FERRIS_WHEEL,
     GUEST_A_QUEST_ANIM_1,
     GUEST_A_QUEST_ANIM_2,
     GUEST_A_QUEST_ANIM_3,
     GUEST_M_QUEST_ANIM_1,
     GUEST_M_QUEST_ANIM_2,
     GUEST_M_QUEST_ANIM_3,
     GUEST_C_QUEST_ANIM_1,
     GUEST_C_QUEST_ANIM_2,
     GUEST_C_QUEST_ANIM_3)
    GUEST_A_DECORATIONS = (GUEST_A_QUEST_DECORATION_1, GUEST_A_QUEST_DECORATION_2, GUEST_A_QUEST_DECORATION_3)
    GUEST_M_DECORATIONS = (GUEST_M_QUEST_DECORATION_1, GUEST_M_QUEST_DECORATION_2, GUEST_M_QUEST_DECORATION_3)
    MAX_LEVEL_DECORATIONS = (HANGAR_DECORATION_AIRSHIP, HANGAR_DECORATION_FERRIS_WHEEL, HANGAR_DECORATION_CHALET)
    ALL_DECORATIONS = MAX_LEVEL_DECORATIONS + GUEST_A_DECORATIONS + GUEST_M_DECORATIONS
