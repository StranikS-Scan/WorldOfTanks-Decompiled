...
from constants import SHELL_TYPES, SHELL_MECHANICS_TYPE, DamageAbsorptionTypeToLabel
...
class HighExplosiveType(ShellType):
    __slots__ = ('explosionRadius', 'explosionDamageFactor', 'explosionDamageAbsorptionFactor', 'explosionEdgeDamageFactor', 'mechanics', 'blastWave', 'shellFragments', 'armorSpalls', 'shellFragmentsDamageAbsorptionFactor', 'protectFromDirectHits', 'protectFromIndirectHits', 'obstaclePenetration', 'shieldPenetration', 'maxDamage')
