...
class SPECIAL_VOICE_TAG(object):
    ...
    ALL = (BUFFON,
     ...
     QUICKY_BABY,
     WITCHES_CREW,
     CELEBRITY_2023) + BATTLE_OF_BLOGGERS + BATTLE_OF_BLOGGERS_2021 + G_I_JOE_TWITCH_2021 + WHITE_TIGER_EVENT_2021 + G_I_JOE_2022 + WHITE_TIGER_EVENT_2022 + BPH_2022 + BPH_MT_2022
