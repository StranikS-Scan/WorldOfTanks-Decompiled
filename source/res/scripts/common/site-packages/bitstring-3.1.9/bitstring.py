...
# Embedded file name: scripts/common/site-packages/bitstring-3.1.9/bitstring.py
...
class Bits(object):
    ...
    def _setauto(self, s, length, offset):
        if isinstance(s, Bits):
            ...
            if isinstance(s, basestring):
                ...
                return
            elif isinstance(s, collectionsAbc.Iterable):
    ...
    def _find_lsb0(self, bs, start=None, end=None, bytealigned=None):
        ...
        return (self.len - p[0] - bs.length,) if p else None
