...
# Embedded file name: scripts/common/site-packages/enum34-1.1.10/enum/__init__.py
import sys as _sys
...
class EnumMeta(type):
    ...
    def __call__(cls, value, names=None, module=None, type=None, start=1):
        return cls.__new__(cls, value) if names is None else cls._create_(value, names, module=module, type=type, start=start)
