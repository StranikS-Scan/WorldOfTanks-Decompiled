...
# Embedded file name: scripts/common/site-packages/enum34-1.1.10/enum/test.py
...
class TestEnum(unittest.TestCase):
    ...
    if pyver >= 3.0:
        ...
        def test_dir_on_class(self):
            Season = self.Season
            self.assertEqual(set(dir(Season)), set(['__class__',
             '__doc__',
             '__members__',
             '__module__',
             'SPRING',
        ...
        def test_dir_on_item(self):
            Season = self.Season
            self.assertEqual(set(dir(Season.WINTER)), set(['__class__',
             '__doc__',
             '__module__',
             'name',
             'value']))
        ...
        def test_dir_with_added_behavior(self):
            ...
            self.assertEqual(set(dir(Test)), set(['__class__',
             '__doc__',
             '__members__',
             '__module__',
             'this',
             'these']))
            self.assertEqual(set(dir(Test.this)), set(['__class__',
             '__doc__',
             '__module__',
             'name',
             'value',
        ...
        def test_dir_on_sub_with_behavior_on_super(self):
            ...
            self.assertEqual(set(dir(SubEnum.sample)), set(['__class__',
             '__doc__',
             '__module__',
             'name',
             'value',
    ...
    def test_enum_duplicates(self):
        ...
        lst = list(Season)
        self.assertEqual(lst, [Season.SPRING,
         Season.SUMMER,
         Season.AUTUMN,
         Season.WINTER])
    ...
    if pyver == 3.4:
        ...
        def test_class_nested_enum_and_pickle_protocol_four(self):
            ...
            test_pickle_exception(self.assertRaises, PicklingError, self.NestedEnum.twigs, protocol=(0, 3))
            test_pickle_dump_load(self.assertTrue, self.NestedEnum.twigs, protocol=(4, HIGHEST_PROTOCOL))
        ...
        def test_class_nested_enum_and_pickle_protocol_four(self):
            ...
            self.__class__.NestedEnum = NestedEnum
            self.NestedEnum.__qualname__ = '%s.NestedEnum' % self.__class__.__name__
            test_pickle_dump_load(self.assertTrue, self.NestedEnum.twigs, protocol=(0, HIGHEST_PROTOCOL))
    ...
    def test_iteration_order(self):
        ...
        self.assertEqual(list(Season), [Season.SUMMER,
         Season.WINTER,
         Season.AUTUMN,
         Season.SPRING])

    def test_iteration_order_reversed(self):
        self.assertEqual(list(reversed(self.Season)), [self.Season.WINTER,
         self.Season.AUTUMN,
         self.Season.SUMMER,
         self.Season.SPRING])
    ...
    def test_iteration_order_with_unorderable_values(self):
        ...
        self.assertEqual(list(Complex), [Complex.a,
         Complex.b,
         Complex.c,
         Complex.d])
    ...
    def test_programatic_function_iterable_with_weird_names(self):
        SummerMonth = Enum('SummerMonth', (('june', 1),
         ('july', 2),
         ('august', 3),
         ('fabulous september', 4)))
        lst = list(SummerMonth)
        self.assertEqual(len(lst), len(SummerMonth))
        self.assertEqual(len(SummerMonth), 4, SummerMonth)
        self.assertEqual([SummerMonth.june,
         SummerMonth.july,
         SummerMonth.august,
         SummerMonth['fabulous september']], lst)
    ...
    def test_programatic_function_unicode_iterable(self):
        SummerMonth = Enum('SummerMonth', ((unicode('june'), 1), (unicode('july'), 2), (unicode('august'), 3)))
        lst = list(SummerMonth)
        self.assertEqual(len(lst), len(SummerMonth))
        self.assertEqual(len(SummerMonth), 3, SummerMonth)
        self.assertEqual([SummerMonth.june, SummerMonth.july, SummerMonth.august], lst)
    ...
    def test_subclasses_with_getnewargs(self):
        ...
        class NamedInt(int):
            ...
            def __str__(self):
                ...
                return base.__repr__(self) if base_str.__objclass__ is object else base_str(self)
    ...
    def test_duplicate_values_give_unique_enum_items(self):
        ...
        self.assertEqual(list(AutoNumber), [AutoNumber.enum_m, AutoNumber.enum_d, AutoNumber.enum_y])
    ...
    def test_ordered_mixin(self):
        ...
        class OrderedEnum(Enum):
            ...
            def __ge__(self, other):
                return self._value_ >= other._value_ if self.__class__ is other.__class__ else NotImplemented
        ...
        self.assertEqual(list(Grade), [Grade.A,
         Grade.B,
         Grade.C,
         Grade.D,
         Grade.F])
