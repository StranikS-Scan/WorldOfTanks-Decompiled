...
# Embedded file name: scripts/common/site-packages/future-1.0.0/future/types/newint.py
...
class newint(with_metaclass(BaseNewInt, long)):
    ...
    def __bool__(self):
        return super(newint, self).__bool__() if PY3 else super(newint, self).__nonzero__()
