...
# Embedded file name: scripts/game_objects/festivalrace_objects/race_sound_zone_01.py
import Triggers
import Math
from constants import IS_CLIENT

def buildCommon(gameObject):
    gameObject.createComponent(Triggers.SquareAreaComponent, Math.Vector3(0, 0, -35), Math.Vector3(20, 35, 35))
