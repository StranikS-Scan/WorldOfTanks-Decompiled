...
# Embedded file name: scripts/game_objects/festivalrace_objects/race_sound_zone_03.py
import Triggers
import Math
from constants import IS_CLIENT

def buildCommon(gameObject):
    gameObject.createComponent(Triggers.SquareAreaComponent, Math.Vector3(0, -2, -20), Math.Vector3(70, 50, 20))
