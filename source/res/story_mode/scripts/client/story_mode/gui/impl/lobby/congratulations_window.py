...
# Embedded file name: story_mode/scripts/client/story_mode/gui/impl/lobby/congratulations_window.py
...
class CongratulationsView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return BadgeTooltip(badgeId=int(event.getArgument('badgeId'))) if contentID == R.views.story_mode.mono.lobby.tooltips.badge_tooltip() else super(CongratulationsView, self).createToolTipContent(event, contentID)
