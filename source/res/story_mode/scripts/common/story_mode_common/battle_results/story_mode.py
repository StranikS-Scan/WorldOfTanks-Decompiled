...
# Embedded file name: story_mode/scripts/common/story_mode_common/battle_results/story_mode.py
...
BATTLE_RESULTS = [('missionId',
  int,
  UNDEFINED_MISSION_ID,
  None,
  'skip',
  ENTRY_TYPE.ACCOUNT_SELF), ('isForceOnboarding',
  bool,
  False,
  None,
  'skip',
