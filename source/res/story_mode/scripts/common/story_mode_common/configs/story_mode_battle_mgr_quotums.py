...
quotumsSchema = GameParamsSchema(gameParamsKey='story_mode_battle_mgr_quotums', fields={'quotums': fields.UniCapList(fieldOrSchema=quotumSchema, required=True, deserializedValidators=validate.Length(minValue=3))}, modelClass=QuotumsModel, checkUnknown=True, deserializedValidators=[validatePriorityies], usedInReplay=True)
