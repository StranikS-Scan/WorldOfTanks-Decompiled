...
class ClientWhiteTigerBattleMode(wt_constants.WhiteTigerBattleMode):
    ...
    def _client_gameControllers(self):
        ...
        return [(IWhiteTigerController, WhiteTigerController, False), (ILootBoxesController, LootBoxesController, False), (IWhiteTigerSettingsController, WtSettingsController, False)]
...
def preInit():
    ...
    _CTRLS_DESC_MAP[CTRL_MODE_NAME.MAP_CASE_HYPERION] = (HyperionMapCaseControlMode, 'strategicMode', aih_constants.CTRL_TYPE.USUAL)


def init():
    _logger.debug('init: %r', __name__)
    LOBBY_EXT_PACKAGES = ['white_tiger.gui.Scaleform.daapi.view.lobby', 'white_tiger.gui.Scaleform.daapi.view.lobby.header']
