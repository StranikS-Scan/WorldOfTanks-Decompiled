...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/Scaleform/daapi/view/battle/markers2d/plugins.py
...
class WhiteTigerBaseAreaMarkerPlugin(AreaMarkerPlugin, ChatCommunicationComponent):
    ...
    def getMarkerType(self, markerID=INVALID_MARKER_ID):
        return MarkerType.NON_INTERACTIVE if avatar_getter.getPlayerTeam() == WT_TEAMS.BOSS_TEAM else MarkerType.BASE_MARKER_TYPE
