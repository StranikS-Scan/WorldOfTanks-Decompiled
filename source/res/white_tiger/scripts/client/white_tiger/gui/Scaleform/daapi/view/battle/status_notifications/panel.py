...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/Scaleform/daapi/view/battle/status_notifications/panel.py
import logging
...
class WhiteTigerStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateItems(self):
        items = [_WhiteTigerHighPriorityGroup, sn_items.PersonalDeathZoneSN, sn_items.StunSN]
        return items
