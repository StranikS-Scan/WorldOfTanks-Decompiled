...
class _WhiteTigerHighPriorityGroup(components.StatusNotificationsGroup):
    ...
    def __init__(self, updateCallback):
        super(_WhiteTigerHighPriorityGroup, self).__init__((wt_sn_items.WhiteTigerHyperionChargingSN,
         ...
         wt_sn_items.WhiteTigerStunAreaSN), updateCallback)
...
class WhiteTigerStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateNotificationTimerSettings(self):
        ...
        self._addNotificationTimerSetting(data, _TYPES.WT_HYPERION_2025_WARNING_CHARGING, _LINKS.WT_HYPERION_WARNING_2025_ICON, link, _COLORS.ORANGE, countdownVisible=True)
        ...
        self._addNotificationTimerSetting(data, _TYPES.WT_STUN_AREA, _LINKS.WT_STUN_AREA_ICON, link, _COLORS.ORANGE)
        return data
