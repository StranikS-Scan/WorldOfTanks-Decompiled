...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/Scaleform/daapi/view/lobby/hangar/prime_time/white_tiger_prime_time_view.py
...
class WhiteTigerPrimeTimeView(PrimeTimeViewBase):
    ...
    def __getStatusTitle(self):
        ...
        return text_styles.grandTitle(backport.text(R.strings.white_tiger_lobby.primeTime.status.disableFirst(), server=currServerName)) if status in (PrimeTimeStatus.FROZEN, PrimeTimeStatus.NOT_SET) else text_styles.grandTitle(backport.text(R.strings.white_tiger_lobby.primeTime.status.allServersDisabled()))
