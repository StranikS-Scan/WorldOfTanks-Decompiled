...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/Scaleform/daapi/view/tooltips/wt_tooltips.py
import logging
...
class EventBattlesCalendar(BlocksTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        if self.__gameEventController.isModeActive():
            ...
            blocks.append(formatters.packBuildUpBlockData([packTimeTableHeaderBlock(SELECTOR_BATTLE_TYPES.EVENT)] + packCalendarBlock(self.__gameEventController, time_utils.getCurrentTimestamp(), SELECTOR_BATTLE_TYPES.EVENT), 0, BLOCKS_TOOLTIP_TYPES.TOOLTIP_BUILDUP_BLOCK_WHITE_BG_LINKAGE, padding=formatters.packPadding(top=-8, bottom=-12)))
...
class EventQuestsTooltipData(BlocksTooltipData):
    ...
    def __packHeader(self, quests, vehicle):
        ...
        allBossCompleted = total == completed and vehicle.eventType == VEHICLE_TAGS.WT_BOSS
