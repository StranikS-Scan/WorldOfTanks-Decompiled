...
class EventBattlesCalendar(BlocksTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        if self.__gameEventController.isModeActive():
            ...
            blocks.append(formatters.packBuildUpBlockData([packTimeTableHeaderBlock(SELECTOR_BATTLE_TYPES.WHITE_TIGER)] + packCalendarBlock(self.__gameEventController, time_utils.getCurrentTimestamp(), SELECTOR_BATTLE_TYPES.WHITE_TIGER), 0, BLOCKS_TOOLTIP_TYPES.TOOLTIP_BUILDUP_BLOCK_WHITE_BG_LINKAGE, padding=formatters.packPadding(top=-8, bottom=-12)))
