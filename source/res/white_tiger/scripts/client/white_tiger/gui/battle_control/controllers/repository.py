...
from gui.battle_control.controllers import battle_field_ctrl, debug_ctrl, team_bases_ctrl, default_maps_ctrl, perk_ctrl, arena_info_ctrl, players_panel_ctrl, teleport_spawn_ctrl
