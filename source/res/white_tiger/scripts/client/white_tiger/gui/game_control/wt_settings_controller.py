...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/game_control/wt_settings_controller.py
...
class WtSettingsController(IWhiteTigerSettingsController, IGlobalListener):
    ...
    def __applyIndicatorSettings(self, vehicleType):
        if not vehicleType or not self.__isInEvent:
            ...
            bossType = getBossType(vehicleType.tags)
            isBoss = bossType is not None
