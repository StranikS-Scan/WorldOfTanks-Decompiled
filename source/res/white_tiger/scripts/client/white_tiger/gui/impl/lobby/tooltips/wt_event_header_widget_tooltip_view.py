...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/impl/lobby/tooltips/wt_event_header_widget_tooltip_view.py
from frameworks.wulf import ViewSettings
from gui.battle_pass.battle_pass_bonuses_packers import packBonusModelAndTooltipData
from gui.impl.gen import R
from white_tiger.gui.impl.gen.view_models.views.lobby.tooltips.wt_event_header_widget_tooltip_view_model import WtEventHeaderWidgetTooltipViewModel, PerformanceRisk
...
class WtEventHeaderWidgetTooltipView(ViewImpl):
    ...
    def __init__(self):
        settings = ViewSettings(R.views.white_tiger.lobby.tooltips.ProgressionEntryPointTooltip())
