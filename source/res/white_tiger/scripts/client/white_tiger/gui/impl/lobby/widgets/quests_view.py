...
class QuestsView(ViewComponent[QuestsViewModel]):
    ...
    def _getEvents(self):
        return ((self.viewModel.onSelectedTab, self.__onSelectedTab), (self.eventsCache.onSyncCompleted, self._onSyncCompleted), (self.wtController.onSettingsChanged, self._onSettingsChanged))
