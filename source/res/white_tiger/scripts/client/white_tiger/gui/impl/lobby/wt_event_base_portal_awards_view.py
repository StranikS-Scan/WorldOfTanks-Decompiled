...
# Embedded file name: white_tiger/scripts/client/white_tiger/gui/impl/lobby/wt_event_base_portal_awards_view.py
import logging
...
from white_tiger.gui.wt_event_models_helper import setLootBoxesCount
...
class WtEventBasePortalAwards(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return WtEventBuyLootBoxesTooltipView() if contentID == R.views.white_tiger.lobby.tooltips.BuyLootBoxesTooltipView() else super(WtEventBasePortalAwards, self).createToolTipContent(event, contentID)
