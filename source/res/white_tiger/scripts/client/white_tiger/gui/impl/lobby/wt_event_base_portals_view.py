...
class WtEventBasePortalsView(ViewImpl):
    ...
    def _updateModel(self):
        ...
        mainVehiclePrizeCD = self._lootBoxesCtrl.getMainPrizeVehicles()[0]
        vehicle = self._itemsCache.items.getItemByCD(mainVehiclePrizeCD)
        self.viewModel.setTankName(vehicle.userName)
        self.viewModel.setTankLevel(vehicle.level)
        self.viewModel.setTankNation(vehicle.name.split(':')[0])
        self.viewModel.setTankType(vehicle.type)
