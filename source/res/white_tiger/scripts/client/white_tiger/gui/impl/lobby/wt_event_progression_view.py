...
from white_tiger.gui.impl.lobby.tooltips.cinematic_tooltip import CinematicTooltip
...
class WTEventProgressionView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.white_tiger.lobby.tooltips.CinematicTooltip():
            outro = bool(event.getArgument('isOutroTooltip'))
            completed = bool(event.getArgument('isProgressionCompleted'))
            return CinematicTooltip(isProgressionCompleted=completed, isOutroTooltip=outro)
