...
class WTEventVehicleSoundPlayer(object):
    _SOUND_MAPPING = {'ussr:R97_Object_140_hound_TLXXL': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_Ob140', 'SoundObject_Ob140')),
     ...
     'ussr:R232_IS-7G': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_wt', 'SoundObject_E100_TLXXL_S')),
     'ussr:R232_IS-7W': (_SoundComponent, ('ev_white_tiger_hangar_electric_substance_is', 'SoundObject_E100_TLXXL_S'))}
...
def playLootboxVehicleRewardsLoopStarted(eventSoundName):
    sound_helpers.play2d(eventSoundName)
    WWISE.WW_setState(_WTEventPortalVideos.GROUP, _WTEventPortalVideos.STOP)
