...
class WhiteTigerConfig(namedtuple('WhiteTigerConfig', ('isEnabled', 'peripheryIDs', 'primeTimes', 'seasons', 'cycleTimes', 'progression', 'stampsPerProgressionStage', 'stamp', 'mainPrizeDiscountToken', 'mainPrizeDiscountPerToken', 'mainPrizeMaxDiscountTokenCount', 'mainPrizeBoughtToken', 'hunterPortalPrice', 'bossPortalPrice', 'tankPortalPrice', 'ticketToken', 'quickBossTicketToken', 'quickHunterTicketToken', 'ticketsToDraw', 'lootBoxDailyPurchaseLimit', 'lootBoxCounterEntitlementID', 'ticketToken2025', 'tickets2025ToDraw', 'maxPlayerInactiveTime'))):
    __slots__ = ()
