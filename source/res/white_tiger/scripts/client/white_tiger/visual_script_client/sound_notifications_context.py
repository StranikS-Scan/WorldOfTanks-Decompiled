...
# Embedded file name: white_tiger/scripts/client/white_tiger/visual_script_client/sound_notifications_context.py
...
class WTSoundNotificationsContext(SoundNotificationsContext):
    ...
    @vse_get_property(SLOT_TYPE.BOOL, display_name='GetIsExpertPlayer', description='Returns is expert based on battle count', aspects=[ASPECT.CLIENT])
