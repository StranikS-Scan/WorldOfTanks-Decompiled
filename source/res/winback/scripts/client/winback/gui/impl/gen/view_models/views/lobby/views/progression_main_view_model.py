...
# Embedded file name: winback/scripts/client/winback/gui/impl/gen/view_models/views/lobby/views/progression_main_view_model.py
from enum import IntEnum
from frameworks.wulf import ViewModel
from winback.gui.impl.gen.view_models.views.lobby.views.progression_view_model import ProgressionViewModel
