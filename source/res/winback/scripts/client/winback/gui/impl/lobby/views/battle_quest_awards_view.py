...
# Embedded file name: winback/scripts/client/winback/gui/impl/lobby/views/battle_quest_awards_view.py
from winback.gui.impl.gen.view_models.views.lobby.missions.battle_quest_awards_model import BattleQuestAwardsModel, BattleStatus
...
class BattleQuestAwardsView(ViewImpl):
    ...
    def __init__(self, stage):
        settings = ViewSettings(R.views.winback.BattleQuestAwardsView())
    ...
    def updateModel(self):
        ...
        with self.viewModel.transaction() as model:
            ...
            packBonusModelAndTooltipData(bonuses, rewards, self.__tooltipData, getWinbackBonusPacker())
