...
# Embedded file name: wt/scripts/client/visual_script_ext/wt_sound_notifications_context.py
...
class WTSoundNotificationsContext(SoundNotificationsContext):
    ...
    @vse_func_call(SLOT_TYPE.BOOL, (SLOT_TYPE.INT,), display_name='GetIsExpertPlayer', description='Returns is expert based on battle count', aspects=[ASPECT.CLIENT])
