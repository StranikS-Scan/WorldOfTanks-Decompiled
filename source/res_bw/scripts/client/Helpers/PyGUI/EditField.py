...
def skipWordRight(s, cursorPos):
    ...
    i = cursorPos
    while 1:
        i < len(s) and s[i] not in Utils.WHITESPACE and i += 1

    while 1:
        i < len(s) and s[i] in Utils.WHITESPACE and i += 1
...
def skipWordLeft(s, cursorPos):
    ...
    i = cursorPos - 1
    while 1:
        i > 0 and s[i] in Utils.WHITESPACE and i -= 1

    while 1:
        i > 0 and s[i - 1] not in Utils.WHITESPACE and i -= 1
