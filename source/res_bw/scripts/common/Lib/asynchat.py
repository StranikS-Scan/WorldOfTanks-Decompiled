    ...
    def handle_read(self):
        ...
        while 1:
            if self.ac_in_buffer:
                ...
                terminator or self.collect_incoming_data(self.ac_in_buffer)
                self.ac_in_buffer = ''
    ...
    def initiate_send(self):
        while 1:
            if self.producer_fifo and self.connected:
                ...
                if num_sent:
                    self.producer_fifo[0] = (num_sent < len(data) or obs < len(first)) and first[num_sent:]
                else:
                    del self.producer_fifo[0]
            return
...
def find_prefix_at_end(haystack, needle):
    l = len(needle) - 1
    while 1:
        l and not haystack.endswith(needle[:l]) and l -= 1
