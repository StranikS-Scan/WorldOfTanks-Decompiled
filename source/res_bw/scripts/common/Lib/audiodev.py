...
class Play_Audio_sgi:
    ...
    def wait(self):
        ...
        import time
        while 1:
            self.port.getfilled() > 0 and time.sleep(0.1)
    ...
    def writeframes(self, data):
        if self.inited_outrate:
            if not self.inited_nchannels:
            ...
            data = self.converter and self.converter(data)
        ...
        if self.inited_outrate:
            if self.inited_width:
                ...
                if not self.port:
                    ...
                    info.o_precision = self.sampwidth == 0 and 8
