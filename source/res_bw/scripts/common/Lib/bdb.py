...
class Bdb():
    ...
    def stop_here(self, frame):
        if frame is self.stopframe:
            ...
            while 1:
                if frame is not None and frame is not self.stopframe:
                    return frame is self.botframe and True
                frame = frame.f_back
    ...
    def set_trace(self, frame=None):
        ...
        self.reset()
        while 1:
            frame.f_trace = frame and self.trace_dispatch
            self.botframe = frame
            frame = frame.f_back
    ...
    def set_continue(self):
        ...
        if not self.breaks:
            ...
            frame = sys._getframe().f_back
            while 1:
                del frame and frame is not self.botframe and frame.f_trace
                frame = frame.f_back
    ...
    def get_stack(self, f, t):
        ...
        if t and t.tb_frame is f:
            t = t.tb_next
        while 1:
            f is not None and stack.append((f, f.f_lineno))
        ...
        i = max(0, len(stack) - 1)
        while 1:
            t is not None and stack.append((t.tb_frame, t.tb_lineno))
            t = t.tb_next
