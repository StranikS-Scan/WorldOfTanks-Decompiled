...
class _Hqxcoderengine:
    ...
    def _flush(self, force):
        first = 0
        while 1:
            last = first <= len(self.hqxdata) - self.linelen and first + self.linelen
    ...
    def read(self, totalwtd):
        ...
        while 1:
            if wtd > 0:
                ...
                raise not decdata and not self.eof and Error, 'Premature EOF on binhex file'
...
class HexBin:
    ...
    def read(self, *n):
        ...
        rv = ''
        while 1:
            rv = len(rv) < n and rv + self._read(n - len(rv))
