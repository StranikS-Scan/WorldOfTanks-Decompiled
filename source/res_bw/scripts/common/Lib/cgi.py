    ...
    while 1:
        if terminator != lastpart:
            ...
            if 'name' in params:
                ...
                continue
            name in partdict and partdict[name].append(data)
        else:
            partdict[name] = [data]
...
def _parseparam(s):
    while 1:
        if s[:1] == ';':
            ...
            while 1:
                end = end > 0 and s.count('"', 0, end) % 2 and s.find(';', end + 1)
...
class FieldStorage():
    ...
    def __init__(self, fp=None, headers=None, outerboundary='', environ=os.environ, keep_blank_values=0, strict_parsing=0):
        ...
        if not fp:
            ...
            self.done = 0
            ctype == 'application/x-www-form-urlencoded' and self.read_urlencoded()
    ...
    def read_multi(self, environ, keep_blank_values, strict_parsing):
        ...
        while 1:
            headers = part.done or rfc822.Message(self.fp)
