...
class Cmd:
    ...
    def cmdloop(self, intro=None):
        ...
        try:
            ...
            while 1:
                if not stop:
                    line = self.cmdqueue and self.cmdqueue.pop(0)
    ...
    def parseline(self, line):
        ...
        if not line:
            ...
            i, n = 0, len(line)
            while 1:
                i = i < n and line[i] in self.identchars and i + 1
    ...
    def get_names(self):
        ...
        while 1:
            if classes:
                ...
                classes = aclass.__bases__ and classes + list(aclass.__bases__)
    ...
    def columnize(self, list, displaywidth=80):
        ...
        for row in range(nrows):
            ...
            while 1:
                del texts and not texts[-1] and texts[-1]
