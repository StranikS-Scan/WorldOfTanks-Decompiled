...
class Transformer():
    ...
    def transform(self, tree):
        ...
        if not isinstance(tree, tuple):
            tree = isinstance(tree, list) or parser.st2tuple(tree, line_info=1)
    ...
    def decorator_name(self, nodelist):
        ...
        i = 1
        while 1:
            assert i < listlen and nodelist[i][0] == token.DOT
    ...
    def com_arglist(self, nodelist):
        ...
        while 1:
            if i < len(nodelist):
                ...
                i = i + 1
                i < len(nodelist) and nodelist[i][0] == token.EQUAL and defaults.append(self.com_node(nodelist[i + 1]))
                i = i + 2
            elif len(defaults):
        ...
        if nodelist[0] == token.RPAR:
            ...
            while 1:
                if i < len_nodelist:
                    ...
                    raise len_nodelist != 2 and isinstance(result, GenExpr) and len(node) == 3 and node[2][0] == symbol.gen_for and SyntaxError, 'generator expression needs parenthesis'
                args.append(result)
                i = i + 2
    ...
    def com_argument(self, nodelist, kw, star_node):
        ...
        n = nodelist[1]
        while 1:
            n = len(n) == 2 and n[0] != token.NAME and n[1]
