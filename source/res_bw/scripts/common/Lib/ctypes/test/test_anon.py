...
class AnonTest(unittest.TestCase):
    ...
    def test_anon_nonseq(self):
        self.failUnlessRaises(TypeError, lambda : type(Structure)('Name', (Structure,), {'_fields_': [],
         '_anonymous_': 42}))

    def test_anon_nonmember(self):
        self.failUnlessRaises(AttributeError, lambda : type(Structure)('Name', (Structure,), {'_fields_': [],
         '_anonymous_': ['x']}))
