...
class Test(unittest.TestCase):
    ...
    def test_array2pointer(self):
        ...
        if 2 * sizeof(c_short) == sizeof(c_int):
            ...
            if sys.byteorder == 'little':
                self.failUnlessEqual([ ptr[i] for i in range(6) ], [42,
                 0,
                 17,
                 0,
                 2,
                ...
                self.failUnlessEqual([ ptr[i] for i in range(6) ], [0,
                 42,
                 0,
                 17,
                 0,
    ...
    def test_p2a_objects(self):
        ...
        p[1] = 'foo bar'
        self.failUnlessEqual(p._objects, {'1': 'foo bar',
         '0': 'spam spam',
         id(array): array})
        self.failUnless(array._objects is p._objects)
        return
    ...
    def test_other(self):
        ...
        self.failUnlessEqual(p[:4:], [1,
         ...
         3,
         4])
        self.failUnlessEqual(p[3:-1:-1], [4,
         3,
         2,
         1])
