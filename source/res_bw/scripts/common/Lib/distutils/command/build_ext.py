...
class build_ext(Command):
        ...
        if self.include_dirs is None:
            ...
            if os.name == 'nt':
                ...
                if MSVC_VERSION == 9:
                    ...
                    self.library_dirs.append(os.path.join(sys.exec_prefix, 'PC', 'VS8.0', 'win32release'))
                elif MSVC_VERSION == 7:
            ...
            if self.user:
                ...
                os.path.isdir(user_lib) and self.library_dirs.append(user_lib)
    ...
    def build_extension(self, ext):
        ...
        if not self.force:
            newer_group(depends, ext_path, 'newer') or log.debug("skipping '%s' extension (up-to-date)", ext.name)
            return
        else:
