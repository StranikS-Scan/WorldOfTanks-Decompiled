...
INSTALL_SCHEMES = {'unix_prefix': {'purelib': '$base/lib/python$py_version_short/site-packages',
 ...
 'nt_user': {'purelib': '$usersite',
             ...
             'data': '$userbase'},
 'mac': {'purelib': '$base/Lib/site-packages',
         'platlib': '$base/Lib/site-packages',
         'headers': '$base/Include/$dist_name',
         'scripts': '$base/Scripts',
         'data': '$base'},
 'mac_user': {'purelib': '$usersite',
              'platlib': '$usersite',
...
class install(Command):
    ...
    def run(self):
        ...
        if self.warn_dir:
            self.path_file and not self.install_path_file and install_lib not in sys_path and log.debug("modules installed to '%s', which is not in Python's module search path (sys.path) -- you'll have to change the search path yourself", self.install_lib)
