...
class NullTranslations:
    ...
    def install(self, unicode=False, names=None):
        import __builtin__
        if not (unicode and self.ugettext):
            __builtin__.__dict__['_'] = self.gettext
            if hasattr(names, '__contains__'):
                if 'gettext' in names:
                    __builtin__.__dict__['gettext'] = __builtin__.__dict__['_']
                if 'ngettext' in names:
                    if not (unicode and self.ungettext):
                        __builtin__.__dict__['ngettext'] = self.ngettext
                    __builtin__.__dict__['lgettext'] = 'lgettext' in names and self.lgettext
                __builtin__.__dict__['lngettext'] = 'lngettext' in names and self.lngettext
