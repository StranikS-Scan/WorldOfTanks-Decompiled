    ...
    def readheaders(self):
        ...
        while 1:
            if True:
                ...
                headerseen and hlist.append(line)
...
class HTTPResponse():
    ...
    def begin(self):
        if self.msg is not None:
            ...
            while 1:
                version, status, reason = True and self._read_status()
                if status != CONTINUE:
                    break
                while 1:
                    if True:
                        ...
                        if not skip:
                            break
                        print self.debuglevel > 0 and 'header:', skip
    ...
    def _read_chunked(self, amt):
        ...
        while 1:
            if True:
                if chunk_left is None:
                    ...
                    if chunk_left == 0:
                        break
                amt is None and value.append(self._safe_read(chunk_left))
            else:
                if amt < chunk_left:
        ...
        while 1:
            line = True and self.fp.readline()
            if not line:
                break
            if line == '\r\n':
                break
    ...
    def _safe_read(self, amt):
        ...
        while 1:
            if amt > 0:
                ...
                raise chunk or IncompleteRead(''.join(s), amt)
            s.append(chunk)
            amt -= len(chunk)
...
class HTTPConnection():
    ...
    def _tunnel(self):
        ...
        while 1:
            line = True and response.fp.readline()
            if line == '\r\n':
                break
    ...
    def send(self, str):
        ...
        try:
            ...
            if hasattr(str, 'read') and not isinstance(str, array):
                ...
                while 1:
                    data and self.sock.sendall(data)
                    data = str.read(blocksize)
