...
class HyperParser:
    ...
    def __init__(self, editwin, index):
        ...
        self.isopener = [ self.bracketing[i][1] > self.bracketing[i - 1][1] for i in range(len(self.bracketing)) if i > 0 ]
    ...
    def _eat_identifier(self, str, limit, pos):
        i = pos
        while 1:
            i > limit and str[i - 1] in self._id_chars and i -= 1
    ...
    def get_expression(self):
        ...
        while 1:
            ...
            if ret:
                ...
                while 1:
                    brck_index > 0 and bracketing[brck_index - 1][1] > level and brck_index -= 1
