...
class ScriptBinding:
    ...
    def ask_save_dialog(self):
        ...
        mb = tkMessageBox.Message(title='Save Before Run or Check', message=msg, icon=tkMessageBox.QUESTION, type=tkMessageBox.OKCANCEL, default=tkMessageBox.OK, master=self.editwin.text)
        return mb.show()
