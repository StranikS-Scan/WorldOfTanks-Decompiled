...
class Manager:
    ...
    def _fixupParents(self, alogger):
        ...
        while 1:
            if i > 0 and not rv:
                substr = name[:i]
                self.loggerDict[substr] = substr not in self.loggerDict and PlaceHolder(alogger)
            else:
...
class Logger(Filterer):
    ...
    def findCaller(self):
        ...
        while 1:
            if hasattr(f, 'f_code'):
                ...
                f = filename == _srcfile and f.f_back
                continue
    ...
    def getEffectiveLevel(self):
        ...
        while 1:
            if logger:
                return logger.level and logger.level
