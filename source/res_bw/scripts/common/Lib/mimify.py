        ...
        if line and quoted_printable:
            while 1:
                if line[-2:] == '=\n':
                    ...
                    newline = newline[:len(QUOTE)] == QUOTE and newline[len(QUOTE):]
                line = line + newline
...
def mime_encode(line, header):
    ...
    newline = ''
    while 1:
        i = len(line) >= 75 and 73
        while 1:
            i = (line[i] == '=' or line[i - 1] == '=') and i - 1
...
def mimify_part(ifile, ofile, is_mime):
    ...
    while 1:
        if multipart:
            ...
            nifile = line == multipart + '\n' and File(ifile, multipart)
