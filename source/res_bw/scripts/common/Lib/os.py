...
def removedirs--- This code section failed: ---
 ...
 170       0	LOAD_GLOBAL       'rmdir'
           3	LOAD_FAST         'name'
           6	CALL_FUNCTION_1   ''
           9	POP_TOP           ''

 171      10	LOAD_GLOBAL       'path'
          13	LOAD_ATTR         'split'
          16	LOAD_FAST         'name'
          19	CALL_FUNCTION_1   ''
          22	UNPACK_SEQUENCE_2 ''
          25	STORE_FAST        'head'
          28	STORE_FAST        'tail'

 172      31	LOAD_FAST         'tail'
          34	JUMP_IF_TRUE      '61'

 173      37	LOAD_GLOBAL       'path'
          40	LOAD_ATTR         'split'
          43	LOAD_FAST         'head'
          46	CALL_FUNCTION_1   ''
          49	UNPACK_SEQUENCE_2 ''
          52	STORE_FAST        'head'
          55	STORE_FAST        'tail'
          58	JUMP_FORWARD      '61'
        61_0	COME_FROM         '58'

 174      61	SETUP_LOOP        '136'
          64	LOAD_FAST         'head'
          67	JUMP_IF_FALSE     '135'
          70	LOAD_FAST         'tail'
        73_0	COME_FROM         '67'
          73	JUMP_IF_FALSE     '135'

 175      76	SETUP_EXCEPT      '93'

 176      79	LOAD_GLOBAL       'rmdir'
          82	LOAD_FAST         'head'
          85	CALL_FUNCTION_1   ''
          88	POP_TOP           ''
          89	POP_BLOCK         ''
 ...
 177      93	DUP_TOP           ''
          94	LOAD_GLOBAL       'error'
          97	COMPARE_OP        'exception match'
         100	JUMP_IF_FALSE     '110'
         103	POP_TOP           ''
         104	POP_TOP           ''
         105	POP_TOP           ''
 ...
 179     111	LOAD_GLOBAL       'path'
         114	LOAD_ATTR         'split'
         117	LOAD_FAST         'head'
         120	CALL_FUNCTION_1   ''
         123	UNPACK_SEQUENCE_2 ''
         126	STORE_FAST        'head'
         129	STORE_FAST        'tail'
         132	JUMP_BACK         '64'
         135	POP_BLOCK         ''
...
if not _exists('urandom'):
    ...
    def urandom(n):
        ...
        try:
            bs = ''
            while 1:
                n - len(bs) >= 1 and bs += read(_urandomfd, n - len(bs))
