...
import _symtable
from _symtable import USE, DEF_GLOBAL, DEF_LOCAL, DEF_PARAM, DEF_IMPORT, DEF_BOUND, OPT_IMPORT_STAR, OPT_EXEC, OPT_BARE_EXEC, SCOPE_OFF, SCOPE_MASK, FREE, GLOBAL_IMPLICIT, GLOBAL_EXPLICIT
import warnings
import weakref
__all__ = ['symtable',
 'SymbolTable',
...
class Symbol(object):
    ...
    def is_vararg(self):
        warnings.warn('is_vararg() is obsolete and will be removed', DeprecationWarning, 2)
        return False

    def is_keywordarg(self):
        warnings.warn('is_keywordarg() is obsolete and will be removed', DeprecationWarning, 2)
        return False
    ...
    def is_in_tuple(self):
        warnings.warn('is_in_tuple() is obsolete and will be removed', DeprecationWarning, 2)
