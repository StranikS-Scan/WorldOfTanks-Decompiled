...
from urllib import unwrap, unquote, splittype, splithost, quote, addinfourl, splitport, splitattr, ftpwrapper, splituser, splitpasswd, splitvalue
    ...
    def reduce_uri(self, uri, default_port=True):
        ...
        if parts[1]:
            ...
            if default_port and port is None and scheme is not None:
                ...
                authority = dport is not None and '%s:%d' % (host, dport)
    ...
    def ftp_open(self, req):
        ...
        try:
            ...
            if not (file and 'I'):
                ...
                retrlen is not None and retrlen >= 0 and headers += 'Content-length: %d\n' % retrlen
            sf = StringIO(headers)
