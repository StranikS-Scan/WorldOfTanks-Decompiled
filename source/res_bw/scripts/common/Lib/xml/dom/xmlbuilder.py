    ...
    def getFeature(self, name):
        ...
        try:
            ...
            if name == 'infoset':
                ...
                return options.datatype_normalization and options.whitespace_in_element_content and options.comments and options.charset_overrides_xml_encoding and (options.namespace_declarations or options.validate_if_schema or options.create_entity_ref_nodes or options.entities or not options.cdata_sections)
