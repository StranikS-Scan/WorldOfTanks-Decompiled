...
class Test_Assertions(unittest.TestCase):
    ...
    def test_AmostEqualWithDelta(self):
        ...
        self.assertRaises(TypeError, self.assertAlmostEqual, 1.1, 1.0, delta = 2, places = 2)
        self.assertRaises(TypeError, self.assertNotAlmostEqual, 1.1, 1.0, delta = 2, places = 2)
...
class TestLongMessage(unittest.TestCase):
    ...
    def testAlmostEqual(self):
        self.assertMessages('assertAlmostEqual', (1, 2), ['^1 != 2 within 7 places$', '^oops$', '^1 != 2 within 7 places$', '^1 != 2 within 7 places : oops$'])
