...
import unittest
from support import TestEquality
from support import TestHashing
from support import LoggingResult
from support import ResultWithNoStartTestRunStopTestRun
class Test(object):
...
class Test_TestCase(unittest.TestCase, TestEquality, TestHashing):
    ...
    def testAssertItemsEqual(self):
        ...
        self.assertRaises(self.failureException, self.assertItemsEqual, [1, {'b': 2}, None, True], [{'b': 2}, True, None])
        a = [{2, 4}, {1, 2}]
        b = a[::-1]
        self.assertItemsEqual(a, b)
        diffs = set(unittest.util._count_diff_all_purpose('aaabccd', 'abbbcce'))
        expected = {(3, 1, 'a'), (1, 0, 'd'), (1, 3, 'b'), (0, 1, 'e')}
